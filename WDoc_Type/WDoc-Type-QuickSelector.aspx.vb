...
' This file implements the code-behind class for WDoc_Type_QuickSelector.aspx.
' App_Code\WDoc_Type_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WDoc_Type_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the WDoc_Type_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.WDoc_Type_QuickSelector.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.WDoc_Type_QuickSelector.SelectorTableControl()
