...
' This file implements the code-behind class for Show_W_User_Table.aspx.
' App_Code\Show_W_User_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_W_User_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_W_User_Table page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetW_UserTableControl()
            SetW_UserTableControl_Base() 
        End Sub
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "W_UserTableControl"
                 SetW_UserTableControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.W_UserTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_SearchText_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.Show_W_User_Table.W_UserTableControl 
            control = new ePortalWFApproval.UI.Controls.Show_W_User_Table.W_UserTableControl()
        ...
        SetW_UserTableControl()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "W_UserMenuItem"
                    End If
                End If
        ...
        Public Sub SetW_UserTableControl_Base()           
        
        
            If W_UserTableControl.Visible Then
                W_UserTableControl.LoadData()
                W_UserTableControl.DataBind()
            End If
        End Sub        
