...
' This file implements the code-behind class for W_User_QuickSelector.aspx.
' App_Code\W_User_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class W_User_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the W_User_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.W_User_QuickSelector.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.W_User_QuickSelector.SelectorTableControl()
