<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="WClassification-QuickSelector1.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="ePortalWFApproval.UI.WClassification_QuickSelector1" %>
<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.WClassification_QuickSelector1" %>
