...
' This file implements the code-behind class for Edit_WCAR_Doc.aspx.
' App_Code\Edit_WCAR_Doc.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Edit_WCAR_Doc
        Inherits BaseApplicationPage
' Code-behind class for the Edit_WCAR_Doc page.
