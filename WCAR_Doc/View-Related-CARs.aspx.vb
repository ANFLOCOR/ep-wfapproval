...
' This file implements the code-behind class for View_Related_CARs.aspx.
' App_Code\View_Related_CARs.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class View_Related_CARs
        Inherits BaseApplicationPage
' Code-behind class for the View_Related_CARs page.
...
Public Sub SetSel_WCAR_Doc_Related_SupplementalTableControl()
            SetSel_WCAR_Doc_Related_SupplementalTableControl_Base() 
        End Sub
<System.Web.Services.WebMethod()> _
        Public Shared Function GetImage(ByVal tableName As String, _
                                        ByVal recordID As String, _
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "View Related CAR Document"
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "Sel_WCAR_Doc_Related_SupplementalTableControl"
                 SetSel_WCAR_Doc_Related_SupplementalTableControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.Sel_WCAR_Doc_Related_SupplementalTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetSel_WCAR_Doc_Related_SupplementalTableControl_Base()           
        
        
            If Sel_WCAR_Doc_Related_SupplementalTableControl.Visible Then
                Sel_WCAR_Doc_Related_SupplementalTableControl.LoadData()
                Sel_WCAR_Doc_Related_SupplementalTableControl.DataBind()
            End If
        End Sub        
