...
' This file implements the code-behind class for Show_WCAR_Doc_Table.aspx.
' App_Code\Show_WCAR_Doc_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_WCAR_Doc_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_WCAR_Doc_Table page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetWCAR_DocTableControl()
            SetWCAR_DocTableControl_Base() 
        End Sub
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.WCAR_DocTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetWCAR_DocTableControl_Base()           
