...
' This file implements the code-behind class for test.aspx.
...
' Code-behind class for the test page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        '        End Sub
        Public Sub SetWCAR_DocRecordControl1()
            SetWCAR_DocRecordControl1_Base()
        End Sub
<System.Web.Services.WebMethod()> _
        Public Shared Function GetImage(ByVal tableName As String, _
                                        ByVal recordID As String, _
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "WCAR_DocRecordControl1"
                 SetWCAR_DocRecordControl1()
      ...
      Public Sub SaveData_Base()
        ...
        Me.WCAR_DocRecordControl1.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetWCAR_DocRecordControl1_Base()           
        
        
            If WCAR_DocRecordControl1.Visible Then
                WCAR_DocRecordControl1.LoadData()
                WCAR_DocRecordControl1.DataBind()
            End If
        End Sub        
