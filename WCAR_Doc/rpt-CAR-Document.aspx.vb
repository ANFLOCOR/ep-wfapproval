...
' This file implements the code-behind class for rpt_CAR_Document.aspx.
' App_Code\rpt_CAR_Document.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class rpt_CAR_Document
        Inherits BaseApplicationPage
' Code-behind class for the rpt_CAR_Document page.
