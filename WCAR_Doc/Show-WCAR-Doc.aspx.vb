...
' This file implements the code-behind class for Show_WCAR_Doc.aspx.
' App_Code\Show_WCAR_Doc.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_WCAR_Doc
        Inherits BaseApplicationPage
' Code-behind class for the Show_WCAR_Doc page.
