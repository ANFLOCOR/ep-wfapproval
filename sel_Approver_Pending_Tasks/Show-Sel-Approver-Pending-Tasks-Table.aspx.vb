...
' This file implements the code-behind class for Show_Sel_Approver_Pending_Tasks_Table.aspx.
' App_Code\Show_Sel_Approver_Pending_Tasks_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Sel_Approver_Pending_Tasks_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_Sel_Approver_Pending_Tasks_Table page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Approver Pending Tasks"
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_SearchText_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.Show_Sel_Approver_Pending_Tasks_Table.Sel_Approver_Pending_TasksTableControl 
            control = new ePortalWFApproval.UI.Controls.Show_Sel_Approver_Pending_Tasks_Table.Sel_Approver_Pending_TasksTableControl()
        ...
        SetSel_Approver_Pending_TasksTableControl()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "Sel_Approver_Pending_TasksMenuItem"
                    End If
                End If
