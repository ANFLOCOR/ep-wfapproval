...
' This file implements the code-behind class for Show_Sel_WPO_Activity_WPOP10100_Table1.aspx.
' App_Code\Show_Sel_WPO_Activity_WPOP10100_Table1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Sel_WPO_Activity_WPOP10100_Table1
        Inherits BaseApplicationPage
' Code-behind class for the Show_Sel_WPO_Activity_WPOP10100_Table1 page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetSel_WPO_Activity_WPOP101001TableControl()
            SetSel_WPO_Activity_WPOP101001TableControl_Base() 
        End Sub
...
'<System.Web.Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_WPO_Step_WPO_StepDetail1SearchText(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetWPO_Step_WPO_StepDetail1SearchTextCompletionList gets the list of suggestions from the database.
'      ' prefixText is the search text typed by the user .
'      ' count specifies the number of suggestions to be returned.
'      ' Customize by adding code before or after the call to  GetAutoCompletionList_WPO_Step_WPO_StepDetail1SearchText()
'      ' or replace the call to GetAutoCompletionList_WPO_Step_WPO_StepDetail1SearchText().
'      Return GetAutoCompletionList_WPO_Step_WPO_StepDetail1SearchText_Base(prefixText, count)
'      End Function
'<System.Web.Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_WPO_PRNo_QWF1SearchText(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetWPO_PRNo_QWF1SearchTextCompletionList gets the list of suggestions from the database.
'      ' prefixText is the search text typed by the user .
'      ' count specifies the number of suggestions to be returned.
'      ' Customize by adding code before or after the call to  GetAutoCompletionList_WPO_PRNo_QWF1SearchText()
'      ' or replace the call to GetAutoCompletionList_WPO_PRNo_QWF1SearchText().
'      Return GetAutoCompletionList_WPO_PRNo_QWF1SearchText_Base(prefixText, count)
'      End Function
'<System.Web.Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_WPO_Activity1SearchText(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetWPO_Activity1SearchTextCompletionList gets the list of suggestions from the database.
'      ' prefixText is the search text typed by the user .
'      ' count specifies the number of suggestions to be returned.
'      ' Customize by adding code before or after the call to  GetAutoCompletionList_WPO_Activity1SearchText()
'      ' or replace the call to GetAutoCompletionList_WPO_Activity1SearchText().
'      Return GetAutoCompletionList_WPO_Activity1SearchText_Base(prefixText, count)
'      End Function
        '<System.Web.Services.WebMethod()> _
        '        Public Shared Function GetImage(ByVal tableName As String, _
        '                                        ByVal recordID As String, _
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "PO Workflow Tasks (North)"
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "Sel_WPO_Activity_WPOP101001TableControl"
                 SetSel_WPO_Activity_WPOP101001TableControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.Sel_WPO_Activity_WPOP101001TableControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetSel_WPO_Activity_WPOP101001TableControl_Base()           
        
        
            If Sel_WPO_Activity_WPOP101001TableControl.Visible Then
                Sel_WPO_Activity_WPOP101001TableControl.LoadData()
                Sel_WPO_Activity_WPOP101001TableControl.DataBind()
            End If
        End Sub        
