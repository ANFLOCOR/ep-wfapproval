...
' This file implements the code-behind class for Show_WCAR_Activity_Table1.aspx.
' App_Code\Show_WCAR_Activity_Table1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_WCAR_Activity_Table1
        Inherits BaseApplicationPage
' Code-behind class for the Show_WCAR_Activity_Table1 page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
			...
			Me.Authorize(Ctype(WCAR_Activity1TableControl, Control), "NOT_ANONYMOUS")
            ...
            Page.Title = "ePortal Worflow Approval - Reassign CAR Document (North)"
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "WCAR_Activity1TableControl"
      ...
      Public Sub SaveData_Base()
        ...
        Me.WCAR_Activity1TableControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetWCAR_Activity1TableControl_Base()           
