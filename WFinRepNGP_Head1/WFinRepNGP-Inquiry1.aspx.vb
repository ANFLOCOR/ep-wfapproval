...
' This file implements the code-behind class for WFinRepNGP_Inquiry1.aspx.
' App_Code\Show_WFinRepNGP_Head_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WFinRepNGP_Inquiry1
        Inherits BaseApplicationPage
' Code-behind class for the WFinRepNGP_Inquiry1 page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetWFinRepNGP_Head1TableControl()
            SetWFinRepNGP_Head1TableControl_Base() 
        End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "ePortal Workflow Approval - Reports Inquiry Non-GP (North)"
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "WFinRepNGP_Head1TableControl"
      ...
      Public Sub SaveData_Base()
        ...
        Me.WFinRepNGP_Head1TableControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetWFinRepNGP_Head1TableControl_Base()           
