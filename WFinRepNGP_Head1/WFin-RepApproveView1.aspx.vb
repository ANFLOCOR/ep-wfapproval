...
' This file implements the code-behind class for WFin_RepApproveView1.aspx.
' App_Code\WFin_RepApproveView1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WFin_RepApproveView1
        Inherits BaseApplicationPage
' Code-behind class for the WFin_RepApproveView1 page.
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            ...
            Select Case sParamDB
                ...
                Case Else
                    If IsNumeric(sParamDB) Then
                        ...
                        ''pepanes 10.08.2015
                        Dim obC As OrderBy = New OrderBy(False, False)
                        Dim compRec As Vw_ANFLO_DW_CompanyNonGP1Record = Vw_ANFLO_DW_CompanyNonGP1View.GetRecord("DynamicsCompanyID=" & sParamDB, obC)
                        If Not (IsNothing(compRec)) Then
                            dbNameStr = compRec.DWCompanyID.ToString
                        End If
            ...
            Else
                ...
                Else
                    sDesc = "/Financial Reports/FS Viewer/"
                    sBSPath = sDesc + sParamDB + " " + sParamPath.ToUpper()
                End If
