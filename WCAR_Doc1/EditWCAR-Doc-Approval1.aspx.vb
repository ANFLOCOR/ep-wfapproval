...
' This file implements the code-behind class for EditWCAR_Doc_Approval1.aspx.
' App_Code\Edit_WCAR_Doc2.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditWCAR_Doc_Approval1
        Inherits BaseApplicationPage
' Code-behind class for the EditWCAR_Doc_Approval1 page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          ' or replace the call to LoadData_Base().
            ...
            If Me.Page.Request.QueryString.Item("WCAR_Doc1") Is Nothing Then
        ...
        Public Sub SaveButton_Click(ByVal sender As Object, ByVal args As EventArgs) Handles btnSubmitAction.Click
            ...
            wcCreator.iAND(WCAR_Doc1Table.WCD_ID, BaseFilter.ComparisonOperator.EqualsTo, Me.WCD_ID.Text)
            For Each itemCreator As WCAR_Doc1Record In WCAR_Doc1Table.GetRecords(wcCreator, Nothing, 0, 100)
            ...
            wc1.iAND(WCAR_Activity1Table.WCA_WCD_ID, BaseFilter.ComparisonOperator.EqualsTo, Me.WCD_ID.Text)
            wc1.iAND(WCAR_Activity1Table.WCA_W_U_ID, BaseFilter.ComparisonOperator.EqualsTo, System.Web.HttpContext.Current.Session("ActivityUserIDN").ToString())
            wc1.iAND(WCAR_Activity1Table.WCA_Status, BaseFilter.ComparisonOperator.EqualsTo, "Pending")
            'note: check to see if record is still pending, if not then do not save
            If WCAR_Activity1Table.GetRecords(wc1, Nothing, 0, 100).Length > 0 Then
                ...
                Select Case ddlAction.SelectedIndex
                    Case 0 'Approved
                        ...
                        wc2.iAND(Sel_WStep_WStep_Detail1View.WS_ID, BaseFilter.ComparisonOperator.EqualsTo, sCurStep)
                        ...
                        For Each itemValue2 As Sel_WStep_WStep_Detail1Record In Sel_WStep_WStep_Detail1View.GetRecords(wc2, Nothing, 0, 100)
                        ...
                        wc3.iAND(WCAR_Activity1Table.WCA_WCD_ID, BaseFilter.ComparisonOperator.EqualsTo, Me.WCD_ID.Text)
                        wc3.iAND(WCAR_Activity1Table.WCA_W_U_ID, BaseFilter.ComparisonOperator.Not_Equals, System.Web.HttpContext.Current.Session("ActivityUserIDN").ToString())
                        wc3.iAND(WCAR_Activity1Table.WCA_Status, BaseFilter.ComparisonOperator.EqualsTo, "Approved")
                        wc3.iAND(WCAR_Activity1Table.WCA_WS_ID, BaseFilter.ComparisonOperator.EqualsTo, sCurStep)
                        ''04.02.2014 -pepanes **gftey
                        wc3.iAND(WCAR_Activity1Table.WCA_Is_Done, BaseFilter.ComparisonOperator.EqualsTo, "0") 'WCA_Is_Done field is updated through trigger


                        For Each itemValue3 As WCAR_Activity1Record In WCAR_Activity1Table.GetRecords(wc3, Nothing, 0, 100)
                        ...
                        If iApprovers = colUser.Count + 1 Then 'met the # of approvers requirement (+1 -> means the current user)
                            If sNextStep = "0" Then 'no next step (end workflow here)
                                ...
                                wc5.iAND(WCAR_Activity1Table.WCA_W_U_ID, BaseFilter.ComparisonOperator.EqualsTo, System.Web.HttpContext.Current.Session("ActivityUserIDN").ToString())
                                wc5.iAND(WCAR_Activity1Table.WCA_Status, BaseFilter.ComparisonOperator.EqualsTo, "Pending")
                                wc5.iAND(WCAR_Activity1Table.WCA_WS_ID, BaseFilter.ComparisonOperator.EqualsTo, sCurStep)
                                ...
                                If WCAR_Activity1Table.GetRecords(wc5, Nothing, 0, 100).Length > 0 Then
                                    For Each itemValue5 As WCAR_Activity1Record In WCAR_Activity1Table.GetRecords(wc5, Nothing, 0, 100)
                                        ...
                                        WCAR_Activity1Record.UpdateRecord(itemValue5.WCA_ID.ToString(), "Approved")
                                    Next
                                End If
                                ...
                                For Each itemValue6 As WCAR_Doc1Record In WCAR_Doc1Table.GetRecords(wc6, Nothing, 0, 100)
                                    WCAR_Doc1Record.UpdateRecord(itemValue6.WCD_ID.ToString(), "Completed")
                                ...
                                For Each itemValueN As WF_Complete_Notify1Record In WF_Complete_Notify1Table.GetRecords(sNotifyComplete, Nothing, 0, 100)
                            ...
                            Else
                                If WCD_Status.Text <> "Return" Then
                                    ...
                                    wc4.iAND(WCAR_Activity1Table.WCA_W_U_ID, BaseFilter.ComparisonOperator.Not_Equals, System.Web.HttpContext.Current.Session("ActivityUserIDN").ToString())
                                    wc4.iAND(WCAR_Activity1Table.WCA_Status, BaseFilter.ComparisonOperator.EqualsTo, "Pending")
                                    wc4.iAND(WCAR_Activity1Table.WCA_WS_ID, BaseFilter.ComparisonOperator.EqualsTo, sCurStep)
                                    ...
                                    For Each itemValue4 As WCAR_Activity1Record In WCAR_Activity1Table.GetRecords(wc4, Nothing, 0, 100)
                                        ...
                                        WCAR_Activity1Record.UpdateRecord(itemValue4.WCA_ID.ToString(), "System Approved")
                                    Next
                                    ...
                                    wc6.iAND(Sel_WStep_WStep_Detail1View.WS_ID, BaseFilter.ComparisonOperator.EqualsTo, sNextStep)

                                    For Each itemValue6 As Sel_WStep_WStep_Detail1Record In Sel_WStep_WStep_Detail1View.GetRecords(wc6, Nothing, 0, 100)
                                        ...
                                        WCAR_Activity1Record.AddRecord(itemValue6.WS_ID.ToString(), itemValue6.WSD_ID.ToString(), _
                                ...
                                Else
                                    ...
                                    wc41.iAND(WCAR_Activity1Table.WCA_WCD_ID, BaseFilter.ComparisonOperator.EqualsTo, Me.WCD_ID.Text)
                                    wc41.iAND(WCAR_Activity1Table.WCA_W_U_ID, BaseFilter.ComparisonOperator.Not_Equals, System.Web.HttpContext.Current.Session("ActivityUserIDN").ToString())
                                    wc41.iAND(WCAR_Activity1Table.WCA_Status, BaseFilter.ComparisonOperator.EqualsTo, "Pending")
                                    wc41.iAND(WCAR_Activity1Table.WCA_WS_ID, BaseFilter.ComparisonOperator.EqualsTo, sCurStep)

                                    For Each itemValue41 As WCAR_Activity1Record In WCAR_Activity1Table.GetRecords(wc41, Nothing, 0, 100)
                                        'note: update Activity table (other user(s) if multiple approvers) -> 'System Approved'
                                        WCAR_Activity1Record.UpdateRecord(itemValue41.WCA_ID.ToString(), "System Approved")
                                    Next

                                    Dim wc4 As WhereClause = New WhereClause

                                    wc4.iAND(WCAR_Activity1Table.WCA_WCD_ID, BaseFilter.ComparisonOperator.EqualsTo, Me.WCD_ID.Text)
                                    wc4.iAND(WCAR_Activity1Table.WCA_W_U_ID, BaseFilter.ComparisonOperator.EqualsTo, System.Web.HttpContext.Current.Session("ActivityUserIDN").ToString())
                                    wc4.iAND(WCAR_Activity1Table.WCA_Status, BaseFilter.ComparisonOperator.EqualsTo, "Pending")
                                    wc4.iAND(WCAR_Activity1Table.WCA_WS_ID, BaseFilter.ComparisonOperator.EqualsTo, sCurStep)

                                    For Each itemValue4 As WCAR_Activity1Record In WCAR_Activity1Table.GetRecords(wc4, Nothing, 0, 100)
                                        WCAR_Activity1Record.UpdateRecord(itemValue4.WCA_ID.ToString(), "Approved")
                                    Next

                                    Dim wc5 As WhereClause = New WhereClause
                                    Dim orderBy As OrderBy = New OrderBy(False, True)
                                    orderBy.Add(WCAR_Activity1Table.WCA_ID, BaseClasses.Data.OrderByItem.OrderDir.Desc) 'get the latest return
                                    ...
                                    If WCAR_Activity1Table.GetRecords(wc5, orderBy, 0, 100).Length > 0 Then
                                        For Each itemValue5 As WCAR_Activity1Record In WCAR_Activity1Table.GetRecords(wc5, orderBy, 0, 100)
                                            'note: update Activity table (current user) -> 'Approved'
                                            ...
                                            Me.WCD_Project_Title.Text, Me.WCD_Request_Date.Text, Me.WCD_Remark.Text, Me.WCD_Exp_Cur_Yr.Text, _
                                            System.Web.HttpContext.Current.Session("UserIDNorth").ToString(), "#4682b4", "wf_car/ShowSel_WCAR_Activity_WCAR_DocTable.aspx", Me.WCD_No.Text, _
                                            "", "", "CAR")
                                            ...
                                            WCAR_Doc1Record.UpdateRecord_Status_Submit(Me.WCD_ID.Text, "Pending", "1", _
                                            DirectCast(Me.Page, BaseApplicationPage).CurrentSecurity.GetUserStatus().ToString() & _
                                            ": " & sRemark)

                                            WCAR_Activity1Record.AddRecord(itemValue5.WCA_WS_ID.ToString(), itemValue5.WCA_WSD_ID.ToString(), _
                                            Me.WCD_WDT_ID.SelectedValue.ToString(), _
                    ...
                    Case 1 'Rejected ---------------------------------------------------------------------------------------------
                        ...
                        For Each itemValue4 As WCAR_Activity1Record In WCAR_Activity1Table.GetRecords(wc4, Nothing, 0, 100)
                            ...
                            WCAR_Activity1Record.UpdateRecord(itemValue4.WCA_ID.ToString(), "System Rejected")
                        Next
                        ...
                        If WCAR_Activity1Table.GetRecords(wc5, Nothing, 0, 100).Length > 0 Then
                            For Each itemValue5 As WCAR_Activity1Record In WCAR_Activity1Table.GetRecords(wc5, Nothing, 0, 100)
                                ...
                                WCAR_Activity1Record.UpdateRecord(itemValue5.WCA_ID.ToString(), "Rejected")
                            Next
                        End If
                        ...
                        If ddlMoveto.SelectedValue.ToString() <> "0" Then 'not the creator
                            wc6.iAND(Sel_WStep_WStep_Detail1View.WS_ID, BaseFilter.ComparisonOperator.EqualsTo, ddlMoveto.SelectedValue.ToString())
                        ...
                        Else
                            ...
                            For Each itemValue6 As WCAR_Doc1Record In WCAR_Doc1Table.GetRecords(wc6, Nothing, 0, 100)
                                Dim sRemark As String = txtRemark.Text
                                WCAR_Doc1Record.UpdateRecord_Status_Submit(itemValue6.WCD_ID.ToString(), "For Review", "0", _
                                DirectCast(Me.Page, BaseApplicationPage).CurrentSecurity.GetUserStatus().ToString() & _
                                ": " & sRemark)
                    ...
                    Case 2 'Voided -----------------------------------------------------------------------------------------------
                        ...
                        If WCAR_Activity1Table.GetRecords(wc5, Nothing, 0, 100).Length > 0 Then
                            For Each itemValue5 As WCAR_Activity1Record In WCAR_Activity1Table.GetRecords(wc5, Nothing, 0, 100)
                                ...
                                WCAR_Activity1Record.UpdateRecord(itemValue5.WCA_ID.ToString(), "Voided")
                            Next
                        End If
                        'note: void CAR
                        Dim wc6 As WhereClause = New WhereClause
                        wc6.iAND(WCAR_Doc1Table.WCD_ID, BaseFilter.ComparisonOperator.EqualsTo, Me.WCD_ID.Text)
                        For Each itemValue6 As WCAR_Doc1Record In WCAR_Doc1Table.GetRecords(wc6, Nothing, 0, 100)
                            WCAR_Doc1Record.UpdateRecord(itemValue6.WCD_ID.ToString(), "Failed")
                    ...
                    Case 3 '### Return ###
                        ...
                        For Each itemValue4 As WCAR_Activity1Record In WCAR_Activity1Table.GetRecords(wc4, Nothing, 0, 100)
                            ...
                            WCAR_Activity1Record.UpdateRecord(itemValue4.WCA_ID.ToString(), "Return")
                        Next
                        ...
                        If WCAR_Activity1Table.GetRecords(wc5, Nothing, 0, 100).Length > 0 Then
                            For Each itemValue5 As WCAR_Activity1Record In WCAR_Activity1Table.GetRecords(wc5, Nothing, 0, 100)
                                WCAR_Activity1Record.UpdateRecord(itemValue5.WCA_ID.ToString(), "Return")
                            Next
                        End If
                        ...
                        If ddlMoveto.SelectedValue.ToString() <> "0" Then 'not the creator
                            ...
                            For Each itemValue6 As Sel_WStep_WStep_Detail1Record In Sel_WStep_WStep_Detail1View.GetRecords(wc6, Nothing, 0, 100)
                                ...
                                WCAR_Doc1Record.UpdateRecord_Status_Submit(Me.WCD_ID.Text, "Return", "1", _
                                                        DirectCast(Me.Page, BaseApplicationPage).CurrentSecurity.GetUserStatus().ToString() & _
                                                        ": " & sRemark)
                        ...
                        Else
                            ...
                            For Each itemValue6 As WCAR_Doc1Record In WCAR_Doc1Table.GetRecords(wc6, Nothing, 0, 100)
                                Dim sRemark As String = txtRemark.Text
                                WCAR_Doc1Record.UpdateRecord_Status_Submit(itemValue6.WCD_ID.ToString(), "Return", "0", _
                                DirectCast(Me.Page, BaseApplicationPage).CurrentSecurity.GetUserStatus().ToString() & _
                                ": " & sRemark)
        ...
        Protected Sub ddlAction_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlAction.SelectedIndexChanged
            ...
            If ddlAction.SelectedIndex = 1 Or ddlAction.SelectedIndex = 3 Then
                ...
                Dim itemValue1 As WCAR_Activity1Record
                Dim bNoParent As Boolean = False
                Dim sStepID As String = ""
                Dim sStepType As String = ""
                For Each itemValue1 In WCAR_Activity1Table.GetRecords(wc1, Nothing, 0, 100)
                    If (itemValue1.WCA_WS_IDSpecified) Then
                        sStepID = itemValue1.WCA_WS_ID.ToString()

                        Do While sStepType <> "Start"
                            Dim wc2 As WhereClause = New WhereClause
                            Dim itemValue2 As WStep1Record
                            wc2.iAND(WStep1Table.WS_ID_Next, BaseFilter.ComparisonOperator.EqualsTo, sStepID)


                            If WStep1Table.GetRecords(wc2, Nothing, 0, 100).Length > 0 Then
                                For Each itemValue2 In WStep1Table.GetRecords(wc2, Nothing, 0, 100)
...
'        Public Sub SetWCAR_Activity1TableControl()
'            SetWCAR_Activity1TableControl_Base() 
'        End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "ePortal Workflow Approval - CAR Document Approval (North)"
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.WCAR_Doc1RecordControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetWCAR_Doc1RecordControl_Base()           
            ...
            If WCAR_Doc1RecordControl.Visible Then
                WCAR_Doc1RecordControl.LoadData()
                WCAR_Doc1RecordControl.DataBind()
            End If
        End Sub        
