<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.View_Related_CARs1" %>

<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="View-Related-CARs1.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Blank.master" Inherits="ePortalWFApproval.UI.View_Related_CARs1" %>
...
</td></tr><tr><td class="tre"><table id="Sel_WCAR_Doc_Related_Supplemental1TableControlGrid"><tr class="tch"><th class="thcnb" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="WCD_NoLabel" Text="Source CAR #">	</asp:Literal></b></th><th class="thcnb" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="WCD_Project_TitleLabel" Text="Source Project">	</asp:Literal></b></th><th class="thcnb" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="WCD_Request_DateLabel" Text="Source Date">	</asp:Literal></b></th><th class="thcnb" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="WCD_Exp_TotalLabel" Text="Source Total">	</asp:Literal></b></th><th class="thcwb" style="padding:0px;vertical-align:middle;text-align:center;"><b><asp:Literal runat="server" id="Rel_CARLabel" Text="Related CAR #">	</asp:Literal></b></th><th class="thc" scope="col" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="Rel_ProjLabel" Text="Related Project">	</asp:Literal></b></th><th class="thc" scope="col" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="Rel_Req_DateLabel" Text="Related Date">	</asp:Literal></b></th><th class="thc" scope="col" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="Rel_TotalLabel" Text="Related Total">	</asp:Literal></b></th></tr><asp:Repeater runat="server" id="Sel_WCAR_Doc_Related_Supplemental1TableControlRepeater">		<ITEMTEMPLATE>		<ePortalWFApproval:Sel_WCAR_Doc_Related_Supplemental1TableControlRow runat="server" id="Sel_WCAR_Doc_Related_Supplemental1TableControlRow">
...
</span></td></tr></ePortalWFApproval:Sel_WCAR_Doc_Related_Supplemental1TableControlRow>
</ITEMTEMPLATE>
