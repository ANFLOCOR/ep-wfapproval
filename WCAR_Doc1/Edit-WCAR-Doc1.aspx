...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title0" Text="Capital Appropriation Request (North)">	</asp:Literal>
                      </td></tr></table>
</td><td class="dher"><img src="../Images/space.gif" alt="" /></td></tr></table>

                </td><td class="panelHeaderR"></td></tr><tr><td class="panelL"></td><td>
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><asp:Literal runat="server" id="Literal32" Text="&amp;nbsp;" visible="True">	</asp:Literal></td></tr><tr><td class="tre"> 
<table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td style="text-align:left;vertical-align:middle;"></td><td style="text-align:left;vertical-align:middle;width:100px;"><ePortalWFApproval:ThemeButton runat="server" id="btnRemoveCheck" button-causesvalidation="False" button-commandname="Redirect" button-text="Withdraw Concurence" button-tooltip="Withdraw Concurence"></ePortalWFApproval:ThemeButton></td><td style="text-align:left;vertical-align:middle;width:100px;"><ePortalWFApproval:ThemeButton runat="server" id="btnChecked" button-causesvalidation="False" button-commandname="Redirect" button-text="Concur Request" button-tooltip="Concur Request"></ePortalWFApproval:ThemeButton></td><td style="text-align:left;vertical-align:middle;"><ePortalWFApproval:ThemeButton runat="server" id="CancelButton" button-causesvalidation="false" button-commandname="Redirect" button-text="Cancel" button-tooltip="Cancel"></ePortalWFApproval:ThemeButton></td></tr><tr><td colspan="4"><asp:literal id="Literal" runat="server" text="&nbsp;" /></td></tr><tr><td class="fls" style="text-align:left;width:180px;"><b><asp:literal id="Literal29" runat="server" text="Co-Requester Remark" /></b></td><td class="fls" style="text-align:left;" colspan="3"><asp:textbox id="txtCoRequestRem" runat="server" Font-Names="Tahoma" Font-Size="13px" Width="279px" Rows="6" TextMode="MultiLine" MaxLength="250" height="127px" /></td></tr></table>
                  ...
                  <asp:panel id="CollapsibleRegion3" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"></td></tr><tr><td></td></tr><tr><td><table><tr><td style="fls" class="fls"></td><td class="fls"><asp:Literal runat="server" id="Literal30">	</asp:Literal></td><td style="white-space:nowrap;text-align:left;" class="fls"></td><td style="white-space:nowrap;text-align:left;" class="fls"></td></tr><tr><td style="fls" class="fls"></td><td class="fls"></td><td style="white-space:nowrap;text-align:left;" class="fls"></td><td style="white-space:nowrap;text-align:left;" class="fls"></td></tr><tr><td style="fls" class="fls"></td><td style="text-align:left;vertical-align:middle;" class="fls"><b><asp:Literal runat="server" id="WCD_C_IDLabel" Text="Company">	</asp:Literal></b></td><td style="white-space:nowrap;text-align:left;" class="fls"><span style="white-space:nowrap;">
  ...
  <ePortalWFApproval:WCAR_Doc_Attach1TableControl runat="server" id="WCAR_Doc_Attach1TableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
            ...
            <ePortalWFApproval:ThemeButtonWithArrow runat="server" id="Filters1Button" button-causesvalidation="False" button-commandname="Custom" button-onclientclick="return ISD_ShowPopupPanel(&#39;Filters1Div&#39;,&#39;Filters1Button&#39;,this);" button-text="&lt;%# GetResourceValue(&quot;Btn:Filters&quot;, &quot;ePortalWFApproval&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:Filters&quot;, &quot;ePortalWFApproval&quot;) %>"></ePortalWFApproval:ThemeButtonWithArrow>
                  ...
                  <asp:panel id="CollapsibleRegion1" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="WCAR_Doc_Attach1TableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thcnb" style="text-align:center;"></th><th class="thcnb" style="text-align:center;"><asp:Literal runat="server" id="Literal31" Text="&amp;nbsp;">	</asp:Literal></th><th class="thcnb" style="text-align:center;"><b><asp:Literal runat="server" id="WCDA_DescLabel" Text="Description">	</asp:Literal></b></th><th class="thcnb" style="text-align:center;"><b><asp:Literal runat="server" id="WCDA_FileLabel" Text="File Upload">	</asp:Literal></b></th><th class="thcnb" style="text-align:center;"><b><asp:Literal runat="server" id="WCDA_WAT_IDLabel" Text="Attach Type">	</asp:Literal></b></th></tr><asp:Repeater runat="server" id="WCAR_Doc_Attach1TableControlRepeater">		<ITEMTEMPLATE>		<ePortalWFApproval:WCAR_Doc_Attach1TableControlRow runat="server" id="WCAR_Doc_Attach1TableControlRow">
...
</td></tr></ePortalWFApproval:WCAR_Doc_Attach1TableControlRow>
</ITEMTEMPLATE>
...
</td></tr><tr><td class="tre"><table id="WCAR_Doc_Checker1TableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thcwb" style="padding:0px;vertical-align:middle;"></th><th class="thc" scope="col" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="WCDC_U_IDLabel1" Text="Full Name">	</asp:Literal></b></th><th class="thc" scope="col" style="text-align:center;"><b><asp:Literal runat="server" id="WCDC_StatusLabel" Text="Status">	</asp:Literal></b></th><th class="thc" scope="col" style="text-align:center;"><b><asp:Literal runat="server" id="WCDC_RemLabel" Text="Remark">	</asp:Literal></b></th></tr><asp:Repeater runat="server" id="WCAR_Doc_Checker1TableControlRepeater">		<ITEMTEMPLATE>		<ePortalWFApproval:WCAR_Doc_Checker1TableControlRow runat="server" id="WCAR_Doc_Checker1TableControlRow">
