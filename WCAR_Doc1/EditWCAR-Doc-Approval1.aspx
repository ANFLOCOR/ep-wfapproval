<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EditWCAR-Doc-Approval1.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="ePortalWFApproval.UI.EditWCAR_Doc_Approval1" %>
<%@ Register Tagprefix="Selectors" Namespace="ePortalWFApproval" %>

<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.EditWCAR_Doc_Approval1" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title0" Text="Capital Appropriation Request Approval (North)">	</asp:Literal>
                      </td></tr></table>
</td></tr></table>

                </td><td class="panelHeaderR"></td></tr><tr><td class="panelL"></td><td>
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
                    <table><tr><td><ePortalWFApproval:ThemeButton runat="server" id="CancelButton" button-causesvalidation="false" button-commandname="Redirect" button-text="Back to Dashboard" button-tooltip="Back to Dashboard"></ePortalWFApproval:ThemeButton></td></tr></table>
</td></tr><tr><td><asp:panel id="WCAR_Doc1RecordControlPanel" runat="server"><table><tr><td style="fls" class="fls"></td><td class="fls"><asp:Literal runat="server" id="Literal30">	</asp:Literal></td><td style="white-space:nowrap;text-align:left;" class="fls"></td><td style="white-space:nowrap;text-align:left;" class="fls"></td></tr><tr><td style="fls" class="fls"></td><td class="fls"></td><td style="white-space:nowrap;text-align:left;" class="fls"></td><td style="white-space:nowrap;text-align:left;" class="fls"></td></tr><tr><td style="fls" class="fls"></td><td style="text-align:left;vertical-align:middle;" class="fls"><b><asp:Literal runat="server" id="WCD_C_IDLabel" Text="Company:">	</asp:Literal></b></td><td style="white-space:nowrap;text-align:left;" class="fls"><span style="white-space:nowrap;">
...
</td><td style="white-space:nowrap;text-align:left;" class="fls"></td><td style="white-space:nowrap;text-align:left;" class="fls"></td></tr></table></asp:panel>
</td></tr></table>
</asp:panel>
                </td><td class="panelR"></td></tr><tr><td class="panelBL"><img src="../Images/space.gif" class="panelBLSpace" alt="" /></td><td class="panelB"></td><td class="panelBR"><img src="../Images/space.gif" class="panelBRSpace" alt="" /></td></tr></table>
