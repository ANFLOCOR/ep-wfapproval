...
' This file implements the code-behind class for rpt_CAR_History1.aspx.
' App_Code\rpt_CAR_History1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class rpt_CAR_History1
        Inherits BaseApplicationPage
' Code-behind class for the rpt_CAR_History1 page.
