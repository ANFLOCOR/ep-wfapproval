...
' This file implements the code-behind class for View_WCPO_Canvass1_QuickSelector1.aspx.
' App_Code\View_WCPO_Canvass1_QuickSelector1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class View_WCPO_Canvass1_QuickSelector1
        Inherits BaseApplicationPage
' Code-behind class for the View_WCPO_Canvass1_QuickSelector1 page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.View_WCPO_Canvass1_QuickSelector1.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.View_WCPO_Canvass1_QuickSelector1.SelectorTableControl()
