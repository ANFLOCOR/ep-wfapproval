...
' This file implements the code-behind class for WStep_QuickSelector.aspx.
' App_Code\WStep_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WStep_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the WStep_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.WStep_QuickSelector.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.WStep_QuickSelector.SelectorTableControl()
