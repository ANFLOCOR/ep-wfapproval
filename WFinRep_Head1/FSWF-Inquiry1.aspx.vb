...
' This file implements the code-behind class for FSWF_Inquiry1.aspx.
' App_Code\Show_WFinRep_Head_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class FSWF_Inquiry1
        Inherits BaseApplicationPage
' Code-behind class for the FSWF_Inquiry1 page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetWFinRep_Head1TableControl()
            SetWFinRep_Head1TableControl_Base() 
        End Sub
...
<System.Web.Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_WFinRep_DocAttach1SearchText(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetWFinRep_DocAttach1SearchTextCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_WFinRep_DocAttach1SearchText()
      ' or replace the call to GetAutoCompletionList_WFinRep_DocAttach1SearchText().
      Return GetAutoCompletionList_WFinRep_DocAttach1SearchText_Base(prefixText, count)
      End Function
<System.Web.Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_Vw_FS_WFinRep_Attachment_PerReportType1SearchText(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetVw_FS_WFinRep_Attachment_PerReportType1SearchTextCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_Vw_FS_WFinRep_Attachment_PerReportType1SearchText()
      ' or replace the call to GetAutoCompletionList_Vw_FS_WFinRep_Attachment_PerReportType1SearchText().
      Return GetAutoCompletionList_Vw_FS_WFinRep_Attachment_PerReportType1SearchText_Base(prefixText, count)
      End Function
#End Region
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "WFin Representative Head"
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "WFinRep_Head1TableControl"
                 SetWFinRep_Head1TableControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.WFinRep_Head1TableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Vw_FS_WFinRep_Attachment_PerReportType1SearchText_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.FSWF_Inquiry1.Vw_FS_WFinRep_Attachment_PerReportType1TableControl 
            control = new ePortalWFApproval.UI.Controls.FSWF_Inquiry1.Vw_FS_WFinRep_Attachment_PerReportType1TableControl()
            
            Return control.GetAutoCompletionList_Vw_FS_WFinRep_Attachment_PerReportType1SearchText(prefixText, count)
              
        End Function
          
        Public Shared Function GetAutoCompletionList_WFinRep_DocAttach1SearchText_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ' Since this method is a shared/static method it does not maintain information about page or controls within the page.
            ' Hence we can not invoke any method associated with any controls.
            ' So, if we need to use any control in the page we need to instantiate it.
            Dim control as ePortalWFApproval.UI.Controls.FSWF_Inquiry1.WFinRep_DocAttach1TableControl 
            control = new ePortalWFApproval.UI.Controls.FSWF_Inquiry1.WFinRep_DocAttach1TableControl()
            
            Return control.GetAutoCompletionList_WFinRep_DocAttach1SearchText(prefixText, count)
        ...
        Public Sub SetWFinRep_Head1TableControl_Base()           
        
        
            If WFinRep_Head1TableControl.Visible Then
                WFinRep_Head1TableControl.LoadData()
                WFinRep_Head1TableControl.DataBind()
            End If
        End Sub        
