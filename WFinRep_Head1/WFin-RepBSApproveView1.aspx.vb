...
' This file implements the code-behind class for WFin_RepBSApproveView1.aspx.
' App_Code\WFin_RepBSApproveView.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WFin_RepBSApproveView1
        Inherits BaseApplicationPage
' Code-behind class for the WFin_RepBSApproveView1 page.
