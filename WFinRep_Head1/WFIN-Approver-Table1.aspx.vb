...
' This file implements the code-behind class for WFIN_Approver_Table1.aspx.
' App_Code\WFIN_Approver_Table1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WFIN_Approver_Table1
        Inherits BaseApplicationPage
' Code-behind class for the WFIN_Approver_Table1 page.
...
'      <System.Web.Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_Sel_WFIN_ApproverPage1SearchText(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetSel_WFIN_ApproverPage1SearchTextCompletionList gets the list of suggestions from the database.
'      ' prefixText is the search text typed by the user .
'      ' count specifies the number of suggestions to be returned.
'      ' Customize by adding code before or after the call to  GetAutoCompletionList_Sel_WFIN_ApproverPage1SearchText()
'      ' or replace the call to GetAutoCompletionList_Sel_WFIN_ApproverPage1SearchText().
'      Return GetAutoCompletionList_Sel_WFIN_ApproverPage1SearchText_Base(prefixText, count)
'      End Function
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        '        Public Sub SetSel_WFIN_ApproverPage1TableControl()
        '            SetSel_WFIN_ApproverPage1TableControl_Base() 
        '        End Sub
        ...
        Public Sub SetSel_WFIN_ApproverPageTableControl()
            SetSel_WFIN_ApproverPageTableControl_Base()
        End Sub
#End Region
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "Sel_WFIN_ApproverPageTableControl"
                 SetSel_WFIN_ApproverPageTableControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.Sel_WFIN_ApproverPageTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetSel_WFIN_ApproverPageTableControl_Base()           
        
        
            If Sel_WFIN_ApproverPageTableControl.Visible Then
                Sel_WFIN_ApproverPageTableControl.LoadData()
                Sel_WFIN_ApproverPageTableControl.DataBind()
            End If
        End Sub        
