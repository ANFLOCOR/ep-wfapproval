...
' This file implements the code-behind class for WFin_ApproverPage1.aspx.
' App_Code\WFin_ApproverPage1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WFin_ApproverPage1
        Inherits BaseApplicationPage
' Code-behind class for the WFin_ApproverPage1 page.
        ...
        Protected Sub ddlAction_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlAction.SelectedIndexChanged
            ...
            If ddlAction.SelectedIndex = 2 Or ddlAction.SelectedIndex = 1 Then 'RETURN
                Try
                    ...
                    wc1.iAND(WFinRep_Activity1Table.AFIN_WDT_ID, BaseFilter.ComparisonOperator.EqualsTo, Me.HFIN_DT_ID1.Text)
                    ...
                    ''MsgBox(Me.HFIN_DT_ID1.Text & vbNewLine & System.Web.HttpContext.Current.Session("UserIDNorth").ToString())
                    Dim itemValue1 As WFinRep_Activity1Record
                    Dim bNoParent As Boolean = False
                    Dim sStepID As String = ""
                    Dim sStepType As String = ""
                    For Each itemValue1 In WFinRep_Activity1Table.GetRecords(wc1, Nothing, 0, 100)
                        ''MsgBox(itemValue1.AFIN_WS_ID.ToString())
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetWFinRep_HeadRecordControl()
            SetWFinRep_HeadRecordControl_Base() 
        End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "FS Approval Workflow (North)"
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "WFinRep_HeadRecordControl"
                 SetWFinRep_HeadRecordControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.WFinRep_HeadRecordControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetWFinRep_HeadRecordControl_Base()           
        
        
            If WFinRep_HeadRecordControl.Visible Then
                WFinRep_HeadRecordControl.LoadData()
                WFinRep_HeadRecordControl.DataBind()
            End If
        End Sub        
