...
' This file implements the code-behind class for Show_W_User_Role_Table.aspx.
' App_Code\Show_W_User_Role_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_W_User_Role_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_W_User_Role_Table page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetW_User_RoleTableControl()
            SetW_User_RoleTableControl_Base() 
        End Sub
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "W_User_RoleTableControl"
                 SetW_User_RoleTableControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.W_User_RoleTableControl.SaveData()
      ...
      End Sub  
        ...
        SetW_User_RoleTableControl()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "W_User_RoleMenuItem"
                    End If
                End If
        ...
        Public Sub SetW_User_RoleTableControl_Base()           
        
        
            If W_User_RoleTableControl.Visible Then
                W_User_RoleTableControl.LoadData()
                W_User_RoleTableControl.DataBind()
            End If
        End Sub        
