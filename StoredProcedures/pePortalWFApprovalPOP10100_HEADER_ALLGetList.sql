if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalPOP10100_HEADER_ALLGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalPOP10100_HEADER_ALLGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalPOP10100_HEADER_ALLGetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH POP10100_HEADER_ALL_ AS ( SELECT  '
        ...
        SET @l_query_select2 = 'SELECT * FROM POP10100_HEADER_ALL_ '
