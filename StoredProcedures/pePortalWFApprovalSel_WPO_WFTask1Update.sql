if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WPO_WFTask1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WPO_WFTask1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WPO_WFTask1Update
    @p_PONUMBER char(17),
    @pk_PONUMBER char(17),
    @p_POSTATUS smallint,
    @p_DOCDATE datetime,
    @p_TOTAL numeric(38,20),
    @p_VENDORID char(15),
    @p_VENDNAME char(65),
    @p_BUYERID char(15),
