if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalVw_WFinRep_DocAttach_FIN_Month1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalVw_WFinRep_DocAttach_FIN_Month1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalVw_WFinRep_DocAttach_FIN_Month1Update
    @p_Mo int,
    @pk_Mo int,
