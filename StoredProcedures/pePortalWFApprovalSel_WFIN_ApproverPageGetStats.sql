if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WFIN_ApproverPageGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WFIN_ApproverPageGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSel_WFIN_ApproverPageGetStats
