if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_Quotation_InternalDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_Quotation_InternalDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCanvass_Quotation_InternalDrillDown
