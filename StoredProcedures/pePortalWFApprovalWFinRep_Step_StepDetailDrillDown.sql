if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_Step_StepDetailDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_Step_StepDetailDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_Step_StepDetailDrillDown
