if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WPO_POP101001GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WPO_POP101001GetList 
GO
...
-- Returns a query resultset from table [dbo].[sel_WPO_POP10100]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_WPO_POP101001GetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH sel_WPO_POP10100_ AS ( SELECT  '
        SET @l_query_rownum = 'ROW_NUMBER() OVER(' + @l_sort_str + ') AS IS_ROWNUM_COL,'
        SET @l_query_cols = 
            N'sel_WPO_POP10100_.[PONUMBER],
            sel_WPO_POP10100_.[POSTATUS],
            sel_WPO_POP10100_.[DOCDATE],
            sel_WPO_POP10100_.[TOTAL],
            sel_WPO_POP10100_.[VENDORID],
            sel_WPO_POP10100_.[VENDNAME],
            sel_WPO_POP10100_.[BUYERID],
            sel_WPO_POP10100_.[Workflow_Approval_Status],
            sel_WPO_POP10100_.[CompanyID],
            sel_WPO_POP10100_.[COMMENTS],
            sel_WPO_POP10100_.[SUBTOTAL],
            sel_WPO_POP10100_.[TRDISAMT],
            sel_WPO_POP10100_.[FRTAMNT],
            sel_WPO_POP10100_.[MSCCHAMT],
            sel_WPO_POP10100_.[TAXAMNT],
            sel_WPO_POP10100_.[isINC],
            sel_WPO_POP10100_.[TAXSCHID]'

        SET @l_query_from = 'FROM ' + @l_from_str + ' ' + @l_join_str + + ' ' + @l_where_str + ') '
        SET @l_query_select2 = 'SELECT * FROM sel_WPO_POP10100_ '
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            sel_WPO_POP10100_.[TAXSCHID]'
        SET @l_query_from = 
            ' FROM [dbo].[sel_WPO_POP10100] sel_WPO_POP10100_ ' + 
            'WHERE 1=2;'
