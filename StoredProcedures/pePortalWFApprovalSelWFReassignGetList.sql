if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSelWFReassignGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSelWFReassignGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSelWFReassignGetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH selWFReassign_ AS ( SELECT  '
        ...
        SET @l_query_select2 = 'SELECT * FROM selWFReassign_ '
