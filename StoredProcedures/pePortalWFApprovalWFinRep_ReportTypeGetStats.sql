if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_ReportTypeGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_ReportTypeGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWFinRep_ReportTypeGetStats
