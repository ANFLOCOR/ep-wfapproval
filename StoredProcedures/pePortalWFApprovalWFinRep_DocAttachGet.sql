if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_DocAttachGet') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_DocAttachGet 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_DocAttachGet
        @pk_FIN_ID int
AS
DECLARE
    @l_count int
