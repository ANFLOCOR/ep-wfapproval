if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_Line_StatusGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_Line_StatusGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWPR_Line_StatusGetStats
