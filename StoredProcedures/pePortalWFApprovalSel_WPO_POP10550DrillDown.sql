if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WPO_POP10550DrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WPO_POP10550DrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WPO_POP10550DrillDown
