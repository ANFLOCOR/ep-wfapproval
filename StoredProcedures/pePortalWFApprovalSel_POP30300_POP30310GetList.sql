if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_POP30300_POP30310GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_POP30300_POP30310GetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_POP30300_POP30310GetList
...
BEGIN
    ...
    BEGIN
        ...
        IS_ROWNUM_COL int identity(1,1),
                [VENDORID] char(15) COLLATE SQL_Latin1_General_CP1_CI_AS,
    [VENDNAME] char(65) COLLATE SQL_Latin1_General_CP1_CI_AS,
    [ITEMNMBR] char(31) COLLATE SQL_Latin1_General_CP1_CI_AS,
    [ITEMDESC] char(101) COLLATE SQL_Latin1_General_CP1_CI_AS,
    [UOFM] char(9) COLLATE SQL_Latin1_General_CP1_CI_AS,
