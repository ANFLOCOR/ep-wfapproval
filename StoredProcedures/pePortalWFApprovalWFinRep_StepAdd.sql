if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_StepAdd') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_StepAdd 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_StepAdd
    @p_WFIN_S_WDT_ID int,
