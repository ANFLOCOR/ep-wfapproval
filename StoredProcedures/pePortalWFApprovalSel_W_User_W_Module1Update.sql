if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_W_User_W_Module1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_W_User_W_Module1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_W_User_W_Module1Update
    @p_W_U_ID int,
    @p_W_MS_ID int,
    @pk_W_MS_ID int,
...
-- Check whether the record still exists before doing update
    IF NOT EXISTS (SELECT * FROM [dbo].[sel_W_User_W_Module] WHERE [W_MS_ID] = @pk_W_MS_ID)
