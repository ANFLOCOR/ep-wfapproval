if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_POP30300_POP30310DrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_POP30300_POP30310DrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_POP30300_POP30310DrillDown
