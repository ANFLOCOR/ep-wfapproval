if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_Doc_StatusGet') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_Doc_StatusGet 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPR_Doc_StatusGet
