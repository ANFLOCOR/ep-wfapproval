if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_HeadGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_HeadGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_HeadGetStats
