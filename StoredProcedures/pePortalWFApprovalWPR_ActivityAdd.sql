if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_ActivityAdd') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_ActivityAdd 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPR_ActivityAdd
    @p_WPRA_WS_ID int,
    @p_WPRA_WSD_ID int,
    @p_WPRA_WDT_ID int,
    @p_WPRA_W_U_ID int,
