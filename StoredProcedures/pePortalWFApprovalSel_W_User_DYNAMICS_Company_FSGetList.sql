if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_W_User_DYNAMICS_Company_FSGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_W_User_DYNAMICS_Company_FSGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_W_User_DYNAMICS_Company_FSGetList
