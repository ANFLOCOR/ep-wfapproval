if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_ActivityGet') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_ActivityGet 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_ActivityGet
        @pk_AFIN_ID int
AS
DECLARE
    @l_count int
