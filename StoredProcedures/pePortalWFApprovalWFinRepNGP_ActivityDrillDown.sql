if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_ActivityDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_ActivityDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_ActivityDrillDown
