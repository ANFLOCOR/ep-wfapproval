if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WASS_User_Dynamics_Company1GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WASS_User_Dynamics_Company1GetList 
GO
...
-- Returns a query resultset from table [dbo].[sel_WASS_User_Dynamics_Company]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_WASS_User_Dynamics_Company1GetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH Sel_WASS_User_Dyna_1664604136_ AS ( SELECT  '
        SET @l_query_rownum = 'ROW_NUMBER() OVER(' + @l_sort_str + ') AS IS_ROWNUM_COL,'
        SET @l_query_cols = 
            N'Sel_WASS_User_Dyna_1664604136_.[SSUC_SSU_UserName],
            Sel_WASS_User_Dyna_1664604136_.[SSUC_APP_ID],
            Sel_WASS_User_Dyna_1664604136_.[SSUC_SSC_CompanyID],
            Sel_WASS_User_Dyna_1664604136_.[SSC_CompanyName],
            Sel_WASS_User_Dyna_1664604136_.[SSC_Description],
            Sel_WASS_User_Dyna_1664604136_.[SSUC_isDefault],
            Sel_WASS_User_Dyna_1664604136_.[INTERID],
            Sel_WASS_User_Dyna_1664604136_.[CMPANYID],
            Sel_WASS_User_Dyna_1664604136_.[CMPNYNAM],
            Sel_WASS_User_Dyna_1664604136_.[Company_Short_Name]'

        SET @l_query_from = 'FROM ' + @l_from_str + ' ' + @l_join_str + + ' ' + @l_where_str + ') '
        SET @l_query_select2 = 'SELECT * FROM Sel_WASS_User_Dyna_1664604136_ '
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            Sel_WASS_User_Dyna_1664604136_.[Company_Short_Name]'
        SET @l_query_from = 
            ' FROM [dbo].[sel_WASS_User_Dynamics_Company] Sel_WASS_User_Dyna_1664604136_ ' + 
            'WHERE 1=2;'
