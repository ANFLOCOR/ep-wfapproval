if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_DocTypeGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_DocTypeGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWFinRep_DocTypeGetList
