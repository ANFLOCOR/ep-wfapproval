if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_InternalExport') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_InternalExport 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCanvass_InternalExport
