if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_POP30300_POP30310GetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_POP30300_POP30310GetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSel_POP30300_POP30310GetStats
