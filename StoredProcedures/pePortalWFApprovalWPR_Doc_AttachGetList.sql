if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_Doc_AttachGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_Doc_AttachGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWPR_Doc_AttachGetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH WPR_Doc_Attach_ AS ( SELECT  '
        ...
        SET @l_query_select2 = 'SELECT * FROM WPR_Doc_Attach_ '
