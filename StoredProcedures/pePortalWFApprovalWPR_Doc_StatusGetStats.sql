if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_Doc_StatusGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_Doc_StatusGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWPR_Doc_StatusGetStats
