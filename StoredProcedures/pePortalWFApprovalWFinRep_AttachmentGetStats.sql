if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_AttachmentGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_AttachmentGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWFinRep_AttachmentGetStats
