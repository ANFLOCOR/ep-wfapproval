if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_ActivityGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_ActivityGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_ActivityGetStats
