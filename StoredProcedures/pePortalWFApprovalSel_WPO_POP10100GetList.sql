if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WPO_POP10100GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WPO_POP10100GetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_WPO_POP10100GetList
