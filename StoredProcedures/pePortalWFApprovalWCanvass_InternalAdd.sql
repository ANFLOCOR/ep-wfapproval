if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_InternalAdd') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_InternalAdd 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCanvass_InternalAdd
    @p_WCI_C_ID smallint,
    @p_WCI_WPRD_ID int,
