if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WCanvass_Detail_Internal_WPR_Line1GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WCanvass_Detail_Internal_WPR_Line1GetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_WCanvass_Detail_Internal_WPR_Line1GetList
