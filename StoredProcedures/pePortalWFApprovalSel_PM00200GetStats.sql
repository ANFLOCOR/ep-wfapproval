if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_PM00200GetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_PM00200GetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSel_PM00200GetStats
