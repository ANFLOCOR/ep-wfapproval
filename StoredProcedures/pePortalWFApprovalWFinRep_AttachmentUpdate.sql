if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_AttachmentUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_AttachmentUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_AttachmentUpdate
    @pk_WFRA_ID int,
    @p_WFRA_FIN_ID int,
