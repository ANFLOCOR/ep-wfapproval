if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_ActivityUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_ActivityUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPR_ActivityUpdate
    @pk_WPRA_ID int,
    @p_WPRA_WS_ID int,
    @p_WPRA_WSD_ID int,
    @p_WPRA_WDT_ID int,
