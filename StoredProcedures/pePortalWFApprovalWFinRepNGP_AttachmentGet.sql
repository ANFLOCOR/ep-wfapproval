if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_AttachmentGet') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_AttachmentGet 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_AttachmentGet
        @pk_WFRNGPAt_ID int
AS
DECLARE
    @l_count int
