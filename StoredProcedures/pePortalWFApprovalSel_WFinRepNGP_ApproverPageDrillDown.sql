if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WFinRepNGP_ApproverPageDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WFinRepNGP_ApproverPageDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WFinRepNGP_ApproverPageDrillDown
