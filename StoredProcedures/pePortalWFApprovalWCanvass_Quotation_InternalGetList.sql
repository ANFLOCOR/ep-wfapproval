if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_Quotation_InternalGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_Quotation_InternalGetList 
GO
...
-- Returns a query resultset from table [dbo].[WCanvass_Quotation_Internal]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWCanvass_Quotation_InternalGetList
...
BEGIN
    ...
    SET @l_from_str = '[dbo].[WCanvass_Quotation_Internal] WCanvass_Quotation_Internal_'
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY WCanvass_Quotation_Internal_.[WCQI_ID] asc '
        ...
        SET @l_temp_colsWithAlias = 
            N'WCanvass_Quotation_Internal_.[WCQI_ID]'
        SET @l_temp_from = 
            ' FROM ' + @l_from_str + ' ' + @l_join_str + ' ' + 
            @l_where_str + ' ' + 
            @l_sort_str
        ...
        SET @l_query_cols = 
            N'WCanvass_Quotation_Internal_.[WCQI_ID],
            WCanvass_Quotation_Internal_.[WCQI_WCI_ID],
            WCanvass_Quotation_Internal_.[WCQI_Desc],
            WCanvass_Quotation_Internal_.[WCQI_File],
            WCanvass_Quotation_Internal_.[WCQI_PM00200_Vendor_ID],
            CAST(BINARY_CHECKSUM(WCanvass_Quotation_Internal_.[WCQI_ID],WCanvass_Quotation_Internal_.[WCQI_WCI_ID],WCanvass_Quotation_Internal_.[WCQI_Desc],WCanvass_Quotation_Internal_.[WCQI_File],WCanvass_Quotation_Internal_.[WCQI_PM00200_Vendor_ID]) AS nvarchar(max)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM ( ' +
                N'SELECT TOP 100 PERCENT IS_ROWNUM_COL, [WCQI_ID] from @IS_TEMP_T_GETLIST ' +
                'WHERE IS_ROWNUM_COL >= '+ convert(varchar, @l_start_gen_row_num) + 
                ') IS_ALIAS LEFT JOIN ' +
                @l_from_str + ' ';

        SET @l_query_where = 
            N'ON WCanvass_Quotation_Internal_.[WCQI_ID] = IS_ALIAS.[WCQI_ID] ' 
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            CAST(BINARY_CHECKSUM(WCanvass_Quotation_Internal_.[WCQI_ID],WCanvass_Quotation_Internal_.[WCQI_WCI_ID],WCanvass_Quotation_Internal_.[WCQI_Desc],WCanvass_Quotation_Internal_.[WCQI_File],WCanvass_Quotation_Internal_.[WCQI_PM00200_Vendor_ID]) AS nvarchar(max)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM [dbo].[WCanvass_Quotation_Internal] WCanvass_Quotation_Internal_ ' + 
            'WHERE 1=2;'
