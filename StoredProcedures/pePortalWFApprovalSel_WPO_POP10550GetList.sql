if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WPO_POP10550GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WPO_POP10550GetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_WPO_POP10550GetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH sel_WPO_POP10550_ AS ( SELECT  '
        ...
        SET @l_query_select2 = 'SELECT * FROM sel_WPO_POP10550_ '
