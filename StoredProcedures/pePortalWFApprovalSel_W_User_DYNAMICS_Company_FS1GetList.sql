if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_W_User_DYNAMICS_Company_FS1GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_W_User_DYNAMICS_Company_FS1GetList 
GO
...
-- Returns a query resultset from table [dbo].[sel_W_User_DYNAMICS_Company_FS]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_W_User_DYNAMICS_Company_FS1GetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH Sel_W_User_DYNAMIC_1089084141_ AS ( SELECT  '
        SET @l_query_rownum = 'ROW_NUMBER() OVER(' + @l_sort_str + ') AS IS_ROWNUM_COL,'
        SET @l_query_cols = 
            N'Sel_W_User_DYNAMIC_1089084141_.[W_U_ID],
            Sel_W_User_DYNAMIC_1089084141_.[W_U_User_Name],
            Sel_W_User_DYNAMIC_1089084141_.[Company_Short_Name],
            Sel_W_User_DYNAMIC_1089084141_.[Company_ID],
            Sel_W_User_DYNAMIC_1089084141_.[IsNonGP]'

        SET @l_query_from = 'FROM ' + @l_from_str + ' ' + @l_join_str + + ' ' + @l_where_str + ') '
        SET @l_query_select2 = 'SELECT * FROM Sel_W_User_DYNAMIC_1089084141_ '
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            Sel_W_User_DYNAMIC_1089084141_.[IsNonGP]'
        SET @l_query_from = 
            ' FROM [dbo].[sel_W_User_DYNAMICS_Company_FS] Sel_W_User_DYNAMIC_1089084141_ ' + 
            'WHERE 1=2;'
