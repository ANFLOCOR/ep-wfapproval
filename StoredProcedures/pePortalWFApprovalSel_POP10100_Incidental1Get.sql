if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_POP10100_Incidental1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_POP10100_Incidental1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_POP10100_Incidental1Get
