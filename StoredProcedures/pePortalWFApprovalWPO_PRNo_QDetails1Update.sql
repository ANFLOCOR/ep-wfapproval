if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_PRNo_QDetails1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_PRNo_QDetails1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPO_PRNo_QDetails1Update
