if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUserPermissionUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUserPermissionUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysSetupUserPermissionUpdate
