if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_FIN_WASP_ReportGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_FIN_WASP_ReportGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSel_FIN_WASP_ReportGetStats
