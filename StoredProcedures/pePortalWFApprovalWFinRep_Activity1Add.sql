if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_Activity1Add') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_Activity1Add 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_Activity1Add
    @p_AFIN_WS_ID int,
    @p_AFIN_WSD_ID int,
    @p_AFIN_WDT_ID int,
    @p_AFIN_W_U_ID int,
