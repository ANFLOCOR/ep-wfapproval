if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_AttachmentGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_AttachmentGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_AttachmentGetStats
