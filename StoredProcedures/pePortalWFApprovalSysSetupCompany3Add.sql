if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupCompany3Add') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupCompany3Add 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysSetupCompany3Add
