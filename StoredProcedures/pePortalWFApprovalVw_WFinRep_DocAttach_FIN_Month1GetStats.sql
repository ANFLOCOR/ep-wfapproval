if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalVw_WFinRep_DocAttach_FIN_Month1GetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalVw_WFinRep_DocAttach_FIN_Month1GetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalVw_WFinRep_DocAttach_FIN_Month1GetStats
    ...
    BEGIN
        ...
        SET @l_temp_col_type_query = N'SELECT @data_type_out = DATA_TYPE, @precision_out = NUMERIC_PRECISION, @scale_out = NUMERIC_SCALE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME=''vw_WFinRep_DocAttach_FIN_Month'' and COLUMN_NAME = ' + '''' + @l_temp_col_name + ''''
        ...
        SET @l_from_str = '[dbo].[vw_WFinRep_DocAttach_FIN_Month] Vw_WFinRep_DocAttac_671747064_'
        ...
        BEGIN
            ...
            ELSE
                SET @l_sort_str = N'ORDER BY Vw_WFinRep_DocAttac_671747064_.[Mo] asc '
            ...
            SET @l_query = 
                ...
                ') ' + 'Vw_WFinRep_DocAttac_671747064_'
        ...
        BEGIN
            SET @l_query = 
                'SELECT count(*) from ' + '[dbo].[vw_WFinRep_DocAttach_FIN_Month] Vw_WFinRep_DocAttac_671747064_ ' +
                'WHERE 1=2;'
            EXECUTE (@l_query)
        END
        SET NOCOUNT OFF
