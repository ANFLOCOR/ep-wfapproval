if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_DocTypeGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_DocTypeGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWFinRep_DocTypeGetStats
