if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_Quotation_InternalGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_Quotation_InternalGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWCanvass_Quotation_InternalGetStats
