if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_StepDetailDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_StepDetailDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_StepDetailDrillDown
