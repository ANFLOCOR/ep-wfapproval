if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupWASSEmail1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupWASSEmail1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysSetupWASSEmail1Update
    @pk_WE_ID int,
    @p_WE_U_ID int,
