if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_Attachment1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_Attachment1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_Attachment1Update
    @pk_WFRNGPAt_ID int,
