if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_FIN_ReportListDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_FIN_ReportListDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_FIN_ReportListDrillDown
