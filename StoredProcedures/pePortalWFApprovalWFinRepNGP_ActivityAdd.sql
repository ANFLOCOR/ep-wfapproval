if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_ActivityAdd') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_ActivityAdd 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_ActivityAdd
    @p_WFRNGPA_WS_ID int,
