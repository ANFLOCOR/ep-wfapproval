if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WCanvass_Detail_Internal_WPR_Line1Export') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WCanvass_Detail_Internal_WPR_Line1Export 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WCanvass_Detail_Internal_WPR_Line1Export
