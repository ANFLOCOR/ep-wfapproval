if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_DocAttach1Add') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_DocAttach1Add 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_DocAttach1Add
    @p_WFRCDNGP_Year int,
