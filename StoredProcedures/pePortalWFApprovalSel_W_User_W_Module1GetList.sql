if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_W_User_W_Module1GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_W_User_W_Module1GetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_W_User_W_Module1GetList
...
BEGIN
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY sel_W_User_W_Module_.[W_MS_ID] asc '
        ...
        SET @l_query_select = 'WITH sel_W_User_W_Module_ AS ( SELECT  '
        ...
        SET @l_query_select2 = 'SELECT * FROM sel_W_User_W_Module_ '
