if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_Activity1GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_Activity1GetList 
GO
...
-- Returns a query resultset from table [dbo].[WPO_Activity]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWPO_Activity1GetList
...
BEGIN
    ...
    SET @l_from_str = '[dbo].[WPO_Activity] WPO_Activity_'
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY WPO_Activity_.[WPO_ID] asc '
        ...
        SET @l_query_cols = 
            N'WPO_Activity_.[WPO_ID],
            WPO_Activity_.[WPO_WS_ID],
            WPO_Activity_.[WPO_WSD_ID],
            WPO_Activity_.[WPO_WDT_ID],
            WPO_Activity_.[WPO_W_U_ID],
            WPO_Activity_.[WPO_W_U_ID_Delegate],
            WPO_Activity_.[WPO_Status],
            WPO_Activity_.[WPO_Date_Assign],
            WPO_Activity_.[WPO_Date_Action],
            WPO_Activity_.[WPO_Remark],
            WPO_Activity_.[WPO_Is_Done],
            WPO_Activity_.[WPO_PONum],
            WPO_Activity_.[WPO_Is_InclPrint],
            CAST(BINARY_CHECKSUM(WPO_Activity_.[WPO_ID],WPO_Activity_.[WPO_WS_ID],WPO_Activity_.[WPO_WSD_ID],WPO_Activity_.[WPO_WDT_ID],WPO_Activity_.[WPO_W_U_ID],WPO_Activity_.[WPO_W_U_ID_Delegate],WPO_Activity_.[WPO_Status],WPO_Activity_.[WPO_Date_Assign],WPO_Activity_.[WPO_Date_Action],WPO_Activity_.[WPO_Remark],WPO_Activity_.[WPO_Is_Done],WPO_Activity_.[WPO_PONum],WPO_Activity_.[WPO_Is_InclPrint]) AS nvarchar(max)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM ( ' +
        ...
        SET @l_query_where = 
            N'ON WPO_Activity_.[WPO_ID] = IS_ALIAS.[WPO_ID] ' 
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            CAST(BINARY_CHECKSUM(WPO_Activity_.[WPO_ID],WPO_Activity_.[WPO_WS_ID],WPO_Activity_.[WPO_WSD_ID],WPO_Activity_.[WPO_WDT_ID],WPO_Activity_.[WPO_W_U_ID],WPO_Activity_.[WPO_W_U_ID_Delegate],WPO_Activity_.[WPO_Status],WPO_Activity_.[WPO_Date_Assign],WPO_Activity_.[WPO_Date_Action],WPO_Activity_.[WPO_Remark],WPO_Activity_.[WPO_Is_Done],WPO_Activity_.[WPO_PONum],WPO_Activity_.[WPO_Is_InclPrint]) AS nvarchar(max)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM [dbo].[WPO_Activity] WPO_Activity_ ' + 
            'WHERE 1=2;'
