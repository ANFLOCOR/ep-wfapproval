if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_Step1Add') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_Step1Add 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPO_Step1Add
    @p_WPO_S_WDT_ID int,
    @p_WPO_S_ID_Next int,
