if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WPO_WFTask1Add') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WPO_WFTask1Add 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WPO_WFTask1Add
    @p_PONUMBER char(17),
    @p_POSTATUS smallint,
    @p_DOCDATE datetime,
