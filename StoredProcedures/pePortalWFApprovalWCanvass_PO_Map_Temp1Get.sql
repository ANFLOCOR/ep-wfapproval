if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_PO_Map_Temp1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_PO_Map_Temp1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCanvass_PO_Map_Temp1Get
        @pk_Temp_ID int
AS
DECLARE
    @l_count int
