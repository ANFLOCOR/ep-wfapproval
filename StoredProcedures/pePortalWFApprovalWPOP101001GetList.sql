if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPOP101001GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPOP101001GetList 
GO
...
-- Returns a query resultset from table [dbo].[WPOP10100]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWPOP101001GetList
...
BEGIN
    ...
    SET @l_from_str = '[dbo].[WPOP10100] WPOP10100_'
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY WPOP10100_.[WPOP_ID] asc '
        ...
        SET @l_query_cols = 
            N'WPOP10100_.[WPOP_ID],
            WPOP10100_.[WPOP_DT_ID],
            WPOP10100_.[WPOP_PONMBR],
            WPOP10100_.[WPOP_Submit],
            WPOP10100_.[WPOP_Status],
            WPOP10100_.[WPOP_C_ID],
            WPOP10100_.[WPOP_U_ID],
            WPOP10100_.[WPOP_Remark],
            WPOP10100_.[WPOP_PRTCNT],
            WPOP10100_.[WPOP_WCur_ID],
            CAST(BINARY_CHECKSUM(WPOP10100_.[WPOP_ID],WPOP10100_.[WPOP_DT_ID],WPOP10100_.[WPOP_PONMBR],WPOP10100_.[WPOP_Submit],WPOP10100_.[WPOP_Status],WPOP10100_.[WPOP_C_ID],WPOP10100_.[WPOP_U_ID],WPOP10100_.[WPOP_Remark],WPOP10100_.[WPOP_PRTCNT],WPOP10100_.[WPOP_WCur_ID]) AS nvarchar(max)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM ( ' +
                N'SELECT TOP 100 PERCENT IS_ROWNUM_COL, [WPOP_ID] from @IS_TEMP_T_GETLIST ' +
                'WHERE IS_ROWNUM_COL >= '+ convert(varchar, @l_start_gen_row_num) + 
                ') IS_ALIAS LEFT JOIN ' +
                @l_from_str + ' ';

        SET @l_query_where = 
            N'ON WPOP10100_.[WPOP_ID] = IS_ALIAS.[WPOP_ID] ' 
