if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_Doc_Attach1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_Doc_Attach1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPR_Doc_Attach1Get
        @pk_WPRDA_ID int
AS
DECLARE
    @l_count int
