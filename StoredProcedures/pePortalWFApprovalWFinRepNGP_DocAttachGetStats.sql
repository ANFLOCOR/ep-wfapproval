if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_DocAttachGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_DocAttachGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_DocAttachGetStats
