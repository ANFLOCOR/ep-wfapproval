if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUserCompany2Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUserCompany2Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysSetupUserCompany2Get
        @pk_SSUC_RowID int
AS
DECLARE
    @l_count int
