if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_FIN_WASP_ReportGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_FIN_WASP_ReportGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_FIN_WASP_ReportGetList
