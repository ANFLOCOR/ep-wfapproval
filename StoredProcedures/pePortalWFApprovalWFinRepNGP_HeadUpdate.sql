if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_HeadUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_HeadUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_HeadUpdate
    @pk_WFRCHNGP_ID int,
    @p_WFRCHNGP_Year int,
