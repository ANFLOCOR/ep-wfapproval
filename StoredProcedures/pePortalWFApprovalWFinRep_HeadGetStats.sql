if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_HeadGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_HeadGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWFinRep_HeadGetStats
