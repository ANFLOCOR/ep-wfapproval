if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_Activity1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_Activity1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPO_Activity1Get
        @pk_WPO_ID int
AS
DECLARE
    @l_count int
