if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupCompany3Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupCompany3Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysSetupCompany3Update
