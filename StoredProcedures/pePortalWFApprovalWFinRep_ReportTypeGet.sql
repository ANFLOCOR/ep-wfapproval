if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_ReportTypeGet') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_ReportTypeGet 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_ReportTypeGet
