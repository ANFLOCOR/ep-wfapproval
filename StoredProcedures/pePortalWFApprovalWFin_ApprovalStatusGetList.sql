if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFin_ApprovalStatusGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFin_ApprovalStatusGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWFin_ApprovalStatusGetList
