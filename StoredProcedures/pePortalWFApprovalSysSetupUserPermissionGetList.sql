if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUserPermissionGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUserPermissionGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSysSetupUserPermissionGetList
