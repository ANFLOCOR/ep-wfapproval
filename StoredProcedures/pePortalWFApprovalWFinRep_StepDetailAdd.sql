if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_StepDetailAdd') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_StepDetailAdd 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_StepDetailAdd
    @p_WFIN_SD_S_ID int,
