if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_Activity1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_Activity1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_Activity1Get
        @pk_WFRNGPA_ID int
AS
DECLARE
    @l_count int
