if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysPages3Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysPages3Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysPages3Get
        @pk_PageID int
AS
DECLARE
    @l_count int
