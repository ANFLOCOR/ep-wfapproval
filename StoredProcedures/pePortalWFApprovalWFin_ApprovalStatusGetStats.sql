if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFin_ApprovalStatusGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFin_ApprovalStatusGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWFin_ApprovalStatusGetStats
