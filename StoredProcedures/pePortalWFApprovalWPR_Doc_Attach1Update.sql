if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_Doc_Attach1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_Doc_Attach1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPR_Doc_Attach1Update
    @pk_WPRDA_ID int,
    @p_WPRDA_WPRD_ID int,
