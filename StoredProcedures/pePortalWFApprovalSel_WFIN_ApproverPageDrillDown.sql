if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WFIN_ApproverPageDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WFIN_ApproverPageDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WFIN_ApproverPageDrillDown
