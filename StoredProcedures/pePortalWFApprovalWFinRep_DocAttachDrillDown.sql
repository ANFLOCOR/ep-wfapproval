if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_DocAttachDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_DocAttachDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_DocAttachDrillDown
