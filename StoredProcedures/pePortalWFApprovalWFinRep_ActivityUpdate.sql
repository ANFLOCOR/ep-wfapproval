if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_ActivityUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_ActivityUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_ActivityUpdate
    @pk_AFIN_ID int,
    @p_AFIN_WS_ID int,
    @p_AFIN_WSD_ID int,
    @p_AFIN_WDT_ID int,
