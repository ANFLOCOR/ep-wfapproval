if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WPOActivity_selPOP10100GetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WPOActivity_selPOP10100GetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSel_WPOActivity_selPOP10100GetStats
