if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_StepDetailGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_StepDetailGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWFinRep_StepDetailGetStats
