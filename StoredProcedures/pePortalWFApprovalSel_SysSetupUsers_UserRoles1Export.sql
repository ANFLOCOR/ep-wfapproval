if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_SysSetupUsers_UserRoles1Export') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_SysSetupUsers_UserRoles1Export 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_SysSetupUsers_UserRoles1Export
