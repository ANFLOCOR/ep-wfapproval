if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalVw_FS_WFinRep_Attachment_PerReportTypeDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalVw_FS_WFinRep_Attachment_PerReportTypeDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalVw_FS_WFinRep_Attachment_PerReportTypeDrillDown
