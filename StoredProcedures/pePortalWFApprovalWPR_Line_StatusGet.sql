if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_Line_StatusGet') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_Line_StatusGet 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPR_Line_StatusGet
