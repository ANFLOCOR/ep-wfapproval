if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_Head1Add') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_Head1Add 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_Head1Add
    @p_WFRCHNGP_Year int,
