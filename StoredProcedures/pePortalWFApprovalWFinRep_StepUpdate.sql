if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_StepUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_StepUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_StepUpdate
    @pk_WFIN_S_ID int,
    @p_WFIN_S_WDT_ID int,
