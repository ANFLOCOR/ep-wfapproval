if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSelWFReassignDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSelWFReassignDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSelWFReassignDrillDown
