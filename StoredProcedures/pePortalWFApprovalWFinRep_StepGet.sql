if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_StepGet') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_StepGet 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_StepGet
        @pk_WFIN_S_ID int
AS
DECLARE
    @l_count int
