if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFin_ApprovalStatusDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFin_ApprovalStatusDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFin_ApprovalStatusDrillDown
