if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUserPermissionExport') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUserPermissionExport 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysSetupUserPermissionExport
