if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_HeadGet') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_HeadGet 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_HeadGet
        @pk_WFRCHNGP_ID int
AS
DECLARE
    @l_count int
