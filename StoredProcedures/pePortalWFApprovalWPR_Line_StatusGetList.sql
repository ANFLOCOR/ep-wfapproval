if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_Line_StatusGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_Line_StatusGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWPR_Line_StatusGetList
