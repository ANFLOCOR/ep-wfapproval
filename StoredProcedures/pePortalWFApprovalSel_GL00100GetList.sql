if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_GL00100GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_GL00100GetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_GL00100GetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH sel_GL00100_ AS ( SELECT  '
        ...
        SET @l_query_select2 = 'SELECT * FROM sel_GL00100_ '
