if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WPO_Activity_WPOP101001Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WPO_Activity_WPOP101001Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WPO_Activity_WPOP101001Get
        @pk_WPO_ID int
AS
DECLARE
    @l_count int
