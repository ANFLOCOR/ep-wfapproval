if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_ActivityUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_ActivityUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_ActivityUpdate
    @pk_WFRNGPA_ID int,
    @p_WFRNGPA_WS_ID int,
