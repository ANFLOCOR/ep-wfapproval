if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_AttachmentGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_AttachmentGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_AttachmentGetList
