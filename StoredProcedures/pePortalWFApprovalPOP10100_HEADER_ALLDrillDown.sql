if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalPOP10100_HEADER_ALLDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalPOP10100_HEADER_ALLDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalPOP10100_HEADER_ALLDrillDown
