if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_PRNo_QWFGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_PRNo_QWFGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWPO_PRNo_QWFGetStats
