if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_W_User_W_ModuleDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_W_User_W_ModuleDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_W_User_W_ModuleDrillDown
