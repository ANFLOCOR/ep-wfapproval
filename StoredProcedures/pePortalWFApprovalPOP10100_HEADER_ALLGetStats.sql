if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalPOP10100_HEADER_ALLGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalPOP10100_HEADER_ALLGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalPOP10100_HEADER_ALLGetStats
