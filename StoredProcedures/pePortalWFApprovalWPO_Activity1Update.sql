if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_Activity1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_Activity1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPO_Activity1Update
    @pk_WPO_ID int,
    @p_WPO_WS_ID int,
    @p_WPO_WSD_ID int,
    @p_WPO_WDT_ID int,
