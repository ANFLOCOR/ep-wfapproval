if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_HeadDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_HeadDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_HeadDrillDown
