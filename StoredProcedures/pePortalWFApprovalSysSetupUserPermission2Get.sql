if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUserPermission2Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUserPermission2Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysSetupUserPermission2Get
        @pk_SSUP_RowID int
AS
DECLARE
    @l_count int
