if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_StepDetailUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_StepDetailUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_StepDetailUpdate
    @pk_WFIN_SD_ID int,
    @p_WFIN_SD_S_ID int,
