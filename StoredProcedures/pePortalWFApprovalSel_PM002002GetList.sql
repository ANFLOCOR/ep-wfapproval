if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_PM002002GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_PM002002GetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_PM002002GetList
...
BEGIN
    ...
    BEGIN
        ...
        IS_ROWNUM_COL int identity(1,1),
                [VENDORID] char(15) COLLATE Latin1_General_BIN,    [Company_ID] int
        ); '
