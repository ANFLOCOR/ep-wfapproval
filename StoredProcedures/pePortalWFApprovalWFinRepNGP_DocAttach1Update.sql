if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_DocAttach1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_DocAttach1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_DocAttach1Update
    @pk_WFRCDNGP_ID int,
    @p_WFRCDNGP_Year int,
