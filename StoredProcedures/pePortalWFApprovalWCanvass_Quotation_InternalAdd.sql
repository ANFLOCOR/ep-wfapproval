if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_Quotation_InternalAdd') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_Quotation_InternalAdd 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCanvass_Quotation_InternalAdd
    @p_WCQI_WCI_ID int,
