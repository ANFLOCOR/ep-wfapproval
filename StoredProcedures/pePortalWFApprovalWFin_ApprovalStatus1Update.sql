if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFin_ApprovalStatus1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFin_ApprovalStatus1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFin_ApprovalStatus1Update
    @p_WPO_STAT_CD int,
    @pk_WPO_STAT_CD int,
