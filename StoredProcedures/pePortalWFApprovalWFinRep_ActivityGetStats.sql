if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_ActivityGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_ActivityGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWFinRep_ActivityGetStats
