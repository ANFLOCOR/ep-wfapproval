if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_ActivityDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_ActivityDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPR_ActivityDrillDown
