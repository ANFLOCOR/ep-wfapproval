if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_DocTypeAdd') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_DocTypeAdd 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_DocTypeAdd
