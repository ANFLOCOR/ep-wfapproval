if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_ActivityGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_ActivityGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWPR_ActivityGetStats
