if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUserPermission2Add') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUserPermission2Add 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysSetupUserPermission2Add
