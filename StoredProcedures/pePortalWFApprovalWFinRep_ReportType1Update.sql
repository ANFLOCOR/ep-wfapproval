if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_ReportType1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_ReportType1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_ReportType1Update
