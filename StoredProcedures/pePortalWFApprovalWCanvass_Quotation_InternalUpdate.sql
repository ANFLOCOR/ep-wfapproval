if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_Quotation_InternalUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_Quotation_InternalUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCanvass_Quotation_InternalUpdate
    @pk_WCQI_ID int,
    @p_WCQI_WCI_ID int,
