if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WASS_User_Dynamics_Company1Export') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WASS_User_Dynamics_Company1Export 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WASS_User_Dynamics_Company1Export
