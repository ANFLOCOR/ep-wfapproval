if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalVw_ANFLO_DW_CompanyNonGPDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalVw_ANFLO_DW_CompanyNonGPDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalVw_ANFLO_DW_CompanyNonGPDrillDown
