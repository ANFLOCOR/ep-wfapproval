if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_ReportTypeDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_ReportTypeDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_ReportTypeDrillDown
