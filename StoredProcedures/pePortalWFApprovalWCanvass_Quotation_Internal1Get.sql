if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_Quotation_Internal1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_Quotation_Internal1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCanvass_Quotation_Internal1Get
        @pk_WCQI_ID int
AS
DECLARE
    @l_count int
