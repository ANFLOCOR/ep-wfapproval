if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_PRNo_QWFGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_PRNo_QWFGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWPO_PRNo_QWFGetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH WPO_PRNo_QWF_ AS ( SELECT  '
        ...
        SET @l_query_select2 = 'SELECT * FROM WPO_PRNo_QWF_ '
