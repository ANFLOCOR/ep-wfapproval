if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_DocAttachGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_DocAttachGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWFinRep_DocAttachGetStats
