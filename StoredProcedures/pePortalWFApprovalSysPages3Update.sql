if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysPages3Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysPages3Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysPages3Update
    @pk_PageID int,
