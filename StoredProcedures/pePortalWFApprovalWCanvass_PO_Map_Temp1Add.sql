if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_PO_Map_Temp1Add') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_PO_Map_Temp1Add 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCanvass_PO_Map_Temp1Add
    @p_WCDI_ID int,
    @p_WCDI_WCI_ID int,
    @p_WCDI_WPRL_ID int,
