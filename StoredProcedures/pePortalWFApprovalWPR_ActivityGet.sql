if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_ActivityGet') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_ActivityGet 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPR_ActivityGet
        @pk_WPRA_ID int
AS
DECLARE
    @l_count int
