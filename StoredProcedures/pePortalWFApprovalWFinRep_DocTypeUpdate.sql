if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_DocTypeUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_DocTypeUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_DocTypeUpdate
    @pk_WFIN_DT_ID int,
