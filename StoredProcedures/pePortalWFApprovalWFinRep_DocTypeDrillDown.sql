if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_DocTypeDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_DocTypeDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_DocTypeDrillDown
