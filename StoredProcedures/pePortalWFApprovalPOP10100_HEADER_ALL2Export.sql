if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalPOP10100_HEADER_ALL2Export') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalPOP10100_HEADER_ALL2Export 
GO
...
CREATE PROCEDURE pePortalWFApprovalPOP10100_HEADER_ALL2Export
