if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_AttachmentGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_AttachmentGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWFinRep_AttachmentGetList
