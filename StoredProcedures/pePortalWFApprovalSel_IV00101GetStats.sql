if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_IV00101GetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_IV00101GetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSel_IV00101GetStats
