if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_POP10100_IncidentalDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_POP10100_IncidentalDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_POP10100_IncidentalDrillDown
