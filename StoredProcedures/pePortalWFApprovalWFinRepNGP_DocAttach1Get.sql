if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_DocAttach1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_DocAttach1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_DocAttach1Get
        @pk_WFRCDNGP_ID int
AS
DECLARE
    @l_count int
