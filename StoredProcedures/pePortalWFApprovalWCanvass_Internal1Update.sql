if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_Internal1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_Internal1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCanvass_Internal1Update
    @pk_WCI_ID int,
    @p_WCI_C_ID smallint,
    @p_WCI_WPRD_ID int,
