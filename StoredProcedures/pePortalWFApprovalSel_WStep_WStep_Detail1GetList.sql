if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WStep_WStep_Detail1GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WStep_WStep_Detail1GetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_WStep_WStep_Detail1GetList
