if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_DocAttach1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_DocAttach1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_DocAttach1Update
    @pk_FIN_ID int,
    @p_FIN_Year int,
    @p_FIN_Month int,
