if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_FIN_ReportListGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_FIN_ReportListGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSel_FIN_ReportListGetStats
