if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WCurrency_sel_WForeign_Exch_Latest1GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WCurrency_sel_WForeign_Exch_Latest1GetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_WCurrency_sel_WForeign_Exch_Latest1GetList
