if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalView_WCPO_Canvass1GetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalView_WCPO_Canvass1GetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalView_WCPO_Canvass1GetStats
