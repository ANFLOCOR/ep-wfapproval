if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_Doc1Export') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_Doc1Export 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPR_Doc1Export
    ...
    BEGIN
        ...
        IF @p_title_str IS NULL
            ...
            SET @l_title_str = 
                ...
                N'"WPRD_Comment"' + @p_separator_str +
