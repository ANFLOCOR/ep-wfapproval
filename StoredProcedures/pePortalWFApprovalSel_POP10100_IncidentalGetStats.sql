if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_POP10100_IncidentalGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_POP10100_IncidentalGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSel_POP10100_IncidentalGetStats
