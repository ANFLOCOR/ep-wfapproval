if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_ActivityDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_ActivityDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_ActivityDrillDown
