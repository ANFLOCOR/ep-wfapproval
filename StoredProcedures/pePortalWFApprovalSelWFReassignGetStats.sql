if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSelWFReassignGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSelWFReassignGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSelWFReassignGetStats
