if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRepNGP_HeadDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRepNGP_HeadDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRepNGP_HeadDrillDown
