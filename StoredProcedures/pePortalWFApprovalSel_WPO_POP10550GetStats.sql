if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WPO_POP10550GetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WPO_POP10550GetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSel_WPO_POP10550GetStats
