if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_IV001011GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_IV001011GetList 
GO
...
-- Returns a query resultset from table [dbo].[sel_IV00101]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_IV001011GetList
...
BEGIN
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY sel_IV00101_.[ITEMNMBR],sel_IV00101_.[Company_ID] asc '
        ...
        SET @l_query_select = 'WITH sel_IV00101_ AS ( SELECT  '
        SET @l_query_rownum = 'ROW_NUMBER() OVER(' + @l_sort_str + ') AS IS_ROWNUM_COL,'
        SET @l_query_cols = 
            N'sel_IV00101_.[ITEMNMBR],
            sel_IV00101_.[ITEMDESC],
            sel_IV00101_.[CURRCOST],
            sel_IV00101_.[IVIVOFIX],
            sel_IV00101_.[IVIVINDX],
            sel_IV00101_.[LOCNCODE],
            sel_IV00101_.[PRCHSUOM],
            sel_IV00101_.[Company_ID],
            sel_IV00101_.[Account],
            sel_IV00101_.[ITMSHNAM],
            CAST(BINARY_CHECKSUM(sel_IV00101_.[ITEMNMBR],sel_IV00101_.[ITEMDESC],sel_IV00101_.[CURRCOST],sel_IV00101_.[IVIVOFIX],sel_IV00101_.[IVIVINDX],sel_IV00101_.[LOCNCODE],sel_IV00101_.[PRCHSUOM],sel_IV00101_.[Company_ID],sel_IV00101_.[Account],sel_IV00101_.[ITMSHNAM]) AS nvarchar(max)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = ' FROM ' + @l_from_str + ' ' + @l_join_str + ' ' + @l_where_str + ') '
        SET @l_query_select2 = 'SELECT * FROM sel_IV00101_ '
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            CAST(BINARY_CHECKSUM(sel_IV00101_.[ITEMNMBR],sel_IV00101_.[ITEMDESC],sel_IV00101_.[CURRCOST],sel_IV00101_.[IVIVOFIX],sel_IV00101_.[IVIVINDX],sel_IV00101_.[LOCNCODE],sel_IV00101_.[PRCHSUOM],sel_IV00101_.[Company_ID],sel_IV00101_.[Account],sel_IV00101_.[ITMSHNAM]) AS nvarchar(max)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM [dbo].[sel_IV00101] sel_IV00101_ ' + 
            'WHERE 1=2;'
