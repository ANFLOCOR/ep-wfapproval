if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_Step1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_Step1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPO_Step1Get
        @pk_WPO_S_ID int
AS
DECLARE
    @l_count int
