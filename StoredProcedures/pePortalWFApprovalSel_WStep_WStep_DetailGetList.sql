if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WStep_WStep_DetailGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WStep_WStep_DetailGetList 
GO
...
-- Returns a query resultset from table [dbo].[sel_WStep_WStep_Detail]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_WStep_WStep_DetailGetList
...
BEGIN
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY sel_WStep_WStep_Detail_.[WSD_ID] asc '
        ...
        SET @l_query_cols = 
            ...
            sel_WStep_WStep_Detail_.[WS_ID_Next],
            sel_WStep_WStep_Detail_.[WS_Step_Type],
            sel_WStep_WStep_Detail_.[WS_Approval_Needed],
            sel_WStep_WStep_Detail_.[WSD_W_U_ID],
            sel_WStep_WStep_Detail_.[WSD_Variable_Ref],
            sel_WStep_WStep_Detail_.[WSD_Variable_SQL],
            CAST(BINARY_CHECKSUM(sel_WStep_WStep_Detail_.[WSD_ID],sel_WStep_WStep_Detail_.[WS_ID],sel_WStep_WStep_Detail_.[WS_WDT_ID],sel_WStep_WStep_Detail_.[WS_ID_Next],sel_WStep_WStep_Detail_.[WS_Step_Type],sel_WStep_WStep_Detail_.[WS_Approval_Needed],sel_WStep_WStep_Detail_.[WSD_W_U_ID],sel_WStep_WStep_Detail_.[WSD_Variable_Ref],sel_WStep_WStep_Detail_.[WSD_Variable_SQL]) AS nvarchar(max)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM ( ' +
                N'SELECT TOP 100 PERCENT IS_ROWNUM_COL, [WSD_ID] from @IS_TEMP_T_GETLIST ' +
                'WHERE IS_ROWNUM_COL >= '+ convert(varchar, @l_start_gen_row_num) + 
                ') IS_ALIAS LEFT JOIN ' +
                @l_from_str + ' ';

        SET @l_query_where = 
            N'ON sel_WStep_WStep_Detail_.[WSD_ID] = IS_ALIAS.[WSD_ID] ' 
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            CAST(BINARY_CHECKSUM(sel_WStep_WStep_Detail_.[WSD_ID],sel_WStep_WStep_Detail_.[WS_ID],sel_WStep_WStep_Detail_.[WS_WDT_ID],sel_WStep_WStep_Detail_.[WS_ID_Next],sel_WStep_WStep_Detail_.[WS_Step_Type],sel_WStep_WStep_Detail_.[WS_Approval_Needed],sel_WStep_WStep_Detail_.[WSD_W_U_ID],sel_WStep_WStep_Detail_.[WSD_Variable_Ref],sel_WStep_WStep_Detail_.[WSD_Variable_SQL]) AS nvarchar(max)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM [dbo].[sel_WStep_WStep_Detail] sel_WStep_WStep_Detail_ ' + 
            'WHERE 1=2;'
