if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_Line1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_Line1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPR_Line1Get
        @pk_WPRL_ID int
AS
DECLARE
    @l_count int
