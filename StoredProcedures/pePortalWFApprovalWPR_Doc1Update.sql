if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_Doc1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_Doc1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPR_Doc1Update
    @pk_WPRD_ID int,
