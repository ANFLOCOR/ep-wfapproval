if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_SysSetupUsers_UserRolesGrouped1GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_SysSetupUsers_UserRolesGrouped1GetList 
GO
...
-- Returns a query resultset from table [dbo].[sel_SysSetupUsers_UserRolesGrouped]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_SysSetupUsers_UserRolesGrouped1GetList
...
BEGIN
    ...
    SET @l_from_str = '[dbo].[sel_SysSetupUsers_UserRolesGrouped] sel_SysSetupUsers_UserRolesGrouped_'
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH sel_SysSetupUsers_UserRolesGrouped_ AS ( SELECT  '
        SET @l_query_rownum = 'ROW_NUMBER() OVER(' + @l_sort_str + ') AS IS_ROWNUM_COL,'
        SET @l_query_cols = 
            N'sel_SysSetupUsers_UserRolesGrouped_.[SSU_UserName],
            sel_SysSetupUsers_UserRolesGrouped_.[SSUC_SSC_CompanyID],
            sel_SysSetupUsers_UserRolesGrouped_.[SSUC_RowID],
            sel_SysSetupUsers_UserRolesGrouped_.[SSUA_App_ID],
            sel_SysSetupUsers_UserRolesGrouped_.[Roles],
            sel_SysSetupUsers_UserRolesGrouped_.[Permissions]'

        SET @l_query_from = 'FROM ' + @l_from_str + ' ' + @l_join_str + + ' ' + @l_where_str + ') '
        SET @l_query_select2 = 'SELECT * FROM sel_SysSetupUsers_UserRolesGrouped_ '
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            sel_SysSetupUsers_UserRolesGrouped_.[Permissions]'
        SET @l_query_from = 
            ' FROM [dbo].[sel_SysSetupUsers_UserRolesGrouped] sel_SysSetupUsers_UserRolesGrouped_ ' + 
            'WHERE 1=2;'
