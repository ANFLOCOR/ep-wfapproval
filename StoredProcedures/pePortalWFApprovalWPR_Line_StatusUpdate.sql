if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_Line_StatusUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_Line_StatusUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPR_Line_StatusUpdate
