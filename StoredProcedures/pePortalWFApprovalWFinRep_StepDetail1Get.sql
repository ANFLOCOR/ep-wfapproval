if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_StepDetail1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_StepDetail1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalWFinRep_StepDetail1Get
        @pk_WFIN_SD_ID int
AS
DECLARE
    @l_count int
