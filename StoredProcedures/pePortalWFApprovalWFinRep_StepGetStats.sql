if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWFinRep_StepGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWFinRep_StepGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWFinRep_StepGetStats
