if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupCompany3Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupCompany3Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysSetupCompany3Get
