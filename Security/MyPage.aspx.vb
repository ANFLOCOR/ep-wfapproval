...
#Region "Section 2: Do not modify this section."
        ...
        Protected Sub Page_InitializeEventHandlers_Base(ByVal sender As Object, ByVal e As System.EventArgs)            		
          ...
          ' Setup the pagination events.
              ...
              AddHandler Me.lbAHNCAR.Click, AddressOf lbAHNCAR_Click
                        
              AddHandler Me.lbAHNCARL.Click, AddressOf lbAHNCARL_Click
                        
              AddHandler Me.lbAHNPO.Click, AddressOf lbAHNPO_Click
                        
              AddHandler Me.lbAHNPOL.Click, AddressOf lbAHNPOL_Click
                        
              AddHandler Me.lbAHSCAR.Click, AddressOf lbAHSCAR_Click
                        
              AddHandler Me.lbAHSCARL.Click, AddressOf lbAHSCARL_Click
                        
              AddHandler Me.lbAHSPO.Click, AddressOf lbAHSPO_Click
                        
              AddHandler Me.lbAHSPOL.Click, AddressOf lbAHSPOL_Click
                        
              AddHandler Me.lbAPNCAR.Click, AddressOf lbAPNCAR_Click
                        
              AddHandler Me.lbAPNPO.Click, AddressOf lbAPNPO_Click
                        
              AddHandler Me.lbAPSCAR.Click, AddressOf lbAPSCAR_Click
                        
              AddHandler Me.lbAPSPO.Click, AddressOf lbAPSPO_Click
                        
              AddHandler Me.lbFSNGP.Click, AddressOf lbFSNGP_Click
                        
              AddHandler Me.lbFSNNGP.Click, AddressOf lbFSNNGP_Click
                        
              AddHandler Me.lbFSSGP.Click, AddressOf lbFSSGP_Click
                        
              AddHandler Me.lbFSSNGP.Click, AddressOf lbFSSNGP_Click
    ...
    End Function
      ...
      End Sub  
        ...
        Public Sub SetlbAHNCAR_Base()                
              
   
        End Sub
            
        Public Sub SetlbAHNCARL_Base()                
              
   
        End Sub
            
        Public Sub SetlbAHNPO_Base()                
              
   
        End Sub
            
        Public Sub SetlbAHNPOL_Base()                
              
   
        End Sub
            
        Public Sub SetlbAHSCAR_Base()                
              
   
        End Sub
            
        Public Sub SetlbAHSCARL_Base()                
              
   
        End Sub
            
        Public Sub SetlbAHSPO_Base()                
              
   
        End Sub
            
        Public Sub SetlbAHSPOL_Base()                
              
   
        End Sub
            
        Public Sub SetlbAPNCAR_Base()                
              
   
        End Sub
            
        Public Sub SetlbAPNPO_Base()                
              
   
        End Sub
            
        Public Sub SetlbAPSCAR_Base()                
              
   
        End Sub
            
        Public Sub SetlbAPSPO_Base()                
              
   
        End Sub
            
        Public Sub SetlbFSNGP_Base()                
              
   
        End Sub
            
        Public Sub SetlbFSNNGP_Base()                
              
   
        End Sub
            
        Public Sub SetlbFSSGP_Base()                
              
   
        End Sub
            
        Public Sub SetlbFSSNGP_Base()                
        ...
        Public Sub lbAHNCAR_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
    ...
    Try
        ...
        ' event handler for LinkButton
        Public Sub lbAHNCARL_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
    ...
    Try
        ...
        ' event handler for LinkButton
        Public Sub lbAHNPO_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
    ...
    Try
        ...
        ' event handler for LinkButton
        Public Sub lbAHNPOL_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
    ...
    Try
        ...
        ' event handler for LinkButton
        Public Sub lbAHSCAR_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../WCAR_Doc/rpt-CAR-History.aspx"
    ...
    Try
      ...
      Me.Response.Redirect(url)
        ...
        ' event handler for LinkButton
        Public Sub lbAHSCARL_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../sel_WCAR_Activity_WCAR_Doc/Show-Sel-WCAR-Activity-WCAR-Doc-Table.aspx"
    ...
    Try
      ...
      Me.Response.Redirect(url)
        ...
        ' event handler for LinkButton
        Public Sub lbAHSPO_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
    ...
    Try
        ...
        ' event handler for LinkButton
        Public Sub lbAHSPOL_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
    ...
    Try
        ...
        ' event handler for LinkButton
        Public Sub lbAPNCAR_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
    ...
    Try
        ...
        ' event handler for LinkButton
        Public Sub lbAPNPO_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
    ...
    Try
        ...
        ' event handler for LinkButton
        Public Sub lbAPSCAR_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../WCAR_Doc/rpt-CAR-Pipeline.aspx"
    ...
    Try
      ...
      Me.Response.Redirect(url)
        ...
        ' event handler for LinkButton
        Public Sub lbAPSPO_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
    ...
    Try
        ...
        ' event handler for LinkButton
        Public Sub lbFSNGP_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
    ...
    Try
        ...
        ' event handler for LinkButton
        Public Sub lbFSNNGP_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
    ...
    Try
        ...
        ' event handler for LinkButton
        Public Sub lbFSSGP_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
    ...
    Try
        ...
        ' event handler for LinkButton
        Public Sub lbFSSNGP_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
