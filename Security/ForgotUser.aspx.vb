    ...
    Try
            ...
            Catch ex As Exception
                ...
                If url.Contains("?") Then 
                      url &= "&Username=" & uname & "&Error=" & ex.Message & "&Email=" & Me.Emailaddress.Text
                Else
                      url &= "?Username=" & uname & "&Error=" & ex.Message & "&Email=" & Me.Emailaddress.Text
                End If
        ...
        Private Sub SendPasswordToUser(usecaptcha As Boolean)
            ...
            Dim userRecord As IUserIdentityRecord = SystemUtils.GetUserInfoEmailAddr(uemail)
            If userRecord Is Nothing Then
                Dim msg As String = GetResourceValue("Msg:InvalidEmail") & "<br />" 
