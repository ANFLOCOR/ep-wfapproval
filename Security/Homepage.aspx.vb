...
' This file implements the code-behind class for Homepage.aspx.
' App_Code\Homepage.Controls.vb contains the Table, Row and Record control classes
...
'      End Function
        ...
        '            SetLinkButton_Base() 
        '        End Sub              
        'Public Sub LinkButton_Click(ByVal sender As Object, ByVal args As EventArgs)
        '          ' Click handler for LinkButton.
        '          ' Customize by adding code before the call or replace the call to the Base function with your own code.
        '          LinkButton_Click_Base(sender, args)
        '          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
        '        End Sub
        '        Public Sub SetLinkButton1()
        '            SetLinkButton1_Base()
        '        End Sub
        '        Public Sub SetLinkButton()
        '            SetLinkButton_Base()
        '        End Sub
        '        Public Sub LinkButton1_Click(ByVal sender As Object, ByVal args As EventArgs)
        '            ' Click handler for LinkButton1.
        '            ' Customize by adding code before the call or replace the call to the Base function with your own code.
        '            LinkButton1_Click_Base(sender, args)
        '            ' NOTE: If the Base function redirects to another page, any code here will not be executed.
        '        End Sub
        '        Public Sub LinkButton_Click(ByVal sender As Object, ByVal args As EventArgs)
        '            ' Click handler for LinkButton.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "ePortal Workflow Approval - Homepage"
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "Sel_Approver_Pending_Tasks2TableControl"
                 SetSel_Approver_Pending_Tasks2TableControl()
          
              Case "Sel_Approver_Pending_TasksTableControl"
                 SetSel_Approver_Pending_TasksTableControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.Sel_Approver_Pending_Tasks2TableControl.SaveData()
                
        Me.Sel_Approver_Pending_TasksTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetSel_Approver_Pending_Tasks2TableControl_Base()           
        
        
            If Sel_Approver_Pending_Tasks2TableControl.Visible Then
                Sel_Approver_Pending_Tasks2TableControl.LoadData()
                Sel_Approver_Pending_Tasks2TableControl.DataBind()
            End If
        End Sub        
      
        Public Sub SetSel_Approver_Pending_TasksTableControl_Base()           
        
        
            If Sel_Approver_Pending_TasksTableControl.Visible Then
                Sel_Approver_Pending_TasksTableControl.LoadData()
                Sel_Approver_Pending_TasksTableControl.DataBind()
            End If
        End Sub        
