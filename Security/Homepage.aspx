		...
		<asp:UpdatePanel runat="server" id="UpdatePanel1" UpdateMode="Conditional">
			<ContentTemplate>
                ...
                <table><tr><td><table class="dv" cellpadding="0" cellspacing="0" border="0" style="width:800px;"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="1200px"><tr><td class="tre">&nbsp;</td><td class="tre"></td><td class="tre"></td><td class="tre"></td><td class="tre"></td></tr><tr><td class="tre" colspan="5"><ePortalWFApproval:Sel_Approver_Pending_Tasks2TableControl runat="server" id="Sel_Approver_Pending_Tasks2TableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
...
<asp:ImageButton id="Icon" runat="server" ToolTip="&lt;%# GetResourceValue(&quot;Btn:ExpandCollapse&quot;) %&gt;" causesvalidation="False" imageurl="../images/icon_panelcollapse.gif" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0" style="height:30px;"><tr><td class="dht" valign="middle" style="text-align:left;"><b><span style="font-size:12pt"><asp:Literal runat="server" id="Sel_Approver_Pending_TasksTitle1" Text="North Pending Documents">	</asp:Literal></span></b></td></tr></table>
                  ...
                  <asp:panel id="Sel_Approver_Pending_Tasks2CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table><tr><td colspan="9"><asp:literal id="Literal" runat="server" text="&nbsp;"></asp:literal></td><td></td><td></td><td></td><td></td></tr><tr><td colspan="7" class="thc2" style="text-align:center;vertical-align:middle;">&nbsp; 
...
</td></tr><tr><td class="tre"><table id="Sel_Approver_Pending_Tasks2TableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thcnb" colspan="2" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="Doc_TypeLabel2" Text="Document Type">	</asp:Literal></b></th><th class="thcnb" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="Company_DescLabel2" Text="Company">	</asp:Literal></b></th><th class="thcnb" colspan="2" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="Doc_NoLabel2" Text="Document Number">	</asp:Literal></b></th><th class="thc" scope="col" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="Date_AssignedLabel2" Text="Date Assigned">	</asp:Literal></b></th><th class="thc" scope="col" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="Doc_TitleLabel2" Text="Title/Remarks">	</asp:Literal></b></th><th class="thc" scope="col" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="Doc_TotalLabel2" Text="Total">	</asp:Literal></b></th></tr><asp:Repeater runat="server" id="Sel_Approver_Pending_Tasks2TableControlRepeater">		<ITEMTEMPLATE>		<ePortalWFApproval:Sel_Approver_Pending_Tasks2TableControlRow runat="server" id="Sel_Approver_Pending_Tasks2TableControlRow">
...
<asp:ImageButton runat="server" id="imbDoc1" causesvalidation="False" commandname="Redirect" imageurl="../Images/icon-open.png" onmouseout="this.src=&#39;../Images/icon-open.png&#39;" onmouseover="this.src=&#39;../Images/icon-open-over.png&#39;" tooltip="Click the icon to act on this document.">		
...
<asp:Image runat="server" id="Image2" imageurl="../Images/docs.png">		
	...
	</asp:Image>&nbsp;&nbsp;&nbsp;<asp:Label runat="server" id="litLoading" Text="Please wait while the browser loads your requested document..." visible="False">	</asp:Label></td><td style="text-align:left;vertical-align:middle;color:Black;font-weight:normal;" class="thc2"><asp:Label runat="server" id="Literal2" Text="&amp;nbsp;">	</asp:Label>&nbsp;</td><td><ePortalWFApproval:ThemeButton runat="server" id="SouthRedirectorButtonCARDoc" button-causesvalidation="False" button-commandname="Redirect" button-text="CAR Documents" button-tooltip="CAR Documents"></ePortalWFApproval:ThemeButton></td><td><ePortalWFApproval:ThemeButton runat="server" id="SouthRedirectorButtonReCAR" button-causesvalidation="False" button-commandname="Redirect" button-text="Reassign CAR" button-tooltip="Reassign CAR"></ePortalWFApproval:ThemeButton></td><td><ePortalWFApproval:ThemeButton runat="server" id="SouthRedirectorButtonPODoc" button-causesvalidation="False" button-commandname="Redirect" button-text="PO Documents" button-tooltip="PO Documents"></ePortalWFApproval:ThemeButton></td><td><ePortalWFApproval:ThemeButton runat="server" id="SouthRedirectorButtonRePO" button-causesvalidation="False" button-commandname="Redirect" button-text="Reassign PO" button-tooltip="Reassign PO"></ePortalWFApproval:ThemeButton></td></tr><tr><td colspan="9"><asp:literal id="Literal4" runat="server" text="&nbsp;"></asp:literal></td><td></td><td></td><td></td><td></td></tr></table>
                  ...
                  <asp:panel id="CollapsibleRegion2" runat="server"></asp:panel>
                    ...
                    <table id="Sel_Approver_Pending_TasksTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thcnb" colspan="2" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="Doc_TypeLabel" Text="Document Type">	</asp:Literal></b></th><th class="thcnb" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="Company_DescLabel" Text="Company">	</asp:Literal></b></th><th class="thcnb" colspan="2" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="Doc_NoLabel" Text="Document Number">	</asp:Literal></b></th><th class="thc" scope="col" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="Date_AssignedLabel" Text="Date Assigned">	</asp:Literal></b></th><th class="thc" scope="col" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="Doc_TitleLabel" Text="Title/Remarks">	</asp:Literal></b></th><th class="thc" scope="col" style="text-align:center;vertical-align:middle;"><b><asp:Literal runat="server" id="Doc_TotalLabel" Text="Total">	</asp:Literal></b></th></tr><asp:Repeater runat="server" id="Sel_Approver_Pending_TasksTableControlRepeater">		<ITEMTEMPLATE>		<ePortalWFApproval:Sel_Approver_Pending_TasksTableControlRow runat="server" id="Sel_Approver_Pending_TasksTableControlRow">
...
<asp:ImageButton runat="server" id="imbDoc" causesvalidation="False" commandname="Redirect" imageurl="../Images/icon-open.png" onmouseout="this.src=&#39;../Images/icon-open.png&#39;" onmouseover="this.src=&#39;../Images/icon-open-over.png&#39;" tooltip="Click the icon to act on this document.">		
