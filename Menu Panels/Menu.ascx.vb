...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          ' or replace the call to LoadData_Base().
		   ...
		   Dim OrigRoles As String
            Dim Permissions As String

            Page.GetandSetUserRoles()

            OrigRoles = BaseClasses.Utils.SecurityControls.GetCurrentUserRoles()

            If (Session IsNot Nothing) Then
                Dim item As Object = Session("UserPermissions")
                If (item IsNot Nothing) Then
                    Permissions = System.Web.HttpContext.Current.Session("UserPermissions").ToString
                    BaseClasses.Utils.SecurityControls.SetCurrentUserRoles(Permissions)
                End If
            End If
		
		
          LoadData_Base()
		BaseClasses.Utils.SecurityControls.SetCurrentUserRoles(OrigRoles)
        ...
        Private Function ReplaceTextWithResourceValue(ByVal value As String) As String
            ...
            While regex.IsMatch(value)
                ...
                If System.Text.RegularExpressions.Regex.IsMatch(value, "}") Then
                    ...
                    value = value.Replace(value.Substring((startIndex - 1), ((endIndex - startIndex) + 2)), GetResourceValue(textToLookUp, "ePortalWFApproval"))
                End If
