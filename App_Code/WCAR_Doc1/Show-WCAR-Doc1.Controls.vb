...
' Show_WCAR_Doc1.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.Show_WCAR_Doc1
...
' Base class for the WCAR_Activity1TableControlRow control on the Show_WCAR_Doc1 page.
...
' Base class for the WCAR_Activity1TableControl control on the Show_WCAR_Doc1 page.
...
Public Class BaseWCAR_Activity1TableControl
    ...
    End Sub
      ...
      Dim selectedRecordKeyValue as KeyValue = New KeyValue()
              ...
              Dim wCAR_Doc1RecordControlObj As ePortalWFApproval.UI.Controls.Show_WCAR_Doc1.WCAR_Doc1RecordControl = DirectCast(MiscUtils.FindControlRecursively(Me.Page, "WCAR_Doc1RecordControl"), ePortalWFApproval.UI.Controls.Show_WCAR_Doc1.WCAR_Doc1RecordControl)
...
' Base class for the WCAR_Doc_Attach1TableControlRow control on the Show_WCAR_Doc1 page.
...
' Base class for the WCAR_Doc_Attach1TableControl control on the Show_WCAR_Doc1 page.
...
' Base class for the WCAR_Doc_Checker1TableControlRow control on the Show_WCAR_Doc1 page.
...
' Base class for the WCAR_Doc_Checker1TableControl control on the Show_WCAR_Doc1 page.
...
' Base class for the WCAR_Doc1RecordControl control on the Show_WCAR_Doc1 page.
...
Public Class BaseWCAR_Doc1RecordControl
        ...
        Public Overridable Sub RegisterPostback()       
              ...
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"OKButton1"))
        ...
        Public Overridable Sub SetOKButton1()                
              ...
              Me.OKButton1.Button.Attributes.Add("onclick", "SubmitHRefOnce(this, """ & Me.Page.GetResourceValue("Txt:SaveRecord", "ePortalWFApproval") & """);")
