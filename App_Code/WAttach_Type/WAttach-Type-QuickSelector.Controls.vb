...
' WAttach_Type_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.WAttach_Type_QuickSelector
...
' Base class for the SelectorTableControlRow control on the WAttach_Type_QuickSelector page.
...
Public Class BaseSelectorTableControlRow
        ...
        Public Overridable Sub LoadData()        
            ...
            ' Load the data from the database into the DataSource DatabaseANFLO-WF%dbo.WAttach_Type record.
            ...
            If Me.RecordUniqueId IsNot Nothing AndAlso Me.RecordUniqueId.Trim <> "" Then
                Me.DataSource = WAttach_TypeTable.GetRecord(Me.RecordUniqueId, True)
            ...
            Me.DataSource = New WAttach_TypeRecord()
        ...
        Public Overridable Sub Delete()
          ...
          WAttach_TypeTable.DeleteRecord(pkValue)
        ...
        Public Property DataSource() As WAttach_TypeRecord
            Get
                Return DirectCast(MyBase._DataSource, WAttach_TypeRecord)
            End Get
            Set(ByVal value As WAttach_TypeRecord)
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetRecord() As WAttach_TypeRecord
            ...
            If Not Me.RecordUniqueId Is Nothing Then
                ...
                Return WAttach_TypeTable.GetRecord(Me.RecordUniqueId, True)
...
' Base class for the SelectorTableControl control on the WAttach_Type_QuickSelector page.
...
Public Class BaseSelectorTableControl
    ...
    ' Setup default pagination settings.
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                If wc IsNot Nothing AndAlso Not wc.RunQuery Then
                    ...
                    Me.DataSource = DirectCast(alist.ToArray(GetType(WAttach_TypeRecord)), WAttach_TypeRecord())
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    ...
                    For Each rc As SelectorTableControlRow In Me.GetRecordControls()
                        ...
                        End If
                    Next
                    Me.DataSource = DirectCast(postdata.ToArray(GetType(WAttach_TypeRecord)), WAttach_TypeRecord())
        ...
        Public Overridable Function GetRecords( _
            ...
            ' selCols.Add(WAttach_TypeTable.Column1, True)         
            ' selCols.Add(WAttach_TypeTable.Column2, True)          
            ' selCols.Add(WAttach_TypeTable.Column3, True)    
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return WAttach_TypeTable.GetRecords(join, where, orderBy, Me.PageIndex, Me.PageSize)
                 
            Else
                Dim databaseTable As New WAttach_TypeTable
                ...
                Return CType(recList.ToArray(GetType(WAttach_TypeRecord)), WAttach_TypeRecord())
            End If            
        ...
        Public Overridable Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return WAttach_TypeTable.GetRecordCount(join, where)
        ...
        Public Overridable Function GetColumnListFromURLParameters(ByVal includeIndexFieldParameter As Boolean, ByVal includeFormulaAndDFKAParameter As Boolean) As ColumnList
            ...
            If includeIndexFieldParameter AndAlso field <> "" Then
                Dim col As BaseColumn = WAttach_TypeTable.GetColumnByName(field)
                If col IsNot Nothing  AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
            End If
            If includeFormulaAndDFKAParameter Then
                If formula <> "" Then
                    For Each col As BaseColumn In MiscUtils.GetFormulaFieldList(formula, WAttach_TypeTable.Instance.TableDefinition)
                        If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                    Next
                
                ElseIf displayFieldName <> ""
                    Dim col As BaseColumn = WAttach_TypeTable.GetColumnByName(displayFieldName)
                    If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                End If
            End If
            Return columnList            
    ...
    End Sub
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            WAttach_TypeTable.Instance.InnerFilter = Nothing
      ...
      Next
            ...
            End If
		        ...
		        If Not String.IsNullOrEmpty(Me.Page.Request("dependOnField")) AndAlso Me.Page.Request("dependOnVal") IsNot Nothing Then
			          Dim dependOnCol as BaseColumn = WAttach_TypeTable.GetColumnByName(Me.Page.GetDecryptedURLParameter("dependOnField"))
    ...
    End Function
      ...
      Next
        ...
        Public Overridable Function GetAutoCompletionList_Search(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim recordList () As ePortalWFApproval.Business.WAttach_TypeRecord = WAttach_TypeTable.GetRecords(filterJoin, wc, Nothing, 0, count,count)
            Dim rec As WAttach_TypeRecord = Nothing
    ...
    Dim recControl As SelectorTableControlRow = DirectCast(repItem.FindControl("SelectorTableControlRow"), SelectorTableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        Dim rec As WAttach_TypeRecord = New WAttach_TypeRecord()
            ...
            For index = 1 To Me.AddNewRecord
                ...
                newRecordList.Insert(0, New WAttach_TypeRecord())
            ...
            If newRecordList.Count > 0 Then
                ...
                Me.DataSource = DirectCast(finalList.ToArray(GetType(WAttach_TypeRecord)), WAttach_TypeRecord())
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Try
        ...
        Public Property TotalRecords() As Integer
            Get
                If _TotalRecords < 0 
                    _TotalRecords = WAttach_TypeTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause())
                End If
