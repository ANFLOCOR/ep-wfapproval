    ...
    Public Class WFinRepNGP_HeadRecordControl
                    ...
                    If iApprovers = colUser.Count + 1 Then 'met the # of approvers requirement (+1 -> means the current user)
                        ...
                        Else
                            ...
                            Else
                                ...
                                orderBy.Add(WFinRepNGP_ActivityTable.WFRNGPA_ID, BaseClasses.Data.OrderByItem.OrderDir.Desc) 'get the latest return

                                wc6.iAND(WFinRepNGP_ActivityTable.WFRNGPA_WFRCHNGP_ID, BaseFilter.ComparisonOperator.EqualsTo, Me.WFRCHNGP_ID.Text)
                                'wc5.iAND(WCAR_ActivityTable.WCA_W_U_ID, BaseFilter.ComparisonOperator.EqualsTo, "")
                                wc6.iAND(WFinRepNGP_ActivityTable.WFRNGPA_Status, BaseFilter.ComparisonOperator.EqualsTo, "9")
                                'wc5.iAND(WCAR_ActivityTable.WCA_WS_ID, BaseFilter.ComparisonOperator.EqualsTo, sCurStep)

                                If WFinRepNGP_ActivityTable.GetRecords(wc6, orderBy, 0, 100).Length > 0 Then
                                    For Each itemValue5 As WFinRepNGP_ActivityRecord In WFinRepNGP_ActivityTable.GetRecords(wc6, orderBy, 0, 100)
                                        'note: update Activity table (current user) -> 'Approved'
                                        ...
                                        WFinRepNGP_ActivityRecord.AddRecord(itemValue5.WFRNGPA_WS_ID, itemValue5.WFRNGPA_WSD_ID, _
                                        CInt(Me.WFRCHNGP_DT_ID1.Text), _
        ...
        Public Sub SelectReturn(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Else
                ...
                wc.iAND(WFinRepNGP_ActivityTable.WFRNGPA_Status, BaseFilter.ComparisonOperator.EqualsTo, "4")
                ...
                If WFinRepNGP_ActivityTable.GetRecords(wc, Nothing, 0, 100).Length > 0 Then
                    ...
                    wc2.iAND(WFinRepNGP_ActivityTable.WFRNGPA_Status, BaseFilter.ComparisonOperator.EqualsTo, "4")
                    ...
                    For Each itemValue2 As WFinRepNGP_ActivityRecord In WFinRepNGP_ActivityTable.GetRecords(wc2, Nothing, 0, 100)
                        ...
                        WFinRepNGP_ActivityRecord.UpdateRecord(itemValue2.WFRNGPA_ID.ToString(), "9")
                    Next
                  ...
                  vbCrLf & "Date: @RD" & vbCrLf & vbCrLf & "Comment(s): @Rem" & vbCrLf & "Type: @T"
                    ...
                    If WFinRepNGP_ActivityTable.GetRecords(wc3, Nothing, 0, 100).Length > 0 Then
                        ...
                        If ddlMoveto.SelectedValue.ToString() <> "0" Then 'not the creator
                            ...
                            Dim wc6 As WhereClause = New WhereClause
                            wc6.iAND(WFinRep_StepDetailTable.WFIN_SD_S_ID, BaseFilter.ComparisonOperator.EqualsTo, ddlMoveto.SelectedValue.ToString())
                            For Each itemValue6 As WFinRep_StepDetailRecord In WFinRep_StepDetailTable.GetRecords(wc6, Nothing, 0, 100)
                                'note: use returned items to insert to Activity table
                                'note: do not insert(update) delegate until task expires
                                ...
                                WFinRepNGP_ActivityRecord.AddRecord(CInt(itemValue6.WFIN_SD_S_ID.ToString()), CInt(itemValue6.WFIN_SD_ID.ToString()), _
                                CInt(WDT_ID), _
