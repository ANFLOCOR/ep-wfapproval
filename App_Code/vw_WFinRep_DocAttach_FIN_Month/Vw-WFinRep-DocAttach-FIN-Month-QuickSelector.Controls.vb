...
' Vw_WFinRep_DocAttach_FIN_Month_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.Vw_WFinRep_DocAttach_FIN_Month_QuickSelector
...
' Base class for the SelectorTableControlRow control on the Vw_WFinRep_DocAttach_FIN_Month_QuickSelector page.
...
Public Class BaseSelectorTableControlRow
        ...
        Public Overridable Sub LoadData()        
            ...
            ' Load the data from the database into the DataSource DatabaseANFLO-WF%dbo.vw_WFinRep_DocAttach_FIN_Month record.
            ...
            If Me.RecordUniqueId IsNot Nothing AndAlso Me.RecordUniqueId.Trim <> "" Then
                Me.DataSource = Vw_WFinRep_DocAttach_FIN_MonthView.GetRecord(Me.RecordUniqueId, True)
            ...
            Me.DataSource = New Vw_WFinRep_DocAttach_FIN_MonthRecord()
        ...
        Public Overridable Sub Delete()
          ...
          Vw_WFinRep_DocAttach_FIN_MonthView.DeleteRecord(pkValue)
        ...
        Public Property DataSource() As Vw_WFinRep_DocAttach_FIN_MonthRecord
            Get
                Return DirectCast(MyBase._DataSource, Vw_WFinRep_DocAttach_FIN_MonthRecord)
            End Get
            Set(ByVal value As Vw_WFinRep_DocAttach_FIN_MonthRecord)
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetRecord() As Vw_WFinRep_DocAttach_FIN_MonthRecord
            ...
            If Not Me.RecordUniqueId Is Nothing Then
                ...
                Return Vw_WFinRep_DocAttach_FIN_MonthView.GetRecord(Me.RecordUniqueId, True)
...
' Base class for the SelectorTableControl control on the Vw_WFinRep_DocAttach_FIN_Month_QuickSelector page.
...
Public Class BaseSelectorTableControl
    ...
    ' Setup default pagination settings.
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                If wc IsNot Nothing AndAlso Not wc.RunQuery Then
                    ...
                    Me.DataSource = DirectCast(alist.ToArray(GetType(Vw_WFinRep_DocAttach_FIN_MonthRecord)), Vw_WFinRep_DocAttach_FIN_MonthRecord())
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    ...
                    For Each rc As SelectorTableControlRow In Me.GetRecordControls()
                        ...
                        End If
                    Next
                    Me.DataSource = DirectCast(postdata.ToArray(GetType(Vw_WFinRep_DocAttach_FIN_MonthRecord)), Vw_WFinRep_DocAttach_FIN_MonthRecord())
        ...
        Public Overridable Function GetRecords( _
            ...
            ' selCols.Add(Vw_WFinRep_DocAttach_FIN_MonthView.Column1, True)         
            ' selCols.Add(Vw_WFinRep_DocAttach_FIN_MonthView.Column2, True)          
            ' selCols.Add(Vw_WFinRep_DocAttach_FIN_MonthView.Column3, True)    
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return Vw_WFinRep_DocAttach_FIN_MonthView.GetRecords(join, where, orderBy, Me.PageIndex, Me.PageSize)
                 
            Else
                Dim databaseTable As New Vw_WFinRep_DocAttach_FIN_MonthView
                ...
                Return CType(recList.ToArray(GetType(Vw_WFinRep_DocAttach_FIN_MonthRecord)), Vw_WFinRep_DocAttach_FIN_MonthRecord())
            End If            
        ...
        Public Overridable Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return Vw_WFinRep_DocAttach_FIN_MonthView.GetRecordCount(join, where)
        ...
        Public Overridable Function GetColumnListFromURLParameters(ByVal includeIndexFieldParameter As Boolean, ByVal includeFormulaAndDFKAParameter As Boolean) As ColumnList
            ...
            If includeIndexFieldParameter AndAlso field <> "" Then
                Dim col As BaseColumn = Vw_WFinRep_DocAttach_FIN_MonthView.GetColumnByName(field)
                If col IsNot Nothing  AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
            End If
            If includeFormulaAndDFKAParameter Then
                If formula <> "" Then
                    For Each col As BaseColumn In MiscUtils.GetFormulaFieldList(formula, Vw_WFinRep_DocAttach_FIN_MonthView.Instance.TableDefinition)
                        If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                    Next
                
                ElseIf displayFieldName <> ""
                    Dim col As BaseColumn = Vw_WFinRep_DocAttach_FIN_MonthView.GetColumnByName(displayFieldName)
                    If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                End If
            End If
            Return columnList            
    ...
    End Sub
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            Vw_WFinRep_DocAttach_FIN_MonthView.Instance.InnerFilter = Nothing
      ...
      Next
            ...
            End If
		        ...
		        If Not String.IsNullOrEmpty(Me.Page.Request("dependOnField")) AndAlso Me.Page.Request("dependOnVal") IsNot Nothing Then
			          Dim dependOnCol as BaseColumn = Vw_WFinRep_DocAttach_FIN_MonthView.GetColumnByName(Me.Page.GetDecryptedURLParameter("dependOnField"))
    ...
    End Function
      ...
      Next
        ...
        Public Overridable Function GetAutoCompletionList_Search(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim recordList () As ePortalWFApproval.Business.Vw_WFinRep_DocAttach_FIN_MonthRecord = Vw_WFinRep_DocAttach_FIN_MonthView.GetRecords(filterJoin, wc, Nothing, 0, count,count)
            Dim rec As Vw_WFinRep_DocAttach_FIN_MonthRecord = Nothing
    ...
    Dim recControl As SelectorTableControlRow = DirectCast(repItem.FindControl("SelectorTableControlRow"), SelectorTableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        Dim rec As Vw_WFinRep_DocAttach_FIN_MonthRecord = New Vw_WFinRep_DocAttach_FIN_MonthRecord()
            ...
            For index = 1 To Me.AddNewRecord
                ...
                newRecordList.Insert(0, New Vw_WFinRep_DocAttach_FIN_MonthRecord())
            ...
            If newRecordList.Count > 0 Then
                ...
                Me.DataSource = DirectCast(finalList.ToArray(GetType(Vw_WFinRep_DocAttach_FIN_MonthRecord)), Vw_WFinRep_DocAttach_FIN_MonthRecord())
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Try
        ...
        Public Property TotalRecords() As Integer
            Get
                If _TotalRecords < 0 
                    _TotalRecords = Vw_WFinRep_DocAttach_FIN_MonthView.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause())
                End If
