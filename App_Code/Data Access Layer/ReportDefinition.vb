...
''' <see cref="ReportTable">ePortalWFApproval.ReportTable</see> class
...
#Region "Definition (XML) for ReportDefinition table"
	'Next 99 lines contain Table Definition (XML) for table "ReportDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="ReportTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>Report</columnName>")
         tbf.Append(      "<columnUIName>Report</columnUIName>")
         ...
         tbf.Append(      "<columnName>Report_ShortName</columnName>")
         tbf.Append(      "<columnUIName>Report Short Name</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>Report</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>Report_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>Report</FolderName>")
         tbf.Append(  "<MenuName>Report</MenuName>")
         tbf.Append(  "<QSPath>../Report/Report-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Report</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalReport</TableStoredProcPrefix>")
