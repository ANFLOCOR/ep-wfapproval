...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="POP10100_HEADER_ALL2View"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class POP10100_HEADER_ALL2SqlView
		Inherits BasePOP10100_HEADER_ALL2SqlView
