...
''' <summary>
''' Used by the <see cref="Vw_Trx_Summary_GroupByCompanyYearPeriodView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Vw_Trx_Summary_GroupByCompanyYearPeriodSqlView
	Inherits BaseVw_Trx_Summary_GroupByCompanyYearPeriodSqlView
