...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WCanvass_PO_Map_Temp1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WCanvass_PO_Map_Temp1SqlTable
		Inherits BaseWCanvass_PO_Map_Temp1SqlTable
