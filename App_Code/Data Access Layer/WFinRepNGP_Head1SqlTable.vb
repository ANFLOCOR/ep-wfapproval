...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WFinRepNGP_Head1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WFinRepNGP_Head1SqlTable
		Inherits BaseWFinRepNGP_Head1SqlTable
