...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="Sel_WPO_Activity_WPOP10100View"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Sel_WPO_Activity_WPOP10100SqlView
		Inherits BaseSel_WPO_Activity_WPOP10100SqlView
