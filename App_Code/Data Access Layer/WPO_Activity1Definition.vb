...
''' <see cref="WPO_Activity1Table">ePortalWFApproval.WPO_Activity1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPO_Activity1Table"></seealso>

Public Class WPO_Activity1Definition

#Region "Definition (XML) for WPO_Activity1Definition table"
	'Next 471 lines contain Table Definition (XML) for table "WPO_Activity1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPO_Activity1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKName>FK_WPO_Activity_WPO_Step</columnFKName>")
         ...
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_WPO_Activity_WPO_Step_Detail</columnFKName>")
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.WPO_Step_Detail1Table, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>WPO_SD_ID</columnFKColumn>")
         ...
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WPO_Activity_WPO_WDT_ID_1</columnFKName>")
         ...
         tbf.Append(      "<updatingFormula></updatingFormula>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WPO_Activity_WPO_W_U_ID_1</columnFKName>")
         ...
         tbf.Append(      "<updatingFormula></updatingFormula>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WPO_Activity_WPO_Status_1</columnFKName>")
         ...
         tbf.Append(      "<columnName>WPO_Is_InclPrint</columnName>")
         tbf.Append(      "<columnUIName>WPO Is Incl Print</columnUIName>")
         tbf.Append(      "<columnType>Boolean</columnType>")
         tbf.Append(      "<columnDBType>bit</columnDBType>")
         tbf.Append(      "<columnLengthSet></columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WPO_Activity</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WPO_Activity_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WPO_Activity1</FolderName>")
         tbf.Append(  "<MenuName>WPO Activity2</MenuName>")
         tbf.Append(  "<QSPath>../WPO_Activity1/WPO-Activity-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPO_Activity1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPO_Activity1</TableStoredProcPrefix>")
