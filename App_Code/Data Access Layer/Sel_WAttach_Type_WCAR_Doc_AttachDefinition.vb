...
''' <see cref="Sel_WAttach_Type_WCAR_Doc_AttachView">ePortalWFApproval.Sel_WAttach_Type_WCAR_Doc_AttachView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WAttach_Type_WCAR_Doc_AttachView"></seealso>

Public Class Sel_WAttach_Type_WCAR_Doc_AttachDefinition

#Region "Definition (XML) for Sel_WAttach_Type_WCAR_Doc_AttachDefinition table"
	'Next 254 lines contain Table Definition (XML) for table "Sel_WAttach_Type_WCAR_Doc_AttachDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WAttach_Type_WCAR_Doc_AttachView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.Sel_WCAR_Activity_WCAR_DocView, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>WCA_WCD_ID</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>=Sel_WCAR_Activity_WCAR_Doc.WCA_ID</columnFKColumnDisplay>")
         ...
         tbf.Append(      "<columnUIName Source=""User"">WAT</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         ...
         tbf.Append(  "<FolderName>sel_WAttach_Type_WCAR_Doc_Attach</FolderName>")
         tbf.Append(  "<MenuName>WAttach Type WCAR Document Attach</MenuName>")
         tbf.Append(  "<QSPath>../sel_WAttach_Type_WCAR_Doc_Attach/Sel-WAttach-Type-WCAR-Doc-Attach-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WAttach_Type_WCAR_Doc_Attach</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WAttach_Type_WCAR_Doc_Attach</TableStoredProcPrefix>")
