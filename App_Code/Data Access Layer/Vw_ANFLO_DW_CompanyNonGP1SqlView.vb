...
''' <summary>
''' Used by the <see cref="Vw_ANFLO_DW_CompanyNonGP1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Vw_ANFLO_DW_CompanyNonGP1SqlView
	Inherits BaseVw_ANFLO_DW_CompanyNonGP1SqlView
