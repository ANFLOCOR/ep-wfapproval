...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="SysSetupUserPermissionTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class SysSetupUserPermissionSqlTable
		Inherits BaseSysSetupUserPermissionSqlTable
