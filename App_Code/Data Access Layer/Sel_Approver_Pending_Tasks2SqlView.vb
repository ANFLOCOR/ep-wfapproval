...
''' <summary>
''' Used by the <see cref="Sel_Approver_Pending_Tasks2View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_Approver_Pending_Tasks2SqlView
	Inherits BaseSel_Approver_Pending_Tasks2SqlView
