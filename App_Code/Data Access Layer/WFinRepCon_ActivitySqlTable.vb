...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WFinRepCon_ActivityTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WFinRepCon_ActivitySqlTable
		Inherits BaseWFinRepCon_ActivitySqlTable
