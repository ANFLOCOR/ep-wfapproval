...
''' <summary>
''' Used by the <see cref="Sel_WFIN_ApproverPage1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WFIN_ApproverPage1SqlView
	Inherits BaseSel_WFIN_ApproverPage1SqlView
