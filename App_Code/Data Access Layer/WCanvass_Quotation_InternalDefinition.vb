...
#Region "Definition (XML) for WCanvass_Quotation_InternalDefinition table"
	'Next 181 lines contain Table Definition (XML) for table "WCanvass_Quotation_InternalDefinition"
...
#End Region
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WCanvass_Quotation_Internal_WCQI_PM00200_Vendor_ID_1</columnFKName>")
