...
#Region "Definition (XML) for Sel_WFIN_ApproverPage1Definition table"
	'Next 585 lines contain Table Definition (XML) for table "Sel_WFIN_ApproverPage1Definition"
...
#End Region
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnUIName Source=""User"">Afin</columnUIName>")
         ...
         tbf.Append(        "<columnFKColumnDisplay>= WFinRep_DocType1.WFIN_DT_Name</columnFKColumnDisplay>")
         ...
         tbf.Append(      "<updatingFormula></updatingFormula>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_sel_WFIN_ApproverPage_AFIN_W_U_ID_1</columnFKName>")
