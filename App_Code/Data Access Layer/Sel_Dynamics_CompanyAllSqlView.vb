...
''' <summary>
''' Used by the <see cref="Sel_Dynamics_CompanyAllView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_Dynamics_CompanyAllSqlView
	Inherits BaseSel_Dynamics_CompanyAllSqlView
