...
''' <see cref="WFinRepNGP_DocAttachTable">ePortalWFApproval.WFinRepNGP_DocAttachTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRepNGP_DocAttachTable"></seealso>

Public Class WFinRepNGP_DocAttachDefinition

#Region "Definition (XML) for WFinRepNGP_DocAttachDefinition table"
	'Next 447 lines contain Table Definition (XML) for table "WFinRepNGP_DocAttachDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRepNGP_DocAttachTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKColumnDisplay>=Vw_WFinRep_DocAttach_FIN_Month.Mo</columnFKColumnDisplay>")
         ...
         tbf.Append(        "<columnFKColumnDisplay>=WFin_ApprovalStatus.WPO_STAT_CD</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(    "</Column>")
         ...
         tbf.Append(  "<FolderName>WFinRepNGP_DocAttach</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative NGP Docum~ttach</MenuName>")
         tbf.Append(  "<QSPath>../WFinRepNGP_DocAttach/WFinRepNGP-DocAttach-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRepNGP_DocAttach</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRepNGP_DocAttach</TableStoredProcPrefix>")
