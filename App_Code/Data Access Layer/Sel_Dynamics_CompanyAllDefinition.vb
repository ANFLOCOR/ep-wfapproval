...
''' <see cref="Sel_Dynamics_CompanyAllView">ePortalWFApproval.Sel_Dynamics_CompanyAllView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_Dynamics_CompanyAllView"></seealso>

Public Class Sel_Dynamics_CompanyAllDefinition

#Region "Definition (XML) for Sel_Dynamics_CompanyAllDefinition table"
	'Next 150 lines contain Table Definition (XML) for table "Sel_Dynamics_CompanyAllDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_Dynamics_CompanyAllView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>sel_Dynamics_CompanyAll</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>sel_Dynamics_CompanyAll_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>sel_Dynamics_CompanyAll</FolderName>")
         tbf.Append(  "<MenuName>Dynamics Company All</MenuName>")
         tbf.Append(  "<QSPath>../sel_Dynamics_CompanyAll/Sel-Dynamics-CompanyAll-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_Dynamics_CompanyAll</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_Dynamics_CompanyAll</TableStoredProcPrefix>")
