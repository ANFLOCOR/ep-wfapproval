...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WFinRepNGP_DocAttach1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WFinRepNGP_DocAttach1SqlTable
		Inherits BaseWFinRepNGP_DocAttach1SqlTable
