...
''' <see cref="Sel_ShowSubmitApproval2View">ePortalWFApproval.Sel_ShowSubmitApproval2View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_ShowSubmitApproval2View"></seealso>

Public Class Sel_ShowSubmitApproval2Definition

#Region "Definition (XML) for Sel_ShowSubmitApproval2Definition table"
	'Next 543 lines contain Table Definition (XML) for table "Sel_ShowSubmitApproval2Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_ShowSubmitApproval2View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>POP_Status</columnName>")
         tbf.Append(      "<columnUIName>POP Status</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>sel_ShowSubmitApproval</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>sel_ShowSubmitApproval_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>sel_ShowSubmitApproval2</FolderName>")
         tbf.Append(  "<MenuName>Show Submit Approval1</MenuName>")
         tbf.Append(  "<QSPath>../sel_ShowSubmitApproval2/Sel-ShowSubmitApproval-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_ShowSubmitApproval2</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_ShowSubmitApproval2</TableStoredProcPrefix>")
