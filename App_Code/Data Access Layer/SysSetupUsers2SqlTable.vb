...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="SysSetupUsers2Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class SysSetupUsers2SqlTable
		Inherits BaseSysSetupUsers2SqlTable
