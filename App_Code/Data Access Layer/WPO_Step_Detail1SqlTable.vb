...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WPO_Step_Detail1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WPO_Step_Detail1SqlTable
		Inherits BaseWPO_Step_Detail1SqlTable
