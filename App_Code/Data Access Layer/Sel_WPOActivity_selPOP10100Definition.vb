...
''' <see cref="Sel_WPOActivity_selPOP10100View">ePortalWFApproval.Sel_WPOActivity_selPOP10100View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WPOActivity_selPOP10100View"></seealso>

Public Class Sel_WPOActivity_selPOP10100Definition

#Region "Definition (XML) for Sel_WPOActivity_selPOP10100Definition table"
	'Next 532 lines contain Table Definition (XML) for table "Sel_WPOActivity_selPOP10100Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WPOActivity_selPOP10100View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_WPOActivity_selPOP10100</FolderName>")
         tbf.Append(  "<MenuName>WPOActivity SEL POP 10100</MenuName>")
         tbf.Append(  "<QSPath>../sel_WPOActivity_selPOP10100/Sel-WPOActivity-selPOP10100-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WPOActivity_selPOP10100</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WPOActivity_selPOP10100</TableStoredProcPrefix>")
