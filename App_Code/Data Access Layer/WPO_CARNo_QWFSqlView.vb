...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WPO_CARNo_QWFView"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WPO_CARNo_QWFSqlView
		Inherits BaseWPO_CARNo_QWFSqlView
