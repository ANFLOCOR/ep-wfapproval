...
''' <see cref="SysSetupWASSEmail1Table">ePortalWFApproval.SysSetupWASSEmail1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="SysSetupWASSEmail1Table"></seealso>

Public Class SysSetupWASSEmail1Definition

#Region "Definition (XML) for SysSetupWASSEmail1Definition table"
	'Next 151 lines contain Table Definition (XML) for table "SysSetupWASSEmail1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="SysSetupWASSEmail1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>SysSetupWASSEmail1</FolderName>")
         tbf.Append(  "<MenuName>System Setup WASS Email1</MenuName>")
         tbf.Append(  "<QSPath>../SysSetupWASSEmail1/SysSetupWASSEmail-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>SysSetupWASSEmail1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSysSetupWASSEmail1</TableStoredProcPrefix>")
