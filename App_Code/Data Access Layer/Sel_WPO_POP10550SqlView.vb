...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="Sel_WPO_POP10550View"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Sel_WPO_POP10550SqlView
		Inherits BaseSel_WPO_POP10550SqlView
