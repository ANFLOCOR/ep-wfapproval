...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="Sel_WPOActivity_selPOP10100View"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Sel_WPOActivity_selPOP10100SqlView
		Inherits BaseSel_WPOActivity_selPOP10100SqlView
