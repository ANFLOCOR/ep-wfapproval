...
''' <see cref="SysSetupUserCompany_view1View">ePortalWFApproval.SysSetupUserCompany_view1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="SysSetupUserCompany_view1View"></seealso>

Public Class SysSetupUserCompany_view1Definition

#Region "Definition (XML) for SysSetupUserCompany_view1Definition table"
	'Next 254 lines contain Table Definition (XML) for table "SysSetupUserCompany_view1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="SysSetupUserCompany_view1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>SysSetupUserCompany_view1</FolderName>")
         tbf.Append(  "<MenuName>System Setup User Company View1</MenuName>")
         tbf.Append(  "<QSPath>../SysSetupUserCompany_view1/SysSetupUserCompany-view-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>SysSetupUserCompany_view1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSysSetupUserCompany_view1</TableStoredProcPrefix>")
