...
''' <see cref="Sel_WPO_Activity_WPOP101001View">ePortalWFApproval.Sel_WPO_Activity_WPOP101001View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WPO_Activity_WPOP101001View"></seealso>

Public Class Sel_WPO_Activity_WPOP101001Definition

#Region "Definition (XML) for Sel_WPO_Activity_WPOP101001Definition table"
	'Next 586 lines contain Table Definition (XML) for table "Sel_WPO_Activity_WPOP101001Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WPO_Activity_WPOP101001View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnUIName Source=""User"">WPO PONum</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>nvarchar</columnDBType>")
         ...
         tbf.Append(      "<updatingFormula></updatingFormula>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_sel_WPO_Activity_WPOP10100_WPO_PONum_1</columnFKName>")
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.POP10100_HEADER_ALL2View, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>PONUMBER</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>=POP10100_HEADER_ALL2.PONUMBER</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(    "</Column>")
         ...
         tbf.Append(  "<FolderName>sel_WPO_Activity_WPOP101001</FolderName>")
         tbf.Append(  "<MenuName>WPO Activity WPOP 101001</MenuName>")
         tbf.Append(  "<QSPath>../sel_WPO_Activity_WPOP101001/Sel-WPO-Activity-WPOP10100-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WPO_Activity_WPOP101001</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WPO_Activity_WPOP101001</TableStoredProcPrefix>")
