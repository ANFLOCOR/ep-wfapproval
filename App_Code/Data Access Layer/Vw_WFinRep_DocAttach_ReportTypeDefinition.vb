...
''' <see cref="Vw_WFinRep_DocAttach_ReportTypeView">ePortalWFApproval.Vw_WFinRep_DocAttach_ReportTypeView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Vw_WFinRep_DocAttach_ReportTypeView"></seealso>

Public Class Vw_WFinRep_DocAttach_ReportTypeDefinition

#Region "Definition (XML) for Vw_WFinRep_DocAttach_ReportTypeDefinition table"
	'Next 432 lines contain Table Definition (XML) for table "Vw_WFinRep_DocAttach_ReportTypeDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Vw_WFinRep_DocAttach_ReportTypeView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKName>VFK_vw_WFinRep_DocAttach_ReportType_FIN_Type_1</columnFKName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>vw_WFinRep_DocAttach_ReportType</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>vw_WFinRep_DocAttach_ReportType_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>vw_WFinRep_DocAttach_ReportType</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Document~Type</MenuName>")
         tbf.Append(  "<QSPath>../vw_WFinRep_DocAttach_ReportType/Vw-WFinRep-DocAttach-ReportType-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Vw_WFinRep_DocAttach_ReportType</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalVw_WFinRep_DocAttach_ReportType</TableStoredProcPrefix>")
