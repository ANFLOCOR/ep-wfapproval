...
''' <summary>
''' Used by the <see cref="Sel_WFinRepNGP_ApproverPageView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WFinRepNGP_ApproverPageSqlView
	Inherits BaseSel_WFinRepNGP_ApproverPageSqlView
