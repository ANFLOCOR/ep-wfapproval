...
''' <see cref="View_FS_StatusAllCompanyView">ePortalWFApproval.View_FS_StatusAllCompanyView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="View_FS_StatusAllCompanyView"></seealso>

Public Class View_FS_StatusAllCompanyDefinition

#Region "Definition (XML) for View_FS_StatusAllCompanyDefinition table"
	'Next 384 lines contain Table Definition (XML) for table "View_FS_StatusAllCompanyDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="View_FS_StatusAllCompanyView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>View_FS_StatusAllCompany</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>View_FS_StatusAllCompany_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>View_FS_StatusAllCompany</FolderName>")
         tbf.Append(  "<MenuName>View FS Status All Company</MenuName>")
         tbf.Append(  "<QSPath>../View_FS_StatusAllCompany/View-FS-StatusAllCompany-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>View_FS_StatusAllCompany</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalView_FS_StatusAllCompany</TableStoredProcPrefix>")
