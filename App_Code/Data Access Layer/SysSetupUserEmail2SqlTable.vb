...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="SysSetupUserEmail2Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class SysSetupUserEmail2SqlTable
		Inherits BaseSysSetupUserEmail2SqlTable
