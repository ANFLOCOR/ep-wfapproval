...
''' <summary>
''' Used by the <see cref="Vw_Conso_BSCategoriesView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Vw_Conso_BSCategoriesSqlView
	Inherits BaseVw_Conso_BSCategoriesSqlView
