...
''' <see cref="WFinRep_StepDetailTable">ePortalWFApproval.WFinRep_StepDetailTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRep_StepDetailTable"></seealso>

Public Class WFinRep_StepDetailDefinition

#Region "Definition (XML) for WFinRep_StepDetailDefinition table"
	'Next 281 lines contain Table Definition (XML) for table "WFinRep_StepDetailDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRep_StepDetailTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WFinRep_StepDetail</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Step Detail</MenuName>")
         tbf.Append(  "<QSPath>../WFinRep_StepDetail/WFinRep-StepDetail-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRep_StepDetail</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRep_StepDetail</TableStoredProcPrefix>")
