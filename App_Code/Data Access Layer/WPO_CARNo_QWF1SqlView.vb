...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WPO_CARNo_QWF1View"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WPO_CARNo_QWF1SqlView
		Inherits BaseWPO_CARNo_QWF1SqlView
