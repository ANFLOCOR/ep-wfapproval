...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WPO_Doc_Type1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WPO_Doc_Type1SqlTable
		Inherits BaseWPO_Doc_Type1SqlTable
