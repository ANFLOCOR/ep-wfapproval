...
''' <summary>
''' Used by the <see cref="Vw_FS_WFinRep_Attachment_PerReportTypeView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Vw_FS_WFinRep_Attachment_PerReportTypeSqlView
	Inherits BaseVw_FS_WFinRep_Attachment_PerReportTypeSqlView
