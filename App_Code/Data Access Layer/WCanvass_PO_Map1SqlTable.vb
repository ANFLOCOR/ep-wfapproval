...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WCanvass_PO_Map1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WCanvass_PO_Map1SqlTable
		Inherits BaseWCanvass_PO_Map1SqlTable
