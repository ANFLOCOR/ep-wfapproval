...
''' <see cref="WFinRep_Attachment1Table">ePortalWFApproval.WFinRep_Attachment1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRep_Attachment1Table"></seealso>

Public Class WFinRep_Attachment1Definition

#Region "Definition (XML) for WFinRep_Attachment1Definition table"
	'Next 147 lines contain Table Definition (XML) for table "WFinRep_Attachment1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRep_Attachment1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKName>VFK_WFinRep_Attachment_WFRA_FIN_ID_1</columnFKName>")
         ...
         tbf.Append(        "<columnFKColumnDisplay>=WFinRep_DocAttach1.FIN_ID</columnFKColumnDisplay>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WFinRep_Attachment</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WFinRep_Attachment_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WFinRep_Attachment1</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Attachment1</MenuName>")
         tbf.Append(  "<QSPath>../WFinRep_Attachment1/WFinRep-Attachment-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRep_Attachment1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRep_Attachment1</TableStoredProcPrefix>")
