...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WPR_Doc_StatusTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WPR_Doc_StatusSqlTable
		Inherits BaseWPR_Doc_StatusSqlTable
