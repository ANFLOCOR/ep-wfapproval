...
''' <summary>
''' Used by the <see cref="POP10100_HEADER_ALLView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class POP10100_HEADER_ALLSqlView
	Inherits BasePOP10100_HEADER_ALLSqlView
