...
#Region "Definition (XML) for Sel_WPO_WFTask1Definition table"
	'Next 510 lines contain Table Definition (XML) for table "Sel_WPO_WFTask1Definition"
...
#End Region
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKName>VFK_sel_WPO_WFTask_Workflow_Approval_Status_1</columnFKName>")
