...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="SysSetupUserCompany2Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class SysSetupUserCompany2SqlTable
		Inherits BaseSysSetupUserCompany2SqlTable
