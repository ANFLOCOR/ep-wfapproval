...
''' <see cref="WFinRep_ReportTypeTable">ePortalWFApproval.WFinRep_ReportTypeTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRep_ReportTypeTable"></seealso>

Public Class WFinRep_ReportTypeDefinition

#Region "Definition (XML) for WFinRep_ReportTypeDefinition table"
	'Next 99 lines contain Table Definition (XML) for table "WFinRep_ReportTypeDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRep_ReportTypeTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WFinRep_ReportType</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Report Type</MenuName>")
         tbf.Append(  "<QSPath>../WFinRep_ReportType/WFinRep-ReportType-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRep_ReportType</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRep_ReportType</TableStoredProcPrefix>")
