...
''' <see cref="Sel_WPO_POP10550View">ePortalWFApproval.Sel_WPO_POP10550View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WPO_POP10550View"></seealso>

Public Class Sel_WPO_POP10550Definition

#Region "Definition (XML) for Sel_WPO_POP10550Definition table"
	'Next 195 lines contain Table Definition (XML) for table "Sel_WPO_POP10550Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WPO_POP10550View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_WPO_POP10550</FolderName>")
         tbf.Append(  "<MenuName>WPO POP 10550</MenuName>")
         tbf.Append(  "<QSPath>../sel_WPO_POP10550/Sel-WPO-POP10550-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WPO_POP10550</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WPO_POP10550</TableStoredProcPrefix>")
