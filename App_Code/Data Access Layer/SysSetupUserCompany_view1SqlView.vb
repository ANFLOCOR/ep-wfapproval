...
''' <summary>
''' Used by the <see cref="SysSetupUserCompany_view1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class SysSetupUserCompany_view1SqlView
	Inherits BaseSysSetupUserCompany_view1SqlView
