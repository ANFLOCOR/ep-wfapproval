...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WCanvass_Quotation_InternalTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WCanvass_Quotation_InternalSqlTable
		Inherits BaseWCanvass_Quotation_InternalSqlTable
