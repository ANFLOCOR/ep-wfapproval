...
''' <see cref="Sel_PM00200View">ePortalWFApproval.Sel_PM00200View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_PM00200View"></seealso>

Public Class Sel_PM00200Definition

#Region "Definition (XML) for Sel_PM00200Definition table"
	'Next 127 lines contain Table Definition (XML) for table "Sel_PM00200Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_PM00200View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_PM00200</FolderName>")
         tbf.Append(  "<MenuName>PM 00200</MenuName>")
         tbf.Append(  "<QSPath>../sel_PM00200/Sel-PM00200-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_PM00200</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_PM00200</TableStoredProcPrefix>")
