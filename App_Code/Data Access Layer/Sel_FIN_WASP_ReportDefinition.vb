...
''' <see cref="Sel_FIN_WASP_ReportView">ePortalWFApproval.Sel_FIN_WASP_ReportView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_FIN_WASP_ReportView"></seealso>

Public Class Sel_FIN_WASP_ReportDefinition

#Region "Definition (XML) for Sel_FIN_WASP_ReportDefinition table"
	'Next 254 lines contain Table Definition (XML) for table "Sel_FIN_WASP_ReportDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_FIN_WASP_ReportView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_FIN_WASP_Report</FolderName>")
         tbf.Append(  "<MenuName>FIN WASP Report</MenuName>")
         tbf.Append(  "<QSPath>../sel_FIN_WASP_Report/Sel-FIN-WASP-Report-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_FIN_WASP_Report</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_FIN_WASP_Report</TableStoredProcPrefix>")
