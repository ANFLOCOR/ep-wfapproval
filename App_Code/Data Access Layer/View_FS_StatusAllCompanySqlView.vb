...
''' <summary>
''' Used by the <see cref="View_FS_StatusAllCompanyView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class View_FS_StatusAllCompanySqlView
	Inherits BaseView_FS_StatusAllCompanySqlView
