...
''' <see cref="WFinRep_StepDetail1Table">ePortalWFApproval.WFinRep_StepDetail1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRep_StepDetail1Table"></seealso>

Public Class WFinRep_StepDetail1Definition

#Region "Definition (XML) for WFinRep_StepDetail1Definition table"
	'Next 281 lines contain Table Definition (XML) for table "WFinRep_StepDetail1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRep_StepDetail1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnUIName>Wfin SD</columnUIName>")
         ...
         tbf.Append(      "<columnName>WFIN_SD_S_ID</columnName>")
         tbf.Append(      "<columnUIName>Wfin SD S</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>WFIN_SD_Desc</columnName>")
         tbf.Append(      "<columnUIName>WFIN SD Description</columnUIName>")
         ...
         tbf.Append(      "<columnName>WFIN_SD_Status</columnName>")
         tbf.Append(      "<columnUIName>WFIN SD Status</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         tbf.Append(      "<columnLengthSet>50</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>WFIN_SD_Variable_Ref</columnName>")
         tbf.Append(      "<columnUIName>WFIN SD Variable Reference</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>WFIN_SD_Variable_SQL</columnName>")
         tbf.Append(      "<columnUIName>WFIN SD Variable SQL</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         ...
         tbf.Append(      "<columnName>WFIN_SD_Expire</columnName>")
         tbf.Append(      "<columnUIName>WFIN SD Expire</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         ...
         tbf.Append(      "<columnName>WFIN_SD_W_U_ID_Delegate</columnName>")
         tbf.Append(      "<columnUIName>WFIN SD W U Delegate</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>WFIN_SD_Is_Escalate</columnName>")
         tbf.Append(      "<columnUIName>WFIN SD Is Escalate</columnUIName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WFinRep_StepDetail</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WFinRep_StepDetail_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WFinRep_StepDetail1</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Step Detail1</MenuName>")
         tbf.Append(  "<QSPath>../WFinRep_StepDetail1/WFinRep-StepDetail-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRep_StepDetail1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRep_StepDetail1</TableStoredProcPrefix>")
