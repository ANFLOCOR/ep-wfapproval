...
''' <summary>
''' Used by the <see cref="Sel_W_User_W_Module1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_W_User_W_Module1SqlView
	Inherits BaseSel_W_User_W_Module1SqlView
