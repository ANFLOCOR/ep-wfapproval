...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WCanvass_Detail_InternalTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WCanvass_Detail_InternalSqlTable
		Inherits BaseWCanvass_Detail_InternalSqlTable
