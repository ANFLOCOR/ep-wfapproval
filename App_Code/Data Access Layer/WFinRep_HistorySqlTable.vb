...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WFinRep_HistoryTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WFinRep_HistorySqlTable
		Inherits BaseWFinRep_HistorySqlTable
