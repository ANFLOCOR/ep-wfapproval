...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WFinRep_Activity1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WFinRep_Activity1SqlTable
		Inherits BaseWFinRep_Activity1SqlTable
