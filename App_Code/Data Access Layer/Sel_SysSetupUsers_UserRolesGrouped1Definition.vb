...
''' <see cref="Sel_SysSetupUsers_UserRolesGrouped1View">ePortalWFApproval.Sel_SysSetupUsers_UserRolesGrouped1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_SysSetupUsers_UserRolesGrouped1View"></seealso>

Public Class Sel_SysSetupUsers_UserRolesGrouped1Definition

#Region "Definition (XML) for Sel_SysSetupUsers_UserRolesGrouped1Definition table"
	'Next 176 lines contain Table Definition (XML) for table "Sel_SysSetupUsers_UserRolesGrouped1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_SysSetupUsers_UserRolesGrouped1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_SysSetupUsers_UserRolesGrouped1</FolderName>")
         tbf.Append(  "<MenuName>System Setup Users User Roles~ouped1</MenuName>")
         tbf.Append(  "<QSPath>../sel_SysSetupUsers_UserRolesGrouped1/Sel-SysSetupUsers-UserRolesGrouped-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_SysSetupUsers_UserRolesGrouped1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_SysSetupUsers_UserRolesGrouped1</TableStoredProcPrefix>")
