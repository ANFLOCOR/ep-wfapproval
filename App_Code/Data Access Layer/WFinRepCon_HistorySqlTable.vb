...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WFinRepCon_HistoryTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WFinRepCon_HistorySqlTable
		Inherits BaseWFinRepCon_HistorySqlTable
