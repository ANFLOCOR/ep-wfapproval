...
''' <see cref="View_FS_PackageForConsoView">ePortalWFApproval.View_FS_PackageForConsoView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="View_FS_PackageForConsoView"></seealso>

Public Class View_FS_PackageForConsoDefinition

#Region "Definition (XML) for View_FS_PackageForConsoDefinition table"
	'Next 428 lines contain Table Definition (XML) for table "View_FS_PackageForConsoDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="View_FS_PackageForConsoView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>wass_C_ID</columnName>")
         tbf.Append(      "<columnUIName>Wass C</columnUIName>")
         ...
         tbf.Append(        "<columnFKName>VFK_view_FS_PackageForConso_Month_1</columnFKName>")
         ...
         tbf.Append(      "<columnName>Doc_TypeID</columnName>")
         ...
         tbf.Append(      "<columnName>Submit</columnName>")
         tbf.Append(      "<columnUIName>Submit</columnUIName>")
         ...
         tbf.Append(      "<updatingFormula></updatingFormula>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_view_FS_PackageForConso_Status_1</columnFKName>")
         ...
         tbf.Append(      "<columnName>Remarks</columnName>")
         tbf.Append(      "<columnUIName>Remarks</columnUIName>")
         ...
         tbf.Append(      "<columnName>ReportCnt</columnName>")
         tbf.Append(      "<columnUIName>Report Count</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>DescriptionStat</columnName>")
         tbf.Append(      "<columnUIName>Description Status</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>nvarchar</columnDBType>")
         ...
         tbf.Append(      "<columnName>FS_Type</columnName>")
         tbf.Append(      "<columnUIName>FS Type</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>view_FS_PackageForConso</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>view_FS_PackageForConso_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>view_FS_PackageForConso</FolderName>")
         tbf.Append(  "<MenuName>FS Package For Conso</MenuName>")
         tbf.Append(  "<QSPath>../view_FS_PackageForConso/View-FS-PackageForConso-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>View_FS_PackageForConso</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalView_FS_PackageForConso</TableStoredProcPrefix>")
