...
''' <summary>
''' Used by the <see cref="View_FS_PackageForConsoView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class View_FS_PackageForConsoSqlView
	Inherits BaseView_FS_PackageForConsoSqlView
