...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WASS_Email_Default1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WASS_Email_Default1SqlTable
		Inherits BaseWASS_Email_Default1SqlTable
