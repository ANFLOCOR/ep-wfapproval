...
''' <see cref="WFinRep_Activity1Table">ePortalWFApproval.WFinRep_Activity1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRep_Activity1Table"></seealso>

Public Class WFinRep_Activity1Definition

#Region "Definition (XML) for WFinRep_Activity1Definition table"
	'Next 526 lines contain Table Definition (XML) for table "WFinRep_Activity1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRep_Activity1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.WFinRep_Step1Table, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>WFIN_S_ID</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>= WFinRep_Step1.WFIN_S_Desc</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WFinRep_Activity_AFIN_WS_ID_2</columnFKName>")
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.WFinRep_StepDetail1Table, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         ...
         tbf.Append(      "<updatingFormula></updatingFormula>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WFinRep_Activity_AFIN_WDT_ID_1</columnFKName>")
         ...
         tbf.Append(        "<columnFKColumnDisplay>= WFinRep_DocType1.WFIN_DT_Type</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(    "</Column>")
         ...
         tbf.Append(  "<FolderName>WFinRep_Activity1</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Activity1</MenuName>")
         tbf.Append(  "<QSPath>../WFinRep_Activity1/WFinRep-Activity-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRep_Activity1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRep_Activity1</TableStoredProcPrefix>")
