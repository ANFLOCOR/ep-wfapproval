...
#Region "Definition (XML) for WFinRep_Activity1Definition table"
	'Next 483 lines contain Table Definition (XML) for table "WFinRep_Activity1Definition"
...
#End Region
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKColumnDisplay>=Sel_WASP_User1.W_U_ID</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(    "</Column>")
