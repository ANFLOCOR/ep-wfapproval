...
''' <see cref="Sel_W_User_DYNAMICS_Company_FSView">ePortalWFApproval.Sel_W_User_DYNAMICS_Company_FSView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_W_User_DYNAMICS_Company_FSView"></seealso>

Public Class Sel_W_User_DYNAMICS_Company_FSDefinition

#Region "Definition (XML) for Sel_W_User_DYNAMICS_Company_FSDefinition table"
	'Next 150 lines contain Table Definition (XML) for table "Sel_W_User_DYNAMICS_Company_FSDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_W_User_DYNAMICS_Company_FSView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_W_User_DYNAMICS_Company_FS</FolderName>")
         tbf.Append(  "<MenuName>W User DYNAMICS Company FS</MenuName>")
         tbf.Append(  "<QSPath>../sel_W_User_DYNAMICS_Company_FS/Sel-W-User-DYNAMICS-Company-FS-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_W_User_DYNAMICS_Company_FS</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_W_User_DYNAMICS_Company_FS</TableStoredProcPrefix>")
