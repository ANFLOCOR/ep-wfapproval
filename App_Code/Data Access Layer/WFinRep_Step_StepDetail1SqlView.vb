...
''' <summary>
''' Used by the <see cref="WFinRep_Step_StepDetail1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class WFinRep_Step_StepDetail1SqlView
	Inherits BaseWFinRep_Step_StepDetail1SqlView
