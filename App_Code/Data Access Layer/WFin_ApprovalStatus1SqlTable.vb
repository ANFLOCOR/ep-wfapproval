...
''' <summary>
''' Used by the <see cref="WFin_ApprovalStatus1Table"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class WFin_ApprovalStatus1SqlTable
	Inherits BaseWFin_ApprovalStatus1SqlTable
