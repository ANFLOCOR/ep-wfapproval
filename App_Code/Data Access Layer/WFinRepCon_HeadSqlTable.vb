...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WFinRepCon_HeadTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WFinRepCon_HeadSqlTable
		Inherits BaseWFinRepCon_HeadSqlTable
