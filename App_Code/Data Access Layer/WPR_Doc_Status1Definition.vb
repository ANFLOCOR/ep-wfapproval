...
''' <see cref="WPR_Doc_Status1Table">ePortalWFApproval.WPR_Doc_Status1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPR_Doc_Status1Table"></seealso>

Public Class WPR_Doc_Status1Definition

#Region "Definition (XML) for WPR_Doc_Status1Definition table"
	'Next 99 lines contain Table Definition (XML) for table "WPR_Doc_Status1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPR_Doc_Status1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WPR_Doc_Status1</FolderName>")
         tbf.Append(  "<MenuName>WPR Document Status1</MenuName>")
         tbf.Append(  "<QSPath>../WPR_Doc_Status1/WPR-Doc-Status-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPR_Doc_Status1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPR_Doc_Status1</TableStoredProcPrefix>")
