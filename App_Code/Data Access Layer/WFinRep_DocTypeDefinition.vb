...
''' <see cref="WFinRep_DocTypeTable">ePortalWFApproval.WFinRep_DocTypeTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRep_DocTypeTable"></seealso>

Public Class WFinRep_DocTypeDefinition

#Region "Definition (XML) for WFinRep_DocTypeDefinition table"
	'Next 203 lines contain Table Definition (XML) for table "WFinRep_DocTypeDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRep_DocTypeTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WFinRep_DocType</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Document Type</MenuName>")
         tbf.Append(  "<QSPath>../WFinRep_DocType/WFinRep-DocType-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRep_DocType</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRep_DocType</TableStoredProcPrefix>")
