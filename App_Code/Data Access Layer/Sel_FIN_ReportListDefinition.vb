...
''' <see cref="Sel_FIN_ReportListView">ePortalWFApproval.Sel_FIN_ReportListView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_FIN_ReportListView"></seealso>

Public Class Sel_FIN_ReportListDefinition

#Region "Definition (XML) for Sel_FIN_ReportListDefinition table"
	'Next 176 lines contain Table Definition (XML) for table "Sel_FIN_ReportListDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_FIN_ReportListView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_FIN_ReportList</FolderName>")
         tbf.Append(  "<MenuName>FIN Report List</MenuName>")
         tbf.Append(  "<QSPath>../sel_FIN_ReportList/Sel-FIN-ReportList-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_FIN_ReportList</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_FIN_ReportList</TableStoredProcPrefix>")
