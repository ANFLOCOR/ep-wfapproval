...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WFinRepNGP_DocAttachTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WFinRepNGP_DocAttachSqlTable
		Inherits BaseWFinRepNGP_DocAttachSqlTable
