...
''' <see cref="Sel_W_User_DYNAMICS_Company_FS1View">ePortalWFApproval.Sel_W_User_DYNAMICS_Company_FS1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_W_User_DYNAMICS_Company_FS1View"></seealso>

Public Class Sel_W_User_DYNAMICS_Company_FS1Definition

#Region "Definition (XML) for Sel_W_User_DYNAMICS_Company_FS1Definition table"
	'Next 150 lines contain Table Definition (XML) for table "Sel_W_User_DYNAMICS_Company_FS1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_W_User_DYNAMICS_Company_FS1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>sel_W_User_DYNAMICS_Company_FS</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>Sel_W_User_DYNAMIC_1089084141_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>sel_W_User_DYNAMICS_Company_FS1</FolderName>")
         tbf.Append(  "<MenuName>W User DYNAMICS Company FS1</MenuName>")
         tbf.Append(  "<QSPath>../sel_W_User_DYNAMICS_Company_FS1/Sel-W-User-DYNAMICS-Company-FS-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_W_User_DYNAMICS_Company_FS1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_W_User_DYNAMICS_Company_FS1</TableStoredProcPrefix>")
