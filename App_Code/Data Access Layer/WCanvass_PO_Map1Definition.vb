...
''' <see cref="WCanvass_PO_Map1Table">ePortalWFApproval.WCanvass_PO_Map1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WCanvass_PO_Map1Table"></seealso>

Public Class WCanvass_PO_Map1Definition

#Region "Definition (XML) for WCanvass_PO_Map1Definition table"
	'Next 483 lines contain Table Definition (XML) for table "WCanvass_PO_Map1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WCanvass_PO_Map1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.WPR_Line1Table, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>WPRL_ID</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>= WPR_Line1.WPRL_Item_Desc</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(    "</Column>")
         ...
         tbf.Append(      "<columnUIName Source=""User"">WCPOM Date</columnUIName>")
         ...
         tbf.Append(  "<FolderName>WCanvass_PO_Map1</FolderName>")
         tbf.Append(  "<MenuName>WCanvass PO Map2</MenuName>")
         tbf.Append(  "<QSPath>../WCanvass_PO_Map1/WCanvass-PO-Map-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WCanvass_PO_Map1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWCanvass_PO_Map1</TableStoredProcPrefix>")
