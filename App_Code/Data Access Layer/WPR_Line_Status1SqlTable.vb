...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WPR_Line_Status1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WPR_Line_Status1SqlTable
		Inherits BaseWPR_Line_Status1SqlTable
