...
''' <see cref="Sel_WPO_POP101001View">ePortalWFApproval.Sel_WPO_POP101001View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WPO_POP101001View"></seealso>

Public Class Sel_WPO_POP101001Definition

#Region "Definition (XML) for Sel_WPO_POP101001Definition table"
	'Next 463 lines contain Table Definition (XML) for table "Sel_WPO_POP101001Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WPO_POP101001View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>TAXSCHID</columnName>")
         tbf.Append(      "<columnUIName>Taxsch</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>char</columnDBType>")
         tbf.Append(      "<columnLengthSet>15</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>sel_WPO_POP10100</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>sel_WPO_POP10100_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>sel_WPO_POP101001</FolderName>")
         tbf.Append(  "<MenuName>WPO POP 101001</MenuName>")
         tbf.Append(  "<QSPath>../sel_WPO_POP101001/Sel-WPO-POP10100-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WPO_POP101001</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WPO_POP101001</TableStoredProcPrefix>")
