...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WClassification1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WClassification1SqlTable
		Inherits BaseWClassification1SqlTable
