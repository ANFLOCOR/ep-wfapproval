...
''' <see cref="WPO_CARNo_QWFView">ePortalWFApproval.WPO_CARNo_QWFView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPO_CARNo_QWFView"></seealso>

Public Class WPO_CARNo_QWFDefinition

#Region "Definition (XML) for WPO_CARNo_QWFDefinition table"
	'Next 356 lines contain Table Definition (XML) for table "WPO_CARNo_QWFDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPO_CARNo_QWFView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKName>VFK_WPO_CARNo_QWF_CompanyID_1</columnFKName>")
         ...
         tbf.Append(      "</foreignKey>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WPO_CARNo_QWF_CompanyID_2</columnFKName>")
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.WPO_PRNo_QWFView, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         ...
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WPO_CARNo_QWF_PONum_1</columnFKName>")
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.WPO_PRNo_QWFView, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>PONo</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>=WPO_PRNo_QWF.CompanyID</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(    "</Column>")
         ...
         tbf.Append(      "<columnVirtualPK Source=""User"">Y</columnVirtualPK>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WPO_CARNo_QWF_PRNum_1</columnFKName>")
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.WPO_PRNo_QWFView, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>PRNo</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>=WPO_PRNo_QWF.CompanyID</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(    "</Column>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WPO_CARNo_QWF</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WPO_CARNo_QWF_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WPO_CARNo_QWF</FolderName>")
         tbf.Append(  "<MenuName>WPO CARNo QWF</MenuName>")
         tbf.Append(  "<QSPath>../WPO_CARNo_QWF/WPO-CARNo-QWF-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPO_CARNo_QWF</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPO_CARNo_QWF</TableStoredProcPrefix>")
