...
''' <see cref="SysPages3Table">ePortalWFApproval.SysPages3Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="SysPages3Table"></seealso>

Public Class SysPages3Definition

#Region "Definition (XML) for SysPages3Definition table"
	'Next 282 lines contain Table Definition (XML) for table "SysPages3Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="SysPages3Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>SysPages3</FolderName>")
         tbf.Append(  "<MenuName>System Pages3</MenuName>")
         tbf.Append(  "<QSPath>../SysPages3/SysPages-QuickSelector3.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>SysPages3</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSysPages3</TableStoredProcPrefix>")
