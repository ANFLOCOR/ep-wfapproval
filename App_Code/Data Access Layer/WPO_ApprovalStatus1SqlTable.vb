...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WPO_ApprovalStatus1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WPO_ApprovalStatus1SqlTable
		Inherits BaseWPO_ApprovalStatus1SqlTable
