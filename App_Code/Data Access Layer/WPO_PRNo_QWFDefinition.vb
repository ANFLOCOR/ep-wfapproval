...
''' <see cref="WPO_PRNo_QWFView">ePortalWFApproval.WPO_PRNo_QWFView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPO_PRNo_QWFView"></seealso>

Public Class WPO_PRNo_QWFDefinition

#Region "Definition (XML) for WPO_PRNo_QWFDefinition table"
	'Next 304 lines contain Table Definition (XML) for table "WPO_PRNo_QWFDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPO_PRNo_QWFView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKName>VFK_WPO_PRNo_QWF_CompanyID_1</columnFKName>")
         ...
         tbf.Append(      "<columnVirtualPK Source=""User"">Y</columnVirtualPK>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WPO_PRNo_QWF_PONo_1</columnFKName>")
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.Sel_WPO_Activity_WPOP10100View, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>WPO_PONum</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>=Sel_WPO_Activity_WPOP10100.WPO_PONum</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(    "</Column>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WPO_PRNo_QWF</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WPO_PRNo_QWF_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WPO_PRNo_QWF</FolderName>")
         tbf.Append(  "<MenuName>WPO PRNo QWF</MenuName>")
         tbf.Append(  "<QSPath>../WPO_PRNo_QWF/WPO-PRNo-QWF-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPO_PRNo_QWF</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPO_PRNo_QWF</TableStoredProcPrefix>")
