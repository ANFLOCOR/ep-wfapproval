...
''' <see cref="Sel_WPO_InquireDetails1View">ePortalWFApproval.Sel_WPO_InquireDetails1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WPO_InquireDetails1View"></seealso>

Public Class Sel_WPO_InquireDetails1Definition

#Region "Definition (XML) for Sel_WPO_InquireDetails1Definition table"
	'Next 629 lines contain Table Definition (XML) for table "Sel_WPO_InquireDetails1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WPO_InquireDetails1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnUIName Source=""User"">Line Number</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         ...
         tbf.Append(      "<columnUIName Source=""User"">Extd Cost</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>numeric</columnDBType>")
         tbf.Append(      "<columnLengthSet>19.5</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<insertingFormula></insertingFormula>")
         tbf.Append(      "<updatingFormula></updatingFormula>")
         tbf.Append(      "<columnFormat Source=""User"">#,#.00</columnFormat>")
         tbf.Append(    "</Column>")
         ...
         tbf.Append(      "<columnName>WPOFR_Rate</columnName>")
         tbf.Append(      "<columnUIName>WPOFR Rate</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>numeric</columnDBType>")
         ...
         tbf.Append(      "<columnName>WPOFR_Unit_Cost</columnName>")
         tbf.Append(      "<columnUIName>WPOFR Unit Cost</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>numeric</columnDBType>")
         tbf.Append(      "<columnLengthSet>18.5</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>ExtCostForex</columnName>")
         tbf.Append(      "<columnUIName>Extension Cost Forex</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>numeric</columnDBType>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>sel_WPO_InquireDetails</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>sel_WPO_InquireDetails_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>sel_WPO_InquireDetails1</FolderName>")
         tbf.Append(  "<MenuName>WPO Inquire Details1</MenuName>")
         tbf.Append(  "<QSPath>../sel_WPO_InquireDetails1/Sel-WPO-InquireDetails-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WPO_InquireDetails1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WPO_InquireDetails1</TableStoredProcPrefix>")
