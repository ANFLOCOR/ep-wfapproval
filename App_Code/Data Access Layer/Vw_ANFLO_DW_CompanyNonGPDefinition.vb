...
''' <see cref="Vw_ANFLO_DW_CompanyNonGPView">ePortalWFApproval.Vw_ANFLO_DW_CompanyNonGPView</see> class
...
#End Region
	...
	''' <see cref="Vw_ANFLO_DW_CompanyNonGPView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<QSPath>../vw_ANFLO_DW_CompanyNonGP/Vw-ANFLO-DW-CompanyNonGP-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Vw_ANFLO_DW_CompanyNonGP</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalVw_ANFLO_DW_CompanyNonGP</TableStoredProcPrefix>")
