...
''' <see cref="WPO_Step_WPO_StepDetail1View">ePortalWFApproval.WPO_Step_WPO_StepDetail1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPO_Step_WPO_StepDetail1View"></seealso>

Public Class WPO_Step_WPO_StepDetail1Definition

#Region "Definition (XML) for WPO_Step_WPO_StepDetail1Definition table"
	'Next 338 lines contain Table Definition (XML) for table "WPO_Step_WPO_StepDetail1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPO_Step_WPO_StepDetail1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKName>VFK_WPO_Step_WPO_StepDetail_WPO_S_ID_1</columnFKName>")
         ...
         tbf.Append(      "<columnUIName Source=""User"">WPO SD</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<updatingFormula></updatingFormula>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WPO_Step_WPO_StepDetail_WPO_SD_W_U_ID_1</columnFKName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WPO_Step_WPO_StepDetail</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WPO_Step_WPO_StepDetail_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WPO_Step_WPO_StepDetail1</FolderName>")
         tbf.Append(  "<MenuName>WPO Step WPO Step Detail1</MenuName>")
         tbf.Append(  "<QSPath>../WPO_Step_WPO_StepDetail1/WPO-Step-WPO-StepDetail-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPO_Step_WPO_StepDetail1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPO_Step_WPO_StepDetail1</TableStoredProcPrefix>")
