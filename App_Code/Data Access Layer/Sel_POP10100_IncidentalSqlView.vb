...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="Sel_POP10100_IncidentalView"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Sel_POP10100_IncidentalSqlView
		Inherits BaseSel_POP10100_IncidentalSqlView
