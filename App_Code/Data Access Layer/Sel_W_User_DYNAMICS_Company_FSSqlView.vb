...
''' <summary>
''' Used by the <see cref="Sel_W_User_DYNAMICS_Company_FSView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_W_User_DYNAMICS_Company_FSSqlView
	Inherits BaseSel_W_User_DYNAMICS_Company_FSSqlView
