...
''' <see cref="WPO_Step1Table">ePortalWFApproval.WPO_Step1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPO_Step1Table"></seealso>

Public Class WPO_Step1Definition

#Region "Definition (XML) for WPO_Step1Definition table"
	'Next 221 lines contain Table Definition (XML) for table "WPO_Step1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPO_Step1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WPO_Step1</FolderName>")
         tbf.Append(  "<MenuName>WPO Step1</MenuName>")
         tbf.Append(  "<QSPath>../WPO_Step1/WPO-Step-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPO_Step1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPO_Step1</TableStoredProcPrefix>")
