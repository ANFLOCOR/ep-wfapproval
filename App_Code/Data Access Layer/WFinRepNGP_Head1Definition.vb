...
''' <see cref="WFinRepNGP_Head1Table">ePortalWFApproval.WFinRepNGP_Head1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRepNGP_Head1Table"></seealso>

Public Class WFinRepNGP_Head1Definition

#Region "Definition (XML) for WFinRepNGP_Head1Definition table"
	'Next 499 lines contain Table Definition (XML) for table "WFinRepNGP_Head1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRepNGP_Head1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnUIName>WFRCHNGP Status</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(  "<FolderName>WFinRepNGP_Head1</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative NGP Head1</MenuName>")
         tbf.Append(  "<QSPath>../WFinRepNGP_Head1/WFinRepNGP-Head-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRepNGP_Head1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRepNGP_Head1</TableStoredProcPrefix>")
