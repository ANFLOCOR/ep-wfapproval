...
''' <see cref="WFinRep_DocAttach1Table">ePortalWFApproval.WFinRep_DocAttach1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRep_DocAttach1Table"></seealso>

Public Class WFinRep_DocAttach1Definition

#Region "Definition (XML) for WFinRep_DocAttach1Definition table"
	'Next 460 lines contain Table Definition (XML) for table "WFinRep_DocAttach1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRep_DocAttach1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<updatingFormula></updatingFormula>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WFinRep_DocAttach_FIN_HFIN_ID_1</columnFKName>")
         ...
         tbf.Append(  "<FolderName>WFinRep_DocAttach1</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Document Attach1</MenuName>")
         tbf.Append(  "<QSPath>../WFinRep_DocAttach1/WFinRep-DocAttach-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRep_DocAttach1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRep_DocAttach1</TableStoredProcPrefix>")
