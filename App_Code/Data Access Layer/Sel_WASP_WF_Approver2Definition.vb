...
''' <see cref="Sel_WASP_WF_Approver2View">ePortalWFApproval.Sel_WASP_WF_Approver2View</see> class
...
#End Region
	...
	''' <see cref="Sel_WASP_WF_Approver2View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>sel_WASP_WF_Approver</TableName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WASP_WF_Approver2</TableStoredProcPrefix>")
