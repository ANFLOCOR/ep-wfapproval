...
''' <summary>
''' Used by the <see cref="Sel_FIN_ReportList1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_FIN_ReportList1SqlView
	Inherits BaseSel_FIN_ReportList1SqlView
