...
''' <see cref="View_WCPO_Canvass1View">ePortalWFApproval.View_WCPO_Canvass1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="View_WCPO_Canvass1View"></seealso>

Public Class View_WCPO_Canvass1Definition

#Region "Definition (XML) for View_WCPO_Canvass1Definition table"
	'Next 321 lines contain Table Definition (XML) for table "View_WCPO_Canvass1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="View_WCPO_Canvass1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<updatingFormula></updatingFormula>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_view_WCPO_Canvass1_Buyer_1</columnFKName>")
         ...
         tbf.Append(  "<FolderName>view_WCPO_Canvass1</FolderName>")
         tbf.Append(  "<MenuName>WCPO Canvass 1</MenuName>")
         tbf.Append(  "<QSPath>../view_WCPO_Canvass1/View-WCPO-Canvass1-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>View_WCPO_Canvass1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalView_WCPO_Canvass1</TableStoredProcPrefix>")
