...
''' <summary>
''' Used by the <see cref="All_SysUserInfo_view1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class All_SysUserInfo_view1SqlView
	Inherits BaseAll_SysUserInfo_view1SqlView
