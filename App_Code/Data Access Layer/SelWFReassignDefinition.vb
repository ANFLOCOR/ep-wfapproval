...
''' <see cref="SelWFReassignView">ePortalWFApproval.SelWFReassignView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="SelWFReassignView"></seealso>

Public Class SelWFReassignDefinition

#Region "Definition (XML) for SelWFReassignDefinition table"
	'Next 539 lines contain Table Definition (XML) for table "SelWFReassignDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="SelWFReassignView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>selWFReassign</FolderName>")
         tbf.Append(  "<MenuName>Workflow Reassign</MenuName>")
         tbf.Append(  "<QSPath>../selWFReassign/SelWFReassign-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>SelWFReassign</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSelWFReassign</TableStoredProcPrefix>")
