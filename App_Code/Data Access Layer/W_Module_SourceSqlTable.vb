...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="W_Module_SourceTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class W_Module_SourceSqlTable
		Inherits BaseW_Module_SourceSqlTable
