...
''' <see cref="Sel_WCAR_Doc_Related_Supplemental1View">ePortalWFApproval.Sel_WCAR_Doc_Related_Supplemental1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WCAR_Doc_Related_Supplemental1View"></seealso>

Public Class Sel_WCAR_Doc_Related_Supplemental1Definition

#Region "Definition (XML) for Sel_WCAR_Doc_Related_Supplemental1Definition table"
	'Next 334 lines contain Table Definition (XML) for table "Sel_WCAR_Doc_Related_Supplemental1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WCAR_Doc_Related_Supplemental1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_WCAR_Doc_Related_Supplemental1</FolderName>")
         tbf.Append(  "<MenuName>WCAR Document Related Supplemental1</MenuName>")
         tbf.Append(  "<QSPath>../sel_WCAR_Doc_Related_Supplemental1/Sel-WCAR-Doc-Related-Supplemental-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WCAR_Doc_Related_Supplemental1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WCAR_Doc_Related_Supplemental1</TableStoredProcPrefix>")
