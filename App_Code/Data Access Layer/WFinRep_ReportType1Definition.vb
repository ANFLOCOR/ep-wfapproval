...
''' <see cref="WFinRep_ReportType1Table">ePortalWFApproval.WFinRep_ReportType1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRep_ReportType1Table"></seealso>

Public Class WFinRep_ReportType1Definition

#Region "Definition (XML) for WFinRep_ReportType1Definition table"
	'Next 99 lines contain Table Definition (XML) for table "WFinRep_ReportType1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRep_ReportType1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>WFRT_Type</columnName>")
         tbf.Append(      "<columnUIName>WFRT Type</columnUIName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WFinRep_ReportType</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WFinRep_ReportType_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WFinRep_ReportType1</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Report Type1</MenuName>")
         tbf.Append(  "<QSPath>../WFinRep_ReportType1/WFinRep-ReportType-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRep_ReportType1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRep_ReportType1</TableStoredProcPrefix>")
