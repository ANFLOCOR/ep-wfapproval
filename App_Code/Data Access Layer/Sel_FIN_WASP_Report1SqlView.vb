...
''' <summary>
''' Used by the <see cref="Sel_FIN_WASP_Report1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_FIN_WASP_Report1SqlView
	Inherits BaseSel_FIN_WASP_Report1SqlView
