...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="Sel_POP10100_Incidental1View"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Sel_POP10100_Incidental1SqlView
		Inherits BaseSel_POP10100_Incidental1SqlView
