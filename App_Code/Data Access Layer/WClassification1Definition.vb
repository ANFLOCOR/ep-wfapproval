...
''' <see cref="WClassification1Table">ePortalWFApproval.WClassification1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WClassification1Table"></seealso>

Public Class WClassification1Definition

#Region "Definition (XML) for WClassification1Definition table"
	'Next 99 lines contain Table Definition (XML) for table "WClassification1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WClassification1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>WClass_ID</columnName>")
         tbf.Append(      "<columnUIName>WClass</columnUIName>")
         ...
         tbf.Append(      "<columnName>WClass_Name</columnName>")
         tbf.Append(      "<columnUIName>WClass Name</columnUIName>")
         ...
         tbf.Append(      "<columnName>WClass_Value</columnName>")
         tbf.Append(      "<columnUIName>WClass Value</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WClassification</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WClassification_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WClassification1</FolderName>")
         tbf.Append(  "<MenuName>W Classification1</MenuName>")
         tbf.Append(  "<QSPath>../WClassification1/WClassification-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WClassification1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWClassification1</TableStoredProcPrefix>")
