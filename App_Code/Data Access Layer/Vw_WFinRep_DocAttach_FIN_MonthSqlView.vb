...
''' <summary>
''' Used by the <see cref="Vw_WFinRep_DocAttach_FIN_MonthView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Vw_WFinRep_DocAttach_FIN_MonthSqlView
	Inherits BaseVw_WFinRep_DocAttach_FIN_MonthSqlView
