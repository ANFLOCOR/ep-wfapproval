...
''' <see cref="WPO_CARNo_QWF1View">ePortalWFApproval.WPO_CARNo_QWF1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPO_CARNo_QWF1View"></seealso>

Public Class WPO_CARNo_QWF1Definition

#Region "Definition (XML) for WPO_CARNo_QWF1Definition table"
	'Next 355 lines contain Table Definition (XML) for table "WPO_CARNo_QWF1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPO_CARNo_QWF1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.WPO_PRNo_QWF1View, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         ...
         tbf.Append(        "<columnFKColumnDisplay>= WPO_PRNo_QWF1.PONo</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(    "</Column>")
         ...
         tbf.Append(        "<columnFKColumnDisplay>= WPO_PRNo_QWF1.PRNo</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(    "</Column>")
         ...
         tbf.Append(  "<FolderName>WPO_CARNo_QWF1</FolderName>")
         tbf.Append(  "<MenuName>WPO CARNo QWF1</MenuName>")
         tbf.Append(  "<QSPath>../WPO_CARNo_QWF1/WPO-CARNo-QWF-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPO_CARNo_QWF1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPO_CARNo_QWF1</TableStoredProcPrefix>")
