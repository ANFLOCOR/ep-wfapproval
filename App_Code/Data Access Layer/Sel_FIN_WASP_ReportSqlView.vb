...
''' <summary>
''' Used by the <see cref="Sel_FIN_WASP_ReportView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_FIN_WASP_ReportSqlView
	Inherits BaseSel_FIN_WASP_ReportSqlView
