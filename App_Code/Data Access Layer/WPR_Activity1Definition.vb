...
''' <see cref="WPR_Activity1Table">ePortalWFApproval.WPR_Activity1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPR_Activity1Table"></seealso>

Public Class WPR_Activity1Definition

#Region "Definition (XML) for WPR_Activity1Definition table"
	'Next 421 lines contain Table Definition (XML) for table "WPR_Activity1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPR_Activity1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>WPRA_ID</columnName>")
         tbf.Append(      "<columnUIName>Wpra</columnUIName>")
         ...
         tbf.Append(      "<columnName>WPRA_WS_ID</columnName>")
         tbf.Append(      "<columnUIName>Wpra WS</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(        "<columnFKName>FK_WPR_Activity_WStep</columnFKName>")
         ...
         tbf.Append(      "<columnName>WPRA_WSD_ID</columnName>")
         tbf.Append(      "<columnUIName>Wpra WSD</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_WPR_Activity_WStep_Detail</columnFKName>")
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.WStep_Detail1Table, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         ...
         tbf.Append(      "<columnName>WPRA_WDT_ID</columnName>")
         tbf.Append(      "<columnUIName>Wpra WDT</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_WPR_Activity_WDoc_Type</columnFKName>")
         ...
         tbf.Append(      "<columnName>WPRA_W_U_ID</columnName>")
         tbf.Append(      "<columnUIName>Wpra W U</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WPR_Activity_WPRA_W_U_ID_1</columnFKName>")
         ...
         tbf.Append(      "<columnName>WPRA_W_U_ID_Delegate</columnName>")
         tbf.Append(      "<columnUIName>WPRA W U Delegate</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>WPRA_WPRD_ID</columnName>")
         tbf.Append(      "<columnUIName>Wpra WPRD</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_WPR_Activity_WPR_Doc</columnFKName>")
         ...
         tbf.Append(      "<columnName>WPRA_Status</columnName>")
         tbf.Append(      "<columnUIName>WPRA Status</columnUIName>")
         ...
         tbf.Append(      "<columnName>WPRA_Date_Assign</columnName>")
         tbf.Append(      "<columnUIName Source=""User"">WPRA Date Assign</columnUIName>")
         ...
         tbf.Append(      "<columnName>WPRA_Date_Action</columnName>")
         tbf.Append(      "<columnUIName Source=""User"">WPRA Date Action</columnUIName>")
         tbf.Append(      "<columnType>Date</columnType>")
         tbf.Append(      "<columnDBType>smalldatetime</columnDBType>")
         tbf.Append(      "<columnLengthSet></columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>WPRA_Remark</columnName>")
         tbf.Append(      "<columnUIName>WPRA Remark</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         ...
         tbf.Append(      "<columnName>WPRA_Is_Done</columnName>")
         tbf.Append(      "<columnUIName>WPRA Is Done</columnUIName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WPR_Activity</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WPR_Activity_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WPR_Activity1</FolderName>")
         tbf.Append(  "<MenuName>WPR Activity2</MenuName>")
         tbf.Append(  "<QSPath>../WPR_Activity1/WPR-Activity-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPR_Activity1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPR_Activity1</TableStoredProcPrefix>")
