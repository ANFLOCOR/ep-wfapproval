...
''' <summary>
''' Used by the <see cref="Vw_FS_WFinRep_Attachment_PerReportType1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Vw_FS_WFinRep_Attachment_PerReportType1SqlView
	Inherits BaseVw_FS_WFinRep_Attachment_PerReportType1SqlView
