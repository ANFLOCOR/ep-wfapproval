...
''' <summary>
''' Used by the <see cref="Vw_WF_DYNAMICS_Company_ALLView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Vw_WF_DYNAMICS_Company_ALLSqlView
	Inherits BaseVw_WF_DYNAMICS_Company_ALLSqlView
