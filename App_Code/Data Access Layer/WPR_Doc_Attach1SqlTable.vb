...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WPR_Doc_Attach1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WPR_Doc_Attach1SqlTable
		Inherits BaseWPR_Doc_Attach1SqlTable
