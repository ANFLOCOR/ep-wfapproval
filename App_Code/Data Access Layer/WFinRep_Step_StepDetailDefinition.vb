...
''' <see cref="WFinRep_Step_StepDetailView">ePortalWFApproval.WFinRep_Step_StepDetailView</see> class
...
#End Region
	...
	''' <see cref="WFinRep_Step_StepDetailView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WFinRep_Step_StepDetail</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Step Step~etail</MenuName>")
         tbf.Append(  "<QSPath>../WFinRep_Step_StepDetail/WFinRep-Step-StepDetail-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRep_Step_StepDetail</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRep_Step_StepDetail</TableStoredProcPrefix>")
