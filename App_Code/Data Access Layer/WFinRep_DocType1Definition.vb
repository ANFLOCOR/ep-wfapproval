...
''' <see cref="WFinRep_DocType1Table">ePortalWFApproval.WFinRep_DocType1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRep_DocType1Table"></seealso>

Public Class WFinRep_DocType1Definition

#Region "Definition (XML) for WFinRep_DocType1Definition table"
	'Next 203 lines contain Table Definition (XML) for table "WFinRep_DocType1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRep_DocType1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>WFIN_DT_ID</columnName>")
         tbf.Append(      "<columnUIName>Wfin DT</columnUIName>")
         ...
         tbf.Append(      "<columnName>WFIN_DT_C_ID</columnName>")
         tbf.Append(      "<columnUIName>Wfin DT C</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         ...
         tbf.Append(      "<columnName>WFIN_DT_Name</columnName>")
         tbf.Append(      "<columnUIName>WFIN DT Name</columnUIName>")
         ...
         tbf.Append(      "<columnName>WFIN_DT_Desc</columnName>")
         tbf.Append(      "<columnUIName>WFIN DT Description</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         ...
         tbf.Append(      "<columnName>WFIN_DT_Type</columnName>")
         tbf.Append(      "<columnUIName>WFIN DT Type</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         ...
         tbf.Append(      "<columnName>WFIN_DT_Minimum</columnName>")
         tbf.Append(      "<columnUIName>WFIN DT Minimum</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         ...
         tbf.Append(      "<columnName>WFIN_DT_Maximum</columnName>")
         tbf.Append(      "<columnUIName>WFIN DT Maximum</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>numeric</columnDBType>")
         tbf.Append(      "<columnLengthSet>18.2</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WFinRep_DocType</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WFinRep_DocType_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WFinRep_DocType1</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Document Type1</MenuName>")
         tbf.Append(  "<QSPath>../WFinRep_DocType1/WFinRep-DocType-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRep_DocType1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRep_DocType1</TableStoredProcPrefix>")
