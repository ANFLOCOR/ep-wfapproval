...
''' <see cref="WPR_Line_Status1Table">ePortalWFApproval.WPR_Line_Status1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPR_Line_Status1Table"></seealso>

Public Class WPR_Line_Status1Definition

#Region "Definition (XML) for WPR_Line_Status1Definition table"
	'Next 99 lines contain Table Definition (XML) for table "WPR_Line_Status1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPR_Line_Status1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>WPRLS_ID</columnName>")
         ...
         tbf.Append(      "<columnName>WPRLS_Desc</columnName>")
         tbf.Append(      "<columnUIName>WPRLS Description</columnUIName>")
         ...
         tbf.Append(      "<columnName>WPRLS_Value</columnName>")
         tbf.Append(      "<columnUIName>WPRLS Value</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>smallint</columnDBType>")
         tbf.Append(      "<columnLengthSet>5.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WPR_Line_Status</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WPR_Line_Status_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WPR_Line_Status1</FolderName>")
         tbf.Append(  "<MenuName>WPR Line Status1</MenuName>")
         tbf.Append(  "<QSPath>../WPR_Line_Status1/WPR-Line-Status-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPR_Line_Status1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPR_Line_Status1</TableStoredProcPrefix>")
