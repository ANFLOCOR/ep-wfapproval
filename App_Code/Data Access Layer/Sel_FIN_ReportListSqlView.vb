...
''' <summary>
''' Used by the <see cref="Sel_FIN_ReportListView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_FIN_ReportListSqlView
	Inherits BaseSel_FIN_ReportListSqlView
