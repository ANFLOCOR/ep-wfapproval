...
''' <see cref="Sel_IV00101View">ePortalWFApproval.Sel_IV00101View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_IV00101View"></seealso>

Public Class Sel_IV00101Definition

#Region "Definition (XML) for Sel_IV00101Definition table"
	'Next 310 lines contain Table Definition (XML) for table "Sel_IV00101Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_IV00101View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_IV00101</FolderName>")
         tbf.Append(  "<MenuName>IV 00101</MenuName>")
         tbf.Append(  "<QSPath>../sel_IV00101/Sel-IV00101-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_IV00101</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_IV00101</TableStoredProcPrefix>")
