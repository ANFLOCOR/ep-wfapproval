...
''' <see cref="SysSetupUserEmail2Table">ePortalWFApproval.SysSetupUserEmail2Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="SysSetupUserEmail2Table"></seealso>

Public Class SysSetupUserEmail2Definition

#Region "Definition (XML) for SysSetupUserEmail2Definition table"
	'Next 108 lines contain Table Definition (XML) for table "SysSetupUserEmail2Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="SysSetupUserEmail2Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>SysSetupUserEmail2</FolderName>")
         tbf.Append(  "<MenuName>System Setup User Email2</MenuName>")
         tbf.Append(  "<QSPath>../SysSetupUserEmail2/SysSetupUserEmail-QuickSelector2.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>SysSetupUserEmail2</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSysSetupUserEmail2</TableStoredProcPrefix>")
