...
''' <see cref="WFinRep_Head1Table">ePortalWFApproval.WFinRep_Head1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRep_Head1Table"></seealso>

Public Class WFinRep_Head1Definition

#Region "Definition (XML) for WFinRep_Head1Definition table"
	'Next 542 lines contain Table Definition (XML) for table "WFinRep_Head1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRep_Head1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<updatingFormula></updatingFormula>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WFinRep_Head_HFIN_FinID_1</columnFKName>")
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.WFinRep_DocAttach1Table, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>FIN_ID</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>= WFinRep_DocAttach1.FIn_Description</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(    "</Column>")
         ...
         tbf.Append(  "<FolderName>WFinRep_Head1</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Head1</MenuName>")
         tbf.Append(  "<QSPath>../WFinRep_Head1/WFinRep-Head-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRep_Head1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRep_Head1</TableStoredProcPrefix>")
