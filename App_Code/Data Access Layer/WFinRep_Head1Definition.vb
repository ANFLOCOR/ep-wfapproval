...
#Region "Definition (XML) for WFinRep_Head1Definition table"
	'Next 499 lines contain Table Definition (XML) for table "WFinRep_Head1Definition"
...
#End Region
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKColumnDisplay>=Vw_WFinRep_DocAttach_FIN_Month1.Mo</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(    "</Column>")
