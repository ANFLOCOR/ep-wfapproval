...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="SysSetupUserPermission2Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class SysSetupUserPermission2SqlTable
		Inherits BaseSysSetupUserPermission2SqlTable
