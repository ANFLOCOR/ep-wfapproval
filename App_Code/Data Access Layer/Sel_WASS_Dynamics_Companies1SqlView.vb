...
''' <summary>
''' Used by the <see cref="Sel_WASS_Dynamics_Companies1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WASS_Dynamics_Companies1SqlView
	Inherits BaseSel_WASS_Dynamics_Companies1SqlView
