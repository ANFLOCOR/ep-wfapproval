...
''' <see cref="WPO_Doc_Type1Table">ePortalWFApproval.WPO_Doc_Type1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPO_Doc_Type1Table"></seealso>

Public Class WPO_Doc_Type1Definition

#Region "Definition (XML) for WPO_Doc_Type1Definition table"
	'Next 229 lines contain Table Definition (XML) for table "WPO_Doc_Type1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPO_Doc_Type1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WPO_Doc_Type1</FolderName>")
         tbf.Append(  "<MenuName>WPO Document Type1</MenuName>")
         tbf.Append(  "<QSPath>../WPO_Doc_Type1/WPO-Doc-Type-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPO_Doc_Type1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPO_Doc_Type1</TableStoredProcPrefix>")
