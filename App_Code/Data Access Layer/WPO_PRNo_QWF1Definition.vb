...
''' <see cref="WPO_PRNo_QWF1View">ePortalWFApproval.WPO_PRNo_QWF1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPO_PRNo_QWF1View"></seealso>

Public Class WPO_PRNo_QWF1Definition

#Region "Definition (XML) for WPO_PRNo_QWF1Definition table"
	'Next 303 lines contain Table Definition (XML) for table "WPO_PRNo_QWF1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPO_PRNo_QWF1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.Sel_WPO_Activity_WPOP101001View, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>WPO_PONum</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>= Sel_WPO_Activity_WPOP101001.WPO_PONum</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(    "</Column>")
         ...
         tbf.Append(  "<FolderName>WPO_PRNo_QWF1</FolderName>")
         tbf.Append(  "<MenuName>WPO PRNo QWF1</MenuName>")
         tbf.Append(  "<QSPath>../WPO_PRNo_QWF1/WPO-PRNo-QWF-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPO_PRNo_QWF1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPO_PRNo_QWF1</TableStoredProcPrefix>")
