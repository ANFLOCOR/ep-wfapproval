...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="SysSetupWASSEmail1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class SysSetupWASSEmail1SqlTable
		Inherits BaseSysSetupWASSEmail1SqlTable
