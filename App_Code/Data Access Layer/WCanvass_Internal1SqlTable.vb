...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WCanvass_Internal1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WCanvass_Internal1SqlTable
		Inherits BaseWCanvass_Internal1SqlTable
