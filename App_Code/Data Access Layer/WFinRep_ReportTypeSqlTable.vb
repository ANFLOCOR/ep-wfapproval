...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WFinRep_ReportTypeTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WFinRep_ReportTypeSqlTable
		Inherits BaseWFinRep_ReportTypeSqlTable
