...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WPR_ActivityTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WPR_ActivitySqlTable
		Inherits BaseWPR_ActivitySqlTable
