...
''' <summary>
''' Used by the <see cref="Sel_WFIN_ApproverPageView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WFIN_ApproverPageSqlView
	Inherits BaseSel_WFIN_ApproverPageSqlView
