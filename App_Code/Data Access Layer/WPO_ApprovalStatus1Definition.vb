...
''' <see cref="WPO_ApprovalStatus1Table">ePortalWFApproval.WPO_ApprovalStatus1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPO_ApprovalStatus1Table"></seealso>

Public Class WPO_ApprovalStatus1Definition

#Region "Definition (XML) for WPO_ApprovalStatus1Definition table"
	'Next 86 lines contain Table Definition (XML) for table "WPO_ApprovalStatus1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPO_ApprovalStatus1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WPO_ApprovalStatus1</FolderName>")
         tbf.Append(  "<MenuName>WPO Approval Status1</MenuName>")
         tbf.Append(  "<QSPath>../WPO_ApprovalStatus1/WPO-ApprovalStatus-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPO_ApprovalStatus1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPO_ApprovalStatus1</TableStoredProcPrefix>")
