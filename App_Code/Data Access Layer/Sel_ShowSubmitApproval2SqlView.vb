...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="Sel_ShowSubmitApproval2View"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Sel_ShowSubmitApproval2SqlView
		Inherits BaseSel_ShowSubmitApproval2SqlView
