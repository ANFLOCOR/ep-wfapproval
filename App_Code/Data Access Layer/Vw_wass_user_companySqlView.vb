...
''' <summary>
''' Used by the <see cref="Vw_wass_user_companyView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Vw_wass_user_companySqlView
	Inherits BaseVw_wass_user_companySqlView
