...
''' <summary>
''' Used by the <see cref="SelWFReassign1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class SelWFReassign1SqlView
	Inherits BaseSelWFReassign1SqlView
