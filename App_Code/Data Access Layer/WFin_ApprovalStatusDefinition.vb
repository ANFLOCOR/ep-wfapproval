...
''' <see cref="WFin_ApprovalStatusTable">ePortalWFApproval.WFin_ApprovalStatusTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFin_ApprovalStatusTable"></seealso>

Public Class WFin_ApprovalStatusDefinition

#Region "Definition (XML) for WFin_ApprovalStatusDefinition table"
	'Next 87 lines contain Table Definition (XML) for table "WFin_ApprovalStatusDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFin_ApprovalStatusTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WFin_ApprovalStatus</FolderName>")
         tbf.Append(  "<MenuName>WFin Approval Status</MenuName>")
         tbf.Append(  "<QSPath>../WFin_ApprovalStatus/WFin-ApprovalStatus-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFin_ApprovalStatus</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFin_ApprovalStatus</TableStoredProcPrefix>")
