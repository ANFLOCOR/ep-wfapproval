...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WPO_Step_WPO_StepDetail1View"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WPO_Step_WPO_StepDetail1SqlView
		Inherits BaseWPO_Step_WPO_StepDetail1SqlView
