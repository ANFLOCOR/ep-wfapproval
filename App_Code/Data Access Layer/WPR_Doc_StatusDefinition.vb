...
''' <see cref="WPR_Doc_StatusTable">ePortalWFApproval.WPR_Doc_StatusTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPR_Doc_StatusTable"></seealso>

Public Class WPR_Doc_StatusDefinition

#Region "Definition (XML) for WPR_Doc_StatusDefinition table"
	'Next 99 lines contain Table Definition (XML) for table "WPR_Doc_StatusDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPR_Doc_StatusTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>WPRDS_ID</columnName>")
         ...
         tbf.Append(      "<columnName>WPRDS_Desc</columnName>")
         tbf.Append(      "<columnUIName>WPRDS Description</columnUIName>")
         ...
         tbf.Append(      "<columnName>WPRDS_Value</columnName>")
         tbf.Append(      "<columnUIName>WPRDS Value</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>smallint</columnDBType>")
         tbf.Append(      "<columnLengthSet>5.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WPR_Doc_Status</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WPR_Doc_Status_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WPR_Doc_Status</FolderName>")
         tbf.Append(  "<MenuName>WPR Document Status</MenuName>")
         tbf.Append(  "<QSPath>../WPR_Doc_Status/WPR-Doc-Status-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPR_Doc_Status</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPR_Doc_Status</TableStoredProcPrefix>")
