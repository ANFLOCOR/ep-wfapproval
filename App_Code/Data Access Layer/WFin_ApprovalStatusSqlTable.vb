...
''' <summary>
''' Used by the <see cref="WFin_ApprovalStatusTable"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class WFin_ApprovalStatusSqlTable
	Inherits BaseWFin_ApprovalStatusSqlTable
