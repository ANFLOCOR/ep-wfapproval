...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WFinRep_StepDetail1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WFinRep_StepDetail1SqlTable
		Inherits BaseWFinRep_StepDetail1SqlTable
