...
''' <see cref="WPR_Doc_AttachTable">ePortalWFApproval.WPR_Doc_AttachTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPR_Doc_AttachTable"></seealso>

Public Class WPR_Doc_AttachDefinition

#Region "Definition (XML) for WPR_Doc_AttachDefinition table"
	'Next 169 lines contain Table Definition (XML) for table "WPR_Doc_AttachDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPR_Doc_AttachTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WPR_Doc_Attach</FolderName>")
         tbf.Append(  "<MenuName>WPR Document Attach</MenuName>")
         tbf.Append(  "<QSPath>../WPR_Doc_Attach/WPR-Doc-Attach-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPR_Doc_Attach</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPR_Doc_Attach</TableStoredProcPrefix>")
