...
''' <see cref="WPR_Line_StatusTable">ePortalWFApproval.WPR_Line_StatusTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPR_Line_StatusTable"></seealso>

Public Class WPR_Line_StatusDefinition

#Region "Definition (XML) for WPR_Line_StatusDefinition table"
	'Next 99 lines contain Table Definition (XML) for table "WPR_Line_StatusDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPR_Line_StatusTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WPR_Line_Status</FolderName>")
         tbf.Append(  "<MenuName>WPR Line Status</MenuName>")
         tbf.Append(  "<QSPath>../WPR_Line_Status/WPR-Line-Status-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPR_Line_Status</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPR_Line_Status</TableStoredProcPrefix>")
