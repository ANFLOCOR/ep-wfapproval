...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="Sel_W_User_W_ModuleView"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Sel_W_User_W_ModuleSqlView
		Inherits BaseSel_W_User_W_ModuleSqlView
