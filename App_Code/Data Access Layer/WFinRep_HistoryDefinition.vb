...
''' <see cref="WFinRep_HistoryTable">ePortalWFApproval.WFinRep_HistoryTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRep_HistoryTable"></seealso>

Public Class WFinRep_HistoryDefinition

#Region "Definition (XML) for WFinRep_HistoryDefinition table"
	'Next 152 lines contain Table Definition (XML) for table "WFinRep_HistoryDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRep_HistoryTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>WFRHi_ID</columnName>")
         tbf.Append(      "<columnUIName>WFRHi</columnUIName>")
         ...
         tbf.Append(      "<columnName>WFRHi_WFRCH_ID</columnName>")
         tbf.Append(      "<columnUIName>WFRHi WFRCH</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>WFRHi_File</columnName>")
         tbf.Append(      "<columnUIName>WFRHi File</columnUIName>")
         ...
         tbf.Append(      "<columnName>WFRHi_CreatedBy</columnName>")
         tbf.Append(      "<columnUIName>WFRHi Created By</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>WFRHi_DateCreated</columnName>")
         tbf.Append(      "<columnUIName>WFRHi Date Created</columnUIName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WFinRep_History</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WFinRep_History_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WFinRep_History</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative History</MenuName>")
         tbf.Append(  "<QSPath>../WFinRep_History/WFinRep-History-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRep_History</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRep_History</TableStoredProcPrefix>")
