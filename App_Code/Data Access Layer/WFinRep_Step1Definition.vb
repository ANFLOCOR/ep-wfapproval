...
''' <see cref="WFinRep_Step1Table">ePortalWFApproval.WFinRep_Step1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRep_Step1Table"></seealso>

Public Class WFinRep_Step1Definition

#Region "Definition (XML) for WFinRep_Step1Definition table"
	'Next 203 lines contain Table Definition (XML) for table "WFinRep_Step1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRep_Step1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WFinRep_Step1</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Step1</MenuName>")
         tbf.Append(  "<QSPath>../WFinRep_Step1/WFinRep-Step-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRep_Step1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRep_Step1</TableStoredProcPrefix>")
