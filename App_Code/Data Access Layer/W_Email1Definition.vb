...
''' <see cref="W_Email1Table">ePortalWFApproval.W_Email1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="W_Email1Table"></seealso>

Public Class W_Email1Definition

#Region "Definition (XML) for W_Email1Definition table"
	'Next 173 lines contain Table Definition (XML) for table "W_Email1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="W_Email1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKName>VFK_W_Email_WE_U_ID_1</columnFKName>")
         ...
         tbf.Append(        "<columnFKColumnDisplay>= W_User1.W_U_Full_Name</columnFKColumnDisplay>")
         ...
         tbf.Append(  "<FolderName>W_Email1</FolderName>")
         tbf.Append(  "<MenuName>W Email1</MenuName>")
         tbf.Append(  "<QSPath>../W_Email1/W-Email-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>W_Email1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalW_Email1</TableStoredProcPrefix>")
