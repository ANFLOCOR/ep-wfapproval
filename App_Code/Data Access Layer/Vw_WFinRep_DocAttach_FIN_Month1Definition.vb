...
''' <see cref="Vw_WFinRep_DocAttach_FIN_Month1View">ePortalWFApproval.Vw_WFinRep_DocAttach_FIN_Month1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Vw_WFinRep_DocAttach_FIN_Month1View"></seealso>

Public Class Vw_WFinRep_DocAttach_FIN_Month1Definition

#Region "Definition (XML) for Vw_WFinRep_DocAttach_FIN_Month1Definition table"
	'Next 87 lines contain Table Definition (XML) for table "Vw_WFinRep_DocAttach_FIN_Month1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Vw_WFinRep_DocAttach_FIN_Month1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>vw_WFinRep_DocAttach_FIN_Month1</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Document~Month1</MenuName>")
         tbf.Append(  "<QSPath>../vw_WFinRep_DocAttach_FIN_Month1/Vw-WFinRep-DocAttach-FIN-Month-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Vw_WFinRep_DocAttach_FIN_Month1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalVw_WFinRep_DocAttach_FIN_Month1</TableStoredProcPrefix>")
