...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WFinRepNGP_Activity1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WFinRepNGP_Activity1SqlTable
		Inherits BaseWFinRepNGP_Activity1SqlTable
