...
''' <see cref="WFinRepNGP_ActivityTable">ePortalWFApproval.WFinRepNGP_ActivityTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRepNGP_ActivityTable"></seealso>

Public Class WFinRepNGP_ActivityDefinition

#Region "Definition (XML) for WFinRepNGP_ActivityDefinition table"
	'Next 453 lines contain Table Definition (XML) for table "WFinRepNGP_ActivityDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRepNGP_ActivityTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnUIName Source=""User"">WFRNGPA W U</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(  "<FolderName>WFinRepNGP_Activity</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative NGP Activity</MenuName>")
         tbf.Append(  "<QSPath>../WFinRepNGP_Activity/WFinRepNGP-Activity-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRepNGP_Activity</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRepNGP_Activity</TableStoredProcPrefix>")
