...
''' <see cref="WPR_Doc_Attach1Table">ePortalWFApproval.WPR_Doc_Attach1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPR_Doc_Attach1Table"></seealso>

Public Class WPR_Doc_Attach1Definition

#Region "Definition (XML) for WPR_Doc_Attach1Definition table"
	'Next 168 lines contain Table Definition (XML) for table "WPR_Doc_Attach1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPR_Doc_Attach1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>WPRDA_ID</columnName>")
         tbf.Append(      "<columnUIName>WPRDA</columnUIName>")
         ...
         tbf.Append(      "<columnName>WPRDA_WPRD_ID</columnName>")
         tbf.Append(      "<columnUIName>WPRDA WPRD</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(        "<columnFKName>FK_WPR_Doc_Attach_WPR_Doc</columnFKName>")
         ...
         tbf.Append(      "<columnName>WPRDA_Desc</columnName>")
         tbf.Append(      "<columnUIName>WPRDA Description</columnUIName>")
         ...
         tbf.Append(      "<columnName>WPRDA_File</columnName>")
         tbf.Append(      "<columnUIName>WPRDA File</columnUIName>")
         ...
         tbf.Append(      "<columnName>WPRDA_WAT_ID</columnName>")
         tbf.Append(      "<columnUIName>WPRDA WAT</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_WPR_Doc_Attach_WAttach_Type</columnFKName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WPR_Doc_Attach</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WPR_Doc_Attach_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WPR_Doc_Attach1</FolderName>")
         tbf.Append(  "<MenuName>WPR Document Attach1</MenuName>")
         tbf.Append(  "<QSPath>../WPR_Doc_Attach1/WPR-Doc-Attach-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPR_Doc_Attach1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPR_Doc_Attach1</TableStoredProcPrefix>")
