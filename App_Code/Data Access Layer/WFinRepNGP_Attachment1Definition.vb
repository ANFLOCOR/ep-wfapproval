...
''' <see cref="WFinRepNGP_Attachment1Table">ePortalWFApproval.WFinRepNGP_Attachment1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRepNGP_Attachment1Table"></seealso>

Public Class WFinRepNGP_Attachment1Definition

#Region "Definition (XML) for WFinRepNGP_Attachment1Definition table"
	'Next 147 lines contain Table Definition (XML) for table "WFinRepNGP_Attachment1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRepNGP_Attachment1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WFinRepNGP_Attachment1</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative NGP Attachment1</MenuName>")
         tbf.Append(  "<QSPath>../WFinRepNGP_Attachment1/WFinRepNGP-Attachment-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRepNGP_Attachment1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRepNGP_Attachment1</TableStoredProcPrefix>")
