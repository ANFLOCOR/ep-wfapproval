...
''' <see cref="Sel_POP10100_IncidentalView">ePortalWFApproval.Sel_POP10100_IncidentalView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_POP10100_IncidentalView"></seealso>

Public Class Sel_POP10100_IncidentalDefinition

#Region "Definition (XML) for Sel_POP10100_IncidentalDefinition table"
	'Next 386 lines contain Table Definition (XML) for table "Sel_POP10100_IncidentalDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_POP10100_IncidentalView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnUIName>PRM Date</columnUIName>")
         tbf.Append(      "<columnType>Date</columnType>")
         tbf.Append(      "<columnDBType>datetime</columnDBType>")
         tbf.Append(      "<columnLengthSet></columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(  "<FolderName>sel_POP10100_Incidental</FolderName>")
         tbf.Append(  "<MenuName>POP 10100 Incidental</MenuName>")
         tbf.Append(  "<QSPath>../sel_POP10100_Incidental/Sel-POP10100-Incidental-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_POP10100_Incidental</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_POP10100_Incidental</TableStoredProcPrefix>")
