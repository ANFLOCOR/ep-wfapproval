...
''' <see cref="Sel_WFinRepNGP_ApproverPageView">ePortalWFApproval.Sel_WFinRepNGP_ApproverPageView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WFinRepNGP_ApproverPageView"></seealso>

Public Class Sel_WFinRepNGP_ApproverPageDefinition

#Region "Definition (XML) for Sel_WFinRepNGP_ApproverPageDefinition table"
	'Next 548 lines contain Table Definition (XML) for table "Sel_WFinRepNGP_ApproverPageDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WFinRepNGP_ApproverPageView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.WFinRepNGP_ActivityTable, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>WFRNGPA_ID</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>=WFinRepNGP_Activity.WFRNGPA_ID</columnFKColumnDisplay>")
         ...
         tbf.Append(  "<FolderName>sel_WFinRepNGP_ApproverPage</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative NGP Appro~Page</MenuName>")
         tbf.Append(  "<QSPath>../sel_WFinRepNGP_ApproverPage/Sel-WFinRepNGP-ApproverPage-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WFinRepNGP_ApproverPage</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WFinRepNGP_ApproverPage</TableStoredProcPrefix>")
