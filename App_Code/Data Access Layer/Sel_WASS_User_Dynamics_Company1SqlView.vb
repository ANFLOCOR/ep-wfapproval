...
''' <summary>
''' Used by the <see cref="Sel_WASS_User_Dynamics_Company1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WASS_User_Dynamics_Company1SqlView
	Inherits BaseSel_WASS_User_Dynamics_Company1SqlView
