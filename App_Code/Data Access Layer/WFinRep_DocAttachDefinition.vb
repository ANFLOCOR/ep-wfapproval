...
''' <see cref="WFinRep_DocAttachTable">ePortalWFApproval.WFinRep_DocAttachTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRep_DocAttachTable"></seealso>

Public Class WFinRep_DocAttachDefinition

#Region "Definition (XML) for WFinRep_DocAttachDefinition table"
	'Next 456 lines contain Table Definition (XML) for table "WFinRep_DocAttachDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRep_DocAttachTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>FIN_ID</columnName>")
         tbf.Append(      "<columnUIName>Fin</columnUIName>")
         ...
         tbf.Append(        "<columnFKName>VFK_WFinRep_DocAttach_FIN_Month_1</columnFKName>")
         ...
         tbf.Append(      "<columnName>FIN_Type</columnName>")
         tbf.Append(      "<columnUIName>FIN Type</columnUIName>")
         ...
         tbf.Append(      "<updatingFormula></updatingFormula>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WFinRep_DocAttach_FIN_Type_1</columnFKName>")
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.WFinRep_ReportTypeTable, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>WFRT_Type</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>= WFinRep_ReportType.WFRT_Description</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(    "</Column>")
         ...
         tbf.Append(      "<columnName>FIN_File</columnName>")
         tbf.Append(      "<columnUIName>FIN File</columnUIName>")
         ...
         tbf.Append(      "<columnName>FIN_Company</columnName>")
         tbf.Append(      "<columnUIName>FIN Company</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         ...
         tbf.Append(      "<updatingFormula></updatingFormula>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WFinRep_DocAttach_FIN_Company_1</columnFKName>")
         ...
         tbf.Append(      "<columnName>FIN_Status</columnName>")
         tbf.Append(      "<columnUIName>FIN Status</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<updatingFormula></updatingFormula>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_WFinRep_DocAttach_FIN_Status_1</columnFKName>")
         ...
         tbf.Append(      "<columnName>FIN_File1</columnName>")
         tbf.Append(      "<columnUIName>FIN File 1</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>nvarchar</columnDBType>")
         ...
         tbf.Append(      "<columnName>FIN_RptID</columnName>")
         tbf.Append(      "<columnUIName>FIN Report</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>FIN_Post</columnName>")
         tbf.Append(      "<columnUIName>FIN Post</columnUIName>")
         ...
         tbf.Append(      "<columnName>FIN_RWRem</columnName>")
         tbf.Append(      "<columnUIName>FIN RWRem</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>nvarchar</columnDBType>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_WFinRep_DocAttach_WFinRep_Head</columnFKName>")
         ...
         tbf.Append(        "<columnFKColumnDisplay>HFIN_Code</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Explicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(      "<applyDFKA>Y</applyDFKA>")
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WFinRep_DocAttach</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WFinRep_DocAttach_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WFinRep_DocAttach</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Document Attach</MenuName>")
         tbf.Append(  "<QSPath>../WFinRep_DocAttach/WFinRep-DocAttach-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRep_DocAttach</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRep_DocAttach</TableStoredProcPrefix>")
