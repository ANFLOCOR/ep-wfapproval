...
''' <summary>
''' Used by the <see cref="View_DW_CompanyView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class View_DW_CompanySqlView
	Inherits BaseView_DW_CompanySqlView
