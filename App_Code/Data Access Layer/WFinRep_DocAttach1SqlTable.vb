...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WFinRep_DocAttach1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WFinRep_DocAttach1SqlTable
		Inherits BaseWFinRep_DocAttach1SqlTable
