...
''' <see cref="View_DW_CompanyView">ePortalWFApproval.View_DW_CompanyView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="View_DW_CompanyView"></seealso>

Public Class View_DW_CompanyDefinition

#Region "Definition (XML) for View_DW_CompanyDefinition table"
	'Next 228 lines contain Table Definition (XML) for table "View_DW_CompanyDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="View_DW_CompanyView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>DW_C_ID</columnName>")
         tbf.Append(      "<columnUIName>DW C</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>View_DW_Company</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>View_DW_Company_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>View_DW_Company</FolderName>")
         tbf.Append(  "<MenuName>View DW Company</MenuName>")
         tbf.Append(  "<QSPath>../View_DW_Company/View-DW-Company-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>View_DW_Company</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalView_DW_Company</TableStoredProcPrefix>")
