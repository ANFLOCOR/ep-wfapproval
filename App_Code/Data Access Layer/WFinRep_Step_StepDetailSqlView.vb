...
''' <summary>
''' Used by the <see cref="WFinRep_Step_StepDetailView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class WFinRep_Step_StepDetailSqlView
	Inherits BaseWFinRep_Step_StepDetailSqlView
