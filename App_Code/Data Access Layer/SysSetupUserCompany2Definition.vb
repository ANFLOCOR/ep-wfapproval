...
''' <see cref="SysSetupUserCompany2Table">ePortalWFApproval.SysSetupUserCompany2Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="SysSetupUserCompany2Table"></seealso>

Public Class SysSetupUserCompany2Definition

#Region "Definition (XML) for SysSetupUserCompany2Definition table"
	'Next 213 lines contain Table Definition (XML) for table "SysSetupUserCompany2Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="SysSetupUserCompany2Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.SysSetupUserApplication2Table, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         ...
         tbf.Append(  "<FolderName>SysSetupUserCompany2</FolderName>")
         tbf.Append(  "<MenuName>System Setup User Company2</MenuName>")
         tbf.Append(  "<QSPath>../SysSetupUserCompany2/SysSetupUserCompany-QuickSelector2.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>SysSetupUserCompany2</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSysSetupUserCompany2</TableStoredProcPrefix>")
