...
''' <summary>
''' Used by the <see cref="Sel_WPO_POP10100View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WPO_POP10100SqlView
	Inherits BaseSel_WPO_POP10100SqlView
