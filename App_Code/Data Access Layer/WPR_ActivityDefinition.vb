...
''' <see cref="WPR_ActivityTable">ePortalWFApproval.WPR_ActivityTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPR_ActivityTable"></seealso>

Public Class WPR_ActivityDefinition

#Region "Definition (XML) for WPR_ActivityDefinition table"
	'Next 421 lines contain Table Definition (XML) for table "WPR_ActivityDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPR_ActivityTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WPR_Activity</FolderName>")
         tbf.Append(  "<MenuName>WPR Activity</MenuName>")
         tbf.Append(  "<QSPath>../WPR_Activity/WPR-Activity-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPR_Activity</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPR_Activity</TableStoredProcPrefix>")
