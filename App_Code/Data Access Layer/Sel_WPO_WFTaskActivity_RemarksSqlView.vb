...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="Sel_WPO_WFTaskActivity_RemarksView"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Sel_WPO_WFTaskActivity_RemarksSqlView
		Inherits BaseSel_WPO_WFTaskActivity_RemarksSqlView
