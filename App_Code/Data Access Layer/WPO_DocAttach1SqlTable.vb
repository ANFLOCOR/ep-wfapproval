...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WPO_DocAttach1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WPO_DocAttach1SqlTable
		Inherits BaseWPO_DocAttach1SqlTable
