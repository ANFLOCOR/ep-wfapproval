...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WPR_Line_StatusTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WPR_Line_StatusSqlTable
		Inherits BaseWPR_Line_StatusSqlTable
