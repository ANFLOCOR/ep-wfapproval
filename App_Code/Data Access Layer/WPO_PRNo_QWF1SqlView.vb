...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WPO_PRNo_QWF1View"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WPO_PRNo_QWF1SqlView
		Inherits BaseWPO_PRNo_QWF1SqlView
