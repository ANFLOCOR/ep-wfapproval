...
''' <see cref="Sel_WASS_User_Dynamics_Company1View">ePortalWFApproval.Sel_WASS_User_Dynamics_Company1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WASS_User_Dynamics_Company1View"></seealso>

Public Class Sel_WASS_User_Dynamics_Company1Definition

#Region "Definition (XML) for Sel_WASS_User_Dynamics_Company1Definition table"
	'Next 280 lines contain Table Definition (XML) for table "Sel_WASS_User_Dynamics_Company1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WASS_User_Dynamics_Company1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_WASS_User_Dynamics_Company1</FolderName>")
         tbf.Append(  "<MenuName>WASS User Dynamics Company1</MenuName>")
         tbf.Append(  "<QSPath>../sel_WASS_User_Dynamics_Company1/Sel-WASS-User-Dynamics-Company-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WASS_User_Dynamics_Company1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WASS_User_Dynamics_Company1</TableStoredProcPrefix>")
