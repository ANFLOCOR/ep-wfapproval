...
''' <see cref="WFinRep_AttachmentTable">ePortalWFApproval.WFinRep_AttachmentTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WFinRep_AttachmentTable"></seealso>

Public Class WFinRep_AttachmentDefinition

#Region "Definition (XML) for WFinRep_AttachmentDefinition table"
	'Next 147 lines contain Table Definition (XML) for table "WFinRep_AttachmentDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WFinRep_AttachmentTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.WFinRep_DocAttachTable, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>FIN_ID</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>=WFinRep_DocAttach.FIN_ID</columnFKColumnDisplay>")
         ...
         tbf.Append(  "<FolderName>WFinRep_Attachment</FolderName>")
         tbf.Append(  "<MenuName>WFin Representative Attachment</MenuName>")
         tbf.Append(  "<QSPath>../WFinRep_Attachment/WFinRep-Attachment-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WFinRep_Attachment</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWFinRep_Attachment</TableStoredProcPrefix>")
