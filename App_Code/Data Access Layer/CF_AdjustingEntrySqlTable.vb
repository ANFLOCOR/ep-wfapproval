...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="CF_AdjustingEntryTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class CF_AdjustingEntrySqlTable
		Inherits BaseCF_AdjustingEntrySqlTable
