...
''' <see cref="WPO_Step_Detail1Table">ePortalWFApproval.WPO_Step_Detail1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPO_Step_Detail1Table"></seealso>

Public Class WPO_Step_Detail1Definition

#Region "Definition (XML) for WPO_Step_Detail1Definition table"
	'Next 316 lines contain Table Definition (XML) for table "WPO_Step_Detail1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPO_Step_Detail1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>WPO_SD_S_ID</columnName>")
         tbf.Append(      "<columnUIName>WPO SD S</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(        "<columnFKName>FK_WPO_Step_Detail_WPO_Step</columnFKName>")
         ...
         tbf.Append(      "<columnName>WPO_SD_Desc</columnName>")
         tbf.Append(      "<columnUIName>WPO SD Description</columnUIName>")
         ...
         tbf.Append(      "<columnName>WPO_SD_Status</columnName>")
         tbf.Append(      "<columnUIName>WPO SD Status</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         tbf.Append(      "<columnLengthSet>50</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>WPO_SD_Variable_Ref</columnName>")
         tbf.Append(      "<columnUIName>WPO SD Variable Reference</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>WPO_SD_Variable_SQL</columnName>")
         tbf.Append(      "<columnUIName>WPO SD Variable SQL</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         ...
         tbf.Append(      "<columnName>WPO_SD_Expire</columnName>")
         tbf.Append(      "<columnUIName>WPO SD Expire</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         ...
         tbf.Append(      "<columnName>WPO_SD_W_U_ID_Delegate</columnName>")
         tbf.Append(      "<columnUIName>WPO SD W U Delegate</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>WPO_SD_Is_Escalate</columnName>")
         tbf.Append(      "<columnUIName>WPO SD Is Escalate</columnUIName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WPO_Step_Detail</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WPO_Step_Detail_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WPO_Step_Detail1</FolderName>")
         tbf.Append(  "<MenuName>WPO Step Detail1</MenuName>")
         tbf.Append(  "<QSPath>../WPO_Step_Detail1/WPO-Step-Detail-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPO_Step_Detail1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPO_Step_Detail1</TableStoredProcPrefix>")
