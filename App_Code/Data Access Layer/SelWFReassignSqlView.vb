...
''' <summary>
''' Used by the <see cref="SelWFReassignView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class SelWFReassignSqlView
	Inherits BaseSelWFReassignSqlView
