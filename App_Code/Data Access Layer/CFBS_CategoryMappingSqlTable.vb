...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="CFBS_CategoryMappingTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class CFBS_CategoryMappingSqlTable
		Inherits BaseCFBS_CategoryMappingSqlTable
