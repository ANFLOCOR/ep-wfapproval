...
''' <see cref="Sel_FIN_ReportList1View">ePortalWFApproval.Sel_FIN_ReportList1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_FIN_ReportList1View"></seealso>

Public Class Sel_FIN_ReportList1Definition

#Region "Definition (XML) for Sel_FIN_ReportList1Definition table"
	'Next 124 lines contain Table Definition (XML) for table "Sel_FIN_ReportList1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_FIN_ReportList1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>Company</columnName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>sel_FIN_ReportList</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>sel_FIN_ReportList_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>sel_FIN_ReportList1</FolderName>")
         tbf.Append(  "<MenuName>FIN Report List1</MenuName>")
         tbf.Append(  "<QSPath>../sel_FIN_ReportList1/Sel-FIN-ReportList-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_FIN_ReportList1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_FIN_ReportList1</TableStoredProcPrefix>")
