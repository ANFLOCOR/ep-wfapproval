...
' WPO_ApprovalStatus_QuickSelector1.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.WPO_ApprovalStatus_QuickSelector1
...
' Base class for the SelectorTableControlRow control on the WPO_ApprovalStatus_QuickSelector1 page.
...
Public Class BaseSelectorTableControlRow
        ...
        Public Overridable Sub LoadData()        
            ...
            ' Load the data from the database into the DataSource DatabaseANFLO-WFN%dbo.WPO_ApprovalStatus record.
            ...
            If Me.RecordUniqueId IsNot Nothing AndAlso Me.RecordUniqueId.Trim <> "" Then
                Me.DataSource = WPO_ApprovalStatus1Table.GetRecord(Me.RecordUniqueId, True)
            ...
            Me.DataSource = New WPO_ApprovalStatus1Record()
        ...
        Public Overridable Sub Delete()
          ...
          WPO_ApprovalStatus1Table.DeleteRecord(pkValue)
        ...
        Public Property DataSource() As WPO_ApprovalStatus1Record
            Get
                Return DirectCast(MyBase._DataSource, WPO_ApprovalStatus1Record)
            End Get
            Set(ByVal value As WPO_ApprovalStatus1Record)
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetRecord() As WPO_ApprovalStatus1Record
            ...
            If Not Me.RecordUniqueId Is Nothing Then
                ...
                Return WPO_ApprovalStatus1Table.GetRecord(Me.RecordUniqueId, True)
...
' Base class for the SelectorTableControl control on the WPO_ApprovalStatus_QuickSelector1 page.
...
Public Class BaseSelectorTableControl
    ...
    ' Setup default pagination settings.
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                If wc IsNot Nothing AndAlso Not wc.RunQuery Then
                    ...
                    Me.DataSource = DirectCast(alist.ToArray(GetType(WPO_ApprovalStatus1Record)), WPO_ApprovalStatus1Record())
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    ...
                    For Each rc As SelectorTableControlRow In Me.GetRecordControls()
                        ...
                        End If
                    Next
                    Me.DataSource = DirectCast(postdata.ToArray(GetType(WPO_ApprovalStatus1Record)), WPO_ApprovalStatus1Record())
        ...
        Public Overridable Function GetRecords( _
            ...
            ' selCols.Add(WPO_ApprovalStatus1Table.Column1, True)         
            ' selCols.Add(WPO_ApprovalStatus1Table.Column2, True)          
            ' selCols.Add(WPO_ApprovalStatus1Table.Column3, True)    
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return WPO_ApprovalStatus1Table.GetRecords(join, where, orderBy, Me.PageIndex, Me.PageSize)
                 
            Else
                Dim databaseTable As New WPO_ApprovalStatus1Table
                ...
                Return CType(recList.ToArray(GetType(WPO_ApprovalStatus1Record)), WPO_ApprovalStatus1Record())
            End If            
        ...
        Public Overridable Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return WPO_ApprovalStatus1Table.GetRecordCount(join, where)
        ...
        Public Overridable Function GetColumnListFromURLParameters(ByVal includeIndexFieldParameter As Boolean, ByVal includeFormulaAndDFKAParameter As Boolean) As ColumnList
            ...
            If includeIndexFieldParameter AndAlso field <> "" Then
                Dim col As BaseColumn = WPO_ApprovalStatus1Table.GetColumnByName(field)
                If col IsNot Nothing  AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
            End If
            If includeFormulaAndDFKAParameter Then
                If formula <> "" Then
                    For Each col As BaseColumn In MiscUtils.GetFormulaFieldList(formula, WPO_ApprovalStatus1Table.Instance.TableDefinition)
                        If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                    Next
                
                ElseIf displayFieldName <> ""
                    Dim col As BaseColumn = WPO_ApprovalStatus1Table.GetColumnByName(displayFieldName)
                    If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                End If
            End If
            Return columnList            
    ...
    End Sub
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            WPO_ApprovalStatus1Table.Instance.InnerFilter = Nothing
      ...
      Next
            ...
            End If
		        ...
		        If Not String.IsNullOrEmpty(Me.Page.Request("dependOnField")) AndAlso Me.Page.Request("dependOnVal") IsNot Nothing Then
			          Dim dependOnCol as BaseColumn = WPO_ApprovalStatus1Table.GetColumnByName(Me.Page.GetDecryptedURLParameter("dependOnField"))
    ...
    End Function
      ...
      Next
        ...
        Public Overridable Function GetAutoCompletionList_Search(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim recordList () As ePortalWFApproval.Business.WPO_ApprovalStatus1Record = WPO_ApprovalStatus1Table.GetRecords(filterJoin, wc, Nothing, 0, count,count)
            Dim rec As WPO_ApprovalStatus1Record = Nothing
    ...
    Dim recControl As SelectorTableControlRow = DirectCast(repItem.FindControl("SelectorTableControlRow"), SelectorTableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        Dim rec As WPO_ApprovalStatus1Record = New WPO_ApprovalStatus1Record()
            ...
            For index = 1 To Me.AddNewRecord
                ...
                newRecordList.Insert(0, New WPO_ApprovalStatus1Record())
            ...
            If newRecordList.Count > 0 Then
                ...
                Me.DataSource = DirectCast(finalList.ToArray(GetType(WPO_ApprovalStatus1Record)), WPO_ApprovalStatus1Record())
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Try
        ...
        Public Property TotalRecords() As Integer
            Get
                If _TotalRecords < 0 
                    _TotalRecords = WPO_ApprovalStatus1Table.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause())
                End If
