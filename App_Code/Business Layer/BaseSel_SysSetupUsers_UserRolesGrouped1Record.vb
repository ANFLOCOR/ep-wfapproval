...
' Your customizations should be made in Sel_SysSetupUsers_UserRolesGrouped1Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_SysSetupUsers_UserRolesGrouped1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="Sel_SysSetupUsers_UserRolesGrouped1View"></see> class.
''' </remarks>
...
<Serializable()> Public Class BaseSel_SysSetupUsers_UserRolesGrouped1Record
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_SysSetupUsers_UserRolesGrouped1View = Sel_SysSetupUsers_UserRolesGrouped1View.Instance
    ...
    Public Overridable Sub Sel_SysSetupUsers_UserRolesGrouped1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_SysSetupUsers_UserRolesGrouped1Rec As Sel_SysSetupUsers_UserRolesGrouped1Record = CType(sender,Sel_SysSetupUsers_UserRolesGrouped1Record)
        If Not Sel_SysSetupUsers_UserRolesGrouped1Rec Is Nothing AndAlso Not Sel_SysSetupUsers_UserRolesGrouped1Rec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_SysSetupUsers_UserRolesGrouped1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
