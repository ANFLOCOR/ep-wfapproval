...
''' <summary>
''' The generated superclass for the <see cref="WClassification1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="WClassification1Table"></see> class.
''' </remarks>
''' <seealso cref="WClassification1Table"></seealso>
''' <seealso cref="WClassification1Record"></seealso>

<Serializable()> Public Class BaseWClassification1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WClassification1Table = WClassification1Table.Instance
    ...
    Public Overridable Sub WClassification1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WClassification1Rec As WClassification1Record = CType(sender,WClassification1Record)
        Validate_Inserting()
        If Not WClassification1Rec Is Nothing AndAlso Not WClassification1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WClassification1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WClassification1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
