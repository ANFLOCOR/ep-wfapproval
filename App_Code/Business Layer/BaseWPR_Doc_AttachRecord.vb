...
''' <summary>
''' The generated superclass for the <see cref="WPR_Doc_AttachRecord"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="WPR_Doc_AttachTable"></see> class.
''' </remarks>
''' <seealso cref="WPR_Doc_AttachTable"></seealso>
''' <seealso cref="WPR_Doc_AttachRecord"></seealso>

<Serializable()> Public Class BaseWPR_Doc_AttachRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WPR_Doc_AttachTable = WPR_Doc_AttachTable.Instance
    ...
    Public Overridable Sub WPR_Doc_AttachRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WPR_Doc_AttachRec As WPR_Doc_AttachRecord = CType(sender,WPR_Doc_AttachRecord)
        Validate_Inserting()
        If Not WPR_Doc_AttachRec Is Nothing AndAlso Not WPR_Doc_AttachRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WPR_Doc_AttachRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WPR_Doc_AttachRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
