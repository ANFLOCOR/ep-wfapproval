...
''' <summary>
''' The generated superclass for the <see cref="WPR_ActivityRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWPR_ActivityRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WPR_ActivityTable = WPR_ActivityTable.Instance
    ...
    Public Overridable Sub WPR_ActivityRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WPR_ActivityRec As WPR_ActivityRecord = CType(sender,WPR_ActivityRecord)
        Validate_Inserting()
        If Not WPR_ActivityRec Is Nothing AndAlso Not WPR_ActivityRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WPR_ActivityRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WPR_ActivityRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
