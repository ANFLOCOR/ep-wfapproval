...
' Your customizations should be made in Sel_SysSetupUsers_Email1Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_SysSetupUsers_Email1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="Sel_SysSetupUsers_Email1View"></see> class.
''' </remarks>
''' <seealso cref="Sel_SysSetupUsers_Email1View"></seealso>
''' <seealso cref="Sel_SysSetupUsers_Email1Record"></seealso>

<Serializable()> Public Class BaseSel_SysSetupUsers_Email1Record
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_SysSetupUsers_Email1View = Sel_SysSetupUsers_Email1View.Instance
    ...
    Public Overridable Sub Sel_SysSetupUsers_Email1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_SysSetupUsers_Email1Rec As Sel_SysSetupUsers_Email1Record = CType(sender,Sel_SysSetupUsers_Email1Record)
        If Not Sel_SysSetupUsers_Email1Rec Is Nothing AndAlso Not Sel_SysSetupUsers_Email1Rec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_SysSetupUsers_Email1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
...
#Region "Convenience methods to get/set values of fields"
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_UserName field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_SysSetupUsers_Email_.SSU_UserName field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_FullName field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_SysSetupUsers_Email_.SSU_FullName field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_Password field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_SysSetupUsers_Email_.SSU_Password field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_EmpID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_SysSetupUsers_Email_.SSU_EmpID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_SSC_CompanyID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_SysSetupUsers_Email_.SSU_SSC_CompanyID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_IsActive field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_SysSetupUsers_Email_.SSU_IsActive field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_DateCreated field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_SysSetupUsers_Email_.SSU_DateCreated field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_DateModified field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_SysSetupUsers_Email_.SSU_DateModified field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_RowID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_SysSetupUsers_Email_.SSU_RowID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_GPUsername field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_SysSetupUsers_Email_.SSU_GPUsername field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_Designation field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_SysSetupUsers_Email_.SSU_Designation field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSUE_Email field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_SysSetupUsers_Email_.SSUE_Email field.
	''' </summary>
...
#Region "Convenience methods to get field names"
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_UserName field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_FullName field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_Password field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_EmpID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_SSC_CompanyID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_IsActive field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_DateCreated field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_DateModified field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_RowID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_GPUsername field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSU_Designation field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_SysSetupUsers_Email_.SSUE_Email field.
	''' </summary>
