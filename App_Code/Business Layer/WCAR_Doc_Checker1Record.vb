...
''' Also provides access to the <see cref="WCAR_Doc_Checker1Table"></see> that each record is associated with.
''' </summary>
''' <remarks>
''' </remarks>
''' <seealso cref="WCAR_Doc_Checker1Table"></seealso>

<Serializable()> Public Class WCAR_Doc_Checker1Record
	Inherits BaseWCAR_Doc_Checker1Record
