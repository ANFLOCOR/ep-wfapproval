...
''' <summary>
''' The generated superclass for the <see cref="WFinRep_Head1Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWFinRep_Head1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WFinRep_Head1Table = WFinRep_Head1Table.Instance
    ...
    Public Overridable Sub WFinRep_Head1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WFinRep_Head1Rec As WFinRep_Head1Record = CType(sender,WFinRep_Head1Record)
        Validate_Inserting()
        If Not WFinRep_Head1Rec Is Nothing AndAlso Not WFinRep_Head1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WFinRep_Head1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WFinRep_Head1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
