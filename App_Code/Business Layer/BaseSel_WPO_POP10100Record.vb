...
' Your customizations should be made in Sel_WPO_POP10100Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WPO_POP10100Record"></see> class.
''' </summary>
''' <remarks>
...
''' <seealso cref="Sel_WPO_POP10100Record"></seealso>

<Serializable()> Public Class BaseSel_WPO_POP10100Record
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WPO_POP10100View = Sel_WPO_POP10100View.Instance
    ...
    Public Overridable Sub Sel_WPO_POP10100Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_WPO_POP10100Rec As Sel_WPO_POP10100Record = CType(sender,Sel_WPO_POP10100Record)
        If Not Sel_WPO_POP10100Rec Is Nothing AndAlso Not Sel_WPO_POP10100Rec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_WPO_POP10100Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
