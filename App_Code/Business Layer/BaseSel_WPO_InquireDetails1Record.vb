...
<Serializable()> Public Class BaseSel_WPO_InquireDetails1Record
    ...
    Public Overridable Sub Sel_WPO_InquireDetails1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
