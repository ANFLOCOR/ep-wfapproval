...
<Serializable()> Public Class BaseSel_WFIN_ApproverPage1Record
    ...
    Public Overridable Sub Sel_WFIN_ApproverPage1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
