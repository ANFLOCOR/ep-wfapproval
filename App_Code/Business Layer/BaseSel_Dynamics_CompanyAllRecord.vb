...
' Your customizations should be made in Sel_Dynamics_CompanyAllRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_Dynamics_CompanyAllRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_Dynamics_CompanyAllRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_Dynamics_CompanyAllView = Sel_Dynamics_CompanyAllView.Instance
    ...
    Public Overridable Sub Sel_Dynamics_CompanyAllRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_Dynamics_CompanyAllRec As Sel_Dynamics_CompanyAllRecord = CType(sender,Sel_Dynamics_CompanyAllRecord)
        If Not Sel_Dynamics_CompanyAllRec Is Nothing AndAlso Not Sel_Dynamics_CompanyAllRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_Dynamics_CompanyAllRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
...
#Region "Convenience methods to get/set values of fields"
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_Dynamics_CompanyAll_.CompanyID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_Dynamics_CompanyAll_.CompanyID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_Dynamics_CompanyAll_.Company_Desc field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_Dynamics_CompanyAll_.Company_Desc field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_Dynamics_CompanyAll_.Company_Short_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_Dynamics_CompanyAll_.Company_Short_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_Dynamics_CompanyAll_.INTERID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_Dynamics_CompanyAll_.INTERID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_Dynamics_CompanyAll_.FULLADDRESS field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_Dynamics_CompanyAll_.FULLADDRESS field.
	''' </summary>
...
#Region "Convenience methods to get field names"
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_Dynamics_CompanyAll_.CompanyID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_Dynamics_CompanyAll_.Company_Desc field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_Dynamics_CompanyAll_.Company_Short_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_Dynamics_CompanyAll_.INTERID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_Dynamics_CompanyAll_.FULLADDRESS field.
	''' </summary>
