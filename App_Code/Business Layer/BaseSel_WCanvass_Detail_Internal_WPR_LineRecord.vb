...
' Your customizations should be made in Sel_WCanvass_Detail_Internal_WPR_LineRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WCanvass_Detail_Internal_WPR_LineRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_WCanvass_Detail_Internal_WPR_LineRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WCanvass_Detail_Internal_WPR_LineView = Sel_WCanvass_Detail_Internal_WPR_LineView.Instance
    ...
    Public Overridable Sub Sel_WCanvass_Detail_Internal_WPR_LineRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_WCanvass_Detail_Internal_WPR_LineRec As Sel_WCanvass_Detail_Internal_WPR_LineRecord = CType(sender,Sel_WCanvass_Detail_Internal_WPR_LineRecord)
        If Not Sel_WCanvass_Detail_Internal_WPR_LineRec Is Nothing AndAlso Not Sel_WCanvass_Detail_Internal_WPR_LineRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_WCanvass_Detail_Internal_WPR_LineRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
