...
' Your customizations should be made in Sel_WPO_WFTask1Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WPO_WFTask1View"></see> class.
''' Provides access to the schema information and record data of a database table or view named DatabaseANFLO-WFN%dbo.sel_WPO_WFTask.
''' </summary>
''' <remarks>
...
''' <see cref="Sel_WPO_WFTask1View.Instance">Sel_WPO_WFTask1View.Instance</see>.
''' </para>
''' </remarks>
''' <seealso cref="Sel_WPO_WFTask1View"></seealso>

<Serializable()> Public Class BaseSel_WPO_WFTask1View
    Inherits PrimaryKeyTable
    

    Private ReadOnly TableDefinitionString As String = Sel_WPO_WFTask1Definition.GetXMLString()
    ...
    Protected Overridable Sub Initialize()
        ...
        Me.TableDefinition.TableClassName = System.Reflection.Assembly.CreateQualifiedName("App_Code", "ePortalWFApproval.Business.Sel_WPO_WFTask1View")
        def.InitializeTableDefinition(Me.TableDefinition)
        Me.ConnectionName = def.GetConnectionName()
        Me.RecordClassName = System.Reflection.Assembly.CreateQualifiedName("App_Code", "ePortalWFApproval.Business.Sel_WPO_WFTask1Record")
        Me.ApplicationName = "App_Code"
        Me.DataAdapter = New Sel_WPO_WFTask1SqlView()
        Directcast(Me.DataAdapter, Sel_WPO_WFTask1SqlView).ConnectionName = Me.ConnectionName
        Directcast(Me.DataAdapter, Sel_WPO_WFTask1SqlView).ApplicationName = Me.ApplicationName
...
#Region "Properties for columns"
    ...
    Public Shared ReadOnly Property PONUMBER() As BaseClasses.Data.StringColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.PONUMBERColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property POSTATUS() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.POSTATUSColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property DOCDATE() As BaseClasses.Data.DateColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.DOCDATEColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property TOTAL() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.TOTALColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property VENDORID() As BaseClasses.Data.StringColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.VENDORIDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property VENDNAME() As BaseClasses.Data.StringColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.VENDNAMEColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property BUYERID() As BaseClasses.Data.StringColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.BUYERIDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property Workflow_Approval_Status() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.Workflow_Approval_StatusColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property CompanyID() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.CompanyIDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property COMMENTS() As BaseClasses.Data.StringColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.COMMENTSColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property SUBTOTAL() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.SUBTOTALColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property TRDISAMT() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.TRDISAMTColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property FRTAMNT() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.FRTAMNTColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property MSCCHAMT() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.MSCCHAMTColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property TAXAMNT() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.TAXAMNTColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property isINC() As BaseClasses.Data.StringColumn
        Get
            Return Sel_WPO_WFTask1View.Instance.isINCColumn
        End Get
    End Property
...
#Region "Shared helper methods"
    ...
    ''' <summary>
    ''' This is a shared function that can be used to get an array of Sel_WPO_WFTask1Record records using a where clause.
    ''' </summary>
    Public Shared Function GetRecords(ByVal where As String) As Sel_WPO_WFTask1Record()
    ...
    ''' This is a shared function that can be used to get an array of Sel_WPO_WFTask1Record records using a where clause.
    ''' </summary>
    Public Shared Function GetRecords(ByVal join As BaseFilter, ByVal where As String) As Sel_WPO_WFTask1Record()

        Return GetRecords(join, where, Nothing, BaseTable.MIN_PAGE_NUMBER, BaseTable.MAX_BATCH_SIZE)
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get an array of Sel_WPO_WFTask1Record records using a where and order by clause.
    ''' </summary>
    Public Shared Function GetRecords( _
     ByVal where As String, _
     ByVal orderBy As OrderBy) As Sel_WPO_WFTask1Record()
    ...
    ''' <summary>
    ''' This is a shared function that can be used to get an array of Sel_WPO_WFTask1Record records using a where and order by clause clause with pagination.
    ''' </summary>
    Public Shared Function GetRecords( _
     ByVal where As String, _
     ByVal orderBy As OrderBy, _
     ByVal pageIndex As Integer, _
     ByVal pageSize As Integer) As Sel_WPO_WFTask1Record()
        ...
        Dim recList As ArrayList =  Sel_WPO_WFTask1View.Instance.GetRecordList(join, whereFilter, Nothing, orderBy, pageIndex, pageSize)
 
        Return CType(recList.ToArray(GetType(ePortalWFApproval.Business.Sel_WPO_WFTask1Record)), Sel_WPO_WFTask1Record())
    End Function
    ...
    Public Shared Function GetRecords( _
     ...
     ByVal pageSize As Integer) As Sel_WPO_WFTask1Record()
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = Sel_WPO_WFTask1View.Instance.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetRecords( _
     ...
     ByRef totalRecords As Integer) As Sel_WPO_WFTask1Record()
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = Sel_WPO_WFTask1View.Instance.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize, totalRecords)
    ...
    Public Shared Function PostGetRecordCount(ByVal selectCols As SqlBuilderColumnSelection, ByVal join As BaseFilter, ByVal finalFilter As BaseFilter) As Integer
	      Return CInt(Sel_WPO_WFTask1View.Instance.GetCountResponseForPost(Sel_WPO_WFTask1View.Instance.TableDefinition, selectCols, join, finalFilter))
    End Function
    ...
    Public Shared Function PostGetRecordList(ByVal requestedSelection As SqlBuilderColumnSelection, ByVal workingSelection As SqlBuilderColumnSelection, _
		...
		If IsNothing(table) Then
			recList = Sel_WPO_WFTask1View.Instance.GetRecordListResponseForPost(Sel_WPO_WFTask1View.Instance.TableDefinition, requestedSelection, workingSelection, distinctSelection, join, filter, _
    ...
    Public Shared Function GetRecordCount(ByVal where As String) As Integer
        ...
        Return CInt(Sel_WPO_WFTask1View.Instance.GetRecordListCount(Nothing, whereFilter, Nothing, Nothing))
    End Function
...
''' <summary>
    ...
    Public Shared Function GetRecordCount(ByVal join As BaseFilter, ByVal where As String) As Integer
        ...
        Return CInt(Sel_WPO_WFTask1View.Instance.GetRecordListCount(join, whereFilter, Nothing, Nothing))
    End Function

    Public Shared Function GetRecordCount(ByVal where As WhereClause) As Integer
        Return CInt(Sel_WPO_WFTask1View.Instance.GetRecordListCount(Nothing, where.GetFilter(), Nothing, Nothing))
    End Function
    
      Public Shared Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
        Return CInt(Sel_WPO_WFTask1View.Instance.GetRecordListCount(join, where.GetFilter(), Nothing, Nothing))
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get a Sel_WPO_WFTask1Record record using a where clause.
    ''' </summary>
    Public Shared Function GetRecord(ByVal where As String) As Sel_WPO_WFTask1Record
    ...
    ''' This is a shared function that can be used to get a Sel_WPO_WFTask1Record record using a where clause.
    ''' </summary>
    Public Shared Function GetRecord(ByVal join As BaseFilter, ByVal where As String) As Sel_WPO_WFTask1Record
        Dim orderBy As OrderBy = Nothing
        Return GetRecord(join, where, orderBy)
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get a Sel_WPO_WFTask1Record record using a where and order by clause.
    ''' </summary>
    Public Shared Function GetRecord( _
     ...
     ByVal orderBy As OrderBy) As Sel_WPO_WFTask1Record
        ...
        End If
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = Sel_WPO_WFTask1View.Instance.GetRecordList(join, whereFilter, Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, BaseTable.MIN_BATCH_SIZE)

        Dim rec As Sel_WPO_WFTask1Record = Nothing
        If recList.Count > 0 Then
            rec = CType(recList(0), Sel_WPO_WFTask1Record)
        End If
    ...
    Public Shared Function GetValues( _
        ...
        Return Sel_WPO_WFTask1View.Instance.GetColumnValues(retCol, Nothing, where.GetFilter(), Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, maxItems)
    ...
    Public Shared Function GetValues( _
        ...
        Return Sel_WPO_WFTask1View.Instance.GetColumnValues(retCol, join, where.GetFilter(), Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, maxItems)
    ...
    Public Shared Function GetDataTable(ByVal where As String) As System.Data.DataTable
        ...
        Dim recs() As Sel_WPO_WFTask1Record = GetRecords(where)
        Return Sel_WPO_WFTask1View.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal join As BaseFilter, ByVal where As String) As System.Data.DataTable
        ...
        Dim recs() As Sel_WPO_WFTask1Record = GetRecords(join, where)
        Return Sel_WPO_WFTask1View.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal where As String, ByVal orderBy As OrderBy) As System.Data.DataTable
        ...
        Dim recs() As Sel_WPO_WFTask1Record = GetRecords(where, orderBy)
        Return Sel_WPO_WFTask1View.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal join As BaseFilter, ByVal where As String, ByVal orderBy As OrderBy) As System.Data.DataTable
        ...
        Dim recs() As Sel_WPO_WFTask1Record = GetRecords(join, where, orderBy)
        Return Sel_WPO_WFTask1View.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable( _
     ...
     ByVal pageSize As Integer) As System.Data.DataTable
        ...
        Dim recs() As Sel_WPO_WFTask1Record = GetRecords(where, orderBy, pageIndex, pageSize)
        Return Sel_WPO_WFTask1View.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable( _
     ...
     ByVal pageSize As Integer) As System.Data.DataTable
        ...
        Dim recs() As Sel_WPO_WFTask1Record = GetRecords(join, where, orderBy, pageIndex, pageSize)
        Return Sel_WPO_WFTask1View.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Sub DeleteRecords(ByVal where As String)
        ...
        Sel_WPO_WFTask1View.Instance.DeleteRecordList(whereFilter)
    End Sub
    ...
    Public Shared Function Export(ByVal where As String) As String
        ...
        Return Sel_WPO_WFTask1View.Instance.ExportRecordData(whereFilter)
    End Function
    ...
    Public Shared Function GetSum( _
        ...
        Return Sel_WPO_WFTask1View.Instance.GetColumnStatistics(colSel, Nothing, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetSum( _
        ...
        Return Sel_WPO_WFTask1View.Instance.GetColumnStatistics(colSel, join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetColumns() As BaseColumn()
        Return Sel_WPO_WFTask1View.Instance.TableDefinition.Columns
    End Function
    ...
    Public Shared Function GetColumnList() As ColumnList
        Return Sel_WPO_WFTask1View.Instance.TableDefinition.ColumnList
    End Function
    ...
    Public Shared Function CreateNewRecord() As IRecord
        Return Sel_WPO_WFTask1View.Instance.CreateRecord()
    End Function
    ...
    Public Shared Function CreateNewRecord(ByVal tempId As String) As IRecord
        Return Sel_WPO_WFTask1View.Instance.CreateRecord(tempId)
    End Function
    ...
    Public Shared Function GetColumn(ByVal uniqueColumnName As String) As BaseColumn
        Dim column As BaseColumn = Sel_WPO_WFTask1View.Instance.TableDefinition.ColumnList.GetByUniqueName(uniqueColumnName)
        Return column
    End Function     
    ...
    Public Shared Function GetColumnByName(ByVal name As String) As BaseColumn
        Dim column As BaseColumn = Sel_WPO_WFTask1View.Instance.TableDefinition.ColumnList.GetByInternalName(name)
        Return column
    End Function       
        

    ' Convenience method for getting a record using a string-based record identifier
    Public Shared Function GetRecord(ByVal id As String, ByVal bMutable As Boolean) As Sel_WPO_WFTask1Record
        Return CType(Sel_WPO_WFTask1View.Instance.GetRecordData(id, bMutable), Sel_WPO_WFTask1Record)
    End Function

    ' Convenience method for getting a record using a KeyValue record identifier
    Public Shared Function GetRecord(ByVal id As KeyValue, ByVal bMutable As Boolean) As Sel_WPO_WFTask1Record
        Return CType(Sel_WPO_WFTask1View.Instance.GetRecordData(id, bMutable), Sel_WPO_WFTask1Record)
    End Function
    ...
    Public Shared Sub DeleteRecord(ByVal kv As KeyValue)
        Sel_WPO_WFTask1View.Instance.DeleteOneRecord(kv)
    End Sub
    ...
    Public Shared Function DoesRecordExist(ByVal kv As KeyValue) As Boolean
        ...
        Try
            Sel_WPO_WFTask1View.GetRecord(kv, False)
    ...
    Public Shared Function GetPrimaryKeyColumns() As ColumnList
        If (Not IsNothing(Sel_WPO_WFTask1View.Instance.TableDefinition.PrimaryKey)) Then
            Return Sel_WPO_WFTask1View.Instance.TableDefinition.PrimaryKey.Columns
        Else
            Return Nothing
        End If
    End Function
    ...
    Public Shared Function GetKeyValue(ByVal key As Object) As KeyValue
        ...
        If (Not (IsNothing(Sel_WPO_WFTask1View.Instance.TableDefinition.PrimaryKey))) Then
            ...
            isCompositePrimaryKey = Sel_WPO_WFTask1View.Instance.TableDefinition.PrimaryKey.IsCompositeKey
            ...
            If ((isCompositePrimaryKey) AndAlso (key.GetType.IsArray())) Then
                ...
                If (Not IsNothing(keyArray)) Then
                    ...
                    Dim pkColumns As ColumnList = Sel_WPO_WFTask1View.Instance.TableDefinition.PrimaryKey.Columns
                    Dim pkColumn As BaseColumn
                    Dim index As Integer = 0
                    For Each pkColumn In pkColumns
                        Dim keyString As String = CType(keyArray.GetValue(index), String)
                        If (Sel_WPO_WFTask1View.Instance.TableDefinition.TableType = BaseClasses.Data.TableDefinition.TableTypes.Virtual) Then
            ...
            Else
                ...
                kv = Sel_WPO_WFTask1View.Instance.TableDefinition.PrimaryKey.ParseValue(CType(key, String))
            End If
        End If
        Return kv
    End Function    
	...
	Public Shared Function GetDFKA(ByVal rec As BaseRecord, ByVal col As BaseColumn) As String
	    Dim fkColumn As ForeignKey = Sel_WPO_WFTask1View.Instance.TableDefinition.GetExpandableNonCompositeForeignKey(col)
