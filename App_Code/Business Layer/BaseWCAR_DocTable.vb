...
' Your customizations should be made in WCAR_DocRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="WCAR_DocTable"></see> class.
''' Provides access to the schema information and record data of a database table or view named DatabaseANFLO-WF%dbo.WCAR_Doc.
''' </summary>
''' <remarks>
...
''' <see cref="WCAR_DocTable.Instance">WCAR_DocTable.Instance</see>.
''' </para>
''' </remarks>
''' <seealso cref="WCAR_DocTable"></seealso>

<Serializable()> Public Class BaseWCAR_DocTable
    Inherits PrimaryKeyTable
    

    Private ReadOnly TableDefinitionString As String = WCAR_DocDefinition.GetXMLString()
    ...
    Protected Overridable Sub Initialize()
        ...
        Me.TableDefinition.TableClassName = System.Reflection.Assembly.CreateQualifiedName("App_Code", "ePortalWFApproval.Business.WCAR_DocTable")
        def.InitializeTableDefinition(Me.TableDefinition)
        Me.ConnectionName = def.GetConnectionName()
        Me.RecordClassName = System.Reflection.Assembly.CreateQualifiedName("App_Code", "ePortalWFApproval.Business.WCAR_DocRecord")
        Me.ApplicationName = "App_Code"
        Me.DataAdapter = New WCAR_DocSqlTable()
        Directcast(Me.DataAdapter, WCAR_DocSqlTable).ConnectionName = Me.ConnectionName
...
#Region "Properties for columns"
    ...
    Public Shared ReadOnly Property WCD_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCAR_DocTable.Instance.WCD_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_WDT_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCAR_DocTable.Instance.WCD_WDT_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_No() As BaseClasses.Data.StringColumn
        Get
            Return WCAR_DocTable.Instance.WCD_NoColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Submit() As BaseClasses.Data.BooleanColumn
        Get
            Return WCAR_DocTable.Instance.WCD_SubmitColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Status() As BaseClasses.Data.StringColumn
        Get
            Return WCAR_DocTable.Instance.WCD_StatusColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Remark() As BaseClasses.Data.ClobColumn
        Get
            Return WCAR_DocTable.Instance.WCD_RemarkColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Unit_Location() As BaseClasses.Data.StringColumn
        Get
            Return WCAR_DocTable.Instance.WCD_Unit_LocationColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Project_Title() As BaseClasses.Data.ClobColumn
        Get
            Return WCAR_DocTable.Instance.WCD_Project_TitleColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Project_No() As BaseClasses.Data.StringColumn
        Get
            Return WCAR_DocTable.Instance.WCD_Project_NoColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Request_Date() As BaseClasses.Data.DateColumn
        Get
            Return WCAR_DocTable.Instance.WCD_Request_DateColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Proj_Inc_ACB() As BaseClasses.Data.BooleanColumn
        Get
            Return WCAR_DocTable.Instance.WCD_Proj_Inc_ACBColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Exp_Total() As BaseClasses.Data.NumberColumn
        Get
            Return WCAR_DocTable.Instance.WCD_Exp_TotalColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Exp_Prev_Total() As BaseClasses.Data.NumberColumn
        Get
            Return WCAR_DocTable.Instance.WCD_Exp_Prev_TotalColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Exp_Budget() As BaseClasses.Data.NumberColumn
        Get
            Return WCAR_DocTable.Instance.WCD_Exp_BudgetColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Exp_Under_Over_Budget() As BaseClasses.Data.NumberColumn
        Get
            Return WCAR_DocTable.Instance.WCD_Exp_Under_Over_BudgetColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Exp_Cur_Yr() As BaseClasses.Data.NumberColumn
        Get
            Return WCAR_DocTable.Instance.WCD_Exp_Cur_YrColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Exp_Nxt_Yr() As BaseClasses.Data.NumberColumn
        Get
            Return WCAR_DocTable.Instance.WCD_Exp_Nxt_YrColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Exp_Sub_Yr() As BaseClasses.Data.NumberColumn
        Get
            Return WCAR_DocTable.Instance.WCD_Exp_Sub_YrColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_C_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCAR_DocTable.Instance.WCD_C_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_U_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCAR_DocTable.Instance.WCD_U_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Created() As BaseClasses.Data.DateColumn
        Get
            Return WCAR_DocTable.Instance.WCD_CreatedColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_WCur_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCAR_DocTable.Instance.WCD_WCur_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Supplementary() As BaseClasses.Data.BooleanColumn
        Get
            Return WCAR_DocTable.Instance.WCD_SupplementaryColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Supplementary_WCD_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCAR_DocTable.Instance.WCD_Supplementary_WCD_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Supplementary_Manual() As BaseClasses.Data.StringColumn
        Get
            Return WCAR_DocTable.Instance.WCD_Supplementary_ManualColumn
        End Get
    End Property
...
#Region "Shared helper methods"
    ...
    ''' <summary>
    ''' This is a shared function that can be used to get an array of WCAR_DocRecord records using a where clause.
    ''' </summary>
    Public Shared Function GetRecords(ByVal where As String) As WCAR_DocRecord()
    ...
    ''' This is a shared function that can be used to get an array of WCAR_DocRecord records using a where clause.
    ''' </summary>
    Public Shared Function GetRecords(ByVal join As BaseFilter, ByVal where As String) As WCAR_DocRecord()

        Return GetRecords(join, where, Nothing, BaseTable.MIN_PAGE_NUMBER, BaseTable.MAX_BATCH_SIZE)
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get an array of WCAR_DocRecord records using a where and order by clause.
    ''' </summary>
    Public Shared Function GetRecords( _
     ByVal where As String, _
     ByVal orderBy As OrderBy) As WCAR_DocRecord()
    ...
    ''' <summary>
    ''' This is a shared function that can be used to get an array of WCAR_DocRecord records using a where and order by clause clause with pagination.
    ''' </summary>
    Public Shared Function GetRecords( _
     ByVal where As String, _
     ...
     ByVal pageSize As Integer) As WCAR_DocRecord()
        ...
        Dim recList As ArrayList =  WCAR_DocTable.Instance.GetRecordList(join, whereFilter, Nothing, orderBy, pageIndex, pageSize)
 
        Return CType(recList.ToArray(GetType(ePortalWFApproval.Business.WCAR_DocRecord)), WCAR_DocRecord())
    End Function
    ...
    Public Shared Function GetRecords( _
     ...
     ByVal pageSize As Integer) As WCAR_DocRecord()
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = WCAR_DocTable.Instance.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetRecords( _
     ...
     ByRef totalRecords As Integer) As WCAR_DocRecord()
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = WCAR_DocTable.Instance.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize, totalRecords)
    ...
    Public Shared Function PostGetRecordCount(ByVal selectCols As SqlBuilderColumnSelection, ByVal join As BaseFilter, ByVal finalFilter As BaseFilter) As Integer
	      Return CInt(WCAR_DocTable.Instance.GetCountResponseForPost(WCAR_DocTable.Instance.TableDefinition, selectCols, join, finalFilter))
    End Function
    ...
    Public Shared Function PostGetRecordList(ByVal requestedSelection As SqlBuilderColumnSelection, ByVal workingSelection As SqlBuilderColumnSelection, _
		...
		If IsNothing(table) Then
			recList = WCAR_DocTable.Instance.GetRecordListResponseForPost(WCAR_DocTable.Instance.TableDefinition, requestedSelection, workingSelection, distinctSelection, join, filter, _
    ...
    Public Shared Function GetRecordCount(ByVal where As String) As Integer
        ...
        Return CInt(WCAR_DocTable.Instance.GetRecordListCount(Nothing, whereFilter, Nothing, Nothing))
    End Function
...
''' <summary>
    ...
    Public Shared Function GetRecordCount(ByVal join As BaseFilter, ByVal where As String) As Integer
        ...
        Return CInt(WCAR_DocTable.Instance.GetRecordListCount(join, whereFilter, Nothing, Nothing))
    End Function

    Public Shared Function GetRecordCount(ByVal where As WhereClause) As Integer
        Return CInt(WCAR_DocTable.Instance.GetRecordListCount(Nothing, where.GetFilter(), Nothing, Nothing))
    End Function
    
      Public Shared Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
        Return CInt(WCAR_DocTable.Instance.GetRecordListCount(join, where.GetFilter(), Nothing, Nothing))
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get a WCAR_DocRecord record using a where clause.
    ''' </summary>
    Public Shared Function GetRecord(ByVal where As String) As WCAR_DocRecord
    ...
    ''' This is a shared function that can be used to get a WCAR_DocRecord record using a where clause.
    ''' </summary>
    Public Shared Function GetRecord(ByVal join As BaseFilter, ByVal where As String) As WCAR_DocRecord
        Dim orderBy As OrderBy = Nothing
        Return GetRecord(join, where, orderBy)
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get a WCAR_DocRecord record using a where and order by clause.
    ''' </summary>
    Public Shared Function GetRecord( _
     ...
     ByVal orderBy As OrderBy) As WCAR_DocRecord
        ...
        End If
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = WCAR_DocTable.Instance.GetRecordList(join, whereFilter, Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, BaseTable.MIN_BATCH_SIZE)

        Dim rec As WCAR_DocRecord = Nothing
        If recList.Count > 0 Then
            rec = CType(recList(0), WCAR_DocRecord)
        End If
    ...
    Public Shared Function GetValues( _
        ...
        Return WCAR_DocTable.Instance.GetColumnValues(retCol, Nothing, where.GetFilter(), Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, maxItems)
    ...
    Public Shared Function GetValues( _
        ...
        Return WCAR_DocTable.Instance.GetColumnValues(retCol, join, where.GetFilter(), Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, maxItems)
    ...
    Public Shared Function GetDataTable(ByVal where As String) As System.Data.DataTable
        ...
        Dim recs() As WCAR_DocRecord = GetRecords(where)
        Return WCAR_DocTable.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal join As BaseFilter, ByVal where As String) As System.Data.DataTable
        ...
        Dim recs() As WCAR_DocRecord = GetRecords(join, where)
        Return WCAR_DocTable.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal where As String, ByVal orderBy As OrderBy) As System.Data.DataTable
        ...
        Dim recs() As WCAR_DocRecord = GetRecords(where, orderBy)
        Return WCAR_DocTable.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal join As BaseFilter, ByVal where As String, ByVal orderBy As OrderBy) As System.Data.DataTable
        ...
        Dim recs() As WCAR_DocRecord = GetRecords(join, where, orderBy)
        Return WCAR_DocTable.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable( _
     ...
     ByVal pageSize As Integer) As System.Data.DataTable
        ...
        Dim recs() As WCAR_DocRecord = GetRecords(where, orderBy, pageIndex, pageSize)
        Return WCAR_DocTable.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable( _
     ...
     ByVal pageSize As Integer) As System.Data.DataTable
        ...
        Dim recs() As WCAR_DocRecord = GetRecords(join, where, orderBy, pageIndex, pageSize)
        Return WCAR_DocTable.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Sub DeleteRecords(ByVal where As String)
        ...
        WCAR_DocTable.Instance.DeleteRecordList(whereFilter)
    End Sub
    ...
    Public Shared Function Export(ByVal where As String) As String
        ...
        Return WCAR_DocTable.Instance.ExportRecordData(whereFilter)
    End Function
    ...
    Public Shared Function GetSum( _
        ...
        Return WCAR_DocTable.Instance.GetColumnStatistics(colSel, Nothing, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetSum( _
        ...
        Return WCAR_DocTable.Instance.GetColumnStatistics(colSel, join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetColumns() As BaseColumn()
        Return WCAR_DocTable.Instance.TableDefinition.Columns
    End Function
    ...
    Public Shared Function GetColumnList() As ColumnList
        Return WCAR_DocTable.Instance.TableDefinition.ColumnList
    End Function
    ...
    Public Shared Function CreateNewRecord() As IRecord
        Return WCAR_DocTable.Instance.CreateRecord()
    End Function
    ...
    Public Shared Function CreateNewRecord(ByVal tempId As String) As IRecord
        Return WCAR_DocTable.Instance.CreateRecord(tempId)
    End Function
    ...
    Public Shared Function GetColumn(ByVal uniqueColumnName As String) As BaseColumn
        Dim column As BaseColumn = WCAR_DocTable.Instance.TableDefinition.ColumnList.GetByUniqueName(uniqueColumnName)
        Return column
    End Function     
    ...
    Public Shared Function GetColumnByName(ByVal name As String) As BaseColumn
        Dim column As BaseColumn = WCAR_DocTable.Instance.TableDefinition.ColumnList.GetByInternalName(name)
        Return column
    End Function       
        

    ' Convenience method for getting a record using a string-based record identifier
    Public Shared Function GetRecord(ByVal id As String, ByVal bMutable As Boolean) As WCAR_DocRecord
        Return CType(WCAR_DocTable.Instance.GetRecordData(id, bMutable), WCAR_DocRecord)
    End Function

    ' Convenience method for getting a record using a KeyValue record identifier
    Public Shared Function GetRecord(ByVal id As KeyValue, ByVal bMutable As Boolean) As WCAR_DocRecord
        Return CType(WCAR_DocTable.Instance.GetRecordData(id, bMutable), WCAR_DocRecord)
    End Function
    ...
    Public Shared Sub DeleteRecord(ByVal kv As KeyValue)
        WCAR_DocTable.Instance.DeleteOneRecord(kv)
    End Sub
    ...
    Public Shared Function DoesRecordExist(ByVal kv As KeyValue) As Boolean
        ...
        Try
            WCAR_DocTable.GetRecord(kv, False)
    ...
    Public Shared Function GetPrimaryKeyColumns() As ColumnList
        If (Not IsNothing(WCAR_DocTable.Instance.TableDefinition.PrimaryKey)) Then
            Return WCAR_DocTable.Instance.TableDefinition.PrimaryKey.Columns
        Else
            Return Nothing
        End If
    End Function
    ...
    Public Shared Function GetKeyValue(ByVal key As Object) As KeyValue
        ...
        If (Not (IsNothing(WCAR_DocTable.Instance.TableDefinition.PrimaryKey))) Then
            ...
            isCompositePrimaryKey = WCAR_DocTable.Instance.TableDefinition.PrimaryKey.IsCompositeKey
            ...
            If ((isCompositePrimaryKey) AndAlso (key.GetType.IsArray())) Then
                ...
                If (Not IsNothing(keyArray)) Then
                    ...
                    Dim pkColumns As ColumnList = WCAR_DocTable.Instance.TableDefinition.PrimaryKey.Columns
                    Dim pkColumn As BaseColumn
                    Dim index As Integer = 0
                    For Each pkColumn In pkColumns
                        Dim keyString As String = CType(keyArray.GetValue(index), String)
                        If (WCAR_DocTable.Instance.TableDefinition.TableType = BaseClasses.Data.TableDefinition.TableTypes.Virtual) Then
            ...
            Else
                ...
                kv = WCAR_DocTable.Instance.TableDefinition.PrimaryKey.ParseValue(CType(key, String))
            End If
        End If
        Return kv
    End Function    
	...
	Public Shared Function GetDFKA(ByVal rec As BaseRecord, ByVal col As BaseColumn) As String
	    Dim fkColumn As ForeignKey = WCAR_DocTable.Instance.TableDefinition.GetExpandableNonCompositeForeignKey(col)
