...
''' <summary>
''' The generated superclass for the <see cref="WFinRep_ActivityRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWFinRep_ActivityRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WFinRep_ActivityTable = WFinRep_ActivityTable.Instance
    ...
    Public Overridable Sub WFinRep_ActivityRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WFinRep_ActivityRec As WFinRep_ActivityRecord = CType(sender,WFinRep_ActivityRecord)
        Validate_Inserting()
        If Not WFinRep_ActivityRec Is Nothing AndAlso Not WFinRep_ActivityRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WFinRep_ActivityRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WFinRep_ActivityRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
