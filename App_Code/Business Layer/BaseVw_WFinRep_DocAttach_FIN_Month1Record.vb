...
''' <summary>
''' The generated superclass for the <see cref="Vw_WFinRep_DocAttach_FIN_Month1Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseVw_WFinRep_DocAttach_FIN_Month1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Vw_WFinRep_DocAttach_FIN_Month1View = Vw_WFinRep_DocAttach_FIN_Month1View.Instance
    ...
    Public Overridable Sub Vw_WFinRep_DocAttach_FIN_Month1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Vw_WFinRep_DocAttach_FIN_Month1Rec As Vw_WFinRep_DocAttach_FIN_Month1Record = CType(sender,Vw_WFinRep_DocAttach_FIN_Month1Record)
        Validate_Inserting()
        If Not Vw_WFinRep_DocAttach_FIN_Month1Rec Is Nothing AndAlso Not Vw_WFinRep_DocAttach_FIN_Month1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Vw_WFinRep_DocAttach_FIN_Month1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Vw_WFinRep_DocAttach_FIN_Month1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
