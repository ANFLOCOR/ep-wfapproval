...
''' <summary>
''' The generated superclass for the <see cref="SysSetupUserPermission2Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="SysSetupUserPermission2Table"></see> class.
''' </remarks>
''' <seealso cref="SysSetupUserPermission2Table"></seealso>
''' <seealso cref="SysSetupUserPermission2Record"></seealso>

<Serializable()> Public Class BaseSysSetupUserPermission2Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As SysSetupUserPermission2Table = SysSetupUserPermission2Table.Instance
    ...
    Public Overridable Sub SysSetupUserPermission2Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim SysSetupUserPermission2Rec As SysSetupUserPermission2Record = CType(sender,SysSetupUserPermission2Record)
        Validate_Inserting()
        If Not SysSetupUserPermission2Rec Is Nothing AndAlso Not SysSetupUserPermission2Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub SysSetupUserPermission2Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub SysSetupUserPermission2Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
