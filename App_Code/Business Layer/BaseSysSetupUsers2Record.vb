...
''' <summary>
''' The generated superclass for the <see cref="SysSetupUsers2Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="SysSetupUsers2Table"></see> class.
''' </remarks>
''' <seealso cref="SysSetupUsers2Table"></seealso>
''' <seealso cref="SysSetupUsers2Record"></seealso>

<Serializable()> Public Class BaseSysSetupUsers2Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As SysSetupUsers2Table = SysSetupUsers2Table.Instance
    ...
    Public Overridable Sub SysSetupUsers2Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim SysSetupUsers2Rec As SysSetupUsers2Record = CType(sender,SysSetupUsers2Record)
        Validate_Inserting()
        If Not SysSetupUsers2Rec Is Nothing AndAlso Not SysSetupUsers2Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub SysSetupUsers2Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub SysSetupUsers2Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
