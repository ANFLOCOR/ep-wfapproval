...
''' <summary>
''' The generated superclass for the <see cref="Sel_IV001011Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="Sel_IV001011View"></see> class.
''' </remarks>
''' <seealso cref="Sel_IV001011View"></seealso>
''' <seealso cref="Sel_IV001011Record"></seealso>

<Serializable()> Public Class BaseSel_IV001011Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_IV001011View = Sel_IV001011View.Instance
    ...
    Public Overridable Sub Sel_IV001011Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Sel_IV001011Rec As Sel_IV001011Record = CType(sender,Sel_IV001011Record)
        Validate_Inserting()
        If Not Sel_IV001011Rec Is Nothing AndAlso Not Sel_IV001011Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Sel_IV001011Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Sel_IV001011Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
