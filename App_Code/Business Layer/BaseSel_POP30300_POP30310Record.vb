...
' Your customizations should be made in Sel_POP30300_POP30310Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_POP30300_POP30310Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="Sel_POP30300_POP30310View"></see> class.
''' </remarks>
''' <seealso cref="Sel_POP30300_POP30310View"></seealso>
''' <seealso cref="Sel_POP30300_POP30310Record"></seealso>

<Serializable()> Public Class BaseSel_POP30300_POP30310Record
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_POP30300_POP30310View = Sel_POP30300_POP30310View.Instance
    ...
    Public Overridable Sub Sel_POP30300_POP30310Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_POP30300_POP30310Rec As Sel_POP30300_POP30310Record = CType(sender,Sel_POP30300_POP30310Record)
        If Not Sel_POP30300_POP30310Rec Is Nothing AndAlso Not Sel_POP30300_POP30310Rec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_POP30300_POP30310Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
