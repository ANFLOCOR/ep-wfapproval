...
''' <summary>
''' The generated superclass for the <see cref="WPR_Line_Status1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="WPR_Line_Status1Table"></see> class.
''' </remarks>
''' <seealso cref="WPR_Line_Status1Table"></seealso>
''' <seealso cref="WPR_Line_Status1Record"></seealso>

<Serializable()> Public Class BaseWPR_Line_Status1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WPR_Line_Status1Table = WPR_Line_Status1Table.Instance
    ...
    Public Overridable Sub WPR_Line_Status1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WPR_Line_Status1Rec As WPR_Line_Status1Record = CType(sender,WPR_Line_Status1Record)
        Validate_Inserting()
        If Not WPR_Line_Status1Rec Is Nothing AndAlso Not WPR_Line_Status1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WPR_Line_Status1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WPR_Line_Status1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
