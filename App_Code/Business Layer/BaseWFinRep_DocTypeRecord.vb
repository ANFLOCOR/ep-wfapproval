...
''' <summary>
''' The generated superclass for the <see cref="WFinRep_DocTypeRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWFinRep_DocTypeRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WFinRep_DocTypeTable = WFinRep_DocTypeTable.Instance
    ...
    Public Overridable Sub WFinRep_DocTypeRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WFinRep_DocTypeRec As WFinRep_DocTypeRecord = CType(sender,WFinRep_DocTypeRecord)
        Validate_Inserting()
        If Not WFinRep_DocTypeRec Is Nothing AndAlso Not WFinRep_DocTypeRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WFinRep_DocTypeRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WFinRep_DocTypeRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
