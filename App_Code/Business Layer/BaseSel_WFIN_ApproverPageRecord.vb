...
' Your customizations should be made in Sel_WFIN_ApproverPageRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WFIN_ApproverPageRecord"></see> class.
''' </summary>
''' <remarks>
...
''' <seealso cref="Sel_WFIN_ApproverPageRecord"></seealso>

<Serializable()> Public Class BaseSel_WFIN_ApproverPageRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WFIN_ApproverPageView = Sel_WFIN_ApproverPageView.Instance
    ...
    Public Overridable Sub Sel_WFIN_ApproverPageRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_WFIN_ApproverPageRec As Sel_WFIN_ApproverPageRecord = CType(sender,Sel_WFIN_ApproverPageRecord)
        If Not Sel_WFIN_ApproverPageRec Is Nothing AndAlso Not Sel_WFIN_ApproverPageRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_WFIN_ApproverPageRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
...
#Region "Convenience methods to get/set values of fields"
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WFIN_ApproverPage_.AFIN_HFIN_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WFIN_ApproverPage_.AFIN_HFIN_ID field.
	''' </summary>
...
#Region "Convenience methods to get field names"
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WFIN_ApproverPage_.AFIN_HFIN_ID field.
	''' </summary>
