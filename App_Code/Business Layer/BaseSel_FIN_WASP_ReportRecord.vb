...
' Your customizations should be made in Sel_FIN_WASP_ReportRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_FIN_WASP_ReportRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_FIN_WASP_ReportRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_FIN_WASP_ReportView = Sel_FIN_WASP_ReportView.Instance
    ...
    Public Overridable Sub Sel_FIN_WASP_ReportRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_FIN_WASP_ReportRec As Sel_FIN_WASP_ReportRecord = CType(sender,Sel_FIN_WASP_ReportRecord)
        If Not Sel_FIN_WASP_ReportRec Is Nothing AndAlso Not Sel_FIN_WASP_ReportRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_FIN_WASP_ReportRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
