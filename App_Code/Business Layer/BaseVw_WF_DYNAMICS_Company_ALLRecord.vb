...
' Your customizations should be made in Vw_WF_DYNAMICS_Company_ALLRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Vw_WF_DYNAMICS_Company_ALLRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseVw_WF_DYNAMICS_Company_ALLRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Vw_WF_DYNAMICS_Company_ALLView = Vw_WF_DYNAMICS_Company_ALLView.Instance
    ...
    Public Overridable Sub Vw_WF_DYNAMICS_Company_ALLRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Vw_WF_DYNAMICS_Company_ALLRec As Vw_WF_DYNAMICS_Company_ALLRecord = CType(sender,Vw_WF_DYNAMICS_Company_ALLRecord)
        If Not Vw_WF_DYNAMICS_Company_ALLRec Is Nothing AndAlso Not Vw_WF_DYNAMICS_Company_ALLRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Vw_WF_DYNAMICS_Company_ALLRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
...
#Region "Convenience methods to get/set values of fields"
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's vw_WF_DYNAMICS_Company_ALL_.Company_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's vw_WF_DYNAMICS_Company_ALL_.Company_ID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's vw_WF_DYNAMICS_Company_ALL_.Company_Desc field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's vw_WF_DYNAMICS_Company_ALL_.Company_Desc field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's vw_WF_DYNAMICS_Company_ALL_.Company_Short_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's vw_WF_DYNAMICS_Company_ALL_.Company_Short_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's vw_WF_DYNAMICS_Company_ALL_.INTERID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's vw_WF_DYNAMICS_Company_ALL_.INTERID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's vw_WF_DYNAMICS_Company_ALL_.FULLADDRESS field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's vw_WF_DYNAMICS_Company_ALL_.FULLADDRESS field.
	''' </summary>
...
#Region "Convenience methods to get field names"
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's vw_WF_DYNAMICS_Company_ALL_.Company_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's vw_WF_DYNAMICS_Company_ALL_.Company_Desc field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's vw_WF_DYNAMICS_Company_ALL_.Company_Short_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's vw_WF_DYNAMICS_Company_ALL_.INTERID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's vw_WF_DYNAMICS_Company_ALL_.FULLADDRESS field.
	''' </summary>
