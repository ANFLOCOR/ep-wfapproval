...
''' Provides access to the schema information and record data of a database table or view named DatabaseANFLODW%dbo.Company.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseCompanyTable
    ...
    Protected Overridable Sub Initialize()
        ...
        Me.TableDefinition.TableClassName = System.Reflection.Assembly.CreateQualifiedName("App_Code", "ePortalWFApproval.Business.CompanyTable")
        def.InitializeTableDefinition(Me.TableDefinition)
        Me.ConnectionName = def.GetConnectionName()
        Me.RecordClassName = System.Reflection.Assembly.CreateQualifiedName("App_Code", "ePortalWFApproval.Business.CompanyRecord")
        Me.ApplicationName = "App_Code"
        Me.DataAdapter = New CompanySqlTable()
        Directcast(Me.DataAdapter, CompanySqlTable).ConnectionName = Me.ConnectionName
        Directcast(Me.DataAdapter, CompanySqlTable).ApplicationName = Me.ApplicationName
        ...
        IsConsoColumn.CodeName = "IsConso"
...
#Region "Properties for columns"
    ...
    ''' <summary>
    ''' This is a convenience property that provides direct access to the table's Company_.CompanyID column object.
    ''' </summary>
    ...
    Public Shared ReadOnly Property CompanyID() As BaseClasses.Data.NumberColumn
        Get
            Return CompanyTable.Instance.CompanyIDColumn
        End Get
    End Property
    ''' <summary>
    ...
    End Property
    ''' <summary>
    ''' This is a convenience property that provides direct access to the table's Company_.ShortName column object.
    ''' </summary>
    ...
    Public Shared ReadOnly Property ShortName() As BaseClasses.Data.StringColumn
        Get
            Return CompanyTable.Instance.ShortNameColumn
        End Get
    End Property
    ''' <summary>
    ''' This is a convenience property that provides direct access to the table's Company_.GroupID column object.
    ''' </summary>
    ...
    Public Shared ReadOnly Property GroupID() As BaseClasses.Data.NumberColumn
        Get
            Return CompanyTable.Instance.GroupIDColumn
        End Get
    End Property
    ''' <summary>
    ''' This is a convenience property that provides direct access to the table's Company_.IsNonGP column object.
    ''' </summary>
    ...
    Public Shared ReadOnly Property IsNonGP() As BaseClasses.Data.BooleanColumn
        Get
            Return CompanyTable.Instance.IsNonGPColumn
        End Get
    End Property
    ''' <summary>
    ''' This is a convenience property that provides direct access to the table's Company_.DynamicsCompanyID column object.
    ''' </summary>
    ...
    Public Shared ReadOnly Property DynamicsCompanyID() As BaseClasses.Data.NumberColumn
        Get
            Return CompanyTable.Instance.DynamicsCompanyIDColumn
        End Get
    End Property
    ''' <summary>
    ''' This is a convenience property that provides direct access to the table's Company_.CreatedBy column object.
    ''' </summary>
    ...
    Public Shared ReadOnly Property CreatedBy() As BaseClasses.Data.NumberColumn
        Get
            Return CompanyTable.Instance.CreatedByColumn
        End Get
    End Property
    ''' <summary>
    ''' This is a convenience property that provides direct access to the table's Company_.DateCreated column object.
    ''' </summary>
    ...
    Public Shared ReadOnly Property DateCreated() As BaseClasses.Data.DateColumn
        Get
            Return CompanyTable.Instance.DateCreatedColumn
        End Get
    End Property
    ''' <summary>
    ''' This is a convenience property that provides direct access to the table's Company_.ModifiedBy column object.
    ''' </summary>
    ...
    Public Shared ReadOnly Property ModifiedBy() As BaseClasses.Data.NumberColumn
        Get
            Return CompanyTable.Instance.ModifiedByColumn
        End Get
    End Property
    ''' <summary>
    ''' This is a convenience property that provides direct access to the table's Company_.DateModified column object.
    ''' </summary>
    ...
    Public Shared ReadOnly Property DateModified() As BaseClasses.Data.DateColumn
        Get
            Return CompanyTable.Instance.DateModifiedColumn
        End Get
    End Property
    ''' <summary>
    ''' This is a convenience property that provides direct access to the table's Company_.GPInterID column object.
    ''' </summary>
    ...
    Public Shared ReadOnly Property GPInterID() As BaseClasses.Data.StringColumn
        Get
            Return CompanyTable.Instance.GPInterIDColumn
        End Get
    End Property
    ''' <summary>
    ''' This is a convenience property that provides direct access to the table's Company_.IsConso column object.
    ''' </summary>
    Public ReadOnly Property IsConsoColumn() As BaseClasses.Data.BooleanColumn
        Get
    ...
    ''' This is a convenience property that provides direct access to the table's Company_.IsConso column object.
    ''' </summary>
    Public Shared ReadOnly Property IsConso() As BaseClasses.Data.BooleanColumn
        Get
            Return CompanyTable.Instance.IsConsoColumn
        End Get
    End Property
...
#Region "Shared helper methods"
    ...
    ''' This is a shared function that can be used to get an array of CompanyRecord records using a where clause.
    ''' </summary>
    Public Shared Function GetRecords(ByVal join As BaseFilter, ByVal where As String) As CompanyRecord()
    ...
    Public Shared Function GetRecords( _
     ...
     ByVal pageSize As Integer) As CompanyRecord()
        ...
        Dim recList As ArrayList =  CompanyTable.Instance.GetRecordList(join, whereFilter, Nothing, orderBy, pageIndex, pageSize)
 
        Return CType(recList.ToArray(GetType(ePortalWFApproval.Business.CompanyRecord)), CompanyRecord())
    End Function
    ...
    Public Shared Function GetRecords( _
     ...
     ByVal pageSize As Integer) As CompanyRecord()
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = CompanyTable.Instance.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetRecords( _
     ...
     ByRef totalRecords As Integer) As CompanyRecord()
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = CompanyTable.Instance.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize, totalRecords)
    ...
    Public Shared Function PostGetRecordCount(ByVal selectCols As SqlBuilderColumnSelection, ByVal join As BaseFilter, ByVal finalFilter As BaseFilter) As Integer
	      Return CInt(CompanyTable.Instance.GetCountResponseForPost(CompanyTable.Instance.TableDefinition, selectCols, join, finalFilter))
    End Function
    ...
    Public Shared Function PostGetRecordList(ByVal requestedSelection As SqlBuilderColumnSelection, ByVal workingSelection As SqlBuilderColumnSelection, _
		...
		If IsNothing(table) Then
			recList = CompanyTable.Instance.GetRecordListResponseForPost(CompanyTable.Instance.TableDefinition, requestedSelection, workingSelection, distinctSelection, join, filter, _
    ...
    Public Shared Function GetRecordCount(ByVal where As String) As Integer
        ...
        Return CInt(CompanyTable.Instance.GetRecordListCount(Nothing, whereFilter, Nothing, Nothing))
    End Function
...
''' <summary>
    ...
    Public Shared Function GetRecordCount(ByVal join As BaseFilter, ByVal where As String) As Integer
        ...
        Return CInt(CompanyTable.Instance.GetRecordListCount(join, whereFilter, Nothing, Nothing))
    End Function

    Public Shared Function GetRecordCount(ByVal where As WhereClause) As Integer
        Return CInt(CompanyTable.Instance.GetRecordListCount(Nothing, where.GetFilter(), Nothing, Nothing))
    End Function
    
      Public Shared Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
        Return CInt(CompanyTable.Instance.GetRecordListCount(join, where.GetFilter(), Nothing, Nothing))
    End Function
    ...
    ''' This is a shared function that can be used to get a CompanyRecord record using a where clause.
    ''' </summary>
    Public Shared Function GetRecord(ByVal join As BaseFilter, ByVal where As String) As CompanyRecord
        Dim orderBy As OrderBy = Nothing
    ...
    Public Shared Function GetRecord( _
     ...
     ByVal orderBy As OrderBy) As CompanyRecord
        ...
        End If
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = CompanyTable.Instance.GetRecordList(join, whereFilter, Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, BaseTable.MIN_BATCH_SIZE)
    ...
    Public Shared Function GetValues( _
        ...
        Return CompanyTable.Instance.GetColumnValues(retCol, Nothing, where.GetFilter(), Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, maxItems)
    ...
    Public Shared Function GetValues( _
        ...
        Return CompanyTable.Instance.GetColumnValues(retCol, join, where.GetFilter(), Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, maxItems)
    ...
    Public Shared Function GetDataTable(ByVal join As BaseFilter, ByVal where As String) As System.Data.DataTable
        ...
        Dim recs() As CompanyRecord = GetRecords(join, where)
        Return CompanyTable.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal join As BaseFilter, ByVal where As String, ByVal orderBy As OrderBy) As System.Data.DataTable
        ...
        Dim recs() As CompanyRecord = GetRecords(join, where, orderBy)
        Return CompanyTable.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable( _
     ...
     ByVal pageSize As Integer) As System.Data.DataTable
        ...
        Dim recs() As CompanyRecord = GetRecords(join, where, orderBy, pageIndex, pageSize)
        Return CompanyTable.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetSum( _
        ...
        Return CompanyTable.Instance.GetColumnStatistics(colSel, Nothing, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetSum( _
        ...
        Return CompanyTable.Instance.GetColumnStatistics(colSel, join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetColumnByName(ByVal name As String) As BaseColumn
        Dim column As BaseColumn = CompanyTable.Instance.TableDefinition.ColumnList.GetByInternalName(name)
        Return column
    End Function       
    ...
    Public Overloads Function NewRecord( _
        ...
        ByVal IsNonGPValue As String, _
        ...
        ByVal GPInterIDValue As String, _
        ByVal IsConsoValue As String _
    ) As KeyValue
        ...
        rec.SetString(IsNonGPValue, IsNonGPColumn)
        ...
        rec.SetString(GPInterIDValue, GPInterIDColumn)
        rec.SetString(IsConsoValue, IsConsoColumn)
	...
	Public Shared Function GetDFKA(ByVal rec As BaseRecord, ByVal col As BaseColumn) As String
	    Dim fkColumn As ForeignKey = CompanyTable.Instance.TableDefinition.GetExpandableNonCompositeForeignKey(col)
