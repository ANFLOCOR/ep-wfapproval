...
''' <summary>
''' The generated superclass for the <see cref="Sel_IV407001Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_IV407001Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_IV407001View = Sel_IV407001View.Instance
    ...
    Public Overridable Sub Sel_IV407001Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Sel_IV407001Rec As Sel_IV407001Record = CType(sender,Sel_IV407001Record)
        Validate_Inserting()
        If Not Sel_IV407001Rec Is Nothing AndAlso Not Sel_IV407001Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Sel_IV407001Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Sel_IV407001Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
