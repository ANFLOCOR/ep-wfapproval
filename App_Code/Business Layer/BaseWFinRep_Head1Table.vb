...
' Your customizations should be made in WFinRep_Head1Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="WFinRep_Head1Table"></see> class.
''' Provides access to the schema information and record data of a database table or view named DatabaseANFLO-WFN%dbo.WFinRep_Head.
''' </summary>
''' <remarks>
...
''' <see cref="WFinRep_Head1Table.Instance">WFinRep_Head1Table.Instance</see>.
''' </para>
''' </remarks>
''' <seealso cref="WFinRep_Head1Table"></seealso>

<Serializable()> Public Class BaseWFinRep_Head1Table
    Inherits PrimaryKeyTable
    

    Private ReadOnly TableDefinitionString As String = WFinRep_Head1Definition.GetXMLString()
    ...
    Protected Overridable Sub Initialize()
        ...
        Me.TableDefinition.TableClassName = System.Reflection.Assembly.CreateQualifiedName("App_Code", "ePortalWFApproval.Business.WFinRep_Head1Table")
        def.InitializeTableDefinition(Me.TableDefinition)
        Me.ConnectionName = def.GetConnectionName()
        Me.RecordClassName = System.Reflection.Assembly.CreateQualifiedName("App_Code", "ePortalWFApproval.Business.WFinRep_Head1Record")
        Me.ApplicationName = "App_Code"
        Me.DataAdapter = New WFinRep_Head1SqlTable()
        Directcast(Me.DataAdapter, WFinRep_Head1SqlTable).ConnectionName = Me.ConnectionName
        Directcast(Me.DataAdapter, WFinRep_Head1SqlTable).ApplicationName = Me.ApplicationName
...
#Region "Properties for columns"
    ...
    Public Shared ReadOnly Property HFIN_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WFinRep_Head1Table.Instance.HFIN_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property HFIN_DT_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WFinRep_Head1Table.Instance.HFIN_DT_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property HFIN_Code() As BaseClasses.Data.StringColumn
        Get
            Return WFinRep_Head1Table.Instance.HFIN_CodeColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property HFIN_Submit() As BaseClasses.Data.BooleanColumn
        Get
            Return WFinRep_Head1Table.Instance.HFIN_SubmitColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property HFIN_Status() As BaseClasses.Data.NumberColumn
        Get
            Return WFinRep_Head1Table.Instance.HFIN_StatusColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property HFIN_C_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WFinRep_Head1Table.Instance.HFIN_C_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property HFIN_U_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WFinRep_Head1Table.Instance.HFIN_U_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property HFIN_Remark() As BaseClasses.Data.ClobColumn
        Get
            Return WFinRep_Head1Table.Instance.HFIN_RemarkColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property HFIN_PRTCNT() As BaseClasses.Data.NumberColumn
        Get
            Return WFinRep_Head1Table.Instance.HFIN_PRTCNTColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property HFIN_FinID() As BaseClasses.Data.NumberColumn
        Get
            Return WFinRep_Head1Table.Instance.HFIN_FinIDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property HFIN_Month() As BaseClasses.Data.NumberColumn
        Get
            Return WFinRep_Head1Table.Instance.HFIN_MonthColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property HFIN_Year() As BaseClasses.Data.NumberColumn
        Get
            Return WFinRep_Head1Table.Instance.HFIN_YearColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property HFIN_RptCount() As BaseClasses.Data.NumberColumn
        Get
            Return WFinRep_Head1Table.Instance.HFIN_RptCountColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property HFIN_Description() As BaseClasses.Data.StringColumn
        Get
            Return WFinRep_Head1Table.Instance.HFIN_DescriptionColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property HFIN_File() As BaseClasses.Data.ImageColumn
        Get
            Return WFinRep_Head1Table.Instance.HFIN_FileColumn
        End Get
    End Property
...
#Region "Shared helper methods"
    ...
    ''' <summary>
    ''' This is a shared function that can be used to get an array of WFinRep_Head1Record records using a where clause.
    ''' </summary>
    Public Shared Function GetRecords(ByVal where As String) As WFinRep_Head1Record()
    ...
    ''' This is a shared function that can be used to get an array of WFinRep_Head1Record records using a where clause.
    ''' </summary>
    Public Shared Function GetRecords(ByVal join As BaseFilter, ByVal where As String) As WFinRep_Head1Record()

        Return GetRecords(join, where, Nothing, BaseTable.MIN_PAGE_NUMBER, BaseTable.MAX_BATCH_SIZE)
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get an array of WFinRep_Head1Record records using a where and order by clause.
    ''' </summary>
    Public Shared Function GetRecords( _
     ByVal where As String, _
     ByVal orderBy As OrderBy) As WFinRep_Head1Record()
    ...
    ''' <summary>
    ''' This is a shared function that can be used to get an array of WFinRep_Head1Record records using a where and order by clause clause with pagination.
    ''' </summary>
    Public Shared Function GetRecords( _
     ByVal where As String, _
     ...
     ByVal pageSize As Integer) As WFinRep_Head1Record()
        ...
        Dim recList As ArrayList =  WFinRep_Head1Table.Instance.GetRecordList(join, whereFilter, Nothing, orderBy, pageIndex, pageSize)
 
        Return CType(recList.ToArray(GetType(ePortalWFApproval.Business.WFinRep_Head1Record)), WFinRep_Head1Record())
    End Function
    ...
    Public Shared Function GetRecords( _
     ...
     ByVal pageSize As Integer) As WFinRep_Head1Record()
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = WFinRep_Head1Table.Instance.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetRecords( _
     ...
     ByRef totalRecords As Integer) As WFinRep_Head1Record()
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = WFinRep_Head1Table.Instance.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize, totalRecords)
    ...
    Public Shared Function PostGetRecordCount(ByVal selectCols As SqlBuilderColumnSelection, ByVal join As BaseFilter, ByVal finalFilter As BaseFilter) As Integer
	      Return CInt(WFinRep_Head1Table.Instance.GetCountResponseForPost(WFinRep_Head1Table.Instance.TableDefinition, selectCols, join, finalFilter))
    End Function
    ...
    Public Shared Function PostGetRecordList(ByVal requestedSelection As SqlBuilderColumnSelection, ByVal workingSelection As SqlBuilderColumnSelection, _
		...
		If IsNothing(table) Then
			recList = WFinRep_Head1Table.Instance.GetRecordListResponseForPost(WFinRep_Head1Table.Instance.TableDefinition, requestedSelection, workingSelection, distinctSelection, join, filter, _
    ...
    Public Shared Function GetRecordCount(ByVal where As String) As Integer
        ...
        Return CInt(WFinRep_Head1Table.Instance.GetRecordListCount(Nothing, whereFilter, Nothing, Nothing))
    End Function
...
''' <summary>
    ...
    Public Shared Function GetRecordCount(ByVal join As BaseFilter, ByVal where As String) As Integer
        ...
        Return CInt(WFinRep_Head1Table.Instance.GetRecordListCount(join, whereFilter, Nothing, Nothing))
    End Function

    Public Shared Function GetRecordCount(ByVal where As WhereClause) As Integer
        Return CInt(WFinRep_Head1Table.Instance.GetRecordListCount(Nothing, where.GetFilter(), Nothing, Nothing))
    End Function
    
      Public Shared Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
        Return CInt(WFinRep_Head1Table.Instance.GetRecordListCount(join, where.GetFilter(), Nothing, Nothing))
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get a WFinRep_Head1Record record using a where clause.
    ''' </summary>
    Public Shared Function GetRecord(ByVal where As String) As WFinRep_Head1Record
    ...
    ''' This is a shared function that can be used to get a WFinRep_Head1Record record using a where clause.
    ''' </summary>
    Public Shared Function GetRecord(ByVal join As BaseFilter, ByVal where As String) As WFinRep_Head1Record
        Dim orderBy As OrderBy = Nothing
        Return GetRecord(join, where, orderBy)
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get a WFinRep_Head1Record record using a where and order by clause.
    ''' </summary>
    Public Shared Function GetRecord( _
     ...
     ByVal orderBy As OrderBy) As WFinRep_Head1Record
        ...
        End If
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = WFinRep_Head1Table.Instance.GetRecordList(join, whereFilter, Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, BaseTable.MIN_BATCH_SIZE)

        Dim rec As WFinRep_Head1Record = Nothing
        If recList.Count > 0 Then
            rec = CType(recList(0), WFinRep_Head1Record)
        End If
    ...
    Public Shared Function GetValues( _
        ...
        Return WFinRep_Head1Table.Instance.GetColumnValues(retCol, Nothing, where.GetFilter(), Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, maxItems)
    ...
    Public Shared Function GetValues( _
        ...
        Return WFinRep_Head1Table.Instance.GetColumnValues(retCol, join, where.GetFilter(), Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, maxItems)
    ...
    Public Shared Function GetDataTable(ByVal where As String) As System.Data.DataTable
        ...
        Dim recs() As WFinRep_Head1Record = GetRecords(where)
        Return WFinRep_Head1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal join As BaseFilter, ByVal where As String) As System.Data.DataTable
        ...
        Dim recs() As WFinRep_Head1Record = GetRecords(join, where)
        Return WFinRep_Head1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal where As String, ByVal orderBy As OrderBy) As System.Data.DataTable
        ...
        Dim recs() As WFinRep_Head1Record = GetRecords(where, orderBy)
        Return WFinRep_Head1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal join As BaseFilter, ByVal where As String, ByVal orderBy As OrderBy) As System.Data.DataTable
        ...
        Dim recs() As WFinRep_Head1Record = GetRecords(join, where, orderBy)
        Return WFinRep_Head1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable( _
     ...
     ByVal pageSize As Integer) As System.Data.DataTable
        ...
        Dim recs() As WFinRep_Head1Record = GetRecords(where, orderBy, pageIndex, pageSize)
        Return WFinRep_Head1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable( _
     ...
     ByVal pageSize As Integer) As System.Data.DataTable
        ...
        Dim recs() As WFinRep_Head1Record = GetRecords(join, where, orderBy, pageIndex, pageSize)
        Return WFinRep_Head1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Sub DeleteRecords(ByVal where As String)
        ...
        WFinRep_Head1Table.Instance.DeleteRecordList(whereFilter)
    End Sub
    ...
    Public Shared Function Export(ByVal where As String) As String
        ...
        Return WFinRep_Head1Table.Instance.ExportRecordData(whereFilter)
    End Function
    ...
    Public Shared Function GetSum( _
        ...
        Return WFinRep_Head1Table.Instance.GetColumnStatistics(colSel, Nothing, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetSum( _
        ...
        Return WFinRep_Head1Table.Instance.GetColumnStatistics(colSel, join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetColumns() As BaseColumn()
        Return WFinRep_Head1Table.Instance.TableDefinition.Columns
    End Function
    ...
    Public Shared Function GetColumnList() As ColumnList
        Return WFinRep_Head1Table.Instance.TableDefinition.ColumnList
    End Function
    ...
    Public Shared Function CreateNewRecord() As IRecord
        Return WFinRep_Head1Table.Instance.CreateRecord()
    End Function
    ...
    Public Shared Function CreateNewRecord(ByVal tempId As String) As IRecord
        Return WFinRep_Head1Table.Instance.CreateRecord(tempId)
    End Function
    ...
    Public Shared Function GetColumn(ByVal uniqueColumnName As String) As BaseColumn
        Dim column As BaseColumn = WFinRep_Head1Table.Instance.TableDefinition.ColumnList.GetByUniqueName(uniqueColumnName)
        Return column
    End Function     
    ...
    Public Shared Function GetColumnByName(ByVal name As String) As BaseColumn
        Dim column As BaseColumn = WFinRep_Head1Table.Instance.TableDefinition.ColumnList.GetByInternalName(name)
        Return column
    End Function       
        

    ' Convenience method for getting a record using a string-based record identifier
    Public Shared Function GetRecord(ByVal id As String, ByVal bMutable As Boolean) As WFinRep_Head1Record
        Return CType(WFinRep_Head1Table.Instance.GetRecordData(id, bMutable), WFinRep_Head1Record)
    End Function

    ' Convenience method for getting a record using a KeyValue record identifier
    Public Shared Function GetRecord(ByVal id As KeyValue, ByVal bMutable As Boolean) As WFinRep_Head1Record
        Return CType(WFinRep_Head1Table.Instance.GetRecordData(id, bMutable), WFinRep_Head1Record)
    End Function
    ...
    Public Shared Sub DeleteRecord(ByVal kv As KeyValue)
        WFinRep_Head1Table.Instance.DeleteOneRecord(kv)
    End Sub
    ...
    Public Shared Function DoesRecordExist(ByVal kv As KeyValue) As Boolean
        ...
        Try
            WFinRep_Head1Table.GetRecord(kv, False)
    ...
    Public Shared Function GetPrimaryKeyColumns() As ColumnList
        If (Not IsNothing(WFinRep_Head1Table.Instance.TableDefinition.PrimaryKey)) Then
            Return WFinRep_Head1Table.Instance.TableDefinition.PrimaryKey.Columns
        Else
            Return Nothing
        End If
    End Function
    ...
    Public Shared Function GetKeyValue(ByVal key As Object) As KeyValue
        ...
        If (Not (IsNothing(WFinRep_Head1Table.Instance.TableDefinition.PrimaryKey))) Then
            ...
            isCompositePrimaryKey = WFinRep_Head1Table.Instance.TableDefinition.PrimaryKey.IsCompositeKey
            ...
            If ((isCompositePrimaryKey) AndAlso (key.GetType.IsArray())) Then
                ...
                If (Not IsNothing(keyArray)) Then
                    ...
                    Dim pkColumns As ColumnList = WFinRep_Head1Table.Instance.TableDefinition.PrimaryKey.Columns
                    Dim pkColumn As BaseColumn
                    Dim index As Integer = 0
                    For Each pkColumn In pkColumns
                        Dim keyString As String = CType(keyArray.GetValue(index), String)
                        If (WFinRep_Head1Table.Instance.TableDefinition.TableType = BaseClasses.Data.TableDefinition.TableTypes.Virtual) Then
            ...
            Else
                ...
                kv = WFinRep_Head1Table.Instance.TableDefinition.PrimaryKey.ParseValue(CType(key, String))
            End If
        End If
        Return kv
    End Function    
	...
	Public Shared Function GetDFKA(ByVal rec As BaseRecord, ByVal col As BaseColumn) As String
	    Dim fkColumn As ForeignKey = WFinRep_Head1Table.Instance.TableDefinition.GetExpandableNonCompositeForeignKey(col)
