...
''' <summary>
''' The generated superclass for the <see cref="WPO_PRNo_QDetails1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="WPO_PRNo_QDetails1View"></see> class.
''' </remarks>
''' <seealso cref="WPO_PRNo_QDetails1View"></seealso>
''' <seealso cref="WPO_PRNo_QDetails1Record"></seealso>

<Serializable()> Public Class BaseWPO_PRNo_QDetails1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WPO_PRNo_QDetails1View = WPO_PRNo_QDetails1View.Instance
    ...
    Public Overridable Sub WPO_PRNo_QDetails1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WPO_PRNo_QDetails1Rec As WPO_PRNo_QDetails1Record = CType(sender,WPO_PRNo_QDetails1Record)
        Validate_Inserting()
        If Not WPO_PRNo_QDetails1Rec Is Nothing AndAlso Not WPO_PRNo_QDetails1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WPO_PRNo_QDetails1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WPO_PRNo_QDetails1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
