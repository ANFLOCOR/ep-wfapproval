...
''' <summary>
''' The generated superclass for the <see cref="WCanvass_Quotation_InternalRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWCanvass_Quotation_InternalRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WCanvass_Quotation_InternalTable = WCanvass_Quotation_InternalTable.Instance
    ...
    Public Overridable Sub WCanvass_Quotation_InternalRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WCanvass_Quotation_InternalRec As WCanvass_Quotation_InternalRecord = CType(sender,WCanvass_Quotation_InternalRecord)
        Validate_Inserting()
        If Not WCanvass_Quotation_InternalRec Is Nothing AndAlso Not WCanvass_Quotation_InternalRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WCanvass_Quotation_InternalRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WCanvass_Quotation_InternalRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
