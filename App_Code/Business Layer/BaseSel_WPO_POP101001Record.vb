...
' Your customizations should be made in Sel_WPO_POP101001Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WPO_POP101001Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="Sel_WPO_POP101001View"></see> class.
''' </remarks>
''' <seealso cref="Sel_WPO_POP101001View"></seealso>
''' <seealso cref="Sel_WPO_POP101001Record"></seealso>

<Serializable()> Public Class BaseSel_WPO_POP101001Record
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WPO_POP101001View = Sel_WPO_POP101001View.Instance
    ...
    Public Overridable Sub Sel_WPO_POP101001Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_WPO_POP101001Rec As Sel_WPO_POP101001Record = CType(sender,Sel_WPO_POP101001Record)
        If Not Sel_WPO_POP101001Rec Is Nothing AndAlso Not Sel_WPO_POP101001Rec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_WPO_POP101001Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
...
#Region "Convenience methods to get/set values of fields"
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.PONUMBER field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.PONUMBER field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.POSTATUS field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.POSTATUS field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.DOCDATE field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.DOCDATE field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.TOTAL field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.TOTAL field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.VENDORID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.VENDORID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.VENDNAME field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.VENDNAME field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.BUYERID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.BUYERID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.Workflow_Approval_Status field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.Workflow_Approval_Status field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.CompanyID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.CompanyID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.COMMENTS field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.COMMENTS field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.SUBTOTAL field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.SUBTOTAL field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.TRDISAMT field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.TRDISAMT field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.FRTAMNT field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.FRTAMNT field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.MSCCHAMT field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.MSCCHAMT field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.TAXAMNT field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.TAXAMNT field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.isINC field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.isINC field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.TAXSCHID field.
	''' </summary>
	Public Function GetTAXSCHIDValue() As ColumnValue
		Return Me.GetValue(TableUtils.TAXSCHIDColumn)
	End Function

	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WPO_POP10100_.TAXSCHID field.
	''' </summary>
	Public Function GetTAXSCHIDFieldValue() As String
		Return CType(Me.GetValue(TableUtils.TAXSCHIDColumn).ToString(), String)
	End Function

	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.TAXSCHID field.
	''' </summary>
	Public Sub SetTAXSCHIDFieldValue(ByVal val As ColumnValue)
		Me.SetValue(val, TableUtils.TAXSCHIDColumn)
	End Sub

	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WPO_POP10100_.TAXSCHID field.
	''' </summary>
	Public Sub SetTAXSCHIDFieldValue(ByVal val As String)
		Dim colValue As ColumnValue = New ColumnValue(val)
		Me.SetValue(colValue, TableUtils.TAXSCHIDColumn)
	End Sub
...
#Region "Convenience methods to get field names"
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.PONUMBER field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.POSTATUS field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.DOCDATE field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.TOTAL field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.VENDORID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.VENDNAME field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.BUYERID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.Workflow_Approval_Status field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.CompanyID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.COMMENTS field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.SUBTOTAL field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.TRDISAMT field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.FRTAMNT field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.MSCCHAMT field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.TAXAMNT field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.isINC field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WPO_POP10100_.TAXSCHID field.
	''' </summary>
	Public Property TAXSCHID() As String
		...
		End Get
		Set (ByVal Value As String) 
			Me.SetString(value, TableUtils.TAXSCHIDColumn)
		End Set
	End Property
	...
	''' This is a convenience method that can be used to determine that the column is set.
	''' </summary>
	Public ReadOnly Property TAXSCHIDSpecified() As Boolean
        Get
            Dim val As ColumnValue = Me.GetValue(TableUtils.TAXSCHIDColumn)
            If val Is Nothing OrElse val.IsNull Then
                Return False
            End If
            Return True
	...
	''' This is a convenience method that can be used to get the default value of a column.
	''' </summary>
    Public ReadOnly Property TAXSCHIDDefault() As String
        Get
            Return TableUtils.TAXSCHIDColumn.DefaultValue
        End Get
    End Property
