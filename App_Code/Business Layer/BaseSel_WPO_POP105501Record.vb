...
''' <summary>
''' The generated superclass for the <see cref="Sel_WPO_POP105501Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_WPO_POP105501Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WPO_POP105501View = Sel_WPO_POP105501View.Instance
    ...
    Public Overridable Sub Sel_WPO_POP105501Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Sel_WPO_POP105501Rec As Sel_WPO_POP105501Record = CType(sender,Sel_WPO_POP105501Record)
        Validate_Inserting()
        If Not Sel_WPO_POP105501Rec Is Nothing AndAlso Not Sel_WPO_POP105501Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Sel_WPO_POP105501Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Sel_WPO_POP105501Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
