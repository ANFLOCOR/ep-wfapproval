...
''' Also provides access to the <see cref="WFinRep_DocAttachTable"></see> that each record is associated with.
''' </summary>
''' <remarks>
''' </remarks>
''' <seealso cref="WFinRep_DocAttachTable"></seealso>

<Serializable()> Public Class WFinRep_DocAttachRecord
	Inherits BaseWFinRep_DocAttachRecord
	...
	End Sub
        ...
        Public Shared Sub AddRecord(ByVal FIN_Year As Integer, ByVal FIN_Month As Integer, ByVal FIN_Type As String, _
                ByVal FIN_Description As String, ByVal FIN_Company As Short, _
        ...
        Public Shared Sub UpdateFinPost(ByVal xFIN_ID As String, ByVal xFIN_Post As Integer)
            ...
            If Not rec Is Nothing Then
                ...
                Try
                    rec = WFinRep_DocAttachTable.GetRecord(xFIN_ID, True)
                    rec.FIN_Post = postflag ' xFIN_Post
                    rec.Save()
                    Utils.DbUtils.CommitTransaction()
                Catch ex As Exception
                    Utils.DbUtils.RollBackTransaction()
