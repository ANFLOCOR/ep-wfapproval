...
''' <summary>
''' The generated superclass for the <see cref="Sel_WAttach_Type_WCAR_Doc_AttachRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_WAttach_Type_WCAR_Doc_AttachRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WAttach_Type_WCAR_Doc_AttachView = Sel_WAttach_Type_WCAR_Doc_AttachView.Instance
    ...
    Public Overridable Sub Sel_WAttach_Type_WCAR_Doc_AttachRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Sel_WAttach_Type_WCAR_Doc_AttachRec As Sel_WAttach_Type_WCAR_Doc_AttachRecord = CType(sender,Sel_WAttach_Type_WCAR_Doc_AttachRecord)
        Validate_Inserting()
        If Not Sel_WAttach_Type_WCAR_Doc_AttachRec Is Nothing AndAlso Not Sel_WAttach_Type_WCAR_Doc_AttachRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Sel_WAttach_Type_WCAR_Doc_AttachRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Sel_WAttach_Type_WCAR_Doc_AttachRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
