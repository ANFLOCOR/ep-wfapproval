...
' Your customizations should be made in SelWFReassign1Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="SelWFReassign1Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSelWFReassign1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As SelWFReassign1View = SelWFReassign1View.Instance
    ...
    Public Overridable Sub SelWFReassign1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim SelWFReassign1Rec As SelWFReassign1Record = CType(sender,SelWFReassign1Record)
        Validate_Inserting()
        If Not SelWFReassign1Rec Is Nothing AndAlso Not SelWFReassign1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub SelWFReassign1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub SelWFReassign1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
