...
''' <summary>
''' The generated superclass for the <see cref="Sel_W_User_W_ModuleRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_W_User_W_ModuleRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_W_User_W_ModuleView = Sel_W_User_W_ModuleView.Instance
    ...
    Public Overridable Sub Sel_W_User_W_ModuleRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Sel_W_User_W_ModuleRec As Sel_W_User_W_ModuleRecord = CType(sender,Sel_W_User_W_ModuleRecord)
        Validate_Inserting()
        If Not Sel_W_User_W_ModuleRec Is Nothing AndAlso Not Sel_W_User_W_ModuleRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Sel_W_User_W_ModuleRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Sel_W_User_W_ModuleRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
