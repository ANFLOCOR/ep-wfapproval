...
''' <summary>
''' The generated superclass for the <see cref="WFinRep_AttachmentRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWFinRep_AttachmentRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WFinRep_AttachmentTable = WFinRep_AttachmentTable.Instance
    ...
    Public Overridable Sub WFinRep_AttachmentRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WFinRep_AttachmentRec As WFinRep_AttachmentRecord = CType(sender,WFinRep_AttachmentRecord)
        Validate_Inserting()
        If Not WFinRep_AttachmentRec Is Nothing AndAlso Not WFinRep_AttachmentRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WFinRep_AttachmentRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WFinRep_AttachmentRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
