...
''' Also provides access to the <see cref="WFinRepNGP_Activity1Table"></see> that each record is associated with.
''' </summary>
''' <remarks>
''' </remarks>
''' <seealso cref="WFinRepNGP_Activity1Table"></seealso>

<Serializable()> Public Class WFinRepNGP_Activity1Record
	Inherits BaseWFinRepNGP_Activity1Record
	...
	End Sub
        ...
        Public Shared Sub AddRecord(ByVal WFRNGPA_WS_ID As Integer, ByVal WFRNGPA_WSD_ID As Integer, ByVal WFRNGPA_WDT_ID As Integer, _
            ...
            Dim rec As New WFinRepNGP_Activity1Record
        ...
        Public Shared Sub UpdateRecord(ByVal WFRNGPA_ID As String, ByVal WFRNGPA_Status As String)
            ...
            Dim rec As New WFinRepNGP_Activity1Record
            rec = WFinRepNGP_Activity1Table.GetRecord(ws)

            If Not rec Is Nothing Then
                WFRNGPA_ID = rec.WFRNGPA_ID.ToString()
                Utils.DbUtils.StartTransaction()
                Try
                    rec = WFinRepNGP_Activity1Table.GetRecord(WFRNGPA_ID, True)
