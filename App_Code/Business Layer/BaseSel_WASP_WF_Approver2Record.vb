...
''' <summary>
''' The generated superclass for the <see cref="Sel_WASP_WF_Approver2Record"></see> class.
''' </summary>
''' <remarks>
...
''' <seealso cref="Sel_WASP_WF_Approver2Record"></seealso>

<Serializable()> Public Class BaseSel_WASP_WF_Approver2Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WASP_WF_Approver2View = Sel_WASP_WF_Approver2View.Instance
    ...
    Public Overridable Sub Sel_WASP_WF_Approver2Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Sel_WASP_WF_Approver2Rec As Sel_WASP_WF_Approver2Record = CType(sender,Sel_WASP_WF_Approver2Record)
        Validate_Inserting()
        If Not Sel_WASP_WF_Approver2Rec Is Nothing AndAlso Not Sel_WASP_WF_Approver2Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Sel_WASP_WF_Approver2Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Sel_WASP_WF_Approver2Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
...
#Region "Convenience methods to get/set values of fields"
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WASP_WF_Approver_.W_U_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WASP_WF_Approver_.W_U_ID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WASP_WF_Approver_.W_U_User_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WASP_WF_Approver_.W_U_User_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WASP_WF_Approver_.W_U_Full_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WASP_WF_Approver_.W_U_Full_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WASP_WF_Approver_.W_R_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WASP_WF_Approver_.W_R_ID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WASP_WF_Approver_.W_R_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WASP_WF_Approver_.W_R_Name field.
	''' </summary>
...
#Region "Convenience methods to get field names"
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WASP_WF_Approver_.W_U_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WASP_WF_Approver_.W_U_User_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WASP_WF_Approver_.W_U_Full_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WASP_WF_Approver_.W_R_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WASP_WF_Approver_.W_R_Name field.
	''' </summary>
