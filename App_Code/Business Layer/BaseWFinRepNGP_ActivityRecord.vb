...
''' <summary>
''' The generated superclass for the <see cref="WFinRepNGP_ActivityRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWFinRepNGP_ActivityRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WFinRepNGP_ActivityTable = WFinRepNGP_ActivityTable.Instance
    ...
    Public Overridable Sub WFinRepNGP_ActivityRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WFinRepNGP_ActivityRec As WFinRepNGP_ActivityRecord = CType(sender,WFinRepNGP_ActivityRecord)
        Validate_Inserting()
        If Not WFinRepNGP_ActivityRec Is Nothing AndAlso Not WFinRepNGP_ActivityRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WFinRepNGP_ActivityRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WFinRepNGP_ActivityRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
