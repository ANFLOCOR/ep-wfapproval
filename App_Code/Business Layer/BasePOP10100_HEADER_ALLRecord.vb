...
' Your customizations should be made in POP10100_HEADER_ALLRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="POP10100_HEADER_ALLRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BasePOP10100_HEADER_ALLRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As POP10100_HEADER_ALLView = POP10100_HEADER_ALLView.Instance
    ...
    Public Overridable Sub POP10100_HEADER_ALLRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim POP10100_HEADER_ALLRec As POP10100_HEADER_ALLRecord = CType(sender,POP10100_HEADER_ALLRecord)
        If Not POP10100_HEADER_ALLRec Is Nothing AndAlso Not POP10100_HEADER_ALLRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub POP10100_HEADER_ALLRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
