...
''' <summary>
''' The generated superclass for the <see cref="WPO_Step_WPO_StepDetail1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="WPO_Step_WPO_StepDetail1View"></see> class.
''' </remarks>
''' <seealso cref="WPO_Step_WPO_StepDetail1View"></seealso>
''' <seealso cref="WPO_Step_WPO_StepDetail1Record"></seealso>

<Serializable()> Public Class BaseWPO_Step_WPO_StepDetail1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WPO_Step_WPO_StepDetail1View = WPO_Step_WPO_StepDetail1View.Instance
    ...
    Public Overridable Sub WPO_Step_WPO_StepDetail1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WPO_Step_WPO_StepDetail1Rec As WPO_Step_WPO_StepDetail1Record = CType(sender,WPO_Step_WPO_StepDetail1Record)
        Validate_Inserting()
        If Not WPO_Step_WPO_StepDetail1Rec Is Nothing AndAlso Not WPO_Step_WPO_StepDetail1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WPO_Step_WPO_StepDetail1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WPO_Step_WPO_StepDetail1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
...
#Region "Convenience methods to get/set values of fields"
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.W_U_Full_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's WPO_Step_WPO_StepDetail_.W_U_Full_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_S_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's WPO_Step_WPO_StepDetail_.WPO_S_ID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_S_WDT_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's WPO_Step_WPO_StepDetail_.WPO_S_WDT_ID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_S_ID_Next field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's WPO_Step_WPO_StepDetail_.WPO_S_ID_Next field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_S_Step_Type field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's WPO_Step_WPO_StepDetail_.WPO_S_Step_Type field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_S_Approval_Needed field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's WPO_Step_WPO_StepDetail_.WPO_S_Approval_Needed field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_SD_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's WPO_Step_WPO_StepDetail_.WPO_SD_ID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_SD_W_U_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's WPO_Step_WPO_StepDetail_.WPO_SD_W_U_ID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.SSU_FullName field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's WPO_Step_WPO_StepDetail_.SSU_FullName field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_SD_Is_FAP field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's WPO_Step_WPO_StepDetail_.WPO_SD_Is_FAP field.
	''' </summary>
...
#Region "Convenience methods to get field names"
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.W_U_Full_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_S_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_S_WDT_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_S_ID_Next field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_S_Step_Type field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_S_Approval_Needed field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_SD_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_SD_W_U_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.SSU_FullName field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's WPO_Step_WPO_StepDetail_.WPO_SD_Is_FAP field.
	''' </summary>
