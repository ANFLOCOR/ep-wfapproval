...
''' Also provides access to the <see cref="WFinRepNGP_DocAttachTable"></see> that each record is associated with.
''' </summary>
''' <remarks>
''' </remarks>
''' <seealso cref="WFinRepNGP_DocAttachTable"></seealso>

<Serializable()> Public Class WFinRepNGP_DocAttachRecord
	Inherits BaseWFinRepNGP_DocAttachRecord
	...
	End Sub
        ...
        Public Shared Sub UpdateStatus(ByVal xFIN_ID As String, ByVal xFIN_Status As Integer)
            ...
            Dim rec As New WFinRepNGP_DocAttachRecord
            rec = WFinRepNGP_DocAttachTable.GetRecord(ws)
            ...
            If Not rec Is Nothing Then
                ...
                Try
                    rec = WFinRepNGP_DocAttachTable.GetRecord(xFIN_ID, True)
