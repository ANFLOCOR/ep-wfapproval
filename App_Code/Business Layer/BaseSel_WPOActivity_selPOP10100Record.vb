...
''' <summary>
''' The generated superclass for the <see cref="Sel_WPOActivity_selPOP10100Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_WPOActivity_selPOP10100Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WPOActivity_selPOP10100View = Sel_WPOActivity_selPOP10100View.Instance
    ...
    Public Overridable Sub Sel_WPOActivity_selPOP10100Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Sel_WPOActivity_selPOP10100Rec As Sel_WPOActivity_selPOP10100Record = CType(sender,Sel_WPOActivity_selPOP10100Record)
        Validate_Inserting()
        If Not Sel_WPOActivity_selPOP10100Rec Is Nothing AndAlso Not Sel_WPOActivity_selPOP10100Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Sel_WPOActivity_selPOP10100Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Sel_WPOActivity_selPOP10100Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
