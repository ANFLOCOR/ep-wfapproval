...
<Serializable()> Public Class BaseVw_ANFLO_DW_CompanyNonGPRecord
    ...
    Public Overridable Sub Vw_ANFLO_DW_CompanyNonGPRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
