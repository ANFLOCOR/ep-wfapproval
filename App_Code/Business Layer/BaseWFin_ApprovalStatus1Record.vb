...
''' <summary>
''' The generated superclass for the <see cref="WFin_ApprovalStatus1Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWFin_ApprovalStatus1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WFin_ApprovalStatus1Table = WFin_ApprovalStatus1Table.Instance
    ...
    Public Overridable Sub WFin_ApprovalStatus1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WFin_ApprovalStatus1Rec As WFin_ApprovalStatus1Record = CType(sender,WFin_ApprovalStatus1Record)
        Validate_Inserting()
        If Not WFin_ApprovalStatus1Rec Is Nothing AndAlso Not WFin_ApprovalStatus1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WFin_ApprovalStatus1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WFin_ApprovalStatus1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
