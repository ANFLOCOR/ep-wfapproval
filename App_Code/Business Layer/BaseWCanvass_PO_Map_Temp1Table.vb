...
' Your customizations should be made in WCanvass_PO_Map_Temp1Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="WCanvass_PO_Map_Temp1Table"></see> class.
''' Provides access to the schema information and record data of a database table or view named DatabaseANFLO-WFN%dbo.WCanvass_PO_Map_Temp.
''' </summary>
''' <remarks>
...
''' <see cref="WCanvass_PO_Map_Temp1Table.Instance">WCanvass_PO_Map_Temp1Table.Instance</see>.
''' </para>
''' </remarks>
''' <seealso cref="WCanvass_PO_Map_Temp1Table"></seealso>

<Serializable()> Public Class BaseWCanvass_PO_Map_Temp1Table
    Inherits PrimaryKeyTable
    

    Private ReadOnly TableDefinitionString As String = WCanvass_PO_Map_Temp1Definition.GetXMLString()
    ...
    Protected Overridable Sub Initialize()
        ...
        Me.TableDefinition.TableClassName = System.Reflection.Assembly.CreateQualifiedName("App_Code", "ePortalWFApproval.Business.WCanvass_PO_Map_Temp1Table")
        def.InitializeTableDefinition(Me.TableDefinition)
        Me.ConnectionName = def.GetConnectionName()
        Me.RecordClassName = System.Reflection.Assembly.CreateQualifiedName("App_Code", "ePortalWFApproval.Business.WCanvass_PO_Map_Temp1Record")
        Me.ApplicationName = "App_Code"
        Me.DataAdapter = New WCanvass_PO_Map_Temp1SqlTable()
        Directcast(Me.DataAdapter, WCanvass_PO_Map_Temp1SqlTable).ConnectionName = Me.ConnectionName
        Directcast(Me.DataAdapter, WCanvass_PO_Map_Temp1SqlTable).ApplicationName = Me.ApplicationName
...
#Region "Properties for columns"
    ...
    Public Shared ReadOnly Property Temp_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.Temp_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCDI_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCDI_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCDI_WCI_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCDI_WCI_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCDI_WPRL_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCDI_WPRL_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCDI_Status() As BaseClasses.Data.StringColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCDI_StatusColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCDI_Audit_Comment() As BaseClasses.Data.StringColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCDI_Audit_CommentColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCDI_Comment() As BaseClasses.Data.StringColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCDI_CommentColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCDI_PM00200_Vendor() As BaseClasses.Data.StringColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCDI_PM00200_VendorColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCDI_Qty() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCDI_QtyColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCDI_Bid() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCDI_BidColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCDI_Award() As BaseClasses.Data.BooleanColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCDI_AwardColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRL_WPRD_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WPRL_WPRD_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property Item() As BaseClasses.Data.StringColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.ItemColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property ItemDescription() As BaseClasses.Data.StringColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.ItemDescriptionColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property UnitOfMeasure() As BaseClasses.Data.StringColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.UnitOfMeasureColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property Site0() As BaseClasses.Data.StringColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.Site0Column
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property UnitPrice() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.UnitPriceColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRL_Qty() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WPRL_QtyColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRL_Ext_Price() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WPRL_Ext_PriceColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCI_C_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCI_C_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCI_Status() As BaseClasses.Data.StringColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCI_StatusColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCI_U_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCI_U_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCI_WClass_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCI_WClass_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_Created() As BaseClasses.Data.DateColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WPRD_CreatedColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCI_Date() As BaseClasses.Data.DateColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCI_DateColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property Offered_Qty() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.Offered_QtyColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property Balance_Qty() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.Balance_QtyColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCDI_Vat() As BaseClasses.Data.BooleanColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCDI_VatColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCDI_Net() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCDI_NetColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCDI_WCur_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCDI_WCur_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_Contract() As BaseClasses.Data.BooleanColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WPRD_ContractColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCI_Contract_Done() As BaseClasses.Data.BooleanColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCI_Contract_DoneColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCI_Contract_Closed() As BaseClasses.Data.DateColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCI_Contract_ClosedColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCI_Contract_U_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.WCI_Contract_U_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property Col_Marker() As BaseClasses.Data.NumberColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.Col_MarkerColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property Status() As BaseClasses.Data.StringColumn
        Get
            Return WCanvass_PO_Map_Temp1Table.Instance.StatusColumn
        End Get
    End Property
...
#Region "Shared helper methods"
    ...
    ''' <summary>
    ''' This is a shared function that can be used to get an array of WCanvass_PO_Map_Temp1Record records using a where clause.
    ''' </summary>
    Public Shared Function GetRecords(ByVal where As String) As WCanvass_PO_Map_Temp1Record()
    ...
    ''' This is a shared function that can be used to get an array of WCanvass_PO_Map_Temp1Record records using a where clause.
    ''' </summary>
    Public Shared Function GetRecords(ByVal join As BaseFilter, ByVal where As String) As WCanvass_PO_Map_Temp1Record()

        Return GetRecords(join, where, Nothing, BaseTable.MIN_PAGE_NUMBER, BaseTable.MAX_BATCH_SIZE)
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get an array of WCanvass_PO_Map_Temp1Record records using a where and order by clause.
    ''' </summary>
    Public Shared Function GetRecords( _
     ByVal where As String, _
     ByVal orderBy As OrderBy) As WCanvass_PO_Map_Temp1Record()
    ...
    ''' <summary>
    ''' This is a shared function that can be used to get an array of WCanvass_PO_Map_Temp1Record records using a where and order by clause clause with pagination.
    ''' </summary>
    Public Shared Function GetRecords( _
     ByVal where As String, _
     ByVal orderBy As OrderBy, _
     ByVal pageIndex As Integer, _
     ByVal pageSize As Integer) As WCanvass_PO_Map_Temp1Record()
        ...
        Dim recList As ArrayList =  WCanvass_PO_Map_Temp1Table.Instance.GetRecordList(join, whereFilter, Nothing, orderBy, pageIndex, pageSize)
 
        Return CType(recList.ToArray(GetType(ePortalWFApproval.Business.WCanvass_PO_Map_Temp1Record)), WCanvass_PO_Map_Temp1Record())
    End Function
    ...
    Public Shared Function GetRecords( _
     ...
     ByVal pageSize As Integer) As WCanvass_PO_Map_Temp1Record()
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = WCanvass_PO_Map_Temp1Table.Instance.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetRecords( _
     ...
     ByRef totalRecords As Integer) As WCanvass_PO_Map_Temp1Record()
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = WCanvass_PO_Map_Temp1Table.Instance.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize, totalRecords)
    ...
    Public Shared Function PostGetRecordCount(ByVal selectCols As SqlBuilderColumnSelection, ByVal join As BaseFilter, ByVal finalFilter As BaseFilter) As Integer
	      Return CInt(WCanvass_PO_Map_Temp1Table.Instance.GetCountResponseForPost(WCanvass_PO_Map_Temp1Table.Instance.TableDefinition, selectCols, join, finalFilter))
    End Function
    ...
    Public Shared Function PostGetRecordList(ByVal requestedSelection As SqlBuilderColumnSelection, ByVal workingSelection As SqlBuilderColumnSelection, _
		...
		If IsNothing(table) Then
			recList = WCanvass_PO_Map_Temp1Table.Instance.GetRecordListResponseForPost(WCanvass_PO_Map_Temp1Table.Instance.TableDefinition, requestedSelection, workingSelection, distinctSelection, join, filter, _
    ...
    Public Shared Function GetRecordCount(ByVal where As String) As Integer
        ...
        Return CInt(WCanvass_PO_Map_Temp1Table.Instance.GetRecordListCount(Nothing, whereFilter, Nothing, Nothing))
    End Function
...
''' <summary>
    ...
    Public Shared Function GetRecordCount(ByVal join As BaseFilter, ByVal where As String) As Integer
        ...
        Return CInt(WCanvass_PO_Map_Temp1Table.Instance.GetRecordListCount(join, whereFilter, Nothing, Nothing))
    End Function

    Public Shared Function GetRecordCount(ByVal where As WhereClause) As Integer
        Return CInt(WCanvass_PO_Map_Temp1Table.Instance.GetRecordListCount(Nothing, where.GetFilter(), Nothing, Nothing))
    End Function
    
      Public Shared Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
        Return CInt(WCanvass_PO_Map_Temp1Table.Instance.GetRecordListCount(join, where.GetFilter(), Nothing, Nothing))
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get a WCanvass_PO_Map_Temp1Record record using a where clause.
    ''' </summary>
    Public Shared Function GetRecord(ByVal where As String) As WCanvass_PO_Map_Temp1Record
    ...
    ''' This is a shared function that can be used to get a WCanvass_PO_Map_Temp1Record record using a where clause.
    ''' </summary>
    Public Shared Function GetRecord(ByVal join As BaseFilter, ByVal where As String) As WCanvass_PO_Map_Temp1Record
        Dim orderBy As OrderBy = Nothing
        Return GetRecord(join, where, orderBy)
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get a WCanvass_PO_Map_Temp1Record record using a where and order by clause.
    ''' </summary>
    Public Shared Function GetRecord( _
     ...
     ByVal orderBy As OrderBy) As WCanvass_PO_Map_Temp1Record
        ...
        End If
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = WCanvass_PO_Map_Temp1Table.Instance.GetRecordList(join, whereFilter, Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, BaseTable.MIN_BATCH_SIZE)

        Dim rec As WCanvass_PO_Map_Temp1Record = Nothing
        If recList.Count > 0 Then
            rec = CType(recList(0), WCanvass_PO_Map_Temp1Record)
        End If
    ...
    Public Shared Function GetValues( _
        ...
        Return WCanvass_PO_Map_Temp1Table.Instance.GetColumnValues(retCol, Nothing, where.GetFilter(), Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, maxItems)
    ...
    Public Shared Function GetValues( _
        ...
        Return WCanvass_PO_Map_Temp1Table.Instance.GetColumnValues(retCol, join, where.GetFilter(), Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, maxItems)
    ...
    Public Shared Function GetDataTable(ByVal where As String) As System.Data.DataTable
        ...
        Dim recs() As WCanvass_PO_Map_Temp1Record = GetRecords(where)
        Return WCanvass_PO_Map_Temp1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal join As BaseFilter, ByVal where As String) As System.Data.DataTable
        ...
        Dim recs() As WCanvass_PO_Map_Temp1Record = GetRecords(join, where)
        Return WCanvass_PO_Map_Temp1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal where As String, ByVal orderBy As OrderBy) As System.Data.DataTable
        ...
        Dim recs() As WCanvass_PO_Map_Temp1Record = GetRecords(where, orderBy)
        Return WCanvass_PO_Map_Temp1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal join As BaseFilter, ByVal where As String, ByVal orderBy As OrderBy) As System.Data.DataTable
        ...
        Dim recs() As WCanvass_PO_Map_Temp1Record = GetRecords(join, where, orderBy)
        Return WCanvass_PO_Map_Temp1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable( _
     ...
     ByVal pageSize As Integer) As System.Data.DataTable
        ...
        Dim recs() As WCanvass_PO_Map_Temp1Record = GetRecords(where, orderBy, pageIndex, pageSize)
        Return WCanvass_PO_Map_Temp1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable( _
     ...
     ByVal pageSize As Integer) As System.Data.DataTable
        ...
        Dim recs() As WCanvass_PO_Map_Temp1Record = GetRecords(join, where, orderBy, pageIndex, pageSize)
        Return WCanvass_PO_Map_Temp1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Sub DeleteRecords(ByVal where As String)
        ...
        WCanvass_PO_Map_Temp1Table.Instance.DeleteRecordList(whereFilter)
    End Sub
    ...
    Public Shared Function Export(ByVal where As String) As String
        ...
        Return WCanvass_PO_Map_Temp1Table.Instance.ExportRecordData(whereFilter)
    End Function
    ...
    Public Shared Function GetSum( _
        ...
        Return WCanvass_PO_Map_Temp1Table.Instance.GetColumnStatistics(colSel, Nothing, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetSum( _
        ...
        Return WCanvass_PO_Map_Temp1Table.Instance.GetColumnStatistics(colSel, join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetColumns() As BaseColumn()
        Return WCanvass_PO_Map_Temp1Table.Instance.TableDefinition.Columns
    End Function
    ...
    Public Shared Function GetColumnList() As ColumnList
        Return WCanvass_PO_Map_Temp1Table.Instance.TableDefinition.ColumnList
    End Function
    ...
    Public Shared Function CreateNewRecord() As IRecord
        Return WCanvass_PO_Map_Temp1Table.Instance.CreateRecord()
    End Function
    ...
    Public Shared Function CreateNewRecord(ByVal tempId As String) As IRecord
        Return WCanvass_PO_Map_Temp1Table.Instance.CreateRecord(tempId)
    End Function
    ...
    Public Shared Function GetColumn(ByVal uniqueColumnName As String) As BaseColumn
        Dim column As BaseColumn = WCanvass_PO_Map_Temp1Table.Instance.TableDefinition.ColumnList.GetByUniqueName(uniqueColumnName)
        Return column
    End Function     
    ...
    Public Shared Function GetColumnByName(ByVal name As String) As BaseColumn
        Dim column As BaseColumn = WCanvass_PO_Map_Temp1Table.Instance.TableDefinition.ColumnList.GetByInternalName(name)
        Return column
    End Function       
        

    ' Convenience method for getting a record using a string-based record identifier
    Public Shared Function GetRecord(ByVal id As String, ByVal bMutable As Boolean) As WCanvass_PO_Map_Temp1Record
        Return CType(WCanvass_PO_Map_Temp1Table.Instance.GetRecordData(id, bMutable), WCanvass_PO_Map_Temp1Record)
    End Function

    ' Convenience method for getting a record using a KeyValue record identifier
    Public Shared Function GetRecord(ByVal id As KeyValue, ByVal bMutable As Boolean) As WCanvass_PO_Map_Temp1Record
        Return CType(WCanvass_PO_Map_Temp1Table.Instance.GetRecordData(id, bMutable), WCanvass_PO_Map_Temp1Record)
    End Function
    ...
    Public Shared Sub DeleteRecord(ByVal kv As KeyValue)
        WCanvass_PO_Map_Temp1Table.Instance.DeleteOneRecord(kv)
    End Sub
    ...
    Public Shared Function DoesRecordExist(ByVal kv As KeyValue) As Boolean
        ...
        Try
            WCanvass_PO_Map_Temp1Table.GetRecord(kv, False)
    ...
    Public Shared Function GetPrimaryKeyColumns() As ColumnList
        If (Not IsNothing(WCanvass_PO_Map_Temp1Table.Instance.TableDefinition.PrimaryKey)) Then
            Return WCanvass_PO_Map_Temp1Table.Instance.TableDefinition.PrimaryKey.Columns
        Else
            Return Nothing
        End If
    End Function
    ...
    Public Shared Function GetKeyValue(ByVal key As Object) As KeyValue
        ...
        If (Not (IsNothing(WCanvass_PO_Map_Temp1Table.Instance.TableDefinition.PrimaryKey))) Then
            ...
            isCompositePrimaryKey = WCanvass_PO_Map_Temp1Table.Instance.TableDefinition.PrimaryKey.IsCompositeKey
            ...
            If ((isCompositePrimaryKey) AndAlso (key.GetType.IsArray())) Then
                ...
                If (Not IsNothing(keyArray)) Then
                    ...
                    Dim pkColumns As ColumnList = WCanvass_PO_Map_Temp1Table.Instance.TableDefinition.PrimaryKey.Columns
                    Dim pkColumn As BaseColumn
                    Dim index As Integer = 0
                    For Each pkColumn In pkColumns
                        Dim keyString As String = CType(keyArray.GetValue(index), String)
                        If (WCanvass_PO_Map_Temp1Table.Instance.TableDefinition.TableType = BaseClasses.Data.TableDefinition.TableTypes.Virtual) Then
            ...
            Else
                ...
                kv = WCanvass_PO_Map_Temp1Table.Instance.TableDefinition.PrimaryKey.ParseValue(CType(key, String))
            End If
        End If
        Return kv
    End Function    
	...
	Public Shared Function GetDFKA(ByVal rec As BaseRecord, ByVal col As BaseColumn) As String
	    Dim fkColumn As ForeignKey = WCanvass_PO_Map_Temp1Table.Instance.TableDefinition.GetExpandableNonCompositeForeignKey(col)
