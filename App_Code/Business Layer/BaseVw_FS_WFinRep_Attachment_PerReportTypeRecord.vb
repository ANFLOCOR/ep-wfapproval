...
''' <summary>
''' The generated superclass for the <see cref="Vw_FS_WFinRep_Attachment_PerReportTypeRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseVw_FS_WFinRep_Attachment_PerReportTypeRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Vw_FS_WFinRep_Attachment_PerReportTypeView = Vw_FS_WFinRep_Attachment_PerReportTypeView.Instance
    ...
    Public Overridable Sub Vw_FS_WFinRep_Attachment_PerReportTypeRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Vw_FS_WFinRep_Attachment_PerReportTypeRec As Vw_FS_WFinRep_Attachment_PerReportTypeRecord = CType(sender,Vw_FS_WFinRep_Attachment_PerReportTypeRecord)
        Validate_Inserting()
        If Not Vw_FS_WFinRep_Attachment_PerReportTypeRec Is Nothing AndAlso Not Vw_FS_WFinRep_Attachment_PerReportTypeRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Vw_FS_WFinRep_Attachment_PerReportTypeRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Vw_FS_WFinRep_Attachment_PerReportTypeRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
