...
''' Also provides access to the <see cref="WPO_Activity1Table"></see> that each record is associated with.
''' </summary>
''' <remarks>
''' </remarks>
''' <seealso cref="WPO_Activity1Table"></seealso>

<Serializable()> Public Class WPO_Activity1Record
	Inherits BaseWPO_Activity1Record
	...
	End Sub
        ...
        ByVal U_ID As String, ByVal U_ID_Delegate As String, ByVal poNum As String, Optional ByVal WPO_Remark As String = "")
            ...
            Dim rec As New WPO_Activity1Record
        ...
        Public Shared Sub UpdateRecord(ByVal WPO_ID As String, ByVal WPO_Status As String)
            ...
            Dim rec As New WPO_Activity1Record
            rec = WPO_Activity1Table.GetRecord(ws)

            If Not rec Is Nothing Then
                WPO_ID = rec.WPO_ID.ToString()
                Utils.DbUtils.StartTransaction()
                Try
                    rec = WPO_Activity1Table.GetRecord(WPO_ID, True)
