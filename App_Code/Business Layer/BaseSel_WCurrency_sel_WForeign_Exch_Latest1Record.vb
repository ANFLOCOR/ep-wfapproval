...
' Your customizations should be made in Sel_WCurrency_sel_WForeign_Exch_Latest1Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WCurrency_sel_WForeign_Exch_Latest1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="Sel_WCurrency_sel_WForeign_Exch_Latest1View"></see> class.
''' </remarks>
...
<Serializable()> Public Class BaseSel_WCurrency_sel_WForeign_Exch_Latest1Record
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WCurrency_sel_WForeign_Exch_Latest1View = Sel_WCurrency_sel_WForeign_Exch_Latest1View.Instance
    ...
    Public Overridable Sub Sel_WCurrency_sel_WForeign_Exch_Latest1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_WCurrency_sel_WForeign_Exch_Latest1Rec As Sel_WCurrency_sel_WForeign_Exch_Latest1Record = CType(sender,Sel_WCurrency_sel_WForeign_Exch_Latest1Record)
        If Not Sel_WCurrency_sel_WForeign_Exch_Latest1Rec Is Nothing AndAlso Not Sel_WCurrency_sel_WForeign_Exch_Latest1Rec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_WCurrency_sel_WForeign_Exch_Latest1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
