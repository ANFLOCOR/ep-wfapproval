...
''' <summary>
''' The generated superclass for the <see cref="WFinRepNGP_AttachmentRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWFinRepNGP_AttachmentRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WFinRepNGP_AttachmentTable = WFinRepNGP_AttachmentTable.Instance
    ...
    Public Overridable Sub WFinRepNGP_AttachmentRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WFinRepNGP_AttachmentRec As WFinRepNGP_AttachmentRecord = CType(sender,WFinRepNGP_AttachmentRecord)
        Validate_Inserting()
        If Not WFinRepNGP_AttachmentRec Is Nothing AndAlso Not WFinRepNGP_AttachmentRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WFinRepNGP_AttachmentRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WFinRepNGP_AttachmentRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
