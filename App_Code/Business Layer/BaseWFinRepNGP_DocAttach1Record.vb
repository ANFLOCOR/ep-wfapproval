...
''' <summary>
''' The generated superclass for the <see cref="WFinRepNGP_DocAttach1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="WFinRepNGP_DocAttach1Table"></see> class.
''' </remarks>
''' <seealso cref="WFinRepNGP_DocAttach1Table"></seealso>
''' <seealso cref="WFinRepNGP_DocAttach1Record"></seealso>

<Serializable()> Public Class BaseWFinRepNGP_DocAttach1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WFinRepNGP_DocAttach1Table = WFinRepNGP_DocAttach1Table.Instance
    ...
    Public Overridable Sub WFinRepNGP_DocAttach1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WFinRepNGP_DocAttach1Rec As WFinRepNGP_DocAttach1Record = CType(sender,WFinRepNGP_DocAttach1Record)
        Validate_Inserting()
        If Not WFinRepNGP_DocAttach1Rec Is Nothing AndAlso Not WFinRepNGP_DocAttach1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WFinRepNGP_DocAttach1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WFinRepNGP_DocAttach1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
