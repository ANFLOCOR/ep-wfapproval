...
' Your customizations should be made in WPR_Doc1Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="WPR_Doc1Table"></see> class.
''' Provides access to the schema information and record data of a database table or view named DatabaseANFLO-WFN%dbo.WPR_Doc.
''' </summary>
''' <remarks>
...
''' <see cref="WPR_Doc1Table.Instance">WPR_Doc1Table.Instance</see>.
''' </para>
''' </remarks>
''' <seealso cref="WPR_Doc1Table"></seealso>

<Serializable()> Public Class BaseWPR_Doc1Table
    Inherits PrimaryKeyTable
    

    Private ReadOnly TableDefinitionString As String = WPR_Doc1Definition.GetXMLString()
    ...
    Protected Overridable Sub Initialize()
        ...
        Me.TableDefinition.TableClassName = System.Reflection.Assembly.CreateQualifiedName("App_Code", "ePortalWFApproval.Business.WPR_Doc1Table")
        def.InitializeTableDefinition(Me.TableDefinition)
        Me.ConnectionName = def.GetConnectionName()
        Me.RecordClassName = System.Reflection.Assembly.CreateQualifiedName("App_Code", "ePortalWFApproval.Business.WPR_Doc1Record")
        Me.ApplicationName = "App_Code"
        Me.DataAdapter = New WPR_Doc1SqlTable()
        Directcast(Me.DataAdapter, WPR_Doc1SqlTable).ConnectionName = Me.ConnectionName
        Directcast(Me.DataAdapter, WPR_Doc1SqlTable).ApplicationName = Me.ApplicationName
...
#Region "Properties for columns"
    ...
    Public Shared ReadOnly Property WPRD_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_C_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_C_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_WDT_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_WDT_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_WCD_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_WCD_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_WCur_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_WCur_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_U_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_U_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_U_ID_Modify() As BaseClasses.Data.NumberColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_U_ID_ModifyColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_No() As BaseClasses.Data.StringColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_NoColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_Created() As BaseClasses.Data.DateColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_CreatedColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_Modified() As BaseClasses.Data.DateColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_ModifiedColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_Total() As BaseClasses.Data.NumberColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_TotalColumn
        End Get
    End Property
    ''' <summary>
    ''' This is a convenience property that provides direct access to the table's WPR_Doc_.WPRD_Comment column object.
    ''' </summary>
    Public ReadOnly Property WPRD_CommentColumn() As BaseClasses.Data.StringColumn
        Get
    ...
    ''' This is a convenience property that provides direct access to the table's WPR_Doc_.WPRD_Comment column object.
    ''' </summary>
    Public Shared ReadOnly Property WPRD_Comment() As BaseClasses.Data.StringColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_CommentColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_WPRDS_ID() As BaseClasses.Data.NumberColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_WPRDS_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_Submit() As BaseClasses.Data.BooleanColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_SubmitColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_Title() As BaseClasses.Data.StringColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_TitleColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WPRD_Contract() As BaseClasses.Data.BooleanColumn
        Get
            Return WPR_Doc1Table.Instance.WPRD_ContractColumn
        End Get
    End Property
...
#Region "Shared helper methods"
    ...
    ''' <summary>
    ''' This is a shared function that can be used to get an array of WPR_Doc1Record records using a where clause.
    ''' </summary>
    Public Shared Function GetRecords(ByVal where As String) As WPR_Doc1Record()
    ...
    ''' This is a shared function that can be used to get an array of WPR_Doc1Record records using a where clause.
    ''' </summary>
    Public Shared Function GetRecords(ByVal join As BaseFilter, ByVal where As String) As WPR_Doc1Record()

        Return GetRecords(join, where, Nothing, BaseTable.MIN_PAGE_NUMBER, BaseTable.MAX_BATCH_SIZE)
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get an array of WPR_Doc1Record records using a where and order by clause.
    ''' </summary>
    Public Shared Function GetRecords( _
     ByVal where As String, _
     ByVal orderBy As OrderBy) As WPR_Doc1Record()
    ...
    ''' <summary>
    ''' This is a shared function that can be used to get an array of WPR_Doc1Record records using a where and order by clause clause with pagination.
    ''' </summary>
    Public Shared Function GetRecords( _
     ByVal where As String, _
     ByVal orderBy As OrderBy, _
     ByVal pageIndex As Integer, _
     ByVal pageSize As Integer) As WPR_Doc1Record()
        ...
        Dim recList As ArrayList =  WPR_Doc1Table.Instance.GetRecordList(join, whereFilter, Nothing, orderBy, pageIndex, pageSize)
 
        Return CType(recList.ToArray(GetType(ePortalWFApproval.Business.WPR_Doc1Record)), WPR_Doc1Record())
    End Function
    ...
    Public Shared Function GetRecords( _
     ...
     ByVal pageSize As Integer) As WPR_Doc1Record()
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = WPR_Doc1Table.Instance.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetRecords( _
     ...
     ByRef totalRecords As Integer) As WPR_Doc1Record()
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = WPR_Doc1Table.Instance.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize, totalRecords)
    ...
    Public Shared Function PostGetRecordCount(ByVal selectCols As SqlBuilderColumnSelection, ByVal join As BaseFilter, ByVal finalFilter As BaseFilter) As Integer
	      Return CInt(WPR_Doc1Table.Instance.GetCountResponseForPost(WPR_Doc1Table.Instance.TableDefinition, selectCols, join, finalFilter))
    End Function
    ...
    Public Shared Function PostGetRecordList(ByVal requestedSelection As SqlBuilderColumnSelection, ByVal workingSelection As SqlBuilderColumnSelection, _
		...
		If IsNothing(table) Then
			recList = WPR_Doc1Table.Instance.GetRecordListResponseForPost(WPR_Doc1Table.Instance.TableDefinition, requestedSelection, workingSelection, distinctSelection, join, filter, _
    ...
    Public Shared Function GetRecordCount(ByVal where As String) As Integer
        ...
        Return CInt(WPR_Doc1Table.Instance.GetRecordListCount(Nothing, whereFilter, Nothing, Nothing))
    End Function
...
''' <summary>
    ...
    Public Shared Function GetRecordCount(ByVal join As BaseFilter, ByVal where As String) As Integer
        ...
        Return CInt(WPR_Doc1Table.Instance.GetRecordListCount(join, whereFilter, Nothing, Nothing))
    End Function

    Public Shared Function GetRecordCount(ByVal where As WhereClause) As Integer
        Return CInt(WPR_Doc1Table.Instance.GetRecordListCount(Nothing, where.GetFilter(), Nothing, Nothing))
    End Function
    
      Public Shared Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
        Return CInt(WPR_Doc1Table.Instance.GetRecordListCount(join, where.GetFilter(), Nothing, Nothing))
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get a WPR_Doc1Record record using a where clause.
    ''' </summary>
    Public Shared Function GetRecord(ByVal where As String) As WPR_Doc1Record
    ...
    ''' This is a shared function that can be used to get a WPR_Doc1Record record using a where clause.
    ''' </summary>
    Public Shared Function GetRecord(ByVal join As BaseFilter, ByVal where As String) As WPR_Doc1Record
        Dim orderBy As OrderBy = Nothing
        Return GetRecord(join, where, orderBy)
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get a WPR_Doc1Record record using a where and order by clause.
    ''' </summary>
    Public Shared Function GetRecord( _
     ...
     ByVal orderBy As OrderBy) As WPR_Doc1Record
        ...
        End If
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = WPR_Doc1Table.Instance.GetRecordList(join, whereFilter, Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, BaseTable.MIN_BATCH_SIZE)

        Dim rec As WPR_Doc1Record = Nothing
        If recList.Count > 0 Then
            rec = CType(recList(0), WPR_Doc1Record)
        End If
    ...
    Public Shared Function GetValues( _
        ...
        Return WPR_Doc1Table.Instance.GetColumnValues(retCol, Nothing, where.GetFilter(), Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, maxItems)
    ...
    Public Shared Function GetValues( _
        ...
        Return WPR_Doc1Table.Instance.GetColumnValues(retCol, join, where.GetFilter(), Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, maxItems)
    ...
    Public Shared Function GetDataTable(ByVal where As String) As System.Data.DataTable
        ...
        Dim recs() As WPR_Doc1Record = GetRecords(where)
        Return WPR_Doc1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal join As BaseFilter, ByVal where As String) As System.Data.DataTable
        ...
        Dim recs() As WPR_Doc1Record = GetRecords(join, where)
        Return WPR_Doc1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal where As String, ByVal orderBy As OrderBy) As System.Data.DataTable
        ...
        Dim recs() As WPR_Doc1Record = GetRecords(where, orderBy)
        Return WPR_Doc1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal join As BaseFilter, ByVal where As String, ByVal orderBy As OrderBy) As System.Data.DataTable
        ...
        Dim recs() As WPR_Doc1Record = GetRecords(join, where, orderBy)
        Return WPR_Doc1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable( _
     ...
     ByVal pageSize As Integer) As System.Data.DataTable
        ...
        Dim recs() As WPR_Doc1Record = GetRecords(where, orderBy, pageIndex, pageSize)
        Return WPR_Doc1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable( _
     ...
     ByVal pageSize As Integer) As System.Data.DataTable
        ...
        Dim recs() As WPR_Doc1Record = GetRecords(join, where, orderBy, pageIndex, pageSize)
        Return WPR_Doc1Table.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Sub DeleteRecords(ByVal where As String)
        ...
        WPR_Doc1Table.Instance.DeleteRecordList(whereFilter)
    End Sub
    ...
    Public Shared Function Export(ByVal where As String) As String
        ...
        Return WPR_Doc1Table.Instance.ExportRecordData(whereFilter)
    End Function
    ...
    Public Shared Function GetSum( _
        ...
        Return WPR_Doc1Table.Instance.GetColumnStatistics(colSel, Nothing, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetSum( _
        ...
        Return WPR_Doc1Table.Instance.GetColumnStatistics(colSel, join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetColumns() As BaseColumn()
        Return WPR_Doc1Table.Instance.TableDefinition.Columns
    End Function
    ...
    Public Shared Function GetColumnList() As ColumnList
        Return WPR_Doc1Table.Instance.TableDefinition.ColumnList
    End Function
    ...
    Public Shared Function CreateNewRecord() As IRecord
        Return WPR_Doc1Table.Instance.CreateRecord()
    End Function
    ...
    Public Shared Function CreateNewRecord(ByVal tempId As String) As IRecord
        Return WPR_Doc1Table.Instance.CreateRecord(tempId)
    End Function
    ...
    Public Shared Function GetColumn(ByVal uniqueColumnName As String) As BaseColumn
        Dim column As BaseColumn = WPR_Doc1Table.Instance.TableDefinition.ColumnList.GetByUniqueName(uniqueColumnName)
        Return column
    End Function     
    ...
    Public Shared Function GetColumnByName(ByVal name As String) As BaseColumn
        Dim column As BaseColumn = WPR_Doc1Table.Instance.TableDefinition.ColumnList.GetByInternalName(name)
        Return column
    End Function       
        

    ' Convenience method for getting a record using a string-based record identifier
    Public Shared Function GetRecord(ByVal id As String, ByVal bMutable As Boolean) As WPR_Doc1Record
        Return CType(WPR_Doc1Table.Instance.GetRecordData(id, bMutable), WPR_Doc1Record)
    End Function

    ' Convenience method for getting a record using a KeyValue record identifier
    Public Shared Function GetRecord(ByVal id As KeyValue, ByVal bMutable As Boolean) As WPR_Doc1Record
        Return CType(WPR_Doc1Table.Instance.GetRecordData(id, bMutable), WPR_Doc1Record)
    End Function
    ...
    Public Shared Sub DeleteRecord(ByVal kv As KeyValue)
        WPR_Doc1Table.Instance.DeleteOneRecord(kv)
    End Sub
    ...
    Public Shared Function DoesRecordExist(ByVal kv As KeyValue) As Boolean
        ...
        Try
            WPR_Doc1Table.GetRecord(kv, False)
    ...
    Public Shared Function GetPrimaryKeyColumns() As ColumnList
        If (Not IsNothing(WPR_Doc1Table.Instance.TableDefinition.PrimaryKey)) Then
            Return WPR_Doc1Table.Instance.TableDefinition.PrimaryKey.Columns
        Else
            Return Nothing
        End If
    End Function
    ...
    Public Shared Function GetKeyValue(ByVal key As Object) As KeyValue
        ...
        If (Not (IsNothing(WPR_Doc1Table.Instance.TableDefinition.PrimaryKey))) Then
            ...
            isCompositePrimaryKey = WPR_Doc1Table.Instance.TableDefinition.PrimaryKey.IsCompositeKey
            ...
            If ((isCompositePrimaryKey) AndAlso (key.GetType.IsArray())) Then
                ...
                If (Not IsNothing(keyArray)) Then
                    ...
                    Dim pkColumns As ColumnList = WPR_Doc1Table.Instance.TableDefinition.PrimaryKey.Columns
                    Dim pkColumn As BaseColumn
                    Dim index As Integer = 0
                    For Each pkColumn In pkColumns
                        Dim keyString As String = CType(keyArray.GetValue(index), String)
                        If (WPR_Doc1Table.Instance.TableDefinition.TableType = BaseClasses.Data.TableDefinition.TableTypes.Virtual) Then
            ...
            Else
                ...
                kv = WPR_Doc1Table.Instance.TableDefinition.PrimaryKey.ParseValue(CType(key, String))
            End If
        End If
        Return kv
    End Function    
	...
	Public Shared Function GetDFKA(ByVal rec As BaseRecord, ByVal col As BaseColumn) As String
	    Dim fkColumn As ForeignKey = WPR_Doc1Table.Instance.TableDefinition.GetExpandableNonCompositeForeignKey(col)
