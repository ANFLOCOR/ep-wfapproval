...
' Your customizations should be made in WFinRep_Step_StepDetailRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="WFinRep_Step_StepDetailRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWFinRep_Step_StepDetailRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As WFinRep_Step_StepDetailView = WFinRep_Step_StepDetailView.Instance
    ...
    Public Overridable Sub WFinRep_Step_StepDetailRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim WFinRep_Step_StepDetailRec As WFinRep_Step_StepDetailRecord = CType(sender,WFinRep_Step_StepDetailRecord)
        If Not WFinRep_Step_StepDetailRec Is Nothing AndAlso Not WFinRep_Step_StepDetailRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub WFinRep_Step_StepDetailRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
