...
''' <summary>
''' The generated superclass for the <see cref="SysSetupWASSEmail1Record"></see> class.
''' </summary>
''' <remarks>
...
''' <seealso cref="SysSetupWASSEmail1Record"></seealso>

<Serializable()> Public Class BaseSysSetupWASSEmail1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As SysSetupWASSEmail1Table = SysSetupWASSEmail1Table.Instance
    ...
    Public Overridable Sub SysSetupWASSEmail1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim SysSetupWASSEmail1Rec As SysSetupWASSEmail1Record = CType(sender,SysSetupWASSEmail1Record)
        Validate_Inserting()
        If Not SysSetupWASSEmail1Rec Is Nothing AndAlso Not SysSetupWASSEmail1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub SysSetupWASSEmail1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub SysSetupWASSEmail1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
...
#Region "Convenience methods to get/set values of fields"
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's SysSetupWASSEmail_.WE_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's SysSetupWASSEmail_.WE_U_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's SysSetupWASSEmail_.WE_U_ID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's SysSetupWASSEmail_.WE_Directory field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's SysSetupWASSEmail_.WE_Directory field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's SysSetupWASSEmail_.WE_Site field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's SysSetupWASSEmail_.WE_Site field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's SysSetupWASSEmail_.WE_Template field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's SysSetupWASSEmail_.WE_Template field.
	''' </summary>
...
#Region "Convenience methods to get field names"
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's SysSetupWASSEmail_.WE_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's SysSetupWASSEmail_.WE_U_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's SysSetupWASSEmail_.WE_Directory field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's SysSetupWASSEmail_.WE_Site field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's SysSetupWASSEmail_.WE_Template field.
	''' </summary>
