...
''' <summary>
''' The generated superclass for the <see cref="WPR_Doc_StatusRecord"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="WPR_Doc_StatusTable"></see> class.
''' </remarks>
''' <seealso cref="WPR_Doc_StatusTable"></seealso>
''' <seealso cref="WPR_Doc_StatusRecord"></seealso>

<Serializable()> Public Class BaseWPR_Doc_StatusRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WPR_Doc_StatusTable = WPR_Doc_StatusTable.Instance
    ...
    Public Overridable Sub WPR_Doc_StatusRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WPR_Doc_StatusRec As WPR_Doc_StatusRecord = CType(sender,WPR_Doc_StatusRecord)
        Validate_Inserting()
        If Not WPR_Doc_StatusRec Is Nothing AndAlso Not WPR_Doc_StatusRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WPR_Doc_StatusRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WPR_Doc_StatusRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
