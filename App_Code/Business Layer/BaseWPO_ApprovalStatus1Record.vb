...
''' <summary>
''' The generated superclass for the <see cref="WPO_ApprovalStatus1Record"></see> class.
''' </summary>
''' <remarks>
...
''' <seealso cref="WPO_ApprovalStatus1Record"></seealso>

<Serializable()> Public Class BaseWPO_ApprovalStatus1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WPO_ApprovalStatus1Table = WPO_ApprovalStatus1Table.Instance
    ...
    Public Overridable Sub WPO_ApprovalStatus1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WPO_ApprovalStatus1Rec As WPO_ApprovalStatus1Record = CType(sender,WPO_ApprovalStatus1Record)
        Validate_Inserting()
        If Not WPO_ApprovalStatus1Rec Is Nothing AndAlso Not WPO_ApprovalStatus1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WPO_ApprovalStatus1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WPO_ApprovalStatus1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
...
#Region "Convenience methods to get/set values of fields"
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's WPO_ApprovalStatus_.WPO_STAT_CD field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's WPO_ApprovalStatus_.WPO_STAT_CD field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's WPO_ApprovalStatus_.WPO_STAT_DESC field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's WPO_ApprovalStatus_.WPO_STAT_DESC field.
	''' </summary>
...
#Region "Convenience methods to get field names"
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's WPO_ApprovalStatus_.WPO_STAT_CD field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's WPO_ApprovalStatus_.WPO_STAT_DESC field.
	''' </summary>
