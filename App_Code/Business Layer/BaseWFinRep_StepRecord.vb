...
''' <summary>
''' The generated superclass for the <see cref="WFinRep_StepRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWFinRep_StepRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WFinRep_StepTable = WFinRep_StepTable.Instance
    ...
    Public Overridable Sub WFinRep_StepRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WFinRep_StepRec As WFinRep_StepRecord = CType(sender,WFinRep_StepRecord)
        Validate_Inserting()
        If Not WFinRep_StepRec Is Nothing AndAlso Not WFinRep_StepRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WFinRep_StepRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WFinRep_StepRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
