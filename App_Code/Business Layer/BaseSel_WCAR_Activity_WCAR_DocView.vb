...
''' <summary>
''' The generated superclass for the <see cref="Sel_WCAR_Activity_WCAR_DocView"></see> class.
''' Provides access to the schema information and record data of a database table or view named DatabaseANFLO-WF%dbo.sel_WCAR_Activity_WCAR_Doc.
''' </summary>
''' <remarks>
...
''' <see cref="Sel_WCAR_Activity_WCAR_DocView.Instance">Sel_WCAR_Activity_WCAR_DocView.Instance</see>.
''' </para>
''' </remarks>
''' <seealso cref="Sel_WCAR_Activity_WCAR_DocView"></seealso>

<Serializable()> Public Class BaseSel_WCAR_Activity_WCAR_DocView
    Inherits PrimaryKeyTable
    

    Private ReadOnly TableDefinitionString As String = Sel_WCAR_Activity_WCAR_DocDefinition.GetXMLString()
    ...
    Protected Overridable Sub Initialize()
        ...
        Me.TableDefinition.TableClassName = System.Reflection.Assembly.CreateQualifiedName("App_Code", "ePortalWFApproval.Business.Sel_WCAR_Activity_WCAR_DocView")
        def.InitializeTableDefinition(Me.TableDefinition)
        Me.ConnectionName = def.GetConnectionName()
        Me.RecordClassName = System.Reflection.Assembly.CreateQualifiedName("App_Code", "ePortalWFApproval.Business.Sel_WCAR_Activity_WCAR_DocRecord")
        Me.ApplicationName = "App_Code"
        Me.DataAdapter = New Sel_WCAR_Activity_WCAR_DocSqlView()
        Directcast(Me.DataAdapter, Sel_WCAR_Activity_WCAR_DocSqlView).ConnectionName = Me.ConnectionName
...
#Region "Properties for columns"
    ...
    Public Shared ReadOnly Property WCA_ID() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCA_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCA_WS_ID() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCA_WS_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCA_WSD_ID() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCA_WSD_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCA_WDT_ID() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCA_WDT_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCA_W_U_ID() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCA_W_U_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCA_WCD_ID() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCA_WCD_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCA_Status() As BaseClasses.Data.StringColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCA_StatusColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCA_Date_Assign() As BaseClasses.Data.DateColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCA_Date_AssignColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCA_Date_Action() As BaseClasses.Data.DateColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCA_Date_ActionColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCA_Remark() As BaseClasses.Data.StringColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCA_RemarkColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_No() As BaseClasses.Data.StringColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCD_NoColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Project_Title() As BaseClasses.Data.ClobColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCD_Project_TitleColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Exp_Total() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCD_Exp_TotalColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCA_Is_Done() As BaseClasses.Data.BooleanColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCA_Is_DoneColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_U_ID() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCD_U_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Remark() As BaseClasses.Data.ClobColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCD_RemarkColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_WCur_ID() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCD_WCur_IDColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_Request_Date() As BaseClasses.Data.DateColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCD_Request_DateColumn
        End Get
    End Property
    ''' <summary>
    ...
    Public Shared ReadOnly Property WCD_C_ID() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.WCD_C_IDColumn
        End Get
    End Property
    ''' <summary>
    ''' This is a convenience property that provides direct access to the table's sel_WCAR_Activity_WCAR_Doc_.SSC_CompanyID column object.
    ''' </summary>
    ...
    Public Shared ReadOnly Property SSC_CompanyID() As BaseClasses.Data.NumberColumn
        Get
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.SSC_CompanyIDColumn
        End Get
    End Property
...
#Region "Shared helper methods"
    ...
    ''' <summary>
    ''' This is a shared function that can be used to get an array of Sel_WCAR_Activity_WCAR_DocRecord records using a where clause.
    ''' </summary>
    Public Shared Function GetRecords(ByVal where As String) As Sel_WCAR_Activity_WCAR_DocRecord()
    ...
    ''' This is a shared function that can be used to get an array of Sel_WCAR_Activity_WCAR_DocRecord records using a where clause.
    ''' </summary>
    Public Shared Function GetRecords(ByVal join As BaseFilter, ByVal where As String) As Sel_WCAR_Activity_WCAR_DocRecord()

        Return GetRecords(join, where, Nothing, BaseTable.MIN_PAGE_NUMBER, BaseTable.MAX_BATCH_SIZE)
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get an array of Sel_WCAR_Activity_WCAR_DocRecord records using a where and order by clause.
    ''' </summary>
    Public Shared Function GetRecords( _
     ByVal where As String, _
     ByVal orderBy As OrderBy) As Sel_WCAR_Activity_WCAR_DocRecord()
    ...
    ''' <summary>
    ''' This is a shared function that can be used to get an array of Sel_WCAR_Activity_WCAR_DocRecord records using a where and order by clause clause with pagination.
    ''' </summary>
    Public Shared Function GetRecords( _
     ByVal where As String, _
     ...
     ByVal pageSize As Integer) As Sel_WCAR_Activity_WCAR_DocRecord()
        ...
        Dim recList As ArrayList =  Sel_WCAR_Activity_WCAR_DocView.Instance.GetRecordList(join, whereFilter, Nothing, orderBy, pageIndex, pageSize)
 
        Return CType(recList.ToArray(GetType(ePortalWFApproval.Business.Sel_WCAR_Activity_WCAR_DocRecord)), Sel_WCAR_Activity_WCAR_DocRecord())
    End Function
    ...
    Public Shared Function GetRecords( _
     ...
     ByVal pageSize As Integer) As Sel_WCAR_Activity_WCAR_DocRecord()
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = Sel_WCAR_Activity_WCAR_DocView.Instance.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetRecords( _
     ...
     ByRef totalRecords As Integer) As Sel_WCAR_Activity_WCAR_DocRecord()
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = Sel_WCAR_Activity_WCAR_DocView.Instance.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize, totalRecords)
    ...
    Public Shared Function PostGetRecordCount(ByVal selectCols As SqlBuilderColumnSelection, ByVal join As BaseFilter, ByVal finalFilter As BaseFilter) As Integer
	      Return CInt(Sel_WCAR_Activity_WCAR_DocView.Instance.GetCountResponseForPost(Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition, selectCols, join, finalFilter))
    End Function
    ...
    Public Shared Function PostGetRecordList(ByVal requestedSelection As SqlBuilderColumnSelection, ByVal workingSelection As SqlBuilderColumnSelection, _
		...
		If IsNothing(table) Then
			recList = Sel_WCAR_Activity_WCAR_DocView.Instance.GetRecordListResponseForPost(Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition, requestedSelection, workingSelection, distinctSelection, join, filter, _
    ...
    Public Shared Function GetRecordCount(ByVal where As String) As Integer
        ...
        Return CInt(Sel_WCAR_Activity_WCAR_DocView.Instance.GetRecordListCount(Nothing, whereFilter, Nothing, Nothing))
    End Function
...
''' <summary>
    ...
    Public Shared Function GetRecordCount(ByVal join As BaseFilter, ByVal where As String) As Integer
        ...
        Return CInt(Sel_WCAR_Activity_WCAR_DocView.Instance.GetRecordListCount(join, whereFilter, Nothing, Nothing))
    End Function

    Public Shared Function GetRecordCount(ByVal where As WhereClause) As Integer
        Return CInt(Sel_WCAR_Activity_WCAR_DocView.Instance.GetRecordListCount(Nothing, where.GetFilter(), Nothing, Nothing))
    End Function
    
      Public Shared Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
        Return CInt(Sel_WCAR_Activity_WCAR_DocView.Instance.GetRecordListCount(join, where.GetFilter(), Nothing, Nothing))
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get a Sel_WCAR_Activity_WCAR_DocRecord record using a where clause.
    ''' </summary>
    Public Shared Function GetRecord(ByVal where As String) As Sel_WCAR_Activity_WCAR_DocRecord
    ...
    ''' This is a shared function that can be used to get a Sel_WCAR_Activity_WCAR_DocRecord record using a where clause.
    ''' </summary>
    Public Shared Function GetRecord(ByVal join As BaseFilter, ByVal where As String) As Sel_WCAR_Activity_WCAR_DocRecord
        Dim orderBy As OrderBy = Nothing
        Return GetRecord(join, where, orderBy)
    End Function

    ''' <summary>
    ''' This is a shared function that can be used to get a Sel_WCAR_Activity_WCAR_DocRecord record using a where and order by clause.
    ''' </summary>
    Public Shared Function GetRecord( _
     ...
     ByVal orderBy As OrderBy) As Sel_WCAR_Activity_WCAR_DocRecord
        ...
        End If
        Dim join As BaseClasses.Data.BaseFilter = Nothing
        Dim recList As ArrayList = Sel_WCAR_Activity_WCAR_DocView.Instance.GetRecordList(join, whereFilter, Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, BaseTable.MIN_BATCH_SIZE)

        Dim rec As Sel_WCAR_Activity_WCAR_DocRecord = Nothing
        If recList.Count > 0 Then
            rec = CType(recList(0), Sel_WCAR_Activity_WCAR_DocRecord)
        End If
    ...
    Public Shared Function GetValues( _
        ...
        Return Sel_WCAR_Activity_WCAR_DocView.Instance.GetColumnValues(retCol, Nothing, where.GetFilter(), Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, maxItems)
    ...
    Public Shared Function GetValues( _
        ...
        Return Sel_WCAR_Activity_WCAR_DocView.Instance.GetColumnValues(retCol, join, where.GetFilter(), Nothing, orderBy, BaseTable.MIN_PAGE_NUMBER, maxItems)
    ...
    Public Shared Function GetDataTable(ByVal where As String) As System.Data.DataTable
        ...
        Dim recs() As Sel_WCAR_Activity_WCAR_DocRecord = GetRecords(where)
        Return Sel_WCAR_Activity_WCAR_DocView.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal join As BaseFilter, ByVal where As String) As System.Data.DataTable
        ...
        Dim recs() As Sel_WCAR_Activity_WCAR_DocRecord = GetRecords(join, where)
        Return Sel_WCAR_Activity_WCAR_DocView.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal where As String, ByVal orderBy As OrderBy) As System.Data.DataTable
        ...
        Dim recs() As Sel_WCAR_Activity_WCAR_DocRecord = GetRecords(where, orderBy)
        Return Sel_WCAR_Activity_WCAR_DocView.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable(ByVal join As BaseFilter, ByVal where As String, ByVal orderBy As OrderBy) As System.Data.DataTable
        ...
        Dim recs() As Sel_WCAR_Activity_WCAR_DocRecord = GetRecords(join, where, orderBy)
        Return Sel_WCAR_Activity_WCAR_DocView.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable( _
     ...
     ByVal pageSize As Integer) As System.Data.DataTable
        ...
        Dim recs() As Sel_WCAR_Activity_WCAR_DocRecord = GetRecords(where, orderBy, pageIndex, pageSize)
        Return Sel_WCAR_Activity_WCAR_DocView.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Function GetDataTable( _
     ...
     ByVal pageSize As Integer) As System.Data.DataTable
        ...
        Dim recs() As Sel_WCAR_Activity_WCAR_DocRecord = GetRecords(join, where, orderBy, pageIndex, pageSize)
        Return Sel_WCAR_Activity_WCAR_DocView.Instance.CreateDataTable(recs, Nothing)
    End Function
    ...
    Public Shared Sub DeleteRecords(ByVal where As String)
        ...
        Sel_WCAR_Activity_WCAR_DocView.Instance.DeleteRecordList(whereFilter)
    End Sub
    ...
    Public Shared Function Export(ByVal where As String) As String
        ...
        Return Sel_WCAR_Activity_WCAR_DocView.Instance.ExportRecordData(whereFilter)
    End Function
    ...
    Public Shared Function GetSum( _
        ...
        Return Sel_WCAR_Activity_WCAR_DocView.Instance.GetColumnStatistics(colSel, Nothing, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetSum( _
        ...
        Return Sel_WCAR_Activity_WCAR_DocView.Instance.GetColumnStatistics(colSel, join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetColumns() As BaseColumn()
        Return Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition.Columns
    End Function
    ...
    Public Shared Function GetColumnList() As ColumnList
        Return Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition.ColumnList
    End Function
    ...
    Public Shared Function CreateNewRecord() As IRecord
        Return Sel_WCAR_Activity_WCAR_DocView.Instance.CreateRecord()
    End Function
    ...
    Public Shared Function CreateNewRecord(ByVal tempId As String) As IRecord
        Return Sel_WCAR_Activity_WCAR_DocView.Instance.CreateRecord(tempId)
    End Function
    ...
    Public Shared Function GetColumn(ByVal uniqueColumnName As String) As BaseColumn
        Dim column As BaseColumn = Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition.ColumnList.GetByUniqueName(uniqueColumnName)
        Return column
    End Function     
    ...
    Public Shared Function GetColumnByName(ByVal name As String) As BaseColumn
        Dim column As BaseColumn = Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition.ColumnList.GetByInternalName(name)
        Return column
    End Function       
        

    ' Convenience method for getting a record using a string-based record identifier
    Public Shared Function GetRecord(ByVal id As String, ByVal bMutable As Boolean) As Sel_WCAR_Activity_WCAR_DocRecord
        Return CType(Sel_WCAR_Activity_WCAR_DocView.Instance.GetRecordData(id, bMutable), Sel_WCAR_Activity_WCAR_DocRecord)
    End Function

    ' Convenience method for getting a record using a KeyValue record identifier
    Public Shared Function GetRecord(ByVal id As KeyValue, ByVal bMutable As Boolean) As Sel_WCAR_Activity_WCAR_DocRecord
        Return CType(Sel_WCAR_Activity_WCAR_DocView.Instance.GetRecordData(id, bMutable), Sel_WCAR_Activity_WCAR_DocRecord)
    End Function
    ...
    Public Overloads Function NewRecord( _
        ...
        ByVal SSC_CompanyIDValue As String _
    ) As KeyValue
        ...
        rec.SetString(SSC_CompanyIDValue, SSC_CompanyIDColumn)
    ...
    Public Shared Sub DeleteRecord(ByVal kv As KeyValue)
        Sel_WCAR_Activity_WCAR_DocView.Instance.DeleteOneRecord(kv)
    End Sub
    ...
    Public Shared Function DoesRecordExist(ByVal kv As KeyValue) As Boolean
        ...
        Try
            Sel_WCAR_Activity_WCAR_DocView.GetRecord(kv, False)
    ...
    Public Shared Function GetPrimaryKeyColumns() As ColumnList
        If (Not IsNothing(Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition.PrimaryKey)) Then
            Return Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition.PrimaryKey.Columns
        Else
            Return Nothing
        End If
    End Function
    ...
    Public Shared Function GetKeyValue(ByVal key As Object) As KeyValue
        ...
        If (Not (IsNothing(Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition.PrimaryKey))) Then
            ...
            isCompositePrimaryKey = Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition.PrimaryKey.IsCompositeKey
            ...
            If ((isCompositePrimaryKey) AndAlso (key.GetType.IsArray())) Then
                ...
                If (Not IsNothing(keyArray)) Then
                    ...
                    Dim pkColumns As ColumnList = Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition.PrimaryKey.Columns
                    Dim pkColumn As BaseColumn
                    Dim index As Integer = 0
                    For Each pkColumn In pkColumns
                        Dim keyString As String = CType(keyArray.GetValue(index), String)
                        If (Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition.TableType = BaseClasses.Data.TableDefinition.TableTypes.Virtual) Then
            ...
            Else
                ...
                kv = Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition.PrimaryKey.ParseValue(CType(key, String))
            End If
        End If
        Return kv
    End Function    
	...
	Public Shared Function GetDFKA(ByVal rec As BaseRecord, ByVal col As BaseColumn) As String
	    Dim fkColumn As ForeignKey = Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition.GetExpandableNonCompositeForeignKey(col)
