...
''' <summary>
''' The generated superclass for the <see cref="WPO_CARNo_QWFRecord"></see> class.
''' </summary>
''' <remarks>
...
''' <seealso cref="WPO_CARNo_QWFRecord"></seealso>

<Serializable()> Public Class BaseWPO_CARNo_QWFRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WPO_CARNo_QWFView = WPO_CARNo_QWFView.Instance
    ...
    Public Overridable Sub WPO_CARNo_QWFRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WPO_CARNo_QWFRec As WPO_CARNo_QWFRecord = CType(sender,WPO_CARNo_QWFRecord)
        Validate_Inserting()
        If Not WPO_CARNo_QWFRec Is Nothing AndAlso Not WPO_CARNo_QWFRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WPO_CARNo_QWFRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WPO_CARNo_QWFRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
