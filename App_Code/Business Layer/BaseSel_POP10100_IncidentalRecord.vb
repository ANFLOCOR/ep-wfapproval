...
''' <summary>
''' The generated superclass for the <see cref="Sel_POP10100_IncidentalRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_POP10100_IncidentalRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_POP10100_IncidentalView = Sel_POP10100_IncidentalView.Instance
    ...
    Public Overridable Sub Sel_POP10100_IncidentalRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Sel_POP10100_IncidentalRec As Sel_POP10100_IncidentalRecord = CType(sender,Sel_POP10100_IncidentalRecord)
        Validate_Inserting()
        If Not Sel_POP10100_IncidentalRec Is Nothing AndAlso Not Sel_POP10100_IncidentalRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Sel_POP10100_IncidentalRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Sel_POP10100_IncidentalRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
