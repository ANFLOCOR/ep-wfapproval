...
''' <summary>
''' The generated superclass for the <see cref="WPO_Activity1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="WPO_Activity1Table"></see> class.
''' </remarks>
''' <seealso cref="WPO_Activity1Table"></seealso>
''' <seealso cref="WPO_Activity1Record"></seealso>

<Serializable()> Public Class BaseWPO_Activity1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WPO_Activity1Table = WPO_Activity1Table.Instance
    ...
    Public Overridable Sub WPO_Activity1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WPO_Activity1Rec As WPO_Activity1Record = CType(sender,WPO_Activity1Record)
        Validate_Inserting()
        If Not WPO_Activity1Rec Is Nothing AndAlso Not WPO_Activity1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WPO_Activity1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WPO_Activity1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
