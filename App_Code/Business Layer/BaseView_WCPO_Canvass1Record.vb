...
' Your customizations should be made in View_WCPO_Canvass1Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="View_WCPO_Canvass1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="View_WCPO_Canvass1View"></see> class.
''' </remarks>
''' <seealso cref="View_WCPO_Canvass1View"></seealso>
''' <seealso cref="View_WCPO_Canvass1Record"></seealso>

<Serializable()> Public Class BaseView_WCPO_Canvass1Record
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As View_WCPO_Canvass1View = View_WCPO_Canvass1View.Instance
    ...
    Public Overridable Sub View_WCPO_Canvass1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim View_WCPO_Canvass1Rec As View_WCPO_Canvass1Record = CType(sender,View_WCPO_Canvass1Record)
        If Not View_WCPO_Canvass1Rec Is Nothing AndAlso Not View_WCPO_Canvass1Rec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub View_WCPO_Canvass1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
