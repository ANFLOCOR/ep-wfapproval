...
''' Also provides access to the <see cref="WFinRep_Activity1Table"></see> that each record is associated with.
''' </summary>
''' <remarks>
''' </remarks>
''' <seealso cref="WFinRep_Activity1Table"></seealso>

<Serializable()> Public Class WFinRep_Activity1Record
	Inherits BaseWFinRep_Activity1Record
