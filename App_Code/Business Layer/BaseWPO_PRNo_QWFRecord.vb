...
''' <summary>
''' The generated superclass for the <see cref="WPO_PRNo_QWFRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWPO_PRNo_QWFRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WPO_PRNo_QWFView = WPO_PRNo_QWFView.Instance
    ...
    Public Overridable Sub WPO_PRNo_QWFRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WPO_PRNo_QWFRec As WPO_PRNo_QWFRecord = CType(sender,WPO_PRNo_QWFRecord)
        Validate_Inserting()
        If Not WPO_PRNo_QWFRec Is Nothing AndAlso Not WPO_PRNo_QWFRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WPO_PRNo_QWFRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WPO_PRNo_QWFRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
