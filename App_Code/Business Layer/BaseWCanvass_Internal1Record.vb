...
''' <summary>
''' The generated superclass for the <see cref="WCanvass_Internal1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="WCanvass_Internal1Table"></see> class.
''' </remarks>
''' <seealso cref="WCanvass_Internal1Table"></seealso>
''' <seealso cref="WCanvass_Internal1Record"></seealso>

<Serializable()> Public Class BaseWCanvass_Internal1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WCanvass_Internal1Table = WCanvass_Internal1Table.Instance
    ...
    Public Overridable Sub WCanvass_Internal1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WCanvass_Internal1Rec As WCanvass_Internal1Record = CType(sender,WCanvass_Internal1Record)
        Validate_Inserting()
        If Not WCanvass_Internal1Rec Is Nothing AndAlso Not WCanvass_Internal1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WCanvass_Internal1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WCanvass_Internal1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
