...
''' <summary>
''' The generated superclass for the <see cref="WCanvass_PO_Map_Temp1Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWCanvass_PO_Map_Temp1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WCanvass_PO_Map_Temp1Table = WCanvass_PO_Map_Temp1Table.Instance
    ...
    Public Overridable Sub WCanvass_PO_Map_Temp1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WCanvass_PO_Map_Temp1Rec As WCanvass_PO_Map_Temp1Record = CType(sender,WCanvass_PO_Map_Temp1Record)
        Validate_Inserting()
        If Not WCanvass_PO_Map_Temp1Rec Is Nothing AndAlso Not WCanvass_PO_Map_Temp1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WCanvass_PO_Map_Temp1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WCanvass_PO_Map_Temp1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
