...
''' <summary>
''' The generated superclass for the <see cref="WFinRep_ReportType1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="WFinRep_ReportType1Table"></see> class.
''' </remarks>
''' <seealso cref="WFinRep_ReportType1Table"></seealso>
''' <seealso cref="WFinRep_ReportType1Record"></seealso>

<Serializable()> Public Class BaseWFinRep_ReportType1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WFinRep_ReportType1Table = WFinRep_ReportType1Table.Instance
    ...
    Public Overridable Sub WFinRep_ReportType1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WFinRep_ReportType1Rec As WFinRep_ReportType1Record = CType(sender,WFinRep_ReportType1Record)
        Validate_Inserting()
        If Not WFinRep_ReportType1Rec Is Nothing AndAlso Not WFinRep_ReportType1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WFinRep_ReportType1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WFinRep_ReportType1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
