...
' Inquiry_WCanvass_Quotation_Internal_File.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.Inquiry_WCanvass_Quotation_Internal_File
...
Public Class WCanvass_Quotation_InternalTableControl
    ...
    ' the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
		...
		Public Overrides Function CreateWhereClause() As WhereClause
            ...
            wc.iAND(WCanvass_Quotation_InternalTable.WCQI_WCI_ID, BaseFilter.ComparisonOperator.EqualsTo, sParam1)
            wc.iAND(WCanvass_Quotation_InternalTable.WCQI_PM00200_Vendor_ID, BaseFilter.ComparisonOperator.EqualsTo, sParam2)
...
' Base class for the WCanvass_Quotation_InternalTableControlRow control on the Inquiry_WCanvass_Quotation_Internal_File page.
...
' Base class for the WCanvass_Quotation_InternalTableControl control on the Inquiry_WCanvass_Quotation_Internal_File page.
