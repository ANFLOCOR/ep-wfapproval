...
' Inquiry_POP30300_POP30310_Item.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.Inquiry_POP30300_POP30310_Item
...
Public Class Sel_POP30300_POP30310TableControl
    ...
    ' the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
		...
		Public Overrides Function CreateWhereClause() As WhereClause
            Sel_POP30300_POP30310View.Instance.InnerFilter = Nothing
            Dim wc As WhereClause = New WhereClause()
            Dim sParam As String = CStr(Me.Page.Request.QueryString("ItemNo"))

            wc.iAND(Sel_POP30300_POP30310View.Company_ID, BaseFilter.ComparisonOperator.EqualsTo, System.Web.HttpContext.Current.Session("CI_C_ID").ToString())
            wc.iAND(Sel_POP30300_POP30310View.ITEMNMBR, BaseFilter.ComparisonOperator.EqualsTo, sParam)
...
' Base class for the Sel_POP30300_POP30310TableControlRow control on the Inquiry_POP30300_POP30310_Item page.
...
Public Class BaseSel_POP30300_POP30310TableControlRow
        ...
        Public Overridable Sub LoadData()        
            ...
            ' Load the data from the database into the DataSource DatabaseANFLO-WF%dbo.sel_POP30300_POP30310 record.
            ...
            Me.DataSource = New Sel_POP30300_POP30310Record()
        ...
        Public Overridable Sub SetEXTDCOST()
            ...
            ' DatabaseANFLO-WF%dbo.sel_POP30300_POP30310 database record.

            ' Me.DataSource is the DatabaseANFLO-WF%dbo.sel_POP30300_POP30310 record retrieved from the database.
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.EXTDCOSTSpecified Then
                ...
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP30310View.EXTDCOST)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.EXTDCOST.Text = Sel_POP30300_POP30310View.EXTDCOST.Format(Sel_POP30300_POP30310View.EXTDCOST.DefaultValue)
        ...
        Public Overridable Sub SetQty()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.QtySpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP30310View.Qty)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.Qty.Text = Sel_POP30300_POP30310View.Qty.Format(Sel_POP30300_POP30310View.Qty.DefaultValue)
        ...
        Public Overridable Sub Setreceiptdate()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.receiptdateSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP30310View.receiptdate, "d")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.receiptdate.Text = Sel_POP30300_POP30310View.receiptdate.Format(Sel_POP30300_POP30310View.receiptdate.DefaultValue, "d")
        ...
        Public Overridable Sub SetUNITCOST()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.UNITCOSTSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP30310View.UNITCOST)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.UNITCOST.Text = Sel_POP30300_POP30310View.UNITCOST.Format(Sel_POP30300_POP30310View.UNITCOST.DefaultValue)
        ...
        Public Overridable Sub SetUOFM()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.UOFMSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP30310View.UOFM)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.UOFM.Text = Sel_POP30300_POP30310View.UOFM.Format(Sel_POP30300_POP30310View.UOFM.DefaultValue)
        ...
        Public Overridable Sub SetVENDNAME()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.VENDNAMESpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP30310View.VENDNAME)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.VENDNAME.Text = Sel_POP30300_POP30310View.VENDNAME.Format(Sel_POP30300_POP30310View.VENDNAME.DefaultValue)
        ...
        Public Overridable Sub SetVENDORID()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.VENDORIDSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP30310View.VENDORID)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.VENDORID.Text = Sel_POP30300_POP30310View.VENDORID.Format(Sel_POP30300_POP30310View.VENDORID.DefaultValue)
        ...
        Public Property DataSource() As Sel_POP30300_POP30310Record
            Get
                Return DirectCast(MyBase._DataSource, Sel_POP30300_POP30310Record)
            End Get
            Set(ByVal value As Sel_POP30300_POP30310Record)
...
#Region "Helper Functions"
        ...
        Public Overrides Overloads Function EvaluateExpressions(ByVal url As String, ByVal arg As String, ByVal bEncrypt As Boolean) As String
            ...
            Dim rec As Sel_POP30300_POP30310Record = Nothing
        ...
        Public Overridable Function GetRecord() As Sel_POP30300_POP30310Record
...
' Base class for the Sel_POP30300_POP30310TableControl control on the Inquiry_POP30300_POP30310_Item page.
...
Public Class BaseSel_POP30300_POP30310TableControl
    ...
    ' Setup default pagination settings.
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            ' Setup the sorting events.
              ...
              AddHandler Me.EXTDCOSTLabel.Click, AddressOf EXTDCOSTLabel_Click
            
              AddHandler Me.QtyLabel.Click, AddressOf QtyLabel_Click
            
              AddHandler Me.receiptdateLabel.Click, AddressOf receiptdateLabel_Click
            
              AddHandler Me.UNITCOSTLabel.Click, AddressOf UNITCOSTLabel_Click
            
              AddHandler Me.UOFMLabel.Click, AddressOf UOFMLabel_Click
            
              AddHandler Me.VENDNAMELabel.Click, AddressOf VENDNAMELabel_Click
            
              AddHandler Me.VENDORIDLabel.Click, AddressOf VENDORIDLabel_Click
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                If wc IsNot Nothing AndAlso Not wc.RunQuery Then
                    ...
                    Me.DataSource = DirectCast(alist.ToArray(GetType(Sel_POP30300_POP30310Record)), Sel_POP30300_POP30310Record())
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    ...
                    For Each rc As Sel_POP30300_POP30310TableControlRow In Me.GetRecordControls()
                        ...
                        End If
                    Next
                    Me.DataSource = DirectCast(postdata.ToArray(GetType(Sel_POP30300_POP30310Record)), Sel_POP30300_POP30310Record())
        ...
        Public Overridable Function GetRecords( _
            ...
            ByVal pageSize As Integer) As Sel_POP30300_POP30310Record()
            ...
            ' selCols.Add(Sel_POP30300_POP30310View.Column1, True)         
            ' selCols.Add(Sel_POP30300_POP30310View.Column2, True)          
            ' selCols.Add(Sel_POP30300_POP30310View.Column3, True)    
            ...
            If selCols.Count = 0 Then                    
                ...
                Return Sel_POP30300_POP30310View.GetRecords(join, where, orderBy, Me.PageIndex, Me.PageSize)
                 
            Else
                Dim databaseTable As New Sel_POP30300_POP30310View
                ...
                Return CType(recList.ToArray(GetType(Sel_POP30300_POP30310Record)), Sel_POP30300_POP30310Record())
            End If            
        ...
        Public Overridable Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
            ...
            If selCols.Count = 0 Then                    
                ...
                Return Sel_POP30300_POP30310View.GetRecordCount(join, where)
    ...
    Dim recControl As Sel_POP30300_POP30310TableControlRow = DirectCast(repItem.FindControl("Sel_POP30300_POP30310TableControlRow"), Sel_POP30300_POP30310TableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        Dim rec As Sel_POP30300_POP30310Record = New Sel_POP30300_POP30310Record()
        
                        If recControl.EXTDCOST.Text <> "" Then
                            rec.Parse(recControl.EXTDCOST.Text, Sel_POP30300_POP30310View.EXTDCOST)
                        End If
                        If recControl.Qty.Text <> "" Then
                            rec.Parse(recControl.Qty.Text, Sel_POP30300_POP30310View.Qty)
                        End If
                        If recControl.receiptdate.Text <> "" Then
                            rec.Parse(recControl.receiptdate.Text, Sel_POP30300_POP30310View.receiptdate)
                        End If
                        If recControl.UNITCOST.Text <> "" Then
                            rec.Parse(recControl.UNITCOST.Text, Sel_POP30300_POP30310View.UNITCOST)
                        End If
                        If recControl.UOFM.Text <> "" Then
                            rec.Parse(recControl.UOFM.Text, Sel_POP30300_POP30310View.UOFM)
                        End If
                        If recControl.VENDNAME.Text <> "" Then
                            rec.Parse(recControl.VENDNAME.Text, Sel_POP30300_POP30310View.VENDNAME)
                        End If
                        If recControl.VENDORID.Text <> "" Then
                            rec.Parse(recControl.VENDORID.Text, Sel_POP30300_POP30310View.VENDORID)
                        End If
            ...
            For index = 1 To Me.AddNewRecord
                ...
                newRecordList.Insert(0, New Sel_POP30300_POP30310Record())
            ...
            If newRecordList.Count > 0 Then
                ...
                Me.DataSource = DirectCast(finalList.ToArray(GetType(Sel_POP30300_POP30310Record)), Sel_POP30300_POP30310Record())
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Try
        ...
        Public Overridable Sub EXTDCOSTLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ' Sorts by EXTDCOST when clicked.
              
            ' Get previous sorting state for EXTDCOST.
            
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Sel_POP30300_POP30310View.EXTDCOST)
            If sd Is Nothing OrElse (Me.CurrentSortOrder.Items IsNot Nothing Andalso Me.CurrentSortOrder.Items.Length > 1) Then
                ' First time sort, so add sort order for EXTDCOST.
                Me.CurrentSortOrder.Reset()
              ...
              Me.CurrentSortOrder.Add(Sel_POP30300_POP30310View.EXTDCOST, OrderByItem.OrderDir.Asc)
            
            Else
                ' Previously sorted by EXTDCOST, so just reverse.
                sd.Reverse()
            End If
        ...
        Public Overridable Sub QtyLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Sel_POP30300_POP30310View.Qty)
            If sd Is Nothing OrElse (Me.CurrentSortOrder.Items IsNot Nothing Andalso Me.CurrentSortOrder.Items.Length > 1) Then
              ...
              Me.CurrentSortOrder.Add(Sel_POP30300_POP30310View.Qty, OrderByItem.OrderDir.Asc)
        ...
        Public Overridable Sub receiptdateLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ' Sorts by receiptdate when clicked.
              
            ' Get previous sorting state for receiptdate.
            
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Sel_POP30300_POP30310View.receiptdate)
            If sd Is Nothing OrElse (Me.CurrentSortOrder.Items IsNot Nothing Andalso Me.CurrentSortOrder.Items.Length > 1) Then
                ' First time sort, so add sort order for receiptdate.
                Me.CurrentSortOrder.Reset()
              ...
              Me.CurrentSortOrder.Add(Sel_POP30300_POP30310View.receiptdate, OrderByItem.OrderDir.Asc)
            
            Else
                ' Previously sorted by receiptdate, so just reverse.
                sd.Reverse()
            End If
        ...
        Public Overridable Sub UNITCOSTLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ' Sorts by UNITCOST when clicked.
              
            ' Get previous sorting state for UNITCOST.
            
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Sel_POP30300_POP30310View.UNITCOST)
            If sd Is Nothing OrElse (Me.CurrentSortOrder.Items IsNot Nothing Andalso Me.CurrentSortOrder.Items.Length > 1) Then
                ' First time sort, so add sort order for UNITCOST.
                Me.CurrentSortOrder.Reset()
              ...
              Me.CurrentSortOrder.Add(Sel_POP30300_POP30310View.UNITCOST, OrderByItem.OrderDir.Asc)
            
            Else
                ' Previously sorted by UNITCOST, so just reverse.
                sd.Reverse()
            End If
        ...
        Public Overridable Sub UOFMLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ' Sorts by UOFM when clicked.
              
            ' Get previous sorting state for UOFM.
            
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Sel_POP30300_POP30310View.UOFM)
            If sd Is Nothing OrElse (Me.CurrentSortOrder.Items IsNot Nothing Andalso Me.CurrentSortOrder.Items.Length > 1) Then
                ' First time sort, so add sort order for UOFM.
                Me.CurrentSortOrder.Reset()
              ...
              Me.CurrentSortOrder.Add(Sel_POP30300_POP30310View.UOFM, OrderByItem.OrderDir.Asc)
            
            Else
                ' Previously sorted by UOFM, so just reverse.
                sd.Reverse()
            End If
        ...
        Public Overridable Sub VENDNAMELabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ' Sorts by VENDNAME when clicked.
              
            ' Get previous sorting state for VENDNAME.
            
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Sel_POP30300_POP30310View.VENDNAME)
            If sd Is Nothing OrElse (Me.CurrentSortOrder.Items IsNot Nothing Andalso Me.CurrentSortOrder.Items.Length > 1) Then
                ' First time sort, so add sort order for VENDNAME.
                Me.CurrentSortOrder.Reset()
              ...
              Me.CurrentSortOrder.Add(Sel_POP30300_POP30310View.VENDNAME, OrderByItem.OrderDir.Asc)
            
            Else
                ' Previously sorted by VENDNAME, so just reverse.
                sd.Reverse()
            End If
        ...
        Public Overridable Sub VENDORIDLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ' Sorts by VENDORID when clicked.
              
            ' Get previous sorting state for VENDORID.
            
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Sel_POP30300_POP30310View.VENDORID)
            If sd Is Nothing OrElse (Me.CurrentSortOrder.Items IsNot Nothing Andalso Me.CurrentSortOrder.Items.Length > 1) Then
                ' First time sort, so add sort order for VENDORID.
                Me.CurrentSortOrder.Reset()
              ...
              Me.CurrentSortOrder.Add(Sel_POP30300_POP30310View.VENDORID, OrderByItem.OrderDir.Asc)
            
            Else
                ' Previously sorted by VENDORID, so just reverse.
                sd.Reverse()
            End If
    ...
    Try
        ...
        Public Property TotalRecords() As Integer
            Get
                If _TotalRecords < 0 
                    _TotalRecords = Sel_POP30300_POP30310View.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause())
                End If
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property EXTDCOSTLabel() As System.Web.UI.WebControls.LinkButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "EXTDCOSTLabel"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
        ...
        Public ReadOnly Property receiptdateLabel() As System.Web.UI.WebControls.LinkButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "receiptdateLabel"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
        ...
        Public ReadOnly Property UNITCOSTLabel() As System.Web.UI.WebControls.LinkButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UNITCOSTLabel"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
        
        Public ReadOnly Property UOFMLabel() As System.Web.UI.WebControls.LinkButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UOFMLabel"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
        
        Public ReadOnly Property VENDNAMELabel() As System.Web.UI.WebControls.LinkButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "VENDNAMELabel"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
        
        Public ReadOnly Property VENDORIDLabel() As System.Web.UI.WebControls.LinkButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "VENDORIDLabel"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
