...
' Inquiry_POP30300_POP30310_Vendor_Item1.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.Inquiry_POP30300_POP30310_Vendor_Item1

#Region "Section 1: Place your customizations here."

    
Public Class Sel_POP30300_POP303101TableControlRow
        Inherits BaseSel_POP30300_POP303101TableControlRow
        ' The BaseSel_POP30300_POP303101TableControlRow implements code for a ROW within the
        ' the Sel_POP30300_POP303101TableControl table.  The BaseSel_POP30300_POP303101TableControlRow implements the DataBind and SaveData methods.
        ' The loading of data is actually performed by the LoadData method in the base class of Sel_POP30300_POP303101TableControl.
...
Public Class Sel_POP30300_POP303101TableControl
        Inherits BaseSel_POP30300_POP303101TableControl

    ' The BaseSel_POP30300_POP303101TableControl class implements the LoadData, DataBind, CreateWhereClause
...
' Base class for the Sel_POP30300_POP303101TableControlRow control on the Inquiry_POP30300_POP30310_Vendor_Item1 page.
' Do not modify this class. Instead override any method in Sel_POP30300_POP303101TableControlRow.
Public Class BaseSel_POP30300_POP303101TableControlRow
        Inherits ePortalWFApproval.UI.BaseApplicationRecordControl

        '  To customize, override this method in Sel_POP30300_POP303101TableControlRow.
        ...
        Public Overridable Sub LoadData()        
            ...
            ' LoadData method of the BaseSel_POP30300_POP303101TableControl when the data for the entire
            ' table is loaded.
        ...
        ' Populate the UI controls using the DataSource.  To customize, override this method in Sel_POP30300_POP303101TableControlRow.
        Public Overrides Sub DataBind()
        ...
        Public Overridable Sub SetEXTDCOST()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.EXTDCOSTSpecified Then
                ...
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP303101View.EXTDCOST, "#,#.0000")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.EXTDCOST.Text = Sel_POP30300_POP303101View.EXTDCOST.Format(Sel_POP30300_POP303101View.EXTDCOST.DefaultValue, "#,#.0000")
        ...
        Public Overridable Sub SetITEMDESC()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.ITEMDESCSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP303101View.ITEMDESC)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.ITEMDESC.Text = Sel_POP30300_POP303101View.ITEMDESC.Format(Sel_POP30300_POP303101View.ITEMDESC.DefaultValue)
        ...
        Public Overridable Sub SetITEMNMBR()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.ITEMNMBRSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP303101View.ITEMNMBR)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.ITEMNMBR.Text = Sel_POP30300_POP303101View.ITEMNMBR.Format(Sel_POP30300_POP303101View.ITEMNMBR.DefaultValue)
        ...
        Public Overridable Sub SetQty()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.QtySpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP303101View.Qty, "#,#.00")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.Qty.Text = Sel_POP30300_POP303101View.Qty.Format(Sel_POP30300_POP303101View.Qty.DefaultValue, "#,#.00")
        ...
        Public Overridable Sub SetUNITCOST()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.UNITCOSTSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP303101View.UNITCOST, "#,#.00")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.UNITCOST.Text = Sel_POP30300_POP303101View.UNITCOST.Format(Sel_POP30300_POP303101View.UNITCOST.DefaultValue, "#,#.00")
        ...
        Public Overridable Sub SaveData()
            ...
            If Me.DataSource.IsAnyValueChanged Then
                ...
                DirectCast(GetParentControlObject(Me, "Sel_POP30300_POP303101TableControl"), Sel_POP30300_POP303101TableControl).DataChanged = True
                DirectCast(GetParentControlObject(Me, "Sel_POP30300_POP303101TableControl"), Sel_POP30300_POP303101TableControl).ResetData = True
            End If
        ...
        Dim hasFiltersSel_POP30300_POP303101TableControl As Boolean = False
...
' Base class for the Sel_POP30300_POP303101TableControl control on the Inquiry_POP30300_POP30310_Vendor_Item1 page.
' Do not modify this class. Instead override any method in Sel_POP30300_POP303101TableControl.
Public Class BaseSel_POP30300_POP303101TableControl
    ...
    ' Setup default pagination settings.
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    ...
                    For Each rc As Sel_POP30300_POP303101TableControlRow In Me.GetRecordControls()
        ...
        Public Overrides Sub DataBind()
          ...
          Dim rep As System.Web.UI.WebControls.Repeater = CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Sel_POP30300_POP303101TableControlRepeater"), System.Web.UI.WebControls.Repeater)
          If rep Is Nothing Then Return
          rep.DataSource = DataSource()
          rep.DataBind()
    ...
    End Sub
        ...
        Protected Overridable Sub BindPaginationControls()
            ...
            ' Bind the buttons for Sel_POP30300_POP303101TableControl pagination.
        ...
        Public Overridable Sub SaveData()
            ...
            Dim recCtl As Sel_POP30300_POP303101TableControlRow
    ...
    Dim recControl As Sel_POP30300_POP303101TableControlRow = DirectCast(repItem.FindControl("Sel_POP30300_POP303101TableControlRow"), Sel_POP30300_POP303101TableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        ...
                        If recControl.ITEMDESC.Text <> "" Then
                            rec.Parse(recControl.ITEMDESC.Text, Sel_POP30300_POP303101View.ITEMDESC)
                        End If
                        If recControl.ITEMNMBR.Text <> "" Then
                            rec.Parse(recControl.ITEMNMBR.Text, Sel_POP30300_POP303101View.ITEMNMBR)
                        End If
        ...
        Public Overridable Sub SetlitVendor()

                  
                  
                      'Code for the text property is generated inside the .aspx file.
                      'To override this property you can uncomment the following property and add your own value.
                      'Me.litVendor.Text = "Some value"
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Me.RemoveFromSession(Me, "Page_Size")
        ...
        Protected Overrides Sub LoadViewState(ByVal savedState As Object)
            ...
            Dim orderByStr As String = CType(ViewState("Sel_POP30300_POP303101TableControl_OrderBy"), String)
        ...
        Protected Overrides Function SaveViewState() As Object
            ...
            If Me.CurrentSortOrder IsNot Nothing Then
                Me.ViewState("Sel_POP30300_POP303101TableControl_OrderBy") = Me.CurrentSortOrder.ToXmlString()
            End If
    ...
    Try
            ...
            Dim Sel_POP30300_POP303101TableControlObj as Sel_POP30300_POP303101TableControl = DirectCast(Me.Page.FindControlRecursively("Sel_POP30300_POP303101TableControl"), Sel_POP30300_POP303101TableControl)
            Sel_POP30300_POP303101TableControlObj.ResetData = True
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property litVendor() As System.Web.UI.WebControls.Literal
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "litVendor"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetSelectedRecordControl() As Sel_POP30300_POP303101TableControlRow
            Return Nothing
          
        End Function

        Public Overridable Function GetSelectedRecordControls() As Sel_POP30300_POP303101TableControlRow()
        
            Return DirectCast((new ArrayList()).ToArray(GetType(Sel_POP30300_POP303101TableControlRow)), Sel_POP30300_POP303101TableControlRow())
          
        End Function

        Public Overridable Sub DeleteSelectedRecords(ByVal deferDeletion As Boolean)
            Dim recList() As Sel_POP30300_POP303101TableControlRow = Me.GetSelectedRecordControls()
        ...
        Public Overridable Function GetRecordControls() As Sel_POP30300_POP303101TableControlRow()
            Dim recCtrls() As Control = BaseClasses.Utils.MiscUtils.FindControlsRecursively(Me, "Sel_POP30300_POP303101TableControlRow")
            Dim list As New List(Of Sel_POP30300_POP303101TableControlRow)
            For Each recCtrl As Sel_POP30300_POP303101TableControlRow In recCtrls
                list.Add(recCtrl)
            Next
            Return list.ToArray()
        End Function
