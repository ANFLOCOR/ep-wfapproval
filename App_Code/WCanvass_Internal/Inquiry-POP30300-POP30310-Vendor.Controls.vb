...
' Inquiry_POP30300_POP30310_Vendor.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.Inquiry_POP30300_POP30310_Vendor
...
Public Class Sel_POP30300_POP30310TableControl
    ...
    ' the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
		...
		Public Overrides Function CreateWhereClause() As WhereClause
            ...
            Dim sParam As String = CStr(Me.Page.Request.QueryString("VendorNo"))
            ...
            wc.iAND(Sel_POP30300_POP30310View.VENDORID, BaseFilter.ComparisonOperator.EqualsTo, sParam)
		...
		Public Overrides Sub DataBind()
            ...
            For Each repItem As System.Web.UI.WebControls.RepeaterItem In rep.Items
                ...
                index += 1
            Next
            Me.litVendor.Text = "Vendor: " & CStr(Me.Page.Request.QueryString("VendorNo"))
        End Sub
End Class
...
' Base class for the Sel_POP30300_POP30310TableControlRow control on the Inquiry_POP30300_POP30310_Vendor page.
...
Public Class BaseSel_POP30300_POP30310TableControlRow
        ...
        Public Overridable Sub SetEXTDCOST()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.EXTDCOSTSpecified Then
                ...
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP30310View.EXTDCOST, "#,#.0000")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.EXTDCOST.Text = Sel_POP30300_POP30310View.EXTDCOST.Format(Sel_POP30300_POP30310View.EXTDCOST.DefaultValue, "#,#.0000")
        ...
        Public Overridable Sub SetITEMDESC()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.ITEMDESCSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP30310View.ITEMDESC)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.ITEMDESC.Text = Sel_POP30300_POP30310View.ITEMDESC.Format(Sel_POP30300_POP30310View.ITEMDESC.DefaultValue)
        ...
        Public Overridable Sub SetITEMNMBR()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.ITEMNMBRSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP30310View.ITEMNMBR)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.ITEMNMBR.Text = Sel_POP30300_POP30310View.ITEMNMBR.Format(Sel_POP30300_POP30310View.ITEMNMBR.DefaultValue)
        ...
        Public Overridable Sub SetQty()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.QtySpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP30310View.Qty, "#,#.00")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.Qty.Text = Sel_POP30300_POP30310View.Qty.Format(Sel_POP30300_POP30310View.Qty.DefaultValue, "#,#.00")
        ...
        Public Overridable Sub SetUNITCOST()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.UNITCOSTSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_POP30300_POP30310View.UNITCOST, "#,#.00")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.UNITCOST.Text = Sel_POP30300_POP30310View.UNITCOST.Format(Sel_POP30300_POP30310View.UNITCOST.DefaultValue, "#,#.00")
...
' Base class for the Sel_POP30300_POP30310TableControl control on the Inquiry_POP30300_POP30310_Vendor page.
    ...
    Dim recControl As Sel_POP30300_POP30310TableControlRow = DirectCast(repItem.FindControl("Sel_POP30300_POP30310TableControlRow"), Sel_POP30300_POP30310TableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        ...
                        If recControl.ITEMDESC.Text <> "" Then
                            rec.Parse(recControl.ITEMDESC.Text, Sel_POP30300_POP30310View.ITEMDESC)
                        End If
                        If recControl.ITEMNMBR.Text <> "" Then
                            rec.Parse(recControl.ITEMNMBR.Text, Sel_POP30300_POP30310View.ITEMNMBR)
                        End If
