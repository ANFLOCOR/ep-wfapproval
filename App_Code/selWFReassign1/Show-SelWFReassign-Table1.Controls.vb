...
Public Class SelWFReassignTableControl
    ...
    ' the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
        ...
        Private Function Get_PR_Detail_for_Email(ByVal Act_ID As String, ByVal PrevOwner As String) As String
            ...
            wc.iAND(Sel_WPOActivity_selPOP101001View.WPO_ID, BaseFilter.ComparisonOperator.EqualsTo, Act_ID)
            For Each itemValue As Sel_WPOActivity_selPOP101001Record In Sel_WPOActivity_selPOP101001View.GetRecords(wc, Nothing, 0, 100)
		...
		Public Overrides Function CreateWhereClause() As WhereClause
            ...
            wc.iAND(SelWFReassign1View.WPO_Status, BaseFilter.ComparisonOperator.EqualsTo, "4")
        ...
        Protected Overrides Sub PopulateWPO_W_U_IDFilter(ByVal selectedValue As String, ByVal maxItems As Integer)
            ...
            orderBy.Add(Sel_WASP_WF_Approver_PO2View.W_U_Full_Name, OrderByItem.OrderDir.Asc)

            Me.WPO_W_U_IDFilter.Items.Clear()
            Dim itemValue As Sel_WASP_WF_Approver_PO2Record
            For Each itemValue In Sel_WASP_WF_Approver_PO2View.GetRecords(wc, orderBy, 0, maxItems)
                ' Create the item and add to the list.
                Dim cvalue As String = Nothing
                Dim fvalue As String = Nothing
                If itemValue.W_U_IDSpecified Then
                    cvalue = itemValue.W_U_ID.ToString()
                    fvalue = itemValue.Format(Sel_WASP_WF_Approver_PO2View.W_U_Full_Name)
                End If
                    ...
                    Else
                        If recCtl.Visible Then
                            ...
                            If recCtl.SelWFReassignRecordRowSelection.Checked Then
                                ...
                                WPO_Activity1Record.AssignTo(recCtl.WPO_ID.Text, ret.SelectedValue.ToString())
        ...
        Protected Sub PopulateAssignUser()
            ...
            control.Items.Clear()
            Dim itemValue As Sel_WASP_WF_Approver_PO2Record
            For Each itemValue In Sel_WASP_WF_Approver_PO2View.GetRecords(wc, orderBy, 0, 100)
                ' Create the item and add to the list.
                Dim cvalue As String = Nothing
                Dim fvalue As String = Nothing
                If itemValue.W_U_IDSpecified Then
    ...
    Public Class WPO_Step_WPO_StepDetail1TableControl
        ...
        Public Overrides Function CreateWhereClause() As WhereClause
            ...
            wc.iAND(WPO_Step_WPO_StepDetail1View.WPO_S_WDT_ID, BaseFilter.ComparisonOperator.EqualsTo, oRow.GetRecord().WPO_WDT_ID.ToString())
    ...
    End Class
    Public Class Sel_WPO_InquireDetails1TableControl
        Inherits BaseSel_WPO_InquireDetails1TableControl

        ' The BaseSel_WPO_InquireDetails1TableControl class implements the LoadData, DataBind, CreateWhereClause
        ' and other methods to load and display the data in a table control.

        ' This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
        ' The Sel_WPO_InquireDetails1TableControlRow class offers another place where you can customize
        ' the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
        ...
        Public Overrides Function CreateWhereClause() As WhereClause
            ...
            Dim oRow As SelWFReassignTableControlRow = DirectCast(MiscUtils.GetParentControlObject(Me, "SelWFReassignTableControlRow"), SelWFReassignTableControlRow)
            wc.iAND(Sel_WPO_InquireDetails1View.PONUMBER, BaseFilter.ComparisonOperator.EqualsTo, oRow.GetRecord().WPO_PONum.ToString())
            wc.iAND(Sel_WPO_InquireDetails1View.CompanyID, BaseFilter.ComparisonOperator.EqualsTo, oRow.GetRecord().coID.ToString())


            Return wc
        End Function
    End Class
    Public Class Sel_WPO_InquireDetails1TableControlRow
        Inherits BaseSel_WPO_InquireDetails1TableControlRow
        ' The BaseSel_WPO_InquireDetails1TableControlRow implements code for a ROW within the
        ' the Sel_WPO_InquireDetails1TableControl table.  The BaseSel_WPO_InquireDetails1TableControlRow implements the DataBind and SaveData methods.
        ' The loading of data is actually performed by the LoadData method in the base class of Sel_WPO_InquireDetails1TableControl.
...
' Base class for the Sel_WPO_InquireDetails1TableControlRow control on the Show_SelWFReassign_Table1 page.
' Do not modify this class. Instead override any method in Sel_WPO_InquireDetails1TableControlRow.
Public Class BaseSel_WPO_InquireDetails1TableControlRow
        Inherits ePortalWFApproval.UI.BaseApplicationRecordControl

        '  To customize, override this method in Sel_WPO_InquireDetails1TableControlRow.
        ...
        Public Overridable Sub LoadData()        
            ...
            ' LoadData method of the BaseSel_WPO_InquireDetails1TableControl when the data for the entire
            ' table is loaded.
        ...
        ' Populate the UI controls using the DataSource.  To customize, override this method in Sel_WPO_InquireDetails1TableControlRow.
        Public Overrides Sub DataBind()
        ...
        Public Overridable Sub SetCompanyID()
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.CompanyID.Text = Sel_WPO_InquireDetails1View.CompanyID.Format(Sel_WPO_InquireDetails1View.CompanyID.DefaultValue)
        ...
        Public Overridable Sub SetPONUMBER()
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.PONUMBER.Text = Sel_WPO_InquireDetails1View.PONUMBER.Format(Sel_WPO_InquireDetails1View.PONUMBER.DefaultValue)
        ...
        Public Overridable Sub SetQTYORDER()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.QTYORDERSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_WPO_InquireDetails1View.QTYORDER)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.QTYORDER.Text = Sel_WPO_InquireDetails1View.QTYORDER.Format(Sel_WPO_InquireDetails1View.QTYORDER.DefaultValue)
        ...
        Public Overridable Sub SetUNITCOST()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.UNITCOSTSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(Sel_WPO_InquireDetails1View.UNITCOST)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.UNITCOST.Text = Sel_WPO_InquireDetails1View.UNITCOST.Format(Sel_WPO_InquireDetails1View.UNITCOST.DefaultValue)
        ...
        Public Overridable Sub SaveData()
            ...
            If Me.DataSource.IsAnyValueChanged Then
                ...
                DirectCast(GetParentControlObject(Me, "Sel_WPO_InquireDetails1TableControl"), Sel_WPO_InquireDetails1TableControl).DataChanged = True
                DirectCast(GetParentControlObject(Me, "Sel_WPO_InquireDetails1TableControl"), Sel_WPO_InquireDetails1TableControl).ResetData = True
            End If
        ...
        Dim hasFiltersSel_WPO_InquireDetails1TableControl As Boolean = False
    ...
    Try
        ...
        Public Property RecordUniqueId() As String
            Get
                Return CType(Me.ViewState("BaseSel_WPO_InquireDetails1TableControlRow_Rec"), String)
            End Get
            Set(ByVal value As String)
                Me.ViewState("BaseSel_WPO_InquireDetails1TableControlRow_Rec") = value
            End Set
        End Property
...
' Base class for the Sel_WPO_InquireDetails1TableControl control on the Show_SelWFReassign_Table1 page.
' Do not modify this class. Instead override any method in Sel_WPO_InquireDetails1TableControl.
Public Class BaseSel_WPO_InquireDetails1TableControl
    ...
    ' Setup default pagination settings.
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    ...
                    For Each rc As Sel_WPO_InquireDetails1TableControlRow In Me.GetRecordControls()
        ...
        Public Overrides Sub DataBind()
          ...
          Dim rep As System.Web.UI.WebControls.Repeater = CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Sel_WPO_InquireDetails1TableControlRepeater"), System.Web.UI.WebControls.Repeater)
          ...
          For Each repItem As System.Web.UI.WebControls.RepeaterItem In rep.Items
            ...
            Dim recControl As Sel_WPO_InquireDetails1TableControlRow = DirectCast(repItem.FindControl("Sel_WPO_InquireDetails1TableControlRow"), Sel_WPO_InquireDetails1TableControlRow)
    ...
    End Sub
        ...
        Protected Overridable Sub BindPaginationControls()
            ...
            ' Bind the buttons for Sel_WPO_InquireDetails1TableControl pagination.
        ...
        Public Overridable Sub SaveData()
            ...
            Dim recCtl As Sel_WPO_InquireDetails1TableControlRow
            For Each recCtl In Me.GetRecordControls()
    ...
    Dim recControl As Sel_WPO_InquireDetails1TableControlRow = DirectCast(repItem.FindControl("Sel_WPO_InquireDetails1TableControlRow"), Sel_WPO_InquireDetails1TableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        ...
                        If recControl.CompanyID.Text <> "" Then
                            rec.Parse(recControl.CompanyID.Text, Sel_WPO_InquireDetails1View.CompanyID)
                        End If
                        ...
                        If recControl.PONUMBER.Text <> "" Then
                            rec.Parse(recControl.PONUMBER.Text, Sel_WPO_InquireDetails1View.PONUMBER)
                        End If
        ...
        Public Sub AddToDeletedRecordIds(ByVal rec As Sel_WPO_InquireDetails1TableControlRow)
        ...
        Protected Overridable Function InDeletedRecordIds(ByVal rec As Sel_WPO_InquireDetails1TableControlRow) As Boolean
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Me.RemoveFromSession(Me, "Page_Size")
        ...
        Protected Overrides Sub LoadViewState(ByVal savedState As Object)
            ...
            Dim orderByStr As String = CType(ViewState("Sel_WPO_InquireDetails1TableControl_OrderBy"), String)
        ...
        Protected Overrides Function SaveViewState() As Object
            ...
            If Me.CurrentSortOrder IsNot Nothing Then
                Me.ViewState("Sel_WPO_InquireDetails1TableControl_OrderBy") = Me.CurrentSortOrder.ToXmlString()
            End If
...
#Region "Helper Functions"
        ...
        Public Overrides Overloads Function EvaluateExpressions(url As String, arg As String, ByVal bEncrypt As Boolean) As String
            ...
            If (needToProcess) Then
                Dim recCtl As Sel_WPO_InquireDetails1TableControlRow = Me.GetSelectedRecordControl()
        ...
        Public Overridable Function GetSelectedRecordControl() As Sel_WPO_InquireDetails1TableControlRow
            Return Nothing
          
        End Function

        Public Overridable Function GetSelectedRecordControls() As Sel_WPO_InquireDetails1TableControlRow()
        
            Return DirectCast((new ArrayList()).ToArray(GetType(Sel_WPO_InquireDetails1TableControlRow)), Sel_WPO_InquireDetails1TableControlRow())
          
        End Function

        Public Overridable Sub DeleteSelectedRecords(ByVal deferDeletion As Boolean)
            Dim recList() As Sel_WPO_InquireDetails1TableControlRow = Me.GetSelectedRecordControls()
        ...
        Public Overridable Function GetRecordControls() As Sel_WPO_InquireDetails1TableControlRow()
            Dim recCtrls() As Control = BaseClasses.Utils.MiscUtils.FindControlsRecursively(Me, "Sel_WPO_InquireDetails1TableControlRow")
            Dim list As New List(Of Sel_WPO_InquireDetails1TableControlRow)
            For Each recCtrl As Sel_WPO_InquireDetails1TableControlRow In recCtrls
                list.Add(recCtrl)
            Next
            Return list.ToArray()
        End Function
...
Public Class BaseSelWFReassignTableControlRow
        ...
        SetSel_WPO_InquireDetails1TableControl()
        ...
        Public Overridable Sub SetTOTAL()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.TOTALSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(SelWFReassign1View.TOTAL, "#,#.00")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.TOTAL.Text = SelWFReassign1View.TOTAL.Format(SelWFReassign1View.TOTAL.DefaultValue, "#,#.00")
        ...
        Public Overridable Sub SetSel_WPO_InquireDetails1TableControl()           
        
        
            If Sel_WPO_InquireDetails1TableControl.Visible Then
                Sel_WPO_InquireDetails1TableControl.LoadData()
                Sel_WPO_InquireDetails1TableControl.DataBind()
            End If
        End Sub        
        ...
        Dim recSel_WPO_InquireDetails1TableControl as Sel_WPO_InquireDetails1TableControl= DirectCast(MiscUtils.FindControlRecursively(Me, "Sel_WPO_InquireDetails1TableControl"), Sel_WPO_InquireDetails1TableControl)
        recSel_WPO_InquireDetails1TableControl.SaveData()
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Sel_WPO_InquireDetails1TableControl() As Sel_WPO_InquireDetails1TableControl
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Sel_WPO_InquireDetails1TableControl"), Sel_WPO_InquireDetails1TableControl)
            End Get
        End Property
...
Public Class BaseSelWFReassignTableControl
    ...
    Dim recControl As SelWFReassignTableControlRow = DirectCast(repItem.FindControl("SelWFReassignTableControlRow"), SelWFReassignTableControlRow)
        ...
        Protected Overridable Sub PopulateWPO_W_U_IDFilter(ByVal selectedValue As String, ByVal maxItems As Integer)
            ...
            Me.WPO_W_U_IDFilter.Items.Add(New ListItem(Me.Page.ExpandResourceValue("All"), "--ANY--"))
...
' Base class for the WPO_Step_WPO_StepDetail1TableControlRow control on the Show_SelWFReassign_Table1 page.
...
' Base class for the WPO_Step_WPO_StepDetail1TableControl control on the Show_SelWFReassign_Table1 page.
