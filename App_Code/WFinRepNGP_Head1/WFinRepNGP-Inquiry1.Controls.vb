...
' WFinRepNGP_Inquiry1.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.WFinRepNGP_Inquiry1
...
Public Class WFinRepNGP_DocAttach1TableControlRow
        ...
        Protected Overrides Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Me.btnPreview.Button.Attributes.Add("onClick", "OpenRptViewer2NGPNorthInq('" & Me.WFRCDNGP_Year.ClientID & "','" & Me.WFRCDNGP_Month.ClientID & "', '" & Me.WFRCDNGP_Type1.ClientID & "', '" & Me.WFRCDNGP_File1.ClientID & "', '" & Me.WFRCDNGP_Company.ClientID & "',  '" & Me.WFRCDNGP_Status.ClientID & "',  '" & Me.WFRCDNGP_WFRCHNGP_ID.ClientID & "');return false;")
        End Sub
...
Public Class WFinRepNGP_Head1TableControlRow
        ...
        Public Overrides Sub DataBind()
            ...
            If Not System.Web.HttpContext.Current.Session("UserName").ToString Is Nothing And Not System.Web.HttpContext.Current.Session("UserName").ToString = "" Then
                wherechecker = Sel_W_User_DYNAMICS_Company_FS1View.W_U_User_Name.UniqueName & "='" & System.Web.HttpContext.Current.Session("UserName").ToString.Trim & "' AND " & Sel_W_User_DYNAMICS_Company_FS1View.IsNonGP.UniqueName & "=1 AND " & Sel_W_User_DYNAMICS_Company_FS1View.Company_ID.UniqueName & "='" & Me.WFRCHNGP_C_ID1.Text & "'"
            Else
            ...
            Me.imbView.Attributes.Add("onClick", "OpenRptViewer2NGPNorthInq('" & Me.WFRCHNGP_Year1.ClientID & "','" & Me.WFRCHNGP_Month1.ClientID & "', '" & Me.WFRCHNGP_Description1.ClientID & "', '" & Me.WFRCHNGP_Description1.ClientID & "', '" & Me.WFRCHNGP_C_ID1.ClientID & "', '" & Me.WFRCHNGP_Status1.ClientID & "', '" & Me.WFRCHNGP_ID.ClientID & "');return false;")
            Me.btnPreview1.Button.Attributes.Add("onClick", "OpenRptViewer2NGPNorthInq('" & Me.WFRCHNGP_Year1.ClientID & "','" & Me.WFRCHNGP_Month1.ClientID & "', '" & Me.WFRCHNGP_Description1.ClientID & "', '" & Me.WFRCHNGP_Description1.ClientID & "', '" & Me.WFRCHNGP_C_ID1.ClientID & "', '" & Me.WFRCHNGP_Status1.ClientID & "', '" & Me.WFRCHNGP_ID.ClientID & "');return false;")
        End Sub
    ...
    ' The WFinRepNGP_Head1TableControlRow class offers another place where you can customize
        ...
        Public Overrides Function CreateWhereClause() As WhereClause
            ...
            If IsValueSelected(Me.WFRCHNGP_C_IDFilter) Then
                ...
                wc.iAND(WFinRepNGP_Head1Table.WFRCHNGP_C_ID, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(Me.WFRCHNGP_C_IDFilter, Me.GetFromSession(Me.WFRCHNGP_C_IDFilter)), False, False)
            Else
                Dim wherssouth As String = Nothing
                If Not System.Web.HttpContext.Current.Session("UserName").ToString Is Nothing And Not System.Web.HttpContext.Current.Session("UserName").ToString = "" Then
                    wherssouth = Sel_W_User_DYNAMICS_Company_FS1View.W_U_User_Name.UniqueName & "='" & System.Web.HttpContext.Current.Session("UserName").ToString.Trim & "' AND " & Sel_W_User_DYNAMICS_Company_FS1View.IsNonGP.UniqueName & "=1"
                Else
                    wherssouth = Sel_W_User_DYNAMICS_Company_FS1View.W_U_User_Name.UniqueName & "="
                End If
                Dim obysouth As BaseClasses.Data.OrderBy = New OrderBy(False, False)
                Dim waspsouth() As Sel_W_User_DYNAMICS_Company_FS1Record = Nothing
                waspsouth = Sel_W_User_DYNAMICS_Company_FS1View.GetRecords(wherssouth, obysouth)
                If (waspsouth.Length > 0) Then
                    If (Page.IsPostBack) Then
                        For Each r As Sel_W_User_DYNAMICS_Company_FS1Record In waspsouth
                            wc.iAND(WFinRepNGP_Head1Table.WFRCHNGP_C_ID, BaseFilter.ComparisonOperator.EqualsTo, r.Company_ID.ToString)
                        Next
                    Else
                        wc.iAND(WFinRepNGP_Head1Table.WFRCHNGP_C_ID, BaseFilter.ComparisonOperator.EqualsTo, "0")
                    End If
            ...
            If IsValueSelected(Me.WFRCHNGP_MonthFilter) Then
                ...
                wc.iAND(WFinRepNGP_Head1Table.WFRCHNGP_Month, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(Me.WFRCHNGP_MonthFilter, Me.GetFromSession(Me.WFRCHNGP_MonthFilter)), False, False)
            ...
            If IsValueSelected(Me.WFRCHNGP_StatusFilter) Then
                ...
                wc.iAND(WFinRepNGP_Head1Table.WFRCHNGP_Status, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(Me.WFRCHNGP_StatusFilter, Me.GetFromSession(Me.WFRCHNGP_StatusFilter)), False, False)
            ...
            If IsValueSelected(Me.WFRCHNGP_YearFromFilter) Then
                ...
                wc.iAND(WFinRepNGP_Head1Table.WFRCHNGP_Year, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(Me.WFRCHNGP_YearFromFilter, Me.GetFromSession(Me.WFRCHNGP_YearFromFilter)), False, False)
                    ...
                    For Each itemValue As WFin_ApprovalStatus1Record In itemValues
                        ...
                        If itemValue.WPO_STAT_CDSpecified Then
                            ...
                            If counter < maxItems AndAlso Me.WFRCHNGP_StatusFilter.Items.FindByValue(cvalue) Is Nothing Then
                                ...
                                Dim _isExpandableNonCompositeForeignKey As Boolean = WFinRepNGP_HeadTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WFinRepNGP_Head1Table.WFRCHNGP_Status)
                                If _isExpandableNonCompositeForeignKey AndAlso WFinRepNGP_Head1Table.WFRCHNGP_Status.IsApplyDisplayAs Then
                                    fvalue = WFinRepNGP_Head1Table.GetDFKA(itemValue, WFinRepNGP_Head1Table.WFRCHNGP_Status)
                                End If
        ...
        Public Overrides Function CreateOrderBy() As OrderBy
            ...
            obC.Add(WFinRepNGP_Head1Table.WFRCHNGP_Year, OrderByItem.OrderDir.Desc)
            obC.Add(WFinRepNGP_Head1Table.WFRCHNGP_Month, OrderByItem.OrderDir.Asc)
            Return obC
        End Function
        ...
        Public Overrides Function CreateWhereClause_WFRCHNGP_C_IDFilter() As WhereClause
            ...
            Dim hasFiltersWFinRepNGP_HeadTable1Control As Boolean = False
        ...
        Protected Overrides Sub PopulateWFRCHNGP_C_IDFilter(ByVal selectedValue As String, ByVal maxItems As Integer)
            ...
            Dim orderBy As OrderBy = New OrderBy(False, False)
            orderBy.Add(Vw_ANFLO_DW_CompanyNonGP1View.ShortName, OrderByItem.OrderDir.Asc)
            orderBy.Add(Vw_ANFLO_DW_CompanyNonGP1View.Name, OrderByItem.OrderDir.Asc)
            ...
            Dim itemValues() As Vw_ANFLO_DW_CompanyNonGP1Record = Nothing
            ...
            If wc.RunQuery Then
                ...
                Do
                    ...
                    itemValues = Vw_ANFLO_DW_CompanyNonGP1View.GetRecords(wc, orderBy, pageNum, maxItems)

                    For Each itemValue As Vw_ANFLO_DW_CompanyNonGP1Record In itemValues
                        ' Create the item and add to the list.
                        'Dim cvalue As String = Nothing
                        'Dim fvalue As String = Nothing
                        ...
                        Dim cvalue As String = itemValue.DynamicsCompanyID.ToString()
                        Dim fvalue As String = itemValue.Format(Vw_ANFLO_DW_CompanyNonGP1View.ShortName)
                        ...
                        waspsouth = Sel_W_User_DYNAMICS_Company_FS1View.GetRecords(wherssouth, obysouth)
                        For Each r As Sel_W_User_DYNAMICS_Company_FS1Record In waspsouth
                            If r.Company_ID = itemValue.DynamicsCompanyID Then
...
' Base class for the WFinRepNGP_Activity1TableControlRow control on the WFinRepNGP_Inquiry1 page.
...
' Base class for the WFinRepNGP_Activity1TableControl control on the WFinRepNGP_Inquiry1 page.
...
Public Class BaseWFinRepNGP_Activity1TableControl
        ...
        wFinRepNGP_Head1RecordObj = Nothing
              ...
              Dim wFinRepNGP_Head1TableControlObjRow As WFinRepNGP_Head1TableControlRow = DirectCast(MiscUtils.GetParentControlObject(Me, "WFinRepNGP_Head1TableControlRow") ,WFinRepNGP_Head1TableControlRow)
                ...
                If (Not IsNothing(wFinRepNGP_Head1TableControlObjRow) AndAlso Not IsNothing(wFinRepNGP_Head1TableControlObjRow.GetRecord()) AndAlso Not IsNothing(wFinRepNGP_Head1TableControlObjRow.GetRecord().WFRCHNGP_ID))
                    wc.iAND(WFinRepNGP_Activity1Table.WFRNGPA_WFRCHNGP_ID, BaseFilter.ComparisonOperator.EqualsTo, wFinRepNGP_Head1TableControlObjRow.GetRecord().WFRCHNGP_ID.ToString())
                Else
                    wc.RunQuery = False
                    Return wc                    
                End If
    ...
    End Function
      ...
      Dim appRelativeVirtualPath As String = CType(HttpContext.Current.Session("AppRelativeVirtualPath"), String)
            ...
            Dim selectedRecordInWFinRepNGP_Head1TableControl as String = DirectCast(HttpContext.Current.Session("WFinRepNGP_Activity1TableControlWhereClause"), String)
...
' Base class for the WFinRepNGP_Attachment1TableControlRow control on the WFinRepNGP_Inquiry1 page.
...
' Base class for the WFinRepNGP_Attachment1TableControl control on the WFinRepNGP_Inquiry1 page.
...
Public Class BaseWFinRepNGP_Attachment1TableControl
      ...
      Dim selectedRecordKeyValue as KeyValue = New KeyValue()
        ...
        wFinRepNGP_Head1RecordObj = Nothing
              ...
              Dim wFinRepNGP_Head1TableControlObjRow As WFinRepNGP_Head1TableControlRow = DirectCast(MiscUtils.GetParentControlObject(Me, "WFinRepNGP_Head1TableControlRow") ,WFinRepNGP_Head1TableControlRow)
                ...
                If (Not IsNothing(wFinRepNGP_Head1TableControlObjRow) AndAlso Not IsNothing(wFinRepNGP_Head1TableControlObjRow.GetRecord()) AndAlso Not IsNothing(wFinRepNGP_Head1TableControlObjRow.GetRecord().WFRCHNGP_ID))
                    wc.iAND(WFinRepNGP_Attachment1Table.WFRNGPAt_WFRCHNGP_ID, BaseFilter.ComparisonOperator.EqualsTo, wFinRepNGP_Head1TableControlObjRow.GetRecord().WFRCHNGP_ID.ToString())
                Else
                    wc.RunQuery = False
                    Return wc                    
                End If
    ...
    End Function
      ...
      Dim appRelativeVirtualPath As String = CType(HttpContext.Current.Session("AppRelativeVirtualPath"), String)
            ...
            Dim selectedRecordInWFinRepNGP_Head1TableControl as String = DirectCast(HttpContext.Current.Session("WFinRepNGP_Attachment1TableControlWhereClause"), String)
...
' Base class for the WFinRepNGP_DocAttach1TableControlRow control on the WFinRepNGP_Inquiry1 page.
...
Public Class BaseWFinRepNGP_DocAttach1TableControlRow
        ...
        Public Overridable Sub SetWFRCDNGP_Company()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WFRCDNGP_CompanySpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WFinRepNGP_DocAttach1Table.WFRCDNGP_Company)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WFRCDNGP_Company.Text = WFinRepNGP_DocAttach1Table.WFRCDNGP_Company.Format(WFinRepNGP_DocAttach1Table.WFRCDNGP_Company.DefaultValue)
        ...
        Public Overridable Sub SetWFRCDNGP_File1()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WFRCDNGP_File1Specified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WFinRepNGP_DocAttach1Table.WFRCDNGP_File1)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WFRCDNGP_File1.Text = WFinRepNGP_DocAttach1Table.WFRCDNGP_File1.Format(WFinRepNGP_DocAttach1Table.WFRCDNGP_File1.DefaultValue)
        ...
        Public Overridable Sub SetWFRCDNGP_Month()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WFRCDNGP_MonthSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                Dim formattedValue As String = ""
                Dim _isExpandableNonCompositeForeignKey As Boolean = WFinRepNGP_DocAttach1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WFinRepNGP_DocAttach1Table.WFRCDNGP_Month)
                If _isExpandableNonCompositeForeignKey AndAlso WFinRepNGP_DocAttach1Table.WFRCDNGP_Month.IsApplyDisplayAs Then
                                  
                       formattedValue = WFinRepNGP_DocAttach1Table.GetDFKA(Me.DataSource.WFRCDNGP_Month.ToString(),WFinRepNGP_DocAttach1Table.WFRCDNGP_Month, Nothing)
                                    
                       If (formattedValue Is Nothing) Then
                              formattedValue = Me.DataSource.Format(WFinRepNGP_DocAttach1Table.WFRCDNGP_Month)
                       End If
                Else
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WFRCDNGP_Month.Text = WFinRepNGP_DocAttach1Table.WFRCDNGP_Month.Format(WFinRepNGP_DocAttach1Table.WFRCDNGP_Month.DefaultValue)
        ...
        Public Overridable Sub SetWFRCDNGP_Status()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WFRCDNGP_StatusSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                Dim formattedValue As String = ""
                Dim _isExpandableNonCompositeForeignKey As Boolean = WFinRepNGP_DocAttach1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WFinRepNGP_DocAttach1Table.WFRCDNGP_Status)
                If _isExpandableNonCompositeForeignKey AndAlso WFinRepNGP_DocAttach1Table.WFRCDNGP_Status.IsApplyDisplayAs Then
                                  
                       formattedValue = WFinRepNGP_DocAttach1Table.GetDFKA(Me.DataSource.WFRCDNGP_Status.ToString(),WFinRepNGP_DocAttach1Table.WFRCDNGP_Status, Nothing)
                                    
                       If (formattedValue Is Nothing) Then
                              formattedValue = Me.DataSource.Format(WFinRepNGP_DocAttach1Table.WFRCDNGP_Status)
                       End If
                Else
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WFRCDNGP_Status.Text = WFinRepNGP_DocAttach1Table.WFRCDNGP_Status.Format(WFinRepNGP_DocAttach1Table.WFRCDNGP_Status.DefaultValue)
        ...
        Public Overridable Sub SetWFRCDNGP_Type1()
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WFRCDNGP_Type1.Text = WFinRepNGP_DocAttach1Table.WFRCDNGP_Type.Format(WFinRepNGP_DocAttach1Table.WFRCDNGP_Type.DefaultValue)
        ...
        Public Overridable Sub SetWFRCDNGP_WFRCHNGP_ID()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WFRCDNGP_WFRCHNGP_IDSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                Dim formattedValue As String = ""
                Dim _isExpandableNonCompositeForeignKey As Boolean = WFinRepNGP_DocAttach1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WFinRepNGP_DocAttach1Table.WFRCDNGP_WFRCHNGP_ID)
                If _isExpandableNonCompositeForeignKey AndAlso WFinRepNGP_DocAttach1Table.WFRCDNGP_WFRCHNGP_ID.IsApplyDisplayAs Then
                                  
                       formattedValue = WFinRepNGP_DocAttach1Table.GetDFKA(Me.DataSource.WFRCDNGP_WFRCHNGP_ID.ToString(),WFinRepNGP_DocAttach1Table.WFRCDNGP_WFRCHNGP_ID, Nothing)
                                    
                       If (formattedValue Is Nothing) Then
                              formattedValue = Me.DataSource.Format(WFinRepNGP_DocAttach1Table.WFRCDNGP_WFRCHNGP_ID)
                       End If
                Else
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WFRCDNGP_WFRCHNGP_ID.Text = WFinRepNGP_DocAttach1Table.WFRCDNGP_WFRCHNGP_ID.Format(WFinRepNGP_DocAttach1Table.WFRCDNGP_WFRCHNGP_ID.DefaultValue)
        ...
        Public Overridable Sub SetWFRCDNGP_Year()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WFRCDNGP_YearSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WFinRepNGP_DocAttach1Table.WFRCDNGP_Year)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WFRCDNGP_Year.Text = WFinRepNGP_DocAttach1Table.WFRCDNGP_Year.Format(WFinRepNGP_DocAttach1Table.WFRCDNGP_Year.DefaultValue)
...
' Base class for the WFinRepNGP_DocAttach1TableControl control on the WFinRepNGP_Inquiry1 page.
...
Public Class BaseWFinRepNGP_DocAttach1TableControl
    ...
    End Sub
          ...
          End If
            ...
            Me.Page.PregetDfkaRecords(WFinRepNGP_DocAttach1Table.WFRCDNGP_Month, Me.DataSource)
          
            Me.Page.PregetDfkaRecords(WFinRepNGP_DocAttach1Table.WFRCDNGP_Status, Me.DataSource)
          
            Me.Page.PregetDfkaRecords(WFinRepNGP_DocAttach1Table.WFRCDNGP_Type, Me.DataSource)
          
            Me.Page.PregetDfkaRecords(WFinRepNGP_DocAttach1Table.WFRCDNGP_Type, Me.DataSource)
          
            Me.Page.PregetDfkaRecords(WFinRepNGP_DocAttach1Table.WFRCDNGP_WFRCHNGP_ID, Me.DataSource)
    ...
    Dim recControl As WFinRepNGP_DocAttach1TableControlRow = DirectCast(repItem.FindControl("WFinRepNGP_DocAttach1TableControlRow"), WFinRepNGP_DocAttach1TableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        ...
                        If recControl.WFRCDNGP_Company.Text <> "" Then
                            rec.Parse(recControl.WFRCDNGP_Company.Text, WFinRepNGP_DocAttach1Table.WFRCDNGP_Company)
                        End If
                        If recControl.WFRCDNGP_File1.Text <> "" Then
                            rec.Parse(recControl.WFRCDNGP_File1.Text, WFinRepNGP_DocAttach1Table.WFRCDNGP_File1)
                        End If
                        If recControl.WFRCDNGP_Month.Text <> "" Then
                            rec.Parse(recControl.WFRCDNGP_Month.Text, WFinRepNGP_DocAttach1Table.WFRCDNGP_Month)
                        End If
                        ...
                        If recControl.WFRCDNGP_Status.Text <> "" Then
                            rec.Parse(recControl.WFRCDNGP_Status.Text, WFinRepNGP_DocAttach1Table.WFRCDNGP_Status)
                        End If
                        ...
                        If recControl.WFRCDNGP_Type1.Text <> "" Then
                            rec.Parse(recControl.WFRCDNGP_Type1.Text, WFinRepNGP_DocAttach1Table.WFRCDNGP_Type)
                        End If
                        If recControl.WFRCDNGP_WFRCHNGP_ID.Text <> "" Then
                            rec.Parse(recControl.WFRCDNGP_WFRCHNGP_ID.Text, WFinRepNGP_DocAttach1Table.WFRCDNGP_WFRCHNGP_ID)
                        End If
                        If recControl.WFRCDNGP_Year.Text <> "" Then
                            rec.Parse(recControl.WFRCDNGP_Year.Text, WFinRepNGP_DocAttach1Table.WFRCDNGP_Year)
                        End If
                        newUIDataList.Add(recControl.PreservedUIData())	  
                        newRecordList.Add(rec)
                    End If
...
' Base class for the WFinRepNGP_Head1TableControlRow control on the WFinRepNGP_Inquiry1 page.
...
Public Class BaseWFinRepNGP_Head1TableControlRow
        ...
        Public Overridable Sub SetWFRCHNGP_Month()
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WFRCHNGP_Month.Text = WFinRepNGP_Head1Table.WFRCHNGP_Month.Format(WFinRepNGP_Head1Table.WFRCHNGP_Month.DefaultValue)
        ...
        Public Overridable Sub SetWFRCHNGP_U_ID()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WFRCHNGP_U_IDSpecified Then
                ...
                If _isExpandableNonCompositeForeignKey AndAlso WFinRepNGP_Head1Table.WFRCHNGP_U_ID.IsApplyDisplayAs Then
                       ...
                       formattedValue = WFinRepNGP_Head1Table.GetDFKA(Me.DataSource.WFRCHNGP_U_ID.ToString(),WFinRepNGP_Head1Table.WFRCHNGP_U_ID, Nothing)
                                    
                       If (formattedValue Is Nothing) Then
                              formattedValue = Me.DataSource.Format(WFinRepNGP_Head1Table.WFRCHNGP_U_ID)
                       End If
                Else
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WFRCHNGP_U_ID.Text = WFinRepNGP_Head1Table.WFRCHNGP_U_ID.Format(WFinRepNGP_Head1Table.WFRCHNGP_U_ID.DefaultValue)
        ...
        Public Overridable Sub SetWFinRepNGP_Head1TabContainer()           
            ...
            If EvaluateFormula("URL(""TabVisible"")").ToLower() = "true" Then
                MiscUtils.FindControlRecursively(Me, "WFinRepNGP_Head1TabContainer").Visible = True
            ElseIf EvaluateFormula("URL(""TabVisible"")").ToLower() = "false" Then
                MiscUtils.FindControlRecursively(Me, "WFinRepNGP_Head1TabContainer").Visible = False
            End If
    ...
    Try
          ...
          Dim panelControl as WFinRepNGP_Head1TableControl = DirectCast(MiscUtils.GetParentControlObject(Me, "WFinRepNGP_Head1TableControl"), WFinRepNGP_Head1TableControl)

          Dim repeatedRows() as WFinRepNGP_Head1TableControlRow = panelControl.GetRecordControls()
          For Each repeatedRow as WFinRepNGP_Head1TableControlRow in repeatedRows
              Dim altRow as System.Web.UI.Control= DirectCast(MiscUtils.FindControlRecursively(repeatedRow, "WFinRepNGP_Head1TableControlAltRow"), System.Web.UI.Control)
...
' Base class for the WFinRepNGP_Head1TableControl control on the WFinRepNGP_Inquiry1 page.
...
Public Class BaseWFinRepNGP_Head1TableControl
           ...
           ' Setup the filter and search.
            ...
            If Not Me.Page.IsPostBack Then
                ...
                Else
                    ...
                    initialVal = EvaluateFormula("URL(""WFRCHNGP_C_IDFrom"")")
    ...
    ' Setup default pagination settings.
        ...
        Public Overrides Sub DataBind()
          ...
          Next
            ...
            Dim recControls() As WFinRepNGP_Head1TableControlRow = Me.GetRecordControls()
            For i As Integer = 0 to recControls.Length - 1
                Dim altRow As System.Web.UI.Control = DirectCast(MiscUtils.FindControlRecursively(recControls(i), "WFinRepNGP_Head1TableControlAltRow"), System.Web.UI.Control)
                If (altRow IsNot Nothing) Then
    ...
    End Sub
          ...
          End If
            ...
            Me.Page.PregetDfkaRecords(WFinRepNGP_Head1Table.WFRCHNGP_U_ID, Me.DataSource)
        ...
        Dim hasFiltersWFinRepNGP_Head1TableControl As Boolean = False
            ...
            If IsValueSelected(Me.WFRCHNGP_C_IDFilter) Then
              ...
              hasFiltersWFinRepNGP_Head1TableControl = True            
    
                wc.iAND(WFinRepNGP_Head1Table.WFRCHNGP_C_ID, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, MiscUtils.GetSelectedValue(Me.WFRCHNGP_C_IDFilter, Me.GetFromSession(Me.WFRCHNGP_C_IDFilter)), False, False)
            ...
            If IsValueSelected(Me.WFRCHNGP_YearFromFilter) Then
              ...
              hasFiltersWFinRepNGP_Head1TableControl = True            
                ...
                wc.iAND(WFinRepNGP_Head1Table.WFRCHNGP_Year, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, MiscUtils.GetSelectedValue(Me.WFRCHNGP_YearFromFilter, Me.GetFromSession(Me.WFRCHNGP_YearFromFilter)), False, False)
      ...
      Dim appRelativeVirtualPath As String = CType(HttpContext.Current.Session("AppRelativeVirtualPath"), String)
            ...
            If IsValueSelected(WFRCHNGP_C_IDFilterSelectedValue) Then
              ...
              hasFiltersWFinRepNGP_Head1TableControl = True            
                 ...
                 wc.iAND(WFinRepNGP_Head1Table.WFRCHNGP_C_ID, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, WFRCHNGP_C_IDFilterSelectedValue, false, False)
            ...
            If IsValueSelected(WFRCHNGP_MonthFilterSelectedValue) Then
              ...
              hasFiltersWFinRepNGP_Head1TableControl = True            
                 ...
                 wc.iAND(WFinRepNGP_Head1Table.WFRCHNGP_Month, BaseFilter.ComparisonOperator.EqualsTo, WFRCHNGP_MonthFilterSelectedValue, false, False)
            ...
            If IsValueSelected(WFRCHNGP_StatusFilterSelectedValue) Then
              ...
              hasFiltersWFinRepNGP_Head1TableControl = True            
                 ...
                 wc.iAND(WFinRepNGP_Head1Table.WFRCHNGP_Status, BaseFilter.ComparisonOperator.EqualsTo, WFRCHNGP_StatusFilterSelectedValue, false, False)
            ...
            If IsValueSelected(WFRCHNGP_YearFromFilterSelectedValue) Then
              ...
              hasFiltersWFinRepNGP_Head1TableControl = True            
                 ...
                 wc.iAND(WFinRepNGP_Head1Table.WFRCHNGP_Year, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, WFRCHNGP_YearFromFilterSelectedValue, false, False)
    ...
    Dim recControl As WFinRepNGP_Head1TableControlRow = DirectCast(repItem.FindControl("WFinRepNGP_Head1TableControlRow"), WFinRepNGP_Head1TableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        ...
                        If recControl.WFRCHNGP_C_ID.Text <> "" Then
                            rec.Parse(recControl.WFRCHNGP_C_ID.Text, WFinRepNGP_Head1Table.WFRCHNGP_C_ID)
                        End If
                        If recControl.WFRCHNGP_C_ID1.Text <> "" Then
                            rec.Parse(recControl.WFRCHNGP_C_ID1.Text, WFinRepNGP_Head1Table.WFRCHNGP_C_ID)
                        End If
                        If recControl.WFRCHNGP_Description.Text <> "" Then
                            rec.Parse(recControl.WFRCHNGP_Description.Text, WFinRepNGP_Head1Table.WFRCHNGP_Description)
                        End If
                        ...
                        If recControl.WFRCHNGP_ID.Text <> "" Then
                            rec.Parse(recControl.WFRCHNGP_ID.Text, WFinRepNGP_Head1Table.WFRCHNGP_ID)
                        End If
                        If recControl.WFRCHNGP_Month.Text <> "" Then
                            rec.Parse(recControl.WFRCHNGP_Month.Text, WFinRepNGP_Head1Table.WFRCHNGP_Month)
                        End If
                        ...
                        If recControl.WFRCHNGP_Status.Text <> "" Then
                            rec.Parse(recControl.WFRCHNGP_Status.Text, WFinRepNGP_Head1Table.WFRCHNGP_Status)
                        End If
                        ...
                        If recControl.WFRCHNGP_U_ID.Text <> "" Then
                            rec.Parse(recControl.WFRCHNGP_U_ID.Text, WFinRepNGP_Head1Table.WFRCHNGP_U_ID)
                        End If
                        If recControl.WFRCHNGP_Year.Text <> "" Then
                            rec.Parse(recControl.WFRCHNGP_Year.Text, WFinRepNGP_Head1Table.WFRCHNGP_Year)
                        End If
        ...
        Protected Overridable Sub PopulateWFRCHNGP_C_IDFilter(ByVal selectedValue As String, ByVal maxItems As Integer)
            ...
            ' Add the All item.
            Me.WFRCHNGP_C_IDFilter.Items.Insert(0, new ListItem(Me.Page.GetResourceValue("Txt:All", "ePortalWFApproval"), "--ANY--"))
                              
            
            
            Dim orderBy As OrderBy = New OrderBy(False, False)
            orderBy.Add(WFinRepNGP_Head1Table.WFRCHNGP_C_ID, OrderByItem.OrderDir.Asc)                
            ...
            If wc.RunQuery Then
                ...
                values = WFinRepNGP_Head1Table.GetValues(WFinRepNGP_Head1Table.WFRCHNGP_C_ID, wc, orderBy, maxItems)
            ...
            For Each cvalue In values
                ...
                If ( WFinRepNGP_Head1Table.WFRCHNGP_C_ID.IsColumnValueTypeBoolean()) Then
                    fvalue = cvalue
                Else
                    fvalue = WFinRepNGP_Head1Table.WFRCHNGP_C_ID.Format(cvalue)
                End If
                    ...
                    For each itemValue As Vw_WFinRep_DocAttach_FIN_Month1Record In itemValues
                        ...
                        If itemValue.MoSpecified Then
                            ...
                            If counter < maxItems AndAlso Me.WFRCHNGP_MonthFilter.Items.FindByValue(cvalue) Is Nothing  Then
                                ...
                                Dim _isExpandableNonCompositeForeignKey As Boolean = WFinRepNGP_Head1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WFinRepNGP_Head1Table.WFRCHNGP_Month)
                                If _isExpandableNonCompositeForeignKey AndAlso WFinRepNGP_Head1Table.WFRCHNGP_Month.IsApplyDisplayAs Then
                                    fvalue = WFinRepNGP_Head1Table.GetDFKA(itemValue, WFinRepNGP_Head1Table.WFRCHNGP_Month)
                                End If
                                If (Not _isExpandableNonCompositeForeignKey) Or (String.IsNullOrEmpty(fvalue)) Then
        ...
        Protected Overridable Sub PopulateWFRCHNGP_YearFromFilter(ByVal selectedValue As String, ByVal maxItems As Integer)
            ...
            Dim orderBy As OrderBy = New OrderBy(False, False)
            orderBy.Add(WFinRepNGP_Head1Table.WFRCHNGP_Year, OrderByItem.OrderDir.Asc)                
            ...
            If wc.RunQuery Then
                ...
                values = WFinRepNGP_Head1Table.GetValues(WFinRepNGP_Head1Table.WFRCHNGP_Year, wc, orderBy, maxItems)
            ...
            For Each cvalue In values
                ' Create the item and add to the list.
                Dim fvalue As String
                If ( WFinRepNGP_Head1Table.WFRCHNGP_Year.IsColumnValueTypeBoolean()) Then
                    fvalue = cvalue
                Else
                    fvalue = WFinRepNGP_Head1Table.WFRCHNGP_Year.Format(cvalue)
                End If
        ...
        Protected Overridable Sub Control_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.PreRender
			...
			Me.Page.Authorize(Ctype(WFRCHNGP_YearFromFilter, Control), "NOT_ANONYMOUS")
