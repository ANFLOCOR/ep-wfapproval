...
' Show_WPO_WFTaskN.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.Show_WPO_WFTaskN
		...
		Public Overrides Sub ImageButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' redirected to the URL.
                ...
                DbUtils.StartTransaction
                  ...
                  Dim url As String = "../WPR_Doc/Show-WPR-Doc1.aspx?WPR_Doc1=" & Me.WPRD_ID.Text '}"
...
' Base class for the Sel_WPO_InquireDetails1TableControl1Row control on the Show_WPO_WFTaskN page.
...
' Base class for the Sel_WPO_InquireDetails1TableControl1 control on the Show_WPO_WFTaskN page.
...
' Base class for the Sel_WPO_InquireDetailsTableControlRow control on the Show_WPO_WFTaskN page.
...
' Base class for the Sel_WPO_InquireDetailsTableControl control on the Show_WPO_WFTaskN page.
...
' Base class for the View_WCPO_Canvass1TableControlRow control on the Show_WPO_WFTaskN page.
...
' Base class for the View_WCPO_Canvass1TableControl control on the Show_WPO_WFTaskN page.
...
' Base class for the WPO_CARNo_QDetailsTableControlRow control on the Show_WPO_WFTaskN page.
...
' Base class for the WPO_CARNo_QDetailsTableControl control on the Show_WPO_WFTaskN page.
...
' Base class for the WPO_Doc_AttachTableControlRow control on the Show_WPO_WFTaskN page.
...
' Base class for the WPO_Doc_AttachTableControl control on the Show_WPO_WFTaskN page.
...
' Base class for the WPO_PRNo_QDetailsTableControlRow control on the Show_WPO_WFTaskN page.
...
Public Class BaseWPO_PRNo_QDetailsTableControlRow
        ...
        Public Overridable Sub ImageButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../WPR_Doc/Show-WPR-Doc1.aspx?WPR_Doc1={WPO_PRNo_QDetailsTableControlRow:FV:WPRD_ID}"
...
' Base class for the WPO_PRNo_QDetailsTableControl control on the Show_WPO_WFTaskN page.
...
' Base class for the WPO_WFHistory_Details_newTableControlRow control on the Show_WPO_WFTaskN page.
...
' Base class for the WPO_WFHistory_Details_newTableControl control on the Show_WPO_WFTaskN page.
...
' Base class for the Sel_WPO_WFTaskActivity_RemarksRecordControl control on the Show_WPO_WFTaskN page.
...
Public Class BaseSel_WPO_WFTaskActivity_RemarksRecordControl
        ...
        Dim hasFiltersWPOP10100RecordControl As Boolean = False
            ...
            End If
            HttpContext.Current.Session("QueryString in Show-WPO-WFTaskN") = recId
...
' Base class for the Sel_WPO_WFTaskRecordControl control on the Show_WPO_WFTaskN page.
...
' Base class for the WPOP10100RecordControl control on the Show_WPO_WFTaskN page.
