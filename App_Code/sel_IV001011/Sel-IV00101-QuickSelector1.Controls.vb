...
' Sel_IV00101_QuickSelector1.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.Sel_IV00101_QuickSelector1
...
' Base class for the SelectorTableControlRow control on the Sel_IV00101_QuickSelector1 page.
...
Public Class BaseSelectorTableControlRow
        ...
        Public Overridable Sub LoadData()        
            ...
            ' Load the data from the database into the DataSource DatabaseANFLO-WFN%dbo.sel_IV00101 record.
            ...
            If Me.RecordUniqueId IsNot Nothing AndAlso Me.RecordUniqueId.Trim <> "" Then
                Me.DataSource = Sel_IV001011View.GetRecord(Me.RecordUniqueId, True)
            ...
            Me.DataSource = New Sel_IV001011Record()
        ...
        Public Overridable Sub Delete()
          ...
          Sel_IV001011View.DeleteRecord(pkValue)
        ...
        Public Property DataSource() As Sel_IV001011Record
            Get
                Return DirectCast(MyBase._DataSource, Sel_IV001011Record)
            End Get
            Set(ByVal value As Sel_IV001011Record)
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetRecord() As Sel_IV001011Record
            ...
            If Not Me.RecordUniqueId Is Nothing Then
                ...
                Return Sel_IV001011View.GetRecord(Me.RecordUniqueId, True)
...
' Base class for the SelectorTableControl control on the Sel_IV00101_QuickSelector1 page.
...
Public Class BaseSelectorTableControl
    ...
    ' Setup default pagination settings.
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                If wc IsNot Nothing AndAlso Not wc.RunQuery Then
                    ...
                    Me.DataSource = DirectCast(alist.ToArray(GetType(Sel_IV001011Record)), Sel_IV001011Record())
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    ...
                    For Each rc As SelectorTableControlRow In Me.GetRecordControls()
                        ...
                        End If
                    Next
                    Me.DataSource = DirectCast(postdata.ToArray(GetType(Sel_IV001011Record)), Sel_IV001011Record())
        ...
        Public Overridable Function GetRecords( _
            ...
            ' selCols.Add(Sel_IV001011View.Column1, True)         
            ' selCols.Add(Sel_IV001011View.Column2, True)          
            ' selCols.Add(Sel_IV001011View.Column3, True)    
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return Sel_IV001011View.GetRecords(join, where, orderBy, Me.PageIndex, Me.PageSize)
                 
            Else
                Dim databaseTable As New Sel_IV001011View
                ...
                Return CType(recList.ToArray(GetType(Sel_IV001011Record)), Sel_IV001011Record())
            End If            
        ...
        Public Overridable Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return Sel_IV001011View.GetRecordCount(join, where)
        ...
        Public Overridable Function GetColumnListFromURLParameters(ByVal includeIndexFieldParameter As Boolean, ByVal includeFormulaAndDFKAParameter As Boolean) As ColumnList
            ...
            If includeIndexFieldParameter AndAlso field <> "" Then
                Dim col As BaseColumn = Sel_IV001011View.GetColumnByName(field)
                If col IsNot Nothing  AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
            End If
            If includeFormulaAndDFKAParameter Then
                If formula <> "" Then
                    For Each col As BaseColumn In MiscUtils.GetFormulaFieldList(formula, Sel_IV001011View.Instance.TableDefinition)
                        If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                    Next
                
                ElseIf displayFieldName <> ""
                    Dim col As BaseColumn = Sel_IV001011View.GetColumnByName(displayFieldName)
                    If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                End If
            End If
            Return columnList            
    ...
    End Sub
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            Sel_IV001011View.Instance.InnerFilter = Nothing
      ...
      Next
            ...
            End If
		        ...
		        If Not String.IsNullOrEmpty(Me.Page.Request("dependOnField")) AndAlso Me.Page.Request("dependOnVal") IsNot Nothing Then
			          Dim dependOnCol as BaseColumn = Sel_IV001011View.GetColumnByName(Me.Page.GetDecryptedURLParameter("dependOnField"))
    ...
    End Function
      ...
      Next
        ...
        Public Overridable Function GetAutoCompletionList_Search(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim recordList () As ePortalWFApproval.Business.Sel_IV001011Record = Sel_IV001011View.GetRecords(filterJoin, wc, Nothing, 0, count,count)
            Dim rec As Sel_IV001011Record = Nothing
    ...
    Dim recControl As SelectorTableControlRow = DirectCast(repItem.FindControl("SelectorTableControlRow"), SelectorTableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        Dim rec As Sel_IV001011Record = New Sel_IV001011Record()
            ...
            For index = 1 To Me.AddNewRecord
                ...
                newRecordList.Insert(0, New Sel_IV001011Record())
            ...
            If newRecordList.Count > 0 Then
                ...
                Me.DataSource = DirectCast(finalList.ToArray(GetType(Sel_IV001011Record)), Sel_IV001011Record())
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Try
        ...
        Public Property TotalRecords() As Integer
            Get
                If _TotalRecords < 0 
                    _TotalRecords = Sel_IV001011View.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause())
                End If
