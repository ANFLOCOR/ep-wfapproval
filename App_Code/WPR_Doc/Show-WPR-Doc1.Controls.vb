...
' Show_WPR_Doc1.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.Show_WPR_Doc1
...
'End Class
'
Public Class WPR_Line1TableControl
        Inherits BaseWPR_Line1TableControl

    ' The BaseWPR_Line1TableControl class implements the LoadData, DataBind, CreateWhereClause
    ' and other methods to load and display the data in a table control.

    ' This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    ' The WPR_Line1TableControlRow class offers another place where you can customize
    ' the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.

End Class
Public Class WPR_Line1TableControlRow
        Inherits BaseWPR_Line1TableControlRow
        ' The BaseWPR_Line1TableControlRow implements code for a ROW within the
        ' the WPR_Line1TableControl table.  The BaseWPR_Line1TableControlRow implements the DataBind and SaveData methods.
        ' The loading of data is actually performed by the LoadData method in the base class of WPR_Line1TableControl.
...
End Class
Public Class WPR_Doc_Attach1TableControl
        Inherits BaseWPR_Doc_Attach1TableControl

    ' The BaseWPR_Doc_Attach1TableControl class implements the LoadData, DataBind, CreateWhereClause
    ' and other methods to load and display the data in a table control.

    ' This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    ' The WPR_Doc_Attach1TableControlRow class offers another place where you can customize
    ' the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.

End Class
Public Class WPR_Doc_Attach1TableControlRow
        Inherits BaseWPR_Doc_Attach1TableControlRow
        ' The BaseWPR_Doc_Attach1TableControlRow implements code for a ROW within the
        ' the WPR_Doc_Attach1TableControl table.  The BaseWPR_Doc_Attach1TableControlRow implements the DataBind and SaveData methods.
        ' The loading of data is actually performed by the LoadData method in the base class of WPR_Doc_Attach1TableControl.
...
End Class
Public Class WPR_Activity1TableControl
        Inherits BaseWPR_Activity1TableControl

    ' The BaseWPR_Activity1TableControl class implements the LoadData, DataBind, CreateWhereClause
    ' and other methods to load and display the data in a table control.

    ' This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    ' The WPR_Activity1TableControlRow class offers another place where you can customize
    ' the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.

End Class
Public Class WPR_Activity1TableControlRow
        Inherits BaseWPR_Activity1TableControlRow
        ' The BaseWPR_Activity1TableControlRow implements code for a ROW within the
        ' the WPR_Activity1TableControl table.  The BaseWPR_Activity1TableControlRow implements the DataBind and SaveData methods.
        ' The loading of data is actually performed by the LoadData method in the base class of WPR_Activity1TableControl.
...
' Base class for the WCAR_Doc_Attach1TableControlRow control on the Show_WPR_Doc1 page.
...
Public Class BaseWCAR_Doc_Attach1TableControlRow
        ...
        Dim hasFiltersWPR_Activity1TableControl As Boolean = False
      
        Dim hasFiltersWPR_Doc_Attach1TableControl As Boolean = False
      
        Dim hasFiltersWPR_DocRecordControl As Boolean = False
      
        Dim hasFiltersWPR_Line1TableControl As Boolean = False
...
' Base class for the WCAR_Doc_Attach1TableControl control on the Show_WPR_Doc1 page.
...
' Base class for the WPR_Activity1TableControlRow control on the Show_WPR_Doc1 page.
' Do not modify this class. Instead override any method in WPR_Activity1TableControlRow.
Public Class BaseWPR_Activity1TableControlRow
        Inherits ePortalWFApproval.UI.BaseApplicationRecordControl

        '  To customize, override this method in WPR_Activity1TableControlRow.
        Protected Overridable Sub Control_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Init
        ...
        Public Overridable Sub LoadData()        
            ...
            ' Load the data from the database into the DataSource DatabaseANFLO-WFN%dbo.WPR_Activity record.
            ' It is better to make changes to functions called by LoadData such as
            ' CreateWhereClause, rather than making changes here.
            ...
            If Me.RecordUniqueId IsNot Nothing AndAlso Me.RecordUniqueId.Trim <> "" Then
                Me.DataSource = WPR_Activity1Table.GetRecord(Me.RecordUniqueId, True)
          
                Return
            End If
        
            ' Since this is a row in the table, the data for this row is loaded by the 
            ' LoadData method of the BaseWPR_Activity1TableControl when the data for the entire
            ' table is loaded.
            
            Me.DataSource = New WPR_Activity1Record()
          
    
    
        End Sub

        ' Populate the UI controls using the DataSource.  To customize, override this method in WPR_Activity1TableControlRow.
        Public Overrides Sub DataBind()
            ' The DataBind method binds the user interface controls to the values
            ' from the database record.  To do this, it calls the Set methods for 
            ' each of the field displayed on the webpage.  It is better to make 
        ...
        Public Overridable Sub SetWPRA_Date_Action()
            ...
            ' DatabaseANFLO-WFN%dbo.WPR_Activity database record.

            ' Me.DataSource is the DatabaseANFLO-WFN%dbo.WPR_Activity record retrieved from the database.
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRA_Date_ActionSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Activity1Table.WPRA_Date_Action, "d")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRA_Date_Action.Text = WPR_Activity1Table.WPRA_Date_Action.Format(WPR_Activity1Table.WPRA_Date_Action.DefaultValue, "d")
        ...
        Public Overridable Sub SetWPRA_Date_Assign()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRA_Date_AssignSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Activity1Table.WPRA_Date_Assign, "d")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRA_Date_Assign.Text = WPR_Activity1Table.WPRA_Date_Assign.Format(WPR_Activity1Table.WPRA_Date_Assign.DefaultValue, "d")
        ...
        Public Overridable Sub SetWPRA_Remark()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRA_RemarkSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Activity1Table.WPRA_Remark)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRA_Remark.Text = WPR_Activity1Table.WPRA_Remark.Format(WPR_Activity1Table.WPRA_Remark.DefaultValue)
        ...
        Public Overridable Sub SetWPRA_Status()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRA_StatusSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Activity1Table.WPRA_Status)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRA_Status.Text = WPR_Activity1Table.WPRA_Status.Format(WPR_Activity1Table.WPRA_Status.DefaultValue)
        ...
        Public Overridable Sub SetWPRA_W_U_ID()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRA_W_U_IDSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                Dim formattedValue As String = ""
                Dim _isExpandableNonCompositeForeignKey As Boolean = WPR_Activity1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WPR_Activity1Table.WPRA_W_U_ID)
                If _isExpandableNonCompositeForeignKey AndAlso WPR_Activity1Table.WPRA_W_U_ID.IsApplyDisplayAs Then
                                  
                       formattedValue = WPR_Activity1Table.GetDFKA(Me.DataSource.WPRA_W_U_ID.ToString(),WPR_Activity1Table.WPRA_W_U_ID, Nothing)
                                    
                       If (formattedValue Is Nothing) Then
                              formattedValue = Me.DataSource.Format(WPR_Activity1Table.WPRA_W_U_ID)
                       End If
                Else
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRA_W_U_ID.Text = WPR_Activity1Table.WPRA_W_U_ID.Format(WPR_Activity1Table.WPRA_W_U_ID.DefaultValue)
        ...
        Dim parentCtrl As WPR_DocRecordControl
          ...
          If (Not IsNothing(parentCtrl) AndAlso IsNothing(parentCtrl.DataSource)) 
            ...
            If Me.DataSource.IsAnyValueChanged Then
                ...
                DirectCast(GetParentControlObject(Me, "WPR_Activity1TableControl"), WPR_Activity1TableControl).DataChanged = True
                DirectCast(GetParentControlObject(Me, "WPR_Activity1TableControl"), WPR_Activity1TableControl).ResetData = True
            End If
        ...
        Public Overridable Sub Delete()
            ...
            Dim pkValue As KeyValue = KeyValue.XmlToKey(Me.RecordUniqueId)
          WPR_Activity1Table.DeleteRecord(pkValue)
        ...
        Public Property RecordUniqueId() As String
            Get
                Return CType(Me.ViewState("BaseWPR_Activity1TableControlRow_Rec"), String)
            End Get
            Set(ByVal value As String)
                Me.ViewState("BaseWPR_Activity1TableControlRow_Rec") = value
            End Set
        End Property
            
        Public Property DataSource() As WPR_Activity1Record
            Get
                Return DirectCast(MyBase._DataSource, WPR_Activity1Record)
            End Get
            Set(ByVal value As WPR_Activity1Record)
                Me._DataSource = value
            End Set
        End Property
...
#Region "Helper Functions"
        ...
        Public Overrides Overloads Function EvaluateExpressions(ByVal url As String, ByVal arg As String, ByVal bEncrypt As Boolean) As String
            ...
            Dim rec As WPR_Activity1Record = Nothing
        ...
        Public Overridable Function GetRecord() As WPR_Activity1Record
            If Not Me.DataSource Is Nothing Then
                Return Me.DataSource
            End If
            ...
            If Not Me.RecordUniqueId Is Nothing Then
                ...
                Return WPR_Activity1Table.GetRecord(Me.RecordUniqueId, True)
...
' Base class for the WPR_Activity1TableControl control on the Show_WPR_Doc1 page.
' Do not modify this class. Instead override any method in WPR_Activity1TableControl.
Public Class BaseWPR_Activity1TableControl
        Inherits ePortalWFApproval.UI.BaseApplicationTableControl
    ...
    ' Setup default pagination settings.
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                If wc IsNot Nothing AndAlso Not wc.RunQuery Then
                    ' Initialize an empty array of records
                    Dim alist As New ArrayList(0)
                    Me.DataSource = DirectCast(alist.ToArray(GetType(WPR_Activity1Record)), WPR_Activity1Record())
                    ' Add records to the list if needed.
                    Me.AddNewRecords()
                    Me._TotalRecords = 0
                    Me._TotalPages = 0
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    Dim postdata As New ArrayList
                    For Each rc As WPR_Activity1TableControlRow In Me.GetRecordControls()
                        If Not rc.IsNewRecord Then
                            rc.DataSource = rc.GetRecord()
                            rc.GetUIData()
                            postdata.Add(rc.DataSource)
                        ...
                        End If
                    Next
                    Me.DataSource = DirectCast(postdata.ToArray(GetType(WPR_Activity1Record)), WPR_Activity1Record())
                Else  ' Get the records from the database	
        ...
        Public Overridable Function GetRecords( _
            ...
            ByVal orderBy As OrderBy, _
            ByVal pageIndex As Integer, _
            ByVal pageSize As Integer) As WPR_Activity1Record()
            ...
            ' However, if you don't specify PK, row button click might show an error message.
            ' And make sure you write similar code in GetRecordCount as well
            ' selCols.Add(WPR_Activity1Table.Column1, True)         
            ' selCols.Add(WPR_Activity1Table.Column2, True)          
            ' selCols.Add(WPR_Activity1Table.Column3, True)    
            ...
            If selCols.Count = 0 Then                    
                ...
                Return WPR_Activity1Table.GetRecords(join, where, orderBy, Me.PageIndex, Me.PageSize)
                 
            Else
                Dim databaseTable As New WPR_Activity1Table
                databaseTable.SelectedColumns.Clear()
                databaseTable.SelectedColumns.AddRange(selCols)
                ...
                orderBy.ExpandForeignKeyColums = False
                recList = databaseTable.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
                Return CType(recList.ToArray(GetType(WPR_Activity1Record)), WPR_Activity1Record())
            End If            
        ...
        Public Overridable Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
            ...
            If selCols.Count = 0 Then                    
                ...
                Return WPR_Activity1Table.GetRecordCount(join, where)
        ...
        Public Overrides Sub DataBind()
          ...
          Dim rep As System.Web.UI.WebControls.Repeater = CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "WPR_Activity1TableControlRepeater"), System.Web.UI.WebControls.Repeater)
          If rep Is Nothing Then Return
          rep.DataSource = DataSource()
          rep.DataBind()
          ...
          For Each repItem As System.Web.UI.WebControls.RepeaterItem In rep.Items
            ...
            ' Loop through all rows in the table, set its DataSource and call DataBind().
            Dim recControl As WPR_Activity1TableControlRow = DirectCast(repItem.FindControl("WPR_Activity1TableControlRow"), WPR_Activity1TableControlRow)
            recControl.DataSource = Me.DataSource(index)          
            If Me.UIData.Count > index Then
              recControl.PreviousUIData = Me.UIData(index)
            End If
    ...
    End Sub
          ...
          End If
            ...
            Me.Page.PregetDfkaRecords(WPR_Activity1Table.WPRA_W_U_ID, Me.DataSource)
        ...
        Protected Overridable Sub BindPaginationControls()
            ...
            ' Bind the buttons for WPR_Activity1TableControl pagination.
        ...
        Public Overridable Sub SaveData()
            ...
            Dim recCtl As WPR_Activity1TableControlRow
            For Each recCtl In Me.GetRecordControls()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            'This CreateWhereClause is used for loading the data.
            WPR_Activity1Table.Instance.InnerFilter = Nothing
            Dim wc As WhereClause = New WhereClause()
      ...
      Dim selectedRecordKeyValue as KeyValue = New KeyValue()
              ...
              Dim wPR_DocRecordControlObj as WPR_DocRecordControl = DirectCast(MiscUtils.GetParentControlObject(Me, "WPR_DocRecordControl") ,WPR_DocRecordControl)
                ...
                If (Not IsNothing(wPR_DocRecordControlObj) AndAlso Not IsNothing(wPR_DocRecordControlObj.GetRecord()) AndAlso wPR_DocRecordControlObj.GetRecord().IsCreated AndAlso Not IsNothing(wPR_DocRecordControlObj.GetRecord().WPRD_ID))
                    wc.iAND(WPR_Activity1Table.WPRA_WPRD_ID, BaseFilter.ComparisonOperator.EqualsTo, wPR_DocRecordControlObj.GetRecord().WPRD_ID.ToString())
                    selectedRecordKeyValue.AddElement(WPR_Activity1Table.WPRA_WPRD_ID.InternalName, wPR_DocRecordControlObj.GetRecord().WPRD_ID.ToString())
                Else
                    wc.RunQuery = False
                    Return wc                    
                End If          
              
      HttpContext.Current.Session("WPR_Activity1TableControlWhereClause") = selectedRecordKeyValue.ToXmlString()
    ...
    End Function
      ...
      Dim appRelativeVirtualPath As String = CType(HttpContext.Current.Session("AppRelativeVirtualPath"), String)
            ...
            Dim selectedRecordInWPR_DocRecordControl as String = DirectCast(HttpContext.Current.Session("WPR_Activity1TableControlWhereClause"), String)
       ...
       If Not IsNothing(selectedRecordKeyValue) AndAlso selectedRecordKeyValue.ContainsColumn(WPR_Activity1Table.WPRA_WPRD_ID) Then
            wc.iAND(WPR_Activity1Table.WPRA_WPRD_ID, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(WPR_Activity1Table.WPRA_WPRD_ID).ToString())
       End If
    ...
    Dim recControl As WPR_Activity1TableControlRow = DirectCast(repItem.FindControl("WPR_Activity1TableControlRow"), WPR_Activity1TableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        Dim rec As WPR_Activity1Record = New WPR_Activity1Record()
        
                        If recControl.WPRA_Date_Action.Text <> "" Then
                            rec.Parse(recControl.WPRA_Date_Action.Text, WPR_Activity1Table.WPRA_Date_Action)
                        End If
                        If recControl.WPRA_Date_Assign.Text <> "" Then
                            rec.Parse(recControl.WPRA_Date_Assign.Text, WPR_Activity1Table.WPRA_Date_Assign)
                        End If
                        If recControl.WPRA_Remark.Text <> "" Then
                            rec.Parse(recControl.WPRA_Remark.Text, WPR_Activity1Table.WPRA_Remark)
                        End If
                        If recControl.WPRA_Status.Text <> "" Then
                            rec.Parse(recControl.WPRA_Status.Text, WPR_Activity1Table.WPRA_Status)
                        End If
                        If recControl.WPRA_W_U_ID.Text <> "" Then
                            rec.Parse(recControl.WPRA_W_U_ID.Text, WPR_Activity1Table.WPRA_W_U_ID)
                        End If
                        newUIDataList.Add(recControl.PreservedUIData())	  
                        newRecordList.Add(rec)
                    End If
            ...
            For index = 1 To Me.AddNewRecord
                ...
                newRecordList.Insert(0, New WPR_Activity1Record())
                newUIDataList.Insert(0, New Hashtable())				
            ...
            If newRecordList.Count > 0 Then
                ...
                Me.DataSource = DirectCast(finalList.ToArray(GetType(WPR_Activity1Record)), WPR_Activity1Record())
        ...
        Public Sub AddToDeletedRecordIds(ByVal rec As WPR_Activity1TableControlRow)
            If rec.IsNewRecord() Then
                Return
            End If
        ...
        Protected Overridable Function InDeletedRecordIds(ByVal rec As WPR_Activity1TableControlRow) As Boolean
            If Me.DeletedRecordIds Is Nothing OrElse Me.DeletedRecordIds.Trim = "" Then
                Return False
            End If
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Me.RemoveFromSession(Me, "Page_Size")
        ...
        Protected Overrides Sub LoadViewState(ByVal savedState As Object)
            ...
            Dim orderByStr As String = CType(ViewState("WPR_Activity1TableControl_OrderBy"), String)
        ...
        Protected Overrides Function SaveViewState() As Object
            ...
            If Me.CurrentSortOrder IsNot Nothing Then
                Me.ViewState("WPR_Activity1TableControl_OrderBy") = Me.CurrentSortOrder.ToXmlString()
            End If
        ...
        Public Property TotalRecords() As Integer
            Get
                If _TotalRecords < 0 
                    _TotalRecords = WPR_Activity1Table.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause())
                End If
                Return Me._TotalRecords
            End Get
            Set(ByVal value As Integer)
...
#Region "Helper Functions"
        ...
        Public Overrides Overloads Function EvaluateExpressions(url As String, arg As String, ByVal bEncrypt As Boolean) As String
            Dim needToProcess As Boolean = AreAnyUrlParametersForMe(url, arg)
            If (needToProcess) Then
                Dim recCtl As WPR_Activity1TableControlRow = Me.GetSelectedRecordControl()
                If recCtl Is Nothing AndAlso url.IndexOf("{") >= 0 Then
                    ' Localization.
                    Throw New Exception(Page.GetResourceValue("Err:NoRecSelected", "ePortalWFApproval"))
                End If
        ...
        Public Overridable Function GetSelectedRecordControl() As WPR_Activity1TableControlRow
            Return Nothing
          
        End Function

        Public Overridable Function GetSelectedRecordControls() As WPR_Activity1TableControlRow()
        
            Return DirectCast((new ArrayList()).ToArray(GetType(WPR_Activity1TableControlRow)), WPR_Activity1TableControlRow())
          
        End Function

        Public Overridable Sub DeleteSelectedRecords(ByVal deferDeletion As Boolean)
            Dim recList() As WPR_Activity1TableControlRow = Me.GetSelectedRecordControls()
            If recList.Length = 0 Then
                ' Localization.
                Throw New Exception(Page.GetResourceValue("Err:NoRecSelected", "ePortalWFApproval"))
            End If
        ...
        Public Overridable Function GetRecordControls() As WPR_Activity1TableControlRow()
            Dim recCtrls() As Control = BaseClasses.Utils.MiscUtils.FindControlsRecursively(Me, "WPR_Activity1TableControlRow")
            Dim list As New List(Of WPR_Activity1TableControlRow)
            For Each recCtrl As WPR_Activity1TableControlRow In recCtrls
                list.Add(recCtrl)
            Next
            Return list.ToArray()
        End Function
...
' Base class for the WPR_Doc_Attach1TableControlRow control on the Show_WPR_Doc1 page.
' Do not modify this class. Instead override any method in WPR_Doc_Attach1TableControlRow.
Public Class BaseWPR_Doc_Attach1TableControlRow
        Inherits ePortalWFApproval.UI.BaseApplicationRecordControl

        '  To customize, override this method in WPR_Doc_Attach1TableControlRow.
        Protected Overridable Sub Control_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Init
        ...
        Public Overridable Sub LoadData()        
            ...
            ' Load the data from the database into the DataSource DatabaseANFLO-WFN%dbo.WPR_Doc_Attach record.
            ' It is better to make changes to functions called by LoadData such as
            ' CreateWhereClause, rather than making changes here.
            ...
            If Me.RecordUniqueId IsNot Nothing AndAlso Me.RecordUniqueId.Trim <> "" Then
                Me.DataSource = WPR_Doc_Attach1Table.GetRecord(Me.RecordUniqueId, True)
          
                Return
            End If
        
            ' Since this is a row in the table, the data for this row is loaded by the 
            ' LoadData method of the BaseWPR_Doc_Attach1TableControl when the data for the entire
            ' table is loaded.
            
            Me.DataSource = New WPR_Doc_Attach1Record()
          
    
    
        End Sub

        ' Populate the UI controls using the DataSource.  To customize, override this method in WPR_Doc_Attach1TableControlRow.
        Public Overrides Sub DataBind()
            ' The DataBind method binds the user interface controls to the values
            ' from the database record.  To do this, it calls the Set methods for 
            ' each of the field displayed on the webpage.  It is better to make 
        ...
        Public Overridable Sub SetWPRDA_Desc()
            ...
            ' DatabaseANFLO-WFN%dbo.WPR_Doc_Attach database record.

            ' Me.DataSource is the DatabaseANFLO-WFN%dbo.WPR_Doc_Attach record retrieved from the database.
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRDA_DescSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Doc_Attach1Table.WPRDA_Desc)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRDA_Desc.Text = WPR_Doc_Attach1Table.WPRDA_Desc.Format(WPR_Doc_Attach1Table.WPRDA_Desc.DefaultValue)
        ...
        Public Overridable Sub SetWPRDA_File()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRDA_FileSpecified Then
                ...
                Me.WPRDA_File.OnClientClick = "window.open('../Shared/ExportFieldValue.aspx?Table=" & _
                            Me.Page.Encrypt("WPR_Doc_Attach1") & _
        ...
        Public Overridable Sub SetWPRDA_WAT_ID()
            ...
            Else
                ...
                If Me.DataSource IsNot Nothing AndAlso Me.DataSource.IsCreated Then
                    selectedValue = Nothing
                Else
                    selectedValue = WPR_Doc_Attach1Table.WPRDA_WAT_ID.DefaultValue
                End If
        ...
        Dim parentCtrl As WPR_DocRecordControl
          ...
          If (Not IsNothing(parentCtrl) AndAlso IsNothing(parentCtrl.DataSource)) 
            ...
            If Me.DataSource.IsAnyValueChanged Then
                ...
                DirectCast(GetParentControlObject(Me, "WPR_Doc_Attach1TableControl"), WPR_Doc_Attach1TableControl).DataChanged = True
                DirectCast(GetParentControlObject(Me, "WPR_Doc_Attach1TableControl"), WPR_Doc_Attach1TableControl).ResetData = True
            End If
        ...
        Public Overridable Sub Delete()
            ...
            Dim pkValue As KeyValue = KeyValue.XmlToKey(Me.RecordUniqueId)
          WPR_Doc_Attach1Table.DeleteRecord(pkValue)
                    ...
                    For each itemValue As WAttach_Type1Record In itemValues
                        ...
                        If itemValue.WAT_IDSpecified Then
                            ...
                            If counter < maxItems AndAlso Me.WPRDA_WAT_ID.Items.FindByValue(cvalue) Is Nothing Then
                                ...
                                Dim _isExpandableNonCompositeForeignKey As Boolean = WPR_Doc_Attach1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WPR_Doc_Attach1Table.WPRDA_WAT_ID)
                                If _isExpandableNonCompositeForeignKey AndAlso WPR_Doc_Attach1Table.WPRDA_WAT_ID.IsApplyDisplayAs Then
                                fvalue = WPR_Doc_Attach1Table.GetDFKA(itemValue, WPR_Doc_Attach1Table.WPRDA_WAT_ID)
                                End If
        ...
        Public Property RecordUniqueId() As String
            Get
                Return CType(Me.ViewState("BaseWPR_Doc_Attach1TableControlRow_Rec"), String)
            End Get
            Set(ByVal value As String)
                Me.ViewState("BaseWPR_Doc_Attach1TableControlRow_Rec") = value
            End Set
        End Property
            
        Public Property DataSource() As WPR_Doc_Attach1Record
            Get
                Return DirectCast(MyBase._DataSource, WPR_Doc_Attach1Record)
            End Get
            Set(ByVal value As WPR_Doc_Attach1Record)
                Me._DataSource = value
            End Set
        End Property
...
#Region "Helper Functions"
        ...
        Public Overrides Overloads Function EvaluateExpressions(ByVal url As String, ByVal arg As String, ByVal bEncrypt As Boolean) As String
            ...
            Dim rec As WPR_Doc_Attach1Record = Nothing
        ...
        Public Overridable Function GetRecord() As WPR_Doc_Attach1Record
            If Not Me.DataSource Is Nothing Then
                Return Me.DataSource
            End If
            ...
            If Not Me.RecordUniqueId Is Nothing Then
                ...
                Return WPR_Doc_Attach1Table.GetRecord(Me.RecordUniqueId, True)
...
' Base class for the WPR_Doc_Attach1TableControl control on the Show_WPR_Doc1 page.
' Do not modify this class. Instead override any method in WPR_Doc_Attach1TableControl.
Public Class BaseWPR_Doc_Attach1TableControl
        Inherits ePortalWFApproval.UI.BaseApplicationTableControl
    ...
    ' Setup default pagination settings.
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                If wc IsNot Nothing AndAlso Not wc.RunQuery Then
                    ' Initialize an empty array of records
                    Dim alist As New ArrayList(0)
                    Me.DataSource = DirectCast(alist.ToArray(GetType(WPR_Doc_Attach1Record)), WPR_Doc_Attach1Record())
                    ' Add records to the list if needed.
                    Me.AddNewRecords()
                    Me._TotalRecords = 0
                    Me._TotalPages = 0
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    Dim postdata As New ArrayList
                    For Each rc As WPR_Doc_Attach1TableControlRow In Me.GetRecordControls()
                        If Not rc.IsNewRecord Then
                            rc.DataSource = rc.GetRecord()
                            rc.GetUIData()
                            postdata.Add(rc.DataSource)
                        ...
                        End If
                    Next
                    Me.DataSource = DirectCast(postdata.ToArray(GetType(WPR_Doc_Attach1Record)), WPR_Doc_Attach1Record())
                Else  ' Get the records from the database	
        ...
        Public Overridable Function GetRecords( _
            ...
            ByVal orderBy As OrderBy, _
            ByVal pageIndex As Integer, _
            ByVal pageSize As Integer) As WPR_Doc_Attach1Record()
            ...
            ' However, if you don't specify PK, row button click might show an error message.
            ' And make sure you write similar code in GetRecordCount as well
            ' selCols.Add(WPR_Doc_Attach1Table.Column1, True)         
            ' selCols.Add(WPR_Doc_Attach1Table.Column2, True)          
            ' selCols.Add(WPR_Doc_Attach1Table.Column3, True)    
            ...
            If selCols.Count = 0 Then                    
                ...
                Return WPR_Doc_Attach1Table.GetRecords(join, where, orderBy, Me.PageIndex, Me.PageSize)
                 
            Else
                Dim databaseTable As New WPR_Doc_Attach1Table
                databaseTable.SelectedColumns.Clear()
                databaseTable.SelectedColumns.AddRange(selCols)
                ...
                orderBy.ExpandForeignKeyColums = False
                recList = databaseTable.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
                Return CType(recList.ToArray(GetType(WPR_Doc_Attach1Record)), WPR_Doc_Attach1Record())
            End If            
        ...
        Public Overridable Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
            ...
            If selCols.Count = 0 Then                    
                ...
                Return WPR_Doc_Attach1Table.GetRecordCount(join, where)
        ...
        Public Overrides Sub DataBind()
          ...
          Dim rep As System.Web.UI.WebControls.Repeater = CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "WPR_Doc_Attach1TableControlRepeater"), System.Web.UI.WebControls.Repeater)
          If rep Is Nothing Then Return
          rep.DataSource = DataSource()
          rep.DataBind()
          ...
          For Each repItem As System.Web.UI.WebControls.RepeaterItem In rep.Items
            ...
            ' Loop through all rows in the table, set its DataSource and call DataBind().
            Dim recControl As WPR_Doc_Attach1TableControlRow = DirectCast(repItem.FindControl("WPR_Doc_Attach1TableControlRow"), WPR_Doc_Attach1TableControlRow)
            recControl.DataSource = Me.DataSource(index)          
            If Me.UIData.Count > index Then
              recControl.PreviousUIData = Me.UIData(index)
            End If
    ...
    End Sub
          ...
          End If
            ...
            Me.Page.PregetDfkaRecords(WPR_Doc_Attach1Table.WPRDA_WAT_ID, Me.DataSource)
        ...
        Protected Overridable Sub BindPaginationControls()
            ...
            ' Bind the buttons for WPR_Doc_Attach1TableControl pagination.
        ...
        Public Overridable Sub SaveData()
            ...
            Dim recCtl As WPR_Doc_Attach1TableControlRow
            For Each recCtl In Me.GetRecordControls()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            'This CreateWhereClause is used for loading the data.
            WPR_Doc_Attach1Table.Instance.InnerFilter = Nothing
            Dim wc As WhereClause = New WhereClause()
      ...
      Dim selectedRecordKeyValue as KeyValue = New KeyValue()
              ...
              Dim wPR_DocRecordControlObj as WPR_DocRecordControl = DirectCast(MiscUtils.GetParentControlObject(Me, "WPR_DocRecordControl") ,WPR_DocRecordControl)
                ...
                If (Not IsNothing(wPR_DocRecordControlObj) AndAlso Not IsNothing(wPR_DocRecordControlObj.GetRecord()) AndAlso wPR_DocRecordControlObj.GetRecord().IsCreated AndAlso Not IsNothing(wPR_DocRecordControlObj.GetRecord().WPRD_ID))
                    wc.iAND(WPR_Doc_Attach1Table.WPRDA_WPRD_ID, BaseFilter.ComparisonOperator.EqualsTo, wPR_DocRecordControlObj.GetRecord().WPRD_ID.ToString())
                    selectedRecordKeyValue.AddElement(WPR_Doc_Attach1Table.WPRDA_WPRD_ID.InternalName, wPR_DocRecordControlObj.GetRecord().WPRD_ID.ToString())
                Else
                    wc.RunQuery = False
                    Return wc                    
                End If          
              
      HttpContext.Current.Session("WPR_Doc_Attach1TableControlWhereClause") = selectedRecordKeyValue.ToXmlString()
    ...
    End Function
      ...
      Dim appRelativeVirtualPath As String = CType(HttpContext.Current.Session("AppRelativeVirtualPath"), String)
            ...
            Dim selectedRecordInWPR_DocRecordControl as String = DirectCast(HttpContext.Current.Session("WPR_Doc_Attach1TableControlWhereClause"), String)
            
            If Not selectedRecordInWPR_DocRecordControl Is Nothing AndAlso KeyValue.IsXmlKey(selectedRecordInWPR_DocRecordControl) Then
                Dim selectedRecordKeyValue as KeyValue = KeyValue.XmlToKey(selectedRecordInWPR_DocRecordControl)
                
       If Not IsNothing(selectedRecordKeyValue) AndAlso selectedRecordKeyValue.ContainsColumn(WPR_Doc_Attach1Table.WPRDA_WPRD_ID) Then
            wc.iAND(WPR_Doc_Attach1Table.WPRDA_WPRD_ID, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(WPR_Doc_Attach1Table.WPRDA_WPRD_ID).ToString())
       End If
    ...
    Dim recControl As WPR_Doc_Attach1TableControlRow = DirectCast(repItem.FindControl("WPR_Doc_Attach1TableControlRow"), WPR_Doc_Attach1TableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        Dim rec As WPR_Doc_Attach1Record = New WPR_Doc_Attach1Record()
        
                        If recControl.WPRDA_Desc.Text <> "" Then
                            rec.Parse(recControl.WPRDA_Desc.Text, WPR_Doc_Attach1Table.WPRDA_Desc)
                        End If
                        If recControl.WPRDA_File.Text <> "" Then
                            rec.Parse(recControl.WPRDA_File.Text, WPR_Doc_Attach1Table.WPRDA_File)
                        End If
                        If MiscUtils.IsValueSelected(recControl.WPRDA_WAT_ID) Then
                            rec.Parse(recControl.WPRDA_WAT_ID.SelectedItem.Value, WPR_Doc_Attach1Table.WPRDA_WAT_ID)
                        End If
                        newUIDataList.Add(recControl.PreservedUIData())	  
                        newRecordList.Add(rec)
                    End If
            ...
            For index = 1 To Me.AddNewRecord
                ...
                newRecordList.Insert(0, New WPR_Doc_Attach1Record())
                newUIDataList.Insert(0, New Hashtable())				
            ...
            If newRecordList.Count > 0 Then
                ...
                Me.DataSource = DirectCast(finalList.ToArray(GetType(WPR_Doc_Attach1Record)), WPR_Doc_Attach1Record())
        ...
        Public Sub AddToDeletedRecordIds(ByVal rec As WPR_Doc_Attach1TableControlRow)
            If rec.IsNewRecord() Then
                Return
            End If
        ...
        Protected Overridable Function InDeletedRecordIds(ByVal rec As WPR_Doc_Attach1TableControlRow) As Boolean
            If Me.DeletedRecordIds Is Nothing OrElse Me.DeletedRecordIds.Trim = "" Then
                Return False
            End If
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Me.RemoveFromSession(Me, "Page_Size")
        ...
        Protected Overrides Sub LoadViewState(ByVal savedState As Object)
            ...
            Dim orderByStr As String = CType(ViewState("WPR_Doc_Attach1TableControl_OrderBy"), String)
        ...
        Protected Overrides Function SaveViewState() As Object
            ...
            If Me.CurrentSortOrder IsNot Nothing Then
                Me.ViewState("WPR_Doc_Attach1TableControl_OrderBy") = Me.CurrentSortOrder.ToXmlString()
            End If
        ...
        Public Property TotalRecords() As Integer
            Get
                If _TotalRecords < 0 
                    _TotalRecords = WPR_Doc_Attach1Table.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause())
                End If
                Return Me._TotalRecords
            End Get
            Set(ByVal value As Integer)
...
#Region "Helper Functions"
        ...
        Public Overrides Overloads Function EvaluateExpressions(url As String, arg As String, ByVal bEncrypt As Boolean) As String
            Dim needToProcess As Boolean = AreAnyUrlParametersForMe(url, arg)
            If (needToProcess) Then
                Dim recCtl As WPR_Doc_Attach1TableControlRow = Me.GetSelectedRecordControl()
                If recCtl Is Nothing AndAlso url.IndexOf("{") >= 0 Then
                    ' Localization.
                    Throw New Exception(Page.GetResourceValue("Err:NoRecSelected", "ePortalWFApproval"))
                End If
        ...
        Public Overridable Function GetSelectedRecordControl() As WPR_Doc_Attach1TableControlRow
            Return Nothing
          
        End Function

        Public Overridable Function GetSelectedRecordControls() As WPR_Doc_Attach1TableControlRow()
        
            Return DirectCast((new ArrayList()).ToArray(GetType(WPR_Doc_Attach1TableControlRow)), WPR_Doc_Attach1TableControlRow())
          
        End Function

        Public Overridable Sub DeleteSelectedRecords(ByVal deferDeletion As Boolean)
            Dim recList() As WPR_Doc_Attach1TableControlRow = Me.GetSelectedRecordControls()
            If recList.Length = 0 Then
                ' Localization.
                Throw New Exception(Page.GetResourceValue("Err:NoRecSelected", "ePortalWFApproval"))
            End If
        ...
        Public Overridable Function GetRecordControls() As WPR_Doc_Attach1TableControlRow()
            Dim recCtrls() As Control = BaseClasses.Utils.MiscUtils.FindControlsRecursively(Me, "WPR_Doc_Attach1TableControlRow")
            Dim list As New List(Of WPR_Doc_Attach1TableControlRow)
            For Each recCtrl As WPR_Doc_Attach1TableControlRow In recCtrls
                list.Add(recCtrl)
            Next
            Return list.ToArray()
        End Function
...
' Base class for the WPR_Line1TableControlRow control on the Show_WPR_Doc1 page.
' Do not modify this class. Instead override any method in WPR_Line1TableControlRow.
Public Class BaseWPR_Line1TableControlRow
        Inherits ePortalWFApproval.UI.BaseApplicationRecordControl

        '  To customize, override this method in WPR_Line1TableControlRow.
        Protected Overridable Sub Control_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Init
        ...
        Public Overridable Sub LoadData()        
            ...
            ' Load the data from the database into the DataSource DatabaseANFLO-WFN%dbo.WPR_Line record.
            ' It is better to make changes to functions called by LoadData such as
            ' CreateWhereClause, rather than making changes here.
            ...
            If Me.RecordUniqueId IsNot Nothing AndAlso Me.RecordUniqueId.Trim <> "" Then
                Me.DataSource = WPR_Line1Table.GetRecord(Me.RecordUniqueId, True)
          
                Return
            End If
        
            ' Since this is a row in the table, the data for this row is loaded by the 
            ' LoadData method of the BaseWPR_Line1TableControl when the data for the entire
            ' table is loaded.
            
            Me.DataSource = New WPR_Line1Record()
          
    
    
        End Sub

        ' Populate the UI controls using the DataSource.  To customize, override this method in WPR_Line1TableControlRow.
        Public Overrides Sub DataBind()
            ' The DataBind method binds the user interface controls to the values
            ' from the database record.  To do this, it calls the Set methods for 
            ' each of the field displayed on the webpage.  It is better to make 
        ...
        Public Overridable Sub SetWPRL_Account()
            ...
            ' DatabaseANFLO-WFN%dbo.WPR_Line database record.

            ' Me.DataSource is the DatabaseANFLO-WFN%dbo.WPR_Line record retrieved from the database.
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRL_AccountSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Line1Table.WPRL_Account)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRL_Account.Text = WPR_Line1Table.WPRL_Account.Format(WPR_Line1Table.WPRL_Account.DefaultValue)
        ...
        Public Overridable Sub SetWPRL_Ext_Price()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRL_Ext_PriceSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Line1Table.WPRL_Ext_Price, "#,#.0000")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRL_Ext_Price.Text = WPR_Line1Table.WPRL_Ext_Price.Format(WPR_Line1Table.WPRL_Ext_Price.DefaultValue, "#,#.0000")
        ...
        Public Overridable Sub SetWPRL_GL00101_Acct_Indx()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRL_GL00101_Acct_IndxSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                Dim formattedValue As String = ""
                Dim _isExpandableNonCompositeForeignKey As Boolean = WPR_Line1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WPR_Line1Table.WPRL_GL00101_Acct_Indx)
                If _isExpandableNonCompositeForeignKey AndAlso WPR_Line1Table.WPRL_GL00101_Acct_Indx.IsApplyDisplayAs Then
                                  
                       formattedValue = WPR_Line1Table.GetDFKA(Me.DataSource.WPRL_GL00101_Acct_Indx.ToString(),WPR_Line1Table.WPRL_GL00101_Acct_Indx, Nothing)
                                    
                       If (formattedValue Is Nothing) Then
                              formattedValue = Me.DataSource.Format(WPR_Line1Table.WPRL_GL00101_Acct_Indx)
                       End If
                Else
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRL_GL00101_Acct_Indx.Text = WPR_Line1Table.WPRL_GL00101_Acct_Indx.Format(WPR_Line1Table.WPRL_GL00101_Acct_Indx.DefaultValue)
        ...
        Public Overridable Sub SetWPRL_Item_Comment()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRL_Item_CommentSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Line1Table.WPRL_Item_Comment)
                ...
                If Not formattedValue is Nothing Then
                    ...
                    If originalLength >= popupThreshold Then
                        ...
                        Dim name As String = HttpUtility.HtmlEncode(WPR_Line1Table.WPRL_Item_Comment.Name)
                        ...
                        formattedValue= "<a onclick='gPersist=true;' class='truncatedText' onmouseout='detailRolloverPopupClose();' " _
                            & "onmouseover='SaveMousePosition(event); delayRolloverPopup(""PageMethods.GetRecordFieldValue(\""ePortalWFApproval.Business.WPR_Line1Table, App_Code\"",\""" _
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRL_Item_Comment.Text = WPR_Line1Table.WPRL_Item_Comment.Format(WPR_Line1Table.WPRL_Item_Comment.DefaultValue)
        ...
        Public Overridable Sub SetWPRL_Item_Desc()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRL_Item_DescSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Line1Table.WPRL_Item_Desc)
                ...
                If Not formattedValue is Nothing Then
                    ...
                    If originalLength >= popupThreshold Then
                        ...
                        Dim name As String = HttpUtility.HtmlEncode(WPR_Line1Table.WPRL_Item_Desc.Name)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRL_Item_Desc.Text = WPR_Line1Table.WPRL_Item_Desc.Format(WPR_Line1Table.WPRL_Item_Desc.DefaultValue)
        ...
        Public Overridable Sub SetWPRL_Item_Non_Inv()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRL_Item_Non_InvSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Line1Table.WPRL_Item_Non_Inv)
                ...
                If Not formattedValue is Nothing Then
                    ...
                    If originalLength >= popupThreshold Then
                        ...
                        Dim name As String = HttpUtility.HtmlEncode(WPR_Line1Table.WPRL_Item_Non_Inv.Name)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRL_Item_Non_Inv.Text = WPR_Line1Table.WPRL_Item_Non_Inv.Format(WPR_Line1Table.WPRL_Item_Non_Inv.DefaultValue)
        ...
        Public Overridable Sub SetWPRL_Item_Non_Inv_UOM()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRL_Item_Non_Inv_UOMSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Line1Table.WPRL_Item_Non_Inv_UOM)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRL_Item_Non_Inv_UOM.Text = WPR_Line1Table.WPRL_Item_Non_Inv_UOM.Format(WPR_Line1Table.WPRL_Item_Non_Inv_UOM.DefaultValue)
        ...
        Public Overridable Sub SetWPRL_Item_Text()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRL_Item_TextSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Line1Table.WPRL_Item_Text)
                ...
                If Not formattedValue is Nothing Then
                    ...
                    If originalLength >= popupThreshold Then
                        ...
                        Dim name As String = HttpUtility.HtmlEncode(WPR_Line1Table.WPRL_Item_Text.Name)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRL_Item_Text.Text = WPR_Line1Table.WPRL_Item_Text.Format(WPR_Line1Table.WPRL_Item_Text.DefaultValue)
        ...
        Public Overridable Sub SetWPRL_IV00101_Item_No()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRL_IV00101_Item_NoSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                Dim formattedValue As String = ""
                Dim _isExpandableNonCompositeForeignKey As Boolean = WPR_Line1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WPR_Line1Table.WPRL_IV00101_Item_No)
                If _isExpandableNonCompositeForeignKey AndAlso WPR_Line1Table.WPRL_IV00101_Item_No.IsApplyDisplayAs Then
                                  
                       formattedValue = WPR_Line1Table.GetDFKA(Me.DataSource.WPRL_IV00101_Item_No.ToString(),WPR_Line1Table.WPRL_IV00101_Item_No, Nothing)
                                    
                       If (formattedValue Is Nothing) Then
                              formattedValue = Me.DataSource.Format(WPR_Line1Table.WPRL_IV00101_Item_No)
                       End If
                Else
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRL_IV00101_Item_No.Text = WPR_Line1Table.WPRL_IV00101_Item_No.Format(WPR_Line1Table.WPRL_IV00101_Item_No.DefaultValue)
        ...
        Public Overridable Sub SetWPRL_IV00101_Prchs_UOM()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRL_IV00101_Prchs_UOMSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Line1Table.WPRL_IV00101_Prchs_UOM)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRL_IV00101_Prchs_UOM.Text = WPR_Line1Table.WPRL_IV00101_Prchs_UOM.Format(WPR_Line1Table.WPRL_IV00101_Prchs_UOM.DefaultValue)
        ...
        Public Overridable Sub SetWPRL_IV40700_Locn_Code()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRL_IV40700_Locn_CodeSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                Dim formattedValue As String = ""
                Dim _isExpandableNonCompositeForeignKey As Boolean = WPR_Line1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WPR_Line1Table.WPRL_IV40700_Locn_Code)
                If _isExpandableNonCompositeForeignKey AndAlso WPR_Line1Table.WPRL_IV40700_Locn_Code.IsApplyDisplayAs Then
                                  
                       formattedValue = WPR_Line1Table.GetDFKA(Me.DataSource.WPRL_IV40700_Locn_Code.ToString(),WPR_Line1Table.WPRL_IV40700_Locn_Code, Nothing)
                                    
                       If (formattedValue Is Nothing) Then
                              formattedValue = Me.DataSource.Format(WPR_Line1Table.WPRL_IV40700_Locn_Code)
                       End If
                Else
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRL_IV40700_Locn_Code.Text = WPR_Line1Table.WPRL_IV40700_Locn_Code.Format(WPR_Line1Table.WPRL_IV40700_Locn_Code.DefaultValue)
        ...
        Public Overridable Sub SetWPRL_Line_Seq_No()
            ...
            ' Set the WPRL_PO_Line_Seq_No TextBox on the webpage with value from the
            ' DatabaseANFLO-WFN%dbo.WPR_Line database record.
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRL_PO_Line_Seq_NoSpecified Then
                				
                ' If the WPRL_PO_Line_Seq_No is non-NULL, then format the value.

                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Line1Table.WPRL_PO_Line_Seq_No)
                              
                Me.WPRL_Line_Seq_No.Text = formattedValue
                
            Else 
            
                ' WPRL_PO_Line_Seq_No is NULL in the database, so use the Default Value.  
                ' Default Value could also be NULL.
        
                 Me.WPRL_Line_Seq_No.Text = WPR_Line1Table.WPRL_PO_Line_Seq_No.Format(WPR_Line1Table.WPRL_PO_Line_Seq_No.DefaultValue)
        ...
        Public Overridable Sub SetWPRL_Qty()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRL_QtySpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Line1Table.WPRL_Qty, "#,#.00")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRL_Qty.Text = WPR_Line1Table.WPRL_Qty.Format(WPR_Line1Table.WPRL_Qty.DefaultValue, "#,#.00")
        ...
        Public Overridable Sub SetWPRL_Required_Date()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRL_Required_DateSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Line1Table.WPRL_Required_Date, "d")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRL_Required_Date.Text = WPR_Line1Table.WPRL_Required_Date.Format(WPR_Line1Table.WPRL_Required_Date.DefaultValue, "d")
        ...
        Public Overridable Sub SetWPRL_Unit_Price()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRL_Unit_PriceSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Line1Table.WPRL_Unit_Price, "#,#.00")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRL_Unit_Price.Text = WPR_Line1Table.WPRL_Unit_Price.Format(WPR_Line1Table.WPRL_Unit_Price.DefaultValue, "#,#.00")
        ...
        Dim parentCtrl As WPR_DocRecordControl
          ...
          If (Not IsNothing(parentCtrl) AndAlso IsNothing(parentCtrl.DataSource)) 
            ...
            If Me.DataSource.IsAnyValueChanged Then
                ...
                DirectCast(GetParentControlObject(Me, "WPR_Line1TableControl"), WPR_Line1TableControl).DataChanged = True
                DirectCast(GetParentControlObject(Me, "WPR_Line1TableControl"), WPR_Line1TableControl).ResetData = True
            End If
        ...
        Public Overridable Sub Delete()
            ...
            Dim pkValue As KeyValue = KeyValue.XmlToKey(Me.RecordUniqueId)
          WPR_Line1Table.DeleteRecord(pkValue)
        ...
        Public Property RecordUniqueId() As String
            Get
                Return CType(Me.ViewState("BaseWPR_Line1TableControlRow_Rec"), String)
            End Get
            Set(ByVal value As String)
                Me.ViewState("BaseWPR_Line1TableControlRow_Rec") = value
            End Set
        End Property
            
        Public Property DataSource() As WPR_Line1Record
            Get
                Return DirectCast(MyBase._DataSource, WPR_Line1Record)
            End Get
            Set(ByVal value As WPR_Line1Record)
                Me._DataSource = value
            End Set
        End Property
...
#Region "Helper Functions"
        ...
        Public Overrides Overloads Function EvaluateExpressions(ByVal url As String, ByVal arg As String, ByVal bEncrypt As Boolean) As String
            ...
            Dim rec As WPR_Line1Record = Nothing
        ...
        Public Overridable Function GetRecord() As WPR_Line1Record
            If Not Me.DataSource Is Nothing Then
                Return Me.DataSource
            End If
            ...
            If Not Me.RecordUniqueId Is Nothing Then
                ...
                Return WPR_Line1Table.GetRecord(Me.RecordUniqueId, True)
...
' Base class for the WPR_Line1TableControl control on the Show_WPR_Doc1 page.
' Do not modify this class. Instead override any method in WPR_Line1TableControl.
Public Class BaseWPR_Line1TableControl
        Inherits ePortalWFApproval.UI.BaseApplicationTableControl
        ...
        Protected Overridable Sub Control_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Init
           ...
           ' Setup the filter and search.
            ...
            Else
                ...
                Me.CurrentSortOrder.Add(WPR_Line1Table.WPRL_PO_Line_Seq_No, OrderByItem.OrderDir.Asc)
    ...
    ' Setup default pagination settings.
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                If wc IsNot Nothing AndAlso Not wc.RunQuery Then
                    ' Initialize an empty array of records
                    Dim alist As New ArrayList(0)
                    Me.DataSource = DirectCast(alist.ToArray(GetType(WPR_Line1Record)), WPR_Line1Record())
                    ' Add records to the list if needed.
                    Me.AddNewRecords()
                    Me._TotalRecords = 0
                    Me._TotalPages = 0
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    Dim postdata As New ArrayList
                    For Each rc As WPR_Line1TableControlRow In Me.GetRecordControls()
                        If Not rc.IsNewRecord Then
                            rc.DataSource = rc.GetRecord()
                            rc.GetUIData()
                            postdata.Add(rc.DataSource)
                        ...
                        End If
                    Next
                    Me.DataSource = DirectCast(postdata.ToArray(GetType(WPR_Line1Record)), WPR_Line1Record())
                Else  ' Get the records from the database	
        ...
        Public Overridable Function GetRecords( _
            ...
            ByVal orderBy As OrderBy, _
            ByVal pageIndex As Integer, _
            ByVal pageSize As Integer) As WPR_Line1Record()
            ...
            ' However, if you don't specify PK, row button click might show an error message.
            ' And make sure you write similar code in GetRecordCount as well
            ' selCols.Add(WPR_Line1Table.Column1, True)         
            ' selCols.Add(WPR_Line1Table.Column2, True)          
            ' selCols.Add(WPR_Line1Table.Column3, True)    
            ...
            If selCols.Count = 0 Then                    
                ...
                Return WPR_Line1Table.GetRecords(join, where, orderBy, Me.PageIndex, Me.PageSize)
                 
            Else
                Dim databaseTable As New WPR_Line1Table
                databaseTable.SelectedColumns.Clear()
                databaseTable.SelectedColumns.AddRange(selCols)
                ...
                orderBy.ExpandForeignKeyColums = False
                recList = databaseTable.GetRecordList(join, where.GetFilter(), Nothing, orderBy, pageIndex, pageSize)
                Return CType(recList.ToArray(GetType(WPR_Line1Record)), WPR_Line1Record())
            End If            
        ...
        Public Overridable Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
            ...
            If selCols.Count = 0 Then                    
                ...
                Return WPR_Line1Table.GetRecordCount(join, where)
        ...
        Public Overrides Sub DataBind()
          ...
          Dim rep As System.Web.UI.WebControls.Repeater = CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "WPR_Line1TableControlRepeater"), System.Web.UI.WebControls.Repeater)
          If rep Is Nothing Then Return
          rep.DataSource = DataSource()
          rep.DataBind()
          ...
          For Each repItem As System.Web.UI.WebControls.RepeaterItem In rep.Items
            ...
            ' Loop through all rows in the table, set its DataSource and call DataBind().
            Dim recControl As WPR_Line1TableControlRow = DirectCast(repItem.FindControl("WPR_Line1TableControlRow"), WPR_Line1TableControlRow)
            recControl.DataSource = Me.DataSource(index)          
            If Me.UIData.Count > index Then
              recControl.PreviousUIData = Me.UIData(index)
            End If
    ...
    End Sub
          ...
          End If
            ...
            Me.Page.PregetDfkaRecords(WPR_Line1Table.WPRL_GL00101_Acct_Indx, Me.DataSource)
          
            Me.Page.PregetDfkaRecords(WPR_Line1Table.WPRL_IV00101_Item_No, Me.DataSource)
          
            Me.Page.PregetDfkaRecords(WPR_Line1Table.WPRL_IV40700_Locn_Code, Me.DataSource)
        ...
        Protected Overridable Sub BindPaginationControls()
            ...
            ' Bind the buttons for WPR_Line1TableControl pagination.
        ...
        Public Overridable Sub SaveData()
            ...
            Dim recCtl As WPR_Line1TableControlRow
            For Each recCtl In Me.GetRecordControls()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            'This CreateWhereClause is used for loading the data.
            WPR_Line1Table.Instance.InnerFilter = Nothing
            Dim wc As WhereClause = New WhereClause()
      ...
      Dim selectedRecordKeyValue as KeyValue = New KeyValue()
              ...
              Dim wPR_DocRecordControlObj as WPR_DocRecordControl = DirectCast(MiscUtils.GetParentControlObject(Me, "WPR_DocRecordControl") ,WPR_DocRecordControl)
                ...
                If (Not IsNothing(wPR_DocRecordControlObj) AndAlso Not IsNothing(wPR_DocRecordControlObj.GetRecord()) AndAlso wPR_DocRecordControlObj.GetRecord().IsCreated AndAlso Not IsNothing(wPR_DocRecordControlObj.GetRecord().WPRD_ID))
                    wc.iAND(WPR_Line1Table.WPRL_WPRD_ID, BaseFilter.ComparisonOperator.EqualsTo, wPR_DocRecordControlObj.GetRecord().WPRD_ID.ToString())
                    selectedRecordKeyValue.AddElement(WPR_Line1Table.WPRL_WPRD_ID.InternalName, wPR_DocRecordControlObj.GetRecord().WPRD_ID.ToString())
                Else
                    wc.RunQuery = False
                    Return wc                    
                End If          
              
      HttpContext.Current.Session("WPR_Line1TableControlWhereClause") = selectedRecordKeyValue.ToXmlString()
    ...
    End Function
      ...
      Dim appRelativeVirtualPath As String = CType(HttpContext.Current.Session("AppRelativeVirtualPath"), String)
            ...
            Dim selectedRecordInWPR_DocRecordControl as String = DirectCast(HttpContext.Current.Session("WPR_Line1TableControlWhereClause"), String)
            
            If Not selectedRecordInWPR_DocRecordControl Is Nothing AndAlso KeyValue.IsXmlKey(selectedRecordInWPR_DocRecordControl) Then
                Dim selectedRecordKeyValue as KeyValue = KeyValue.XmlToKey(selectedRecordInWPR_DocRecordControl)
                
       If Not IsNothing(selectedRecordKeyValue) AndAlso selectedRecordKeyValue.ContainsColumn(WPR_Line1Table.WPRL_WPRD_ID) Then
            wc.iAND(WPR_Line1Table.WPRL_WPRD_ID, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(WPR_Line1Table.WPRL_WPRD_ID).ToString())
       End If
    ...
    Dim recControl As WPR_Line1TableControlRow = DirectCast(repItem.FindControl("WPR_Line1TableControlRow"), WPR_Line1TableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        Dim rec As WPR_Line1Record = New WPR_Line1Record()
        
                        If recControl.WPRL_Account.Text <> "" Then
                            rec.Parse(recControl.WPRL_Account.Text, WPR_Line1Table.WPRL_Account)
                        End If
                        If recControl.WPRL_Ext_Price.Text <> "" Then
                            rec.Parse(recControl.WPRL_Ext_Price.Text, WPR_Line1Table.WPRL_Ext_Price)
                        End If
                        If recControl.WPRL_GL00101_Acct_Indx.Text <> "" Then
                            rec.Parse(recControl.WPRL_GL00101_Acct_Indx.Text, WPR_Line1Table.WPRL_GL00101_Acct_Indx)
                        End If
                        If recControl.WPRL_Item_Comment.Text <> "" Then
                            rec.Parse(recControl.WPRL_Item_Comment.Text, WPR_Line1Table.WPRL_Item_Comment)
                        End If
                        If recControl.WPRL_Item_Desc.Text <> "" Then
                            rec.Parse(recControl.WPRL_Item_Desc.Text, WPR_Line1Table.WPRL_Item_Desc)
                        End If
                        If recControl.WPRL_Item_Non_Inv.Text <> "" Then
                            rec.Parse(recControl.WPRL_Item_Non_Inv.Text, WPR_Line1Table.WPRL_Item_Non_Inv)
                        End If
                        If recControl.WPRL_Item_Non_Inv_UOM.Text <> "" Then
                            rec.Parse(recControl.WPRL_Item_Non_Inv_UOM.Text, WPR_Line1Table.WPRL_Item_Non_Inv_UOM)
                        End If
                        If recControl.WPRL_Item_Text.Text <> "" Then
                            rec.Parse(recControl.WPRL_Item_Text.Text, WPR_Line1Table.WPRL_Item_Text)
                        End If
                        If recControl.WPRL_IV00101_Item_No.Text <> "" Then
                            rec.Parse(recControl.WPRL_IV00101_Item_No.Text, WPR_Line1Table.WPRL_IV00101_Item_No)
                        End If
                        If recControl.WPRL_IV00101_Prchs_UOM.Text <> "" Then
                            rec.Parse(recControl.WPRL_IV00101_Prchs_UOM.Text, WPR_Line1Table.WPRL_IV00101_Prchs_UOM)
                        End If
                        If recControl.WPRL_IV40700_Locn_Code.Text <> "" Then
                            rec.Parse(recControl.WPRL_IV40700_Locn_Code.Text, WPR_Line1Table.WPRL_IV40700_Locn_Code)
                        End If
                        If recControl.WPRL_Line_Seq_No.Text <> "" Then
                            rec.Parse(recControl.WPRL_Line_Seq_No.Text, WPR_Line1Table.WPRL_PO_Line_Seq_No)
                        End If
                        If recControl.WPRL_Qty.Text <> "" Then
                            rec.Parse(recControl.WPRL_Qty.Text, WPR_Line1Table.WPRL_Qty)
                        End If
                        If recControl.WPRL_Required_Date.Text <> "" Then
                            rec.Parse(recControl.WPRL_Required_Date.Text, WPR_Line1Table.WPRL_Required_Date)
                        End If
                        If recControl.WPRL_Unit_Price.Text <> "" Then
                            rec.Parse(recControl.WPRL_Unit_Price.Text, WPR_Line1Table.WPRL_Unit_Price)
                        End If
                        newUIDataList.Add(recControl.PreservedUIData())	  
                        newRecordList.Add(rec)
                    End If
            ...
            For index = 1 To Me.AddNewRecord
                ...
                newRecordList.Insert(0, New WPR_Line1Record())
                newUIDataList.Insert(0, New Hashtable())				
            ...
            If newRecordList.Count > 0 Then
                ...
                Me.DataSource = DirectCast(finalList.ToArray(GetType(WPR_Line1Record)), WPR_Line1Record())
        ...
        Public Sub AddToDeletedRecordIds(ByVal rec As WPR_Line1TableControlRow)
            If rec.IsNewRecord() Then
                Return
            End If
        ...
        Protected Overridable Function InDeletedRecordIds(ByVal rec As WPR_Line1TableControlRow) As Boolean
            If Me.DeletedRecordIds Is Nothing OrElse Me.DeletedRecordIds.Trim = "" Then
                Return False
            End If
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Me.RemoveFromSession(Me, "Page_Size")
        ...
        Protected Overrides Sub LoadViewState(ByVal savedState As Object)
            ...
            Dim orderByStr As String = CType(ViewState("WPR_Line1TableControl_OrderBy"), String)
        ...
        Protected Overrides Function SaveViewState() As Object
            ...
            If Me.CurrentSortOrder IsNot Nothing Then
                Me.ViewState("WPR_Line1TableControl_OrderBy") = Me.CurrentSortOrder.ToXmlString()
            End If
        ...
        Public Property TotalRecords() As Integer
            Get
                If _TotalRecords < 0 
                    _TotalRecords = WPR_Line1Table.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause())
                End If
                Return Me._TotalRecords
            End Get
            Set(ByVal value As Integer)
...
#Region "Helper Functions"
        ...
        Public Overrides Overloads Function EvaluateExpressions(url As String, arg As String, ByVal bEncrypt As Boolean) As String
            Dim needToProcess As Boolean = AreAnyUrlParametersForMe(url, arg)
            If (needToProcess) Then
                Dim recCtl As WPR_Line1TableControlRow = Me.GetSelectedRecordControl()
                If recCtl Is Nothing AndAlso url.IndexOf("{") >= 0 Then
                    ' Localization.
                    Throw New Exception(Page.GetResourceValue("Err:NoRecSelected", "ePortalWFApproval"))
                End If
        ...
        Public Overridable Function GetSelectedRecordControl() As WPR_Line1TableControlRow
            Return Nothing
          
        End Function

        Public Overridable Function GetSelectedRecordControls() As WPR_Line1TableControlRow()
        
            Return DirectCast((new ArrayList()).ToArray(GetType(WPR_Line1TableControlRow)), WPR_Line1TableControlRow())
          
        End Function

        Public Overridable Sub DeleteSelectedRecords(ByVal deferDeletion As Boolean)
            Dim recList() As WPR_Line1TableControlRow = Me.GetSelectedRecordControls()
            If recList.Length = 0 Then
                ' Localization.
                Throw New Exception(Page.GetResourceValue("Err:NoRecSelected", "ePortalWFApproval"))
            End If
        ...
        Public Overridable Function GetRecordControls() As WPR_Line1TableControlRow()
            Dim recCtrls() As Control = BaseClasses.Utils.MiscUtils.FindControlsRecursively(Me, "WPR_Line1TableControlRow")
            Dim list As New List(Of WPR_Line1TableControlRow)
            For Each recCtrl As WPR_Line1TableControlRow In recCtrls
                list.Add(recCtrl)
            Next
            Return list.ToArray()
        End Function
...
' Base class for the WPR_DocRecordControl control on the Show_WPR_Doc1 page.
...
Public Class BaseWPR_DocRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            ' Load the data from the database into the DataSource DatabaseANFLO-WFN%dbo.WPR_Doc record.
            ' It is better to make changes to functions called by LoadData such as
            ' CreateWhereClause, rather than making changes here.
            ...
            If Me.RecordUniqueId IsNot Nothing AndAlso Me.RecordUniqueId.Trim <> "" Then
                Me.DataSource = WPR_Doc1Table.GetRecord(Me.RecordUniqueId, True)
            ...
            If wc Is Nothing OrElse Not wc.RunQuery Then
                Me.DataSource = New WPR_Doc1Record()
            ...
            Dim recList() As WPR_Doc1Record = WPR_Doc1Table.GetRecords(wc, Nothing, 0, 2)
            If recList.Length = 0 Then
            ...
            Me.DataSource = WPR_Doc1Table.GetRecord(recList(0).GetID.ToXmlString(), True)
        ...
        SetWCAR_Doc_Attach1TableControl()
            ...
            If (shouldResetControl OrElse Me.Page.IsPageRefresh)
              WPR_Activity1TableControl.ResetControl()
            End IF
                    
        SetWPR_Activity1TableControl()
        
            If (shouldResetControl OrElse Me.Page.IsPageRefresh)
              WPR_Doc_Attach1TableControl.ResetControl()
            End IF
                    
        SetWPR_Doc_Attach1TableControl()
        
            If (shouldResetControl OrElse Me.Page.IsPageRefresh)
              WPR_Line1TableControl.ResetControl()
            End IF
                    
        SetWPR_Line1TableControl()
        ...
        Public Overridable Sub SetWPRD_C_ID()
            ...
            ' DatabaseANFLO-WFN%dbo.WPR_Doc database record.

            ' Me.DataSource is the DatabaseANFLO-WFN%dbo.WPR_Doc record retrieved from the database.
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRD_C_IDSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                Dim formattedValue As String = ""
                Dim _isExpandableNonCompositeForeignKey As Boolean = WPR_Doc1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WPR_Doc1Table.WPRD_C_ID)
                If _isExpandableNonCompositeForeignKey AndAlso WPR_Doc1Table.WPRD_C_ID.IsApplyDisplayAs Then
                                  
                       formattedValue = WPR_Doc1Table.GetDFKA(Me.DataSource.WPRD_C_ID.ToString(),WPR_Doc1Table.WPRD_C_ID, Nothing)
                                    
                       If (formattedValue Is Nothing) Then
                              formattedValue = Me.DataSource.Format(WPR_Doc1Table.WPRD_C_ID)
                       End If
                Else
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRD_C_ID.Text = WPR_Doc1Table.WPRD_C_ID.Format(WPR_Doc1Table.WPRD_C_ID.DefaultValue)
        ...
        Public Overridable Sub SetWPRD_Comment()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRD_CommentSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Doc1Table.WPRD_Comment)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRD_Comment.Text = WPR_Doc1Table.WPRD_Comment.Format(WPR_Doc1Table.WPRD_Comment.DefaultValue)
        ...
        Public Overridable Sub SetWPRD_No()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRD_NoSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Doc1Table.WPRD_No)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRD_No.Text = WPR_Doc1Table.WPRD_No.Format(WPR_Doc1Table.WPRD_No.DefaultValue)
        ...
        Public Overridable Sub SetWPRD_Submit()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRD_SubmitSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Doc1Table.WPRD_Submit)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRD_Submit.Text = WPR_Doc1Table.WPRD_Submit.Format(WPR_Doc1Table.WPRD_Submit.DefaultValue)
        ...
        Public Overridable Sub SetWPRD_Total()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRD_TotalSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(WPR_Doc1Table.WPRD_Total, "#,#.00")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRD_Total.Text = WPR_Doc1Table.WPRD_Total.Format(WPR_Doc1Table.WPRD_Total.DefaultValue, "#,#.00")
        ...
        Public Overridable Sub SetWPRD_U_ID()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRD_U_IDSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                Dim formattedValue As String = ""
                Dim _isExpandableNonCompositeForeignKey As Boolean = WPR_Doc1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WPR_Doc1Table.WPRD_U_ID)
                If _isExpandableNonCompositeForeignKey AndAlso WPR_Doc1Table.WPRD_U_ID.IsApplyDisplayAs Then
                                  
                       formattedValue = WPR_Doc1Table.GetDFKA(Me.DataSource.WPRD_U_ID.ToString(),WPR_Doc1Table.WPRD_U_ID, Nothing)
                                    
                       If (formattedValue Is Nothing) Then
                              formattedValue = Me.DataSource.Format(WPR_Doc1Table.WPRD_U_ID)
                       End If
                Else
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRD_U_ID.Text = WPR_Doc1Table.WPRD_U_ID.Format(WPR_Doc1Table.WPRD_U_ID.DefaultValue)
        ...
        Public Overridable Sub SetWPRD_WCD_ID()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRD_WCD_IDSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                Dim formattedValue As String = ""
                Dim _isExpandableNonCompositeForeignKey As Boolean = WPR_Doc1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WPR_Doc1Table.WPRD_WCD_ID)
                If _isExpandableNonCompositeForeignKey AndAlso WPR_Doc1Table.WPRD_WCD_ID.IsApplyDisplayAs Then
                                  
                       formattedValue = WPR_Doc1Table.GetDFKA(Me.DataSource.WPRD_WCD_ID.ToString(),WPR_Doc1Table.WPRD_WCD_ID, Nothing)
                                    
                       If (formattedValue Is Nothing) Then
                              formattedValue = Me.DataSource.Format(WPR_Doc1Table.WPRD_WCD_ID)
                       End If
                Else
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRD_WCD_ID.Text = WPR_Doc1Table.WPRD_WCD_ID.Format(WPR_Doc1Table.WPRD_WCD_ID.DefaultValue)
        ...
        Public Overridable Sub SetWPRD_WCur_ID()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRD_WCur_IDSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                Dim formattedValue As String = ""
                Dim _isExpandableNonCompositeForeignKey As Boolean = WPR_Doc1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WPR_Doc1Table.WPRD_WCur_ID)
                If _isExpandableNonCompositeForeignKey AndAlso WPR_Doc1Table.WPRD_WCur_ID.IsApplyDisplayAs Then
                                  
                       formattedValue = WPR_Doc1Table.GetDFKA(Me.DataSource.WPRD_WCur_ID.ToString(),WPR_Doc1Table.WPRD_WCur_ID, Nothing)
                                    
                       If (formattedValue Is Nothing) Then
                              formattedValue = Me.DataSource.Format(WPR_Doc1Table.WPRD_WCur_ID)
                       End If
                Else
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRD_WCur_ID.Text = WPR_Doc1Table.WPRD_WCur_ID.Format(WPR_Doc1Table.WPRD_WCur_ID.DefaultValue)
        ...
        Public Overridable Sub SetWPRD_WDT_ID()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRD_WDT_IDSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                Dim formattedValue As String = ""
                Dim _isExpandableNonCompositeForeignKey As Boolean = WPR_Doc1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WPR_Doc1Table.WPRD_WDT_ID)
                If _isExpandableNonCompositeForeignKey AndAlso WPR_Doc1Table.WPRD_WDT_ID.IsApplyDisplayAs Then
                                  
                       formattedValue = WPR_Doc1Table.GetDFKA(Me.DataSource.WPRD_WDT_ID.ToString(),WPR_Doc1Table.WPRD_WDT_ID, Nothing)
                                    
                       If (formattedValue Is Nothing) Then
                              formattedValue = Me.DataSource.Format(WPR_Doc1Table.WPRD_WDT_ID)
                       End If
                Else
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRD_WDT_ID.Text = WPR_Doc1Table.WPRD_WDT_ID.Format(WPR_Doc1Table.WPRD_WDT_ID.DefaultValue)
        ...
        Public Overridable Sub SetWPRD_WPRDS_ID()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.WPRD_WPRDS_IDSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                Dim formattedValue As String = ""
                Dim _isExpandableNonCompositeForeignKey As Boolean = WPR_Doc1Table.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(WPR_Doc1Table.WPRD_WPRDS_ID)
                If _isExpandableNonCompositeForeignKey AndAlso WPR_Doc1Table.WPRD_WPRDS_ID.IsApplyDisplayAs Then
                                  
                       formattedValue = WPR_Doc1Table.GetDFKA(Me.DataSource.WPRD_WPRDS_ID.ToString(),WPR_Doc1Table.WPRD_WPRDS_ID, Nothing)
                                    
                       If (formattedValue Is Nothing) Then
                              formattedValue = Me.DataSource.Format(WPR_Doc1Table.WPRD_WPRDS_ID)
                       End If
                Else
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.WPRD_WPRDS_ID.Text = WPR_Doc1Table.WPRD_WPRDS_ID.Format(WPR_Doc1Table.WPRD_WPRDS_ID.DefaultValue)
        ...
        Public Overridable Sub SetWPR_Activity1TableControl()           
        
        
            If WPR_Activity1TableControl.Visible Then
                WPR_Activity1TableControl.LoadData()
                WPR_Activity1TableControl.DataBind()
            End If
        End Sub        
      
        Public Overridable Sub SetWPR_Doc_Attach1TableControl()           
        
        
            If WPR_Doc_Attach1TableControl.Visible Then
                WPR_Doc_Attach1TableControl.LoadData()
                WPR_Doc_Attach1TableControl.DataBind()
            End If
        End Sub        
      
        Public Overridable Sub SetWPR_Line1TableControl()           
        
        
            If WPR_Line1TableControl.Visible Then
                WPR_Line1TableControl.LoadData()
                WPR_Line1TableControl.DataBind()
            End If
        End Sub        
        ...
        Dim recWPR_Activity1TableControl as WPR_Activity1TableControl= DirectCast(MiscUtils.FindControlRecursively(Me, "WPR_Activity1TableControl"), WPR_Activity1TableControl)
        recWPR_Activity1TableControl.SaveData()
          
        Dim recWPR_Doc_Attach1TableControl as WPR_Doc_Attach1TableControl= DirectCast(MiscUtils.FindControlRecursively(Me, "WPR_Doc_Attach1TableControl"), WPR_Doc_Attach1TableControl)
        recWPR_Doc_Attach1TableControl.SaveData()
          
        Dim recWPR_Line1TableControl as WPR_Line1TableControl= DirectCast(MiscUtils.FindControlRecursively(Me, "WPR_Line1TableControl"), WPR_Line1TableControl)
        recWPR_Line1TableControl.SaveData()
        ...
        Dim hasFiltersWPR_Line1TableControl As Boolean = False
            ...
            WPR_Doc1Table.Instance.InnerFilter = Nothing
            wc = New WhereClause()
            ...
            ' Retrieve the record id from the URL parameter.
                  ...
                  Dim recId As String = DirectCast(Me.Page, BaseApplicationPage).Decrypt(Me.Page.Request.QueryString.Item("WPR_Doc1"))
                
            If recId Is Nothing OrElse recId.Trim = "" Then
                ' Get the error message from the application resource file.
                Throw New Exception(Page.GetResourceValue("Err:UrlParamMissing", "ePortalWFApproval").Replace("{URL}", "WPR_Doc1"))
            End If
            HttpContext.Current.Session("QueryString in Show-WPR-Doc1") = recId
            ...
            If KeyValue.IsXmlKey(recId) Then
                ...
                wc.iAND(WPR_Doc1Table.WPRD_ID, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(WPR_Doc1Table.WPRD_ID))
        
            Else
                ' The URL parameter contains the actual value, not an XML structure.
                
                wc.iAND(WPR_Doc1Table.WPRD_ID, BaseFilter.ComparisonOperator.EqualsTo, recId)
        ...
        Public Overridable Sub Delete()
            ...
            Dim pkValue As KeyValue = KeyValue.XmlToKey(Me.RecordUniqueId)
          WPR_Doc1Table.DeleteRecord(pkValue)
    ...
    Try
      ...
      Me.Page.RedirectBack()
        ...
        Public Property DataSource() As WPR_Doc1Record
            Get
                Return DirectCast(MyBase._DataSource, WPR_Doc1Record)
            End Get
            Set(ByVal value As WPR_Doc1Record)
                Me._DataSource = value
            End Set
        End Property
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property WPR_Activity1TableControl() As WPR_Activity1TableControl
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "WPR_Activity1TableControl"), WPR_Activity1TableControl)
            End Get
        End Property
        
        Public ReadOnly Property WPR_Doc_Attach1TableControl() As WPR_Doc_Attach1TableControl
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "WPR_Doc_Attach1TableControl"), WPR_Doc_Attach1TableControl)
            End Get
        End Property
        ...
        Public ReadOnly Property WPR_Line1TableControl() As WPR_Line1TableControl
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "WPR_Line1TableControl"), WPR_Line1TableControl)
            End Get
        End Property
...
#Region "Helper Functions"
        ...
        Public Overrides Overloads Function EvaluateExpressions(ByVal url As String, ByVal arg As String, ByVal bEncrypt As Boolean) As String
            ...
            Dim rec As WPR_Doc1Record = Nothing
        ...
        Public Overridable Function GetRecord() As WPR_Doc1Record
            If Not Me.DataSource Is Nothing Then
                Return Me.DataSource
            End If
            ...
            If Not Me.RecordUniqueId Is Nothing Then
                ...
                Return WPR_Doc1Table.GetRecord(Me.RecordUniqueId, True)
