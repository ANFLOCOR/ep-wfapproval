...
' WFinRep_DocType_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.WFinRep_DocType_QuickSelector
...
' Base class for the SelectorTableControlRow control on the WFinRep_DocType_QuickSelector page.
...
Public Class BaseSelectorTableControlRow
        ...
        Public Overridable Sub LoadData()        
            ...
            ' Load the data from the database into the DataSource DatabaseANFLO-WF%dbo.WFinRep_DocType record.
            ...
            If Me.RecordUniqueId IsNot Nothing AndAlso Me.RecordUniqueId.Trim <> "" Then
                Me.DataSource = WFinRep_DocTypeTable.GetRecord(Me.RecordUniqueId, True)
            ...
            Me.DataSource = New WFinRep_DocTypeRecord()
        ...
        Public Overridable Sub Delete()
          ...
          WFinRep_DocTypeTable.DeleteRecord(pkValue)
        ...
        Public Property DataSource() As WFinRep_DocTypeRecord
            Get
                Return DirectCast(MyBase._DataSource, WFinRep_DocTypeRecord)
            End Get
            Set(ByVal value As WFinRep_DocTypeRecord)
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetRecord() As WFinRep_DocTypeRecord
            ...
            If Not Me.RecordUniqueId Is Nothing Then
                ...
                Return WFinRep_DocTypeTable.GetRecord(Me.RecordUniqueId, True)
...
' Base class for the SelectorTableControl control on the WFinRep_DocType_QuickSelector page.
...
Public Class BaseSelectorTableControl
    ...
    ' Setup default pagination settings.
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                If wc IsNot Nothing AndAlso Not wc.RunQuery Then
                    ...
                    Me.DataSource = DirectCast(alist.ToArray(GetType(WFinRep_DocTypeRecord)), WFinRep_DocTypeRecord())
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    ...
                    For Each rc As SelectorTableControlRow In Me.GetRecordControls()
                        ...
                        End If
                    Next
                    Me.DataSource = DirectCast(postdata.ToArray(GetType(WFinRep_DocTypeRecord)), WFinRep_DocTypeRecord())
        ...
        Public Overridable Function GetRecords( _
            ...
            ' selCols.Add(WFinRep_DocTypeTable.Column1, True)         
            ' selCols.Add(WFinRep_DocTypeTable.Column2, True)          
            ' selCols.Add(WFinRep_DocTypeTable.Column3, True)    
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return WFinRep_DocTypeTable.GetRecords(join, where, orderBy, Me.PageIndex, Me.PageSize)
                 
            Else
                Dim databaseTable As New WFinRep_DocTypeTable
                ...
                Return CType(recList.ToArray(GetType(WFinRep_DocTypeRecord)), WFinRep_DocTypeRecord())
            End If            
        ...
        Public Overridable Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return WFinRep_DocTypeTable.GetRecordCount(join, where)
        ...
        Public Overridable Function GetColumnListFromURLParameters(ByVal includeIndexFieldParameter As Boolean, ByVal includeFormulaAndDFKAParameter As Boolean) As ColumnList
            ...
            If includeIndexFieldParameter AndAlso field <> "" Then
                Dim col As BaseColumn = WFinRep_DocTypeTable.GetColumnByName(field)
                If col IsNot Nothing  AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
            End If
            If includeFormulaAndDFKAParameter Then
                If formula <> "" Then
                    For Each col As BaseColumn In MiscUtils.GetFormulaFieldList(formula, WFinRep_DocTypeTable.Instance.TableDefinition)
                        If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                    Next
                
                ElseIf displayFieldName <> ""
                    Dim col As BaseColumn = WFinRep_DocTypeTable.GetColumnByName(displayFieldName)
                    If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                End If
            End If
            Return columnList            
    ...
    End Sub
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            WFinRep_DocTypeTable.Instance.InnerFilter = Nothing
      ...
      Next
            ...
            End If
		        ...
		        If Not String.IsNullOrEmpty(Me.Page.Request("dependOnField")) AndAlso Me.Page.Request("dependOnVal") IsNot Nothing Then
			          Dim dependOnCol as BaseColumn = WFinRep_DocTypeTable.GetColumnByName(Me.Page.GetDecryptedURLParameter("dependOnField"))
    ...
    End Function
      ...
      Next
        ...
        Public Overridable Function GetAutoCompletionList_Search(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim recordList () As ePortalWFApproval.Business.WFinRep_DocTypeRecord = WFinRep_DocTypeTable.GetRecords(filterJoin, wc, Nothing, 0, count,count)
            Dim rec As WFinRep_DocTypeRecord = Nothing
    ...
    Dim recControl As SelectorTableControlRow = DirectCast(repItem.FindControl("SelectorTableControlRow"), SelectorTableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        Dim rec As WFinRep_DocTypeRecord = New WFinRep_DocTypeRecord()
            ...
            For index = 1 To Me.AddNewRecord
                ...
                newRecordList.Insert(0, New WFinRep_DocTypeRecord())
            ...
            If newRecordList.Count > 0 Then
                ...
                Me.DataSource = DirectCast(finalList.ToArray(GetType(WFinRep_DocTypeRecord)), WFinRep_DocTypeRecord())
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Try
        ...
        Public Property TotalRecords() As Integer
            Get
                If _TotalRecords < 0 
                    _TotalRecords = WFinRep_DocTypeTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause())
                End If
