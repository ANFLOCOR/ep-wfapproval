...
' This file implements the code-behind class for WPR_Activity_QuickSelector.aspx.
' App_Code\WPR_Activity_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WPR_Activity_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the WPR_Activity_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.WPR_Activity_QuickSelector.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.WPR_Activity_QuickSelector.SelectorTableControl()
