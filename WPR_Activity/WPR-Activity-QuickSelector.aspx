<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="WPR-Activity-QuickSelector.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="ePortalWFApproval.UI.WPR_Activity_QuickSelector" %>
<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.WPR_Activity_QuickSelector" %>
