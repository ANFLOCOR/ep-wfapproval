...
' This file implements the code-behind class for Show_ACTIVITY_Table.aspx.
' App_Code\Show_ACTIVITY_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_ACTIVITY_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_ACTIVITY_Table page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetACTIVITYTableControl()
            SetACTIVITYTableControl_Base() 
        End Sub
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "ACTIVITYTableControl"
                 SetACTIVITYTableControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.ACTIVITYTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_SearchText_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.Show_ACTIVITY_Table.ACTIVITYTableControl 
            control = new ePortalWFApproval.UI.Controls.Show_ACTIVITY_Table.ACTIVITYTableControl()
        ...
        Public Sub SetACTIVITYTableControl_Base()           
        
        
            If ACTIVITYTableControl.Visible Then
                ACTIVITYTableControl.LoadData()
                ACTIVITYTableControl.DataBind()
            End If
        End Sub        
