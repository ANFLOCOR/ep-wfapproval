...
' This file implements the code-behind class for ACTIVITY_QuickSelector.aspx.
' App_Code\ACTIVITY_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ACTIVITY_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the ACTIVITY_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.ACTIVITY_QuickSelector.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.ACTIVITY_QuickSelector.SelectorTableControl()
