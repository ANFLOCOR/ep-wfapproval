			...
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td><ePortalWFApproval:SelWFReassignTableControl runat="server" id="SelWFReassignTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="SelWFReassignTitle" Text="PO Workflow Reassign Task (South)">	</asp:Literal></td></tr></table>
...
<tr><td class="ttc" scope="row"><asp:ImageButton runat="server" id="SelWFReassignRowExpandCollapseRowButton" causesvalidation="False" commandname="ExpandCollapseRow" cssclass="button_link" imageurl="../Images/icon_expandcollapserow.gif" tooltip="&lt;%# GetResourceValue(&quot;Txt:ExpandCollapseRow&quot;, &quot;ePortalWFApproval&quot;) %>">		
...
</td></tr><tr id="SelWFReassignTableControlAltRow" runat="server"><td class="ttc"></td><td class="ttc" colspan="9"><BaseClasses:TabContainer runat="server" id="WFReassignContainer" onclientactivetabchanged="fixedHeaderTab" panellayout="Tabbed"> 
...
</BaseClasses:TabContainer></td><td class="ttc"></td></tr></ePortalWFApproval:SelWFReassignTableControlRow>
</ITEMTEMPLATE>
