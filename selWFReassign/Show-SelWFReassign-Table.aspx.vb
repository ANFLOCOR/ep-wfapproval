...
Public Sub SetSelWFReassignTableControl()
            SetSelWFReassignTableControl_Base() 
        End Sub
#End Region
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "SelWFReassignTableControl"
                 SetSelWFReassignTableControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.SelWFReassignTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetSelWFReassignTableControl_Base()           
        
        
            If SelWFReassignTableControl.Visible Then
                SelWFReassignTableControl.LoadData()
                SelWFReassignTableControl.DataBind()
            End If
        End Sub        
