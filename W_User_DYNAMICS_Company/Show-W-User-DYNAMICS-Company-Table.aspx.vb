...
' This file implements the code-behind class for Show_W_User_DYNAMICS_Company_Table.aspx.
' App_Code\Show_W_User_DYNAMICS_Company_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_W_User_DYNAMICS_Company_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_W_User_DYNAMICS_Company_Table page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetW_User_DYNAMICS_CompanyTableControl()
            SetW_User_DYNAMICS_CompanyTableControl_Base() 
        End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "W User DYNAMICS Company"
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "W_User_DYNAMICS_CompanyTableControl"
                 SetW_User_DYNAMICS_CompanyTableControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.W_User_DYNAMICS_CompanyTableControl.SaveData()
      ...
      End Sub  
        ...
        SetW_User_DYNAMICS_CompanyTableControl()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "W_User_DYNAMICS_CompanyMenuItem"
                    End If
                End If
        ...
        Public Sub SetW_User_DYNAMICS_CompanyTableControl_Base()           
        
        
            If W_User_DYNAMICS_CompanyTableControl.Visible Then
                W_User_DYNAMICS_CompanyTableControl.LoadData()
                W_User_DYNAMICS_CompanyTableControl.DataBind()
            End If
        End Sub        
