...
' This file implements the code-behind class for Sel_WCAR_Doc_Creator_Approver_QuickSelector1.aspx.
' App_Code\Sel_WCAR_Doc_Creator_Approver_QuickSelector1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Sel_WCAR_Doc_Creator_Approver_QuickSelector1
        Inherits BaseApplicationPage
' Code-behind class for the Sel_WCAR_Doc_Creator_Approver_QuickSelector1 page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.Sel_WCAR_Doc_Creator_Approver_QuickSelector1.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.Sel_WCAR_Doc_Creator_Approver_QuickSelector1.SelectorTableControl()
