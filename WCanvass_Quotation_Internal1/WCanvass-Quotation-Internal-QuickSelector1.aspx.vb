...
' This file implements the code-behind class for WCanvass_Quotation_Internal_QuickSelector1.aspx.
' App_Code\WCanvass_Quotation_Internal_QuickSelector1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WCanvass_Quotation_Internal_QuickSelector1
        Inherits BaseApplicationPage
' Code-behind class for the WCanvass_Quotation_Internal_QuickSelector1 page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.WCanvass_Quotation_Internal_QuickSelector1.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.WCanvass_Quotation_Internal_QuickSelector1.SelectorTableControl()
