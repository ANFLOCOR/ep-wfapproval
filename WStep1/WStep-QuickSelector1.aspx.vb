...
' This file implements the code-behind class for WStep_QuickSelector1.aspx.
' App_Code\WStep_QuickSelector1.Controls.vb contains the Table, Row and Record control classes
...
Namespace ePortalWFApproval.UI
    ...
    Partial Public Class WStep_QuickSelector1
        Inherits BaseApplicationPage
        ' Code-behind class for the WStep_QuickSelector1 page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.WStep_QuickSelector1.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.WStep_QuickSelector1.SelectorTableControl()
