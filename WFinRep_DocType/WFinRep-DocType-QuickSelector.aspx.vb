...
' This file implements the code-behind class for WFinRep_DocType_QuickSelector.aspx.
' App_Code\WFinRep_DocType_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WFinRep_DocType_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the WFinRep_DocType_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.WFinRep_DocType_QuickSelector.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.WFinRep_DocType_QuickSelector.SelectorTableControl()
