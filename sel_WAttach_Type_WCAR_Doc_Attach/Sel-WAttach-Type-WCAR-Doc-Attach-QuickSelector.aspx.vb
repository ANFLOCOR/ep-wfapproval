...
' This file implements the code-behind class for Sel_WAttach_Type_WCAR_Doc_Attach_QuickSelector.aspx.
' App_Code\Sel_WAttach_Type_WCAR_Doc_Attach_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Sel_WAttach_Type_WCAR_Doc_Attach_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the Sel_WAttach_Type_WCAR_Doc_Attach_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.Sel_WAttach_Type_WCAR_Doc_Attach_QuickSelector.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.Sel_WAttach_Type_WCAR_Doc_Attach_QuickSelector.SelectorTableControl()
