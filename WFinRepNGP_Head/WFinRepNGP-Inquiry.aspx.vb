...
' This file implements the code-behind class for WFinRepNGP_Inquiry.aspx.
...
Partial Public Class WFinRepNGP_Inquiry
        Inherits BaseApplicationPage
' Code-behind class for the WFinRepNGP_Inquiry page.
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "WFinRepNGP_HeadTableControl"
      ...
      Public Sub SaveData_Base()
        ...
        Me.WFinRepNGP_HeadTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetWFinRepNGP_HeadTableControl_Base()           
