...
' This file implements the code-behind class for WFin_RepApproveView.aspx.
' App_Code\WFin_RepApproveView.Controls.vb contains the Table, Row and Record control classes
...
Namespace ePortalWFApproval.UI
    ...
    Partial Public Class WFin_RepApproveView
        Inherits BaseApplicationPage
        ' Code-behind class for the WFin_RepApproveView page.
