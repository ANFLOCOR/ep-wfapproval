<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.WFin_ApprovalStatus_QuickSelector" %>

<%@ Register Tagprefix="ePortalWFApproval" TagName="PaginationModern" Src="../Shared/PaginationModern.ascx" %>

<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="WFin-ApprovalStatus-QuickSelector.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="ePortalWFApproval.UI.WFin_ApprovalStatus_QuickSelector" %>
