...
' This file implements the code-behind class for WFin_ApprovalStatus_QuickSelector.aspx.
' App_Code\WFin_ApprovalStatus_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WFin_ApprovalStatus_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the WFin_ApprovalStatus_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.WFin_ApprovalStatus_QuickSelector.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.WFin_ApprovalStatus_QuickSelector.SelectorTableControl()
