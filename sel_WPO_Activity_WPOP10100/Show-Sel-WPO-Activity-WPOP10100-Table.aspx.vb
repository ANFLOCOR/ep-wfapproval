...
' This file implements the code-behind class for Show-Sel-WPO-Activity-WPOP10100-Table.aspx.
...
Partial Public Class Show_Sel_WPO_Activity_WPOP10100_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_Sel_WPO_Activity_WPOP10100_Table page.
...
Public Sub SetSel_WPO_Activity_WPOP10100TableControl()
            SetSel_WPO_Activity_WPOP10100TableControl_Base() 
        End Sub
#End Region
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "Sel_WPO_Activity_WPOP10100TableControl"
                 SetSel_WPO_Activity_WPOP10100TableControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.Sel_WPO_Activity_WPOP10100TableControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetSel_WPO_Activity_WPOP10100TableControl_Base()           
        
        
            If Sel_WPO_Activity_WPOP10100TableControl.Visible Then
                Sel_WPO_Activity_WPOP10100TableControl.LoadData()
                Sel_WPO_Activity_WPOP10100TableControl.DataBind()
            End If
        End Sub        
