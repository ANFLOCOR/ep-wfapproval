<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.Sel_POP30300_POP30310_QuickSelector1" %>
...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Sel-POP30300-POP30310-QuickSelector1.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="ePortalWFApproval.UI.Sel_POP30300_POP30310_QuickSelector1" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
