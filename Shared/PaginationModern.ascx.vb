...
Partial Public Class PaginationModern
        Inherits BaseApplicationUserControl
        Implements IPaginationModern
#Region "Section 1: Place your customizations here."
      ...
      Public Function GetCurrentPageSize() As Integer Implements IPaginationModern.GetCurrentPageSize
          Return Me.GetCurrentPageSize_Base()
      End Function
    ...
    End Function
      ...
      Public Sub Page_PreRender_Base(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            ' Data bind for each chart UI control.
  	          ...
  	          Dim ddlPageSize As DropDownList = CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "_PageSizeSelector"), System.Web.UI.WebControls.DropDownList)
              Dim textPageSize As TextBox = CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "_PageSize"), System.Web.UI.WebControls.TextBox)

              If ( Not IsNothing(ddlPageSize) AndAlso Not IsNothing(textPageSize) AndAlso textPageSize.Text <> "" ) Then
            	  If IsNothing(ddlPageSize.Items.FindByText(textPageSize.Text)) Then
            		  Dim idx As Integer = 0

            		  For Each item As ListItem In ddlPageSize.Items
            			  If (item.Value > textPageSize.Text AndAlso item.Value.Length = textPageSize.Text.Length) OrElse item.Value.Length > textPageSize.Text.Length Then
            				  Exit For
            			  End If
      ...
      End Sub  
              ...
              Public Function GetCurrentPageSize_Base() As Integer 
                  Dim ddlPageSize As DropDownList = CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "_PageSizeSelector"), System.Web.UI.WebControls.DropDownList)
                  Dim textPageSize As TextBox = CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "_PageSize"), System.Web.UI.WebControls.TextBox)
                  If ddlPageSize IsNot Nothing
                      Return Integer.Parse(ddlPageSize.SelectedValue)
                  ElseIf textPageSize IsNot Nothing
                      Return Integer.Parse(textPageSize.Text)
                  Else
                      Return 1
                  End If
              End Function              
        ...
        Public ReadOnly Property CurrentPage() As System.Web.UI.WebControls.TextBox Implements IPaginationModern.CurrentPage
            Get
        ...
        NotifyParentProperty(True), _
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
        Public ReadOnly Property FirstPage() As System.Web.UI.WebControls.ImageButton Implements IPaginationModern.FirstPage
            Get
        ...
        NotifyParentProperty(True), _
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
        Public ReadOnly Property LastPage() As System.Web.UI.WebControls.ImageButton Implements IPaginationModern.LastPage
            Get
        ...
        NotifyParentProperty(True), _
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
        Public ReadOnly Property NextPage() As System.Web.UI.WebControls.ImageButton Implements IPaginationModern.NextPage
            Get
        ...
        NotifyParentProperty(True), _
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
        Public ReadOnly Property PageSize() As System.Web.UI.WebControls.TextBox Implements IPaginationModern.PageSize
            Get
        ...
        NotifyParentProperty(True), _
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
        Public ReadOnly Property PageSizeButton() As System.Web.UI.WebControls.LinkButton Implements IPaginationModern.PageSizeButton
            Get
        ...
        NotifyParentProperty(True), _
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
        Public ReadOnly Property PageSizeSelector() As System.Web.UI.WebControls.DropdownList Implements IPaginationModern.PageSizeSelector
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "_PageSizeSelector"), System.Web.UI.WebControls.DropdownList)
            End Get
        End Property
        ...
        NotifyParentProperty(True), _
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
        Public ReadOnly Property PreviousPage() As System.Web.UI.WebControls.ImageButton Implements IPaginationModern.PreviousPage
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "_PreviousPage"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
                
      Public Overrides Property Visible() As Boolean Implements IPaginationModern.Visible
