...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetNextInterval()
            SetNextInterval_Base() 
        End Sub              
            
        Public Sub SetNextPageInterval()
            SetNextPageInterval_Base() 
        End Sub              
            
        Public Sub SetPreviousInterval()
            SetPreviousInterval_Base() 
        End Sub              
            
        Public Sub SetPreviousPageInterval()
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      End Sub  
        ...
        Public Sub SetNextInterval_Base()                
              
   
        End Sub
            
        Public Sub SetNextPageInterval_Base()                
              
   
        End Sub
            
        Public Sub SetPreviousInterval_Base()                
              
   
        End Sub
            
        Public Sub SetPreviousPageInterval_Base()                
