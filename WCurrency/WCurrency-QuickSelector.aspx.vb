...
' This file implements the code-behind class for WCurrency_QuickSelector.aspx.
' App_Code\WCurrency_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WCurrency_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the WCurrency_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.WCurrency_QuickSelector.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.WCurrency_QuickSelector.SelectorTableControl()
