...
' This file implements the code-behind class for Vw_FS_WFinRep_Attachment_PerReportType_QuickSelector1.aspx.
' App_Code\Vw_FS_WFinRep_Attachment_PerReportType_QuickSelector1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Vw_FS_WFinRep_Attachment_PerReportType_QuickSelector1
        Inherits BaseApplicationPage
' Code-behind class for the Vw_FS_WFinRep_Attachment_PerReportType_QuickSelector1 page.
...
#Region "Ajax Functions"
      ...
      Public Shared Function GetAutoCompletionList_Search(ByVal prefixText As String, ByVal count As Integer) As String()
      ...
      ' Customize by adding code before or after the call to  GetAutoCompletionList_Search()
      ' or replace the call to GetAutoCompletionList_Search().
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetSelectorTableControl()
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(Me, Me.GetType(), "PopupScript", "openPopupPage('QSSize');", True)
        End If
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.Vw_FS_WFinRep_Attachment_PerReportType_QuickSelector1.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.Vw_FS_WFinRep_Attachment_PerReportType_QuickSelector1.SelectorTableControl()
        ...
        Public Sub SetSelectorTableControl_Base()           
        
        
            If SelectorTableControl.Visible Then
