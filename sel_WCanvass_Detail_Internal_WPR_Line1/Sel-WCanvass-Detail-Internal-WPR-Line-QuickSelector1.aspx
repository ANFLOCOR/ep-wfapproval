<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Sel-WCanvass-Detail-Internal-WPR-Line-QuickSelector1.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="ePortalWFApproval.UI.Sel_WCanvass_Detail_Internal_WPR_Line_QuickSelector1" %>
<%@ Register Tagprefix="Selectors" Namespace="ePortalWFApproval" %>

<%@ Register Tagprefix="ePortalWFApproval" TagName="PaginationModern" Src="../Shared/PaginationModern.ascx" %>

<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.Sel_WCanvass_Detail_Internal_WPR_Line_QuickSelector1" %>
