...
' This file implements the code-behind class for Show_SysPages_Table.aspx.
' App_Code\Show_SysPages_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_SysPages_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_SysPages_Table page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetSysPagesTableControl()
            SetSysPagesTableControl_Base() 
        End Sub
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "SysPagesTableControl"
                 SetSysPagesTableControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.SysPagesTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_SearchText_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.Show_SysPages_Table.SysPagesTableControl 
            control = new ePortalWFApproval.UI.Controls.Show_SysPages_Table.SysPagesTableControl()
        ...
        Public Sub SetSysPagesTableControl_Base()           
        
        
            If SysPagesTableControl.Visible Then
                SysPagesTableControl.LoadData()
                SysPagesTableControl.DataBind()
            End If
        End Sub        
