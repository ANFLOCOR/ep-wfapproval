...
' This file implements the code-behind class for SysPages_QuickSelector.aspx.
' App_Code\SysPages_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class SysPages_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the SysPages_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.SysPages_QuickSelector.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.SysPages_QuickSelector.SelectorTableControl()
