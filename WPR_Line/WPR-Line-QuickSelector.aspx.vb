...
' This file implements the code-behind class for WPR_Line_QuickSelector.aspx.
' App_Code\WPR_Line_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WPR_Line_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the WPR_Line_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Search_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.WPR_Line_QuickSelector.SelectorTableControl 
            control = new ePortalWFApproval.UI.Controls.WPR_Line_QuickSelector.SelectorTableControl()
