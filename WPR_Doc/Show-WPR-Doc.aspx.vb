...
' This file implements the code-behind class for Show_WPR_Doc.aspx.
' App_Code\Show_WPR_Doc.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_WPR_Doc
        Inherits BaseApplicationPage
' Code-behind class for the Show_WPR_Doc page.
...
'<System.Web.Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_WPR_LineSearchText(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetWPR_LineSearchTextCompletionList gets the list of suggestions from the database.
'      ' prefixText is the search text typed by the user .
'      ' count specifies the number of suggestions to be returned.
'      ' Customize by adding code before or after the call to  GetAutoCompletionList_WPR_LineSearchText()
'      ' or replace the call to GetAutoCompletionList_WPR_LineSearchText().
'      Return GetAutoCompletionList_WPR_LineSearchText_Base(prefixText, count)
'      End Function
'<System.Web.Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_WPR_Doc_AttachSearchText(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetWPR_Doc_AttachSearchTextCompletionList gets the list of suggestions from the database.
'      ' prefixText is the search text typed by the user .
'      ' count specifies the number of suggestions to be returned.
'      ' Customize by adding code before or after the call to  GetAutoCompletionList_WPR_Doc_AttachSearchText()
'      ' or replace the call to GetAutoCompletionList_WPR_Doc_AttachSearchText().
'      Return GetAutoCompletionList_WPR_Doc_AttachSearchText_Base(prefixText, count)
'      End Function
'<System.Web.Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_WCAR_Doc_AttachSearchText(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetWCAR_Doc_AttachSearchTextCompletionList gets the list of suggestions from the database.
'      ' prefixText is the search text typed by the user .
'      ' count specifies the number of suggestions to be returned.
