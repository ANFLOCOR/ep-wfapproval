...
' This file implements the code-behind class for Show_WPR_Doc1.aspx.
' App_Code\Show_WPR_Doc1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_WPR_Doc1
        Inherits BaseApplicationPage
' Code-behind class for the Show_WPR_Doc1 page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetWPR_DocRecordControl()
            SetWPR_DocRecordControl_Base() 
        End Sub
...
'<System.Web.Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_WPR_Line1SearchText(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetWPR_Line1SearchTextCompletionList gets the list of suggestions from the database.
'      ' prefixText is the search text typed by the user .
'      ' count specifies the number of suggestions to be returned.
'      ' Customize by adding code before or after the call to  GetAutoCompletionList_WPR_Line1SearchText()
'      ' or replace the call to GetAutoCompletionList_WPR_Line1SearchText().
'      Return GetAutoCompletionList_WPR_Line1SearchText_Base(prefixText, count)
'      End Function
'<System.Web.Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_WPR_Doc_Attach1SearchText(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetWPR_Doc_Attach1SearchTextCompletionList gets the list of suggestions from the database.
'      ' prefixText is the search text typed by the user .
'      ' count specifies the number of suggestions to be returned.
'      ' Customize by adding code before or after the call to  GetAutoCompletionList_WPR_Doc_Attach1SearchText()
'      ' or replace the call to GetAutoCompletionList_WPR_Doc_Attach1SearchText().
'      Return GetAutoCompletionList_WPR_Doc_Attach1SearchText_Base(prefixText, count)
'      End Function
'<System.Web.Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_WCAR_Doc_Attach1SearchText(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetWCAR_Doc_Attach1SearchTextCompletionList gets the list of suggestions from the database.
'      ' prefixText is the search text typed by the user .
'      ' count specifies the number of suggestions to be returned.
'      ' Customize by adding code before or after the call to  GetAutoCompletionList_WCAR_Doc_Attach1SearchText()
'      ' or replace the call to GetAutoCompletionList_WCAR_Doc_Attach1SearchText().
'      Return GetAutoCompletionList_WCAR_Doc_Attach1SearchText_Base(prefixText, count)
'      End Function
<System.Web.Services.WebMethod()> _
        Public Shared Function GetImage(ByVal tableName As String, _
                                        ByVal recordID As String, _
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "WPR_DocRecordControl"
                 SetWPR_DocRecordControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.WPR_DocRecordControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetWPR_DocRecordControl_Base()           
        
        
            If WPR_DocRecordControl.Visible Then
                WPR_DocRecordControl.LoadData()
                WPR_DocRecordControl.DataBind()
            End If
        End Sub        
