<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-WPR-Doc.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="ePortalWFApproval.UI.Show_WPR_Doc" %>
<%@ Register Tagprefix="Selectors" Namespace="ePortalWFApproval" %>

<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.Show_WPR_Doc" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                        ...
                        <ePortalWFApproval:WPR_DocRecordControl runat="server" id="WPR_DocRecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelT"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle"><asp:Literal runat="server" id="WPR_DocTitle" Text="PR Document (View)">	</asp:Literal></td></tr></table>
</td><td class="dher"><img src="../Images/space.gif" alt="" /></td></tr></table>
</td></tr><tr><td class="recordPanelButtonsAlignment" style="text-align:right;"><table cellpadding="0" cellspacing="0" border="0"><tr><td style="font-weight:bold;font-size:14pt"><ePortalWFApproval:ThemeButton runat="server" id="OKButton" button-causesvalidation="False" button-commandname="Redirect" button-text="&lt;%# GetResourceValue(&quot;Back&quot;, &quot;ePortalWFApproval&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Back&quot;, &quot;ePortalWFApproval&quot;) %>"></ePortalWFApproval:ThemeButton></td></tr></table>
</td></tr><tr><td>
...
<td>
&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="WPRL_Line_Seq_NoTextBoxMaxLengthValidator" ControlToValidate="WPRL_Line_Seq_No" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ePortalWFApproval&quot;).Replace(&quot;{FieldName}&quot;, &quot;WPRL Line SEQ Number&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
</tr>
</table>
</span>
...
<asp:Literal runat="server" id="WPRL_GL00101_Acct_Indx" visible="False"></asp:Literal></span>
</td><td class="ttc" colspan="3"><asp:Literal runat="server" id="WPRL_Item_Text"></asp:Literal></td></tr></ePortalWFApproval:WPR_LineTableControlRow>
</ITEMTEMPLATE>
	...
	<asp:hiddenfield id="WPR_LineTableControl_PostbackTracker" runat="server" />
</ePortalWFApproval:WPR_LineTableControl>
 
 </ContentTemplate></BaseClasses:TabPanel> 
 <BaseClasses:TabPanel runat="server" id="WPR_Doc_AttachTabPanel" HeaderText="Supporting Documents">	<ContentTemplate> 
  <ePortalWFApproval:WPR_Doc_AttachTableControl runat="server" id="WPR_Doc_AttachTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td>
                  <asp:panel id="WPR_Doc_AttachTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="WPR_Doc_AttachTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="text-align:center;"><asp:Literal runat="server" id="WPRDA_FileLabel" Text="Download">	</asp:Literal></th><th class="thc" style="text-align:center;"><asp:Literal runat="server" id="WPRDA_DescLabel" Text="Description">	</asp:Literal></th><th class="thc" style="text-align:center;"><asp:Literal runat="server" id="WPRDA_WAT_IDLabel" Text="Attach Type">	</asp:Literal></th></tr><asp:Repeater runat="server" id="WPR_Doc_AttachTableControlRepeater">		<ITEMTEMPLATE>		<ePortalWFApproval:WPR_Doc_AttachTableControlRow runat="server" id="WPR_Doc_AttachTableControlRow">
...
<asp:TextBox runat="server" id="WPRDA_Desc" MaxLength="50" columns="110" cssclass="field_input" htmlencodevalue="Default" readonly="True" textformat="{0}"></asp:TextBox>&nbsp;
...
<asp:DropDownList runat="server" id="WPRDA_WAT_ID" cssclass="field_input" enabled="False" enabletheming="True" onkeypress="dropDownListTypeAhead(this,false)"></asp:DropDownList></span>
</td></tr></ePortalWFApproval:WPR_Doc_AttachTableControlRow>
</ITEMTEMPLATE>
	...
	<asp:hiddenfield id="WPR_Doc_AttachTableControl_PostbackTracker" runat="server" />
</ePortalWFApproval:WPR_Doc_AttachTableControl>
 
 </ContentTemplate></BaseClasses:TabPanel> 
 <BaseClasses:TabPanel runat="server" id="WPR_ActivityTabPanel" HeaderText="Approval History">	<ContentTemplate> 
  <ePortalWFApproval:WPR_ActivityTableControl runat="server" id="WPR_ActivityTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td>
                  <asp:panel id="WPR_ActivityTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="WPR_ActivityTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc"><asp:Literal runat="server" id="WPRA_W_U_IDLabel" Text="User (Assigned)">	</asp:Literal></th><th class="thc"><asp:Literal runat="server" id="WPRA_StatusLabel" Text="Status">	</asp:Literal></th><th class="thc"><asp:Literal runat="server" id="WPRA_Date_AssignLabel" Text="Date Assign">	</asp:Literal></th><th class="thc"><asp:Literal runat="server" id="WPRA_Date_ActionLabel" Text="Date Action">	</asp:Literal></th><th class="thc"><asp:Literal runat="server" id="WPRA_RemarkLabel" Text="Remark">	</asp:Literal></th></tr><asp:Repeater runat="server" id="WPR_ActivityTableControlRepeater">		<ITEMTEMPLATE>		<ePortalWFApproval:WPR_ActivityTableControlRow runat="server" id="WPR_ActivityTableControlRow">
<tr><td class="ttc"><span style="white-space:nowrap;">
...
<asp:Literal runat="server" id="WPRA_Date_Action"></asp:Literal></span>
</td><td class="ttc"><asp:Literal runat="server" id="WPRA_Remark"></asp:Literal></td></tr></ePortalWFApproval:WPR_ActivityTableControlRow>
</ITEMTEMPLATE>
	...
	<asp:hiddenfield id="WPR_ActivityTableControl_PostbackTracker" runat="server" />
</ePortalWFApproval:WPR_ActivityTableControl>
 
 </ContentTemplate></BaseClasses:TabPanel> 
 <BaseClasses:TabPanel runat="server" id="WPR_Ref_CARTabPanel" HeaderText="CAR Supporting Docs">	<ContentTemplate> 
  <ePortalWFApproval:WCAR_Doc_AttachTableControl runat="server" id="WCAR_Doc_AttachTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td>
                  <asp:panel id="WCAR_Doc_AttachTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="WCAR_Doc_AttachTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="text-align:center;"><asp:Literal runat="server" id="WCDA_FileLabel" Text="Download">	</asp:Literal></th><th class="thc" style="text-align:center;"><asp:Literal runat="server" id="WCDA_DescLabel" Text="Description">	</asp:Literal></th><th class="thc" style="text-align:center;"><asp:Literal runat="server" id="WCDA_WAT_IDLabel" Text="Attach Type">	</asp:Literal></th></tr><asp:Repeater runat="server" id="WCAR_Doc_AttachTableControlRepeater">		<ITEMTEMPLATE>		<ePortalWFApproval:WCAR_Doc_AttachTableControlRow runat="server" id="WCAR_Doc_AttachTableControlRow">
<tr><td class="ttc"><asp:LinkButton runat="server" id="WCDA_File" CommandName="Redirect"></asp:LinkButton></td><td class="ttc"><asp:Literal runat="server" id="WCDA_Desc"></asp:Literal></td><td class="ttc"><asp:Literal runat="server" id="WCDA_WAT_ID"></asp:Literal></td></tr></ePortalWFApproval:WCAR_Doc_AttachTableControlRow>
</ITEMTEMPLATE>
