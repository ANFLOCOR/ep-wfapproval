...
' This file implements the code-behind class for tst.aspx.
' App_Code\tst.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class tst
        Inherits BaseApplicationPage
' Code-behind class for the tst page.
...
#Region "Ajax Functions"
      ...
      Public Shared Function GetAutoCompletionList_Sel_WAttach_Type_WCAR_Doc_AttachSearchText(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetSel_WAttach_Type_WCAR_Doc_AttachSearchTextCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_Sel_WAttach_Type_WCAR_Doc_AttachSearchText()
      ' or replace the call to GetAutoCompletionList_Sel_WAttach_Type_WCAR_Doc_AttachSearchText().
      Return GetAutoCompletionList_Sel_WAttach_Type_WCAR_Doc_AttachSearchText_Base(prefixText, count)
      End Function
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetSel_WAttach_Type_WCAR_Doc_AttachTableControl()
            SetSel_WAttach_Type_WCAR_Doc_AttachTableControl_Base() 
        End Sub
...
'Public Sub SetSel_WAttach_Type_WCAR_Doc_AttachTableControl1()
'            SetSel_WAttach_Type_WCAR_Doc_AttachTableControl1_Base() 
'        End Sub
'<System.Web.Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_Sel_WAttach_Type_WCAR_Doc_AttachSearchText1(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetSel_WAttach_Type_WCAR_Doc_AttachSearchText1CompletionList gets the list of suggestions from the database.
'      ' prefixText is the search text typed by the user .
'      ' count specifies the number of suggestions to be returned.
'      ' Customize by adding code before or after the call to  GetAutoCompletionList_Sel_WAttach_Type_WCAR_Doc_AttachSearchText1()
'      ' or replace the call to GetAutoCompletionList_Sel_WAttach_Type_WCAR_Doc_AttachSearchText1().
'      Return GetAutoCompletionList_Sel_WAttach_Type_WCAR_Doc_AttachSearchText1_Base(prefixText, count)
'      End Function
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "Sel_WAttach_Type_WCAR_Doc_AttachTableControl"
                 SetSel_WAttach_Type_WCAR_Doc_AttachTableControl()
          
              Case "Sel_WStep_WStep_DetailTableControl"
      ...
      Public Sub SaveData_Base()
        ...
        Me.Sel_WAttach_Type_WCAR_Doc_AttachTableControl.SaveData()
                
        Me.Sel_WStep_WStep_DetailTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Sel_WAttach_Type_WCAR_Doc_AttachSearchText_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ePortalWFApproval.UI.Controls.tst.Sel_WAttach_Type_WCAR_Doc_AttachTableControl 
            control = new ePortalWFApproval.UI.Controls.tst.Sel_WAttach_Type_WCAR_Doc_AttachTableControl()
            
            Return control.GetAutoCompletionList_Sel_WAttach_Type_WCAR_Doc_AttachSearchText(prefixText, count)
        ...
        Public Sub SetSel_WAttach_Type_WCAR_Doc_AttachTableControl_Base()           
        ...
        Public Sub SetSel_WStep_WStep_DetailTableControl_Base()           
