...
' This file implements the code-behind class for Show_WCAR_Activity_Table.aspx.
' App_Code\Show_WCAR_Activity_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_WCAR_Activity_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_WCAR_Activity_Table page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub SetPageFocus()
        ...
        Protected Sub PopulateAssignUser()
            ...
            'Me.WCA_W_U_IDFilter.Items.Insert(0, New ListItem(Page.GetResourceValue("Txt:All", "EPORTAL"), "--ANY--"))	
        End Sub
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetWCAR_ActivityTableControl()
            SetWCAR_ActivityTableControl_Base() 
        End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
			...
			Me.Authorize(Ctype(WCAR_ActivityTableControl, Control), "NOT_ANONYMOUS")
            ...
            Page.Title = "ePortal Workflow Approval - CAR Workflow Reassign Tasks  (South)"
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "WCAR_ActivityTableControl"
      ...
      Public Sub SaveData_Base()
        ...
        Me.WCAR_ActivityTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetWCAR_ActivityTableControl_Base()           
