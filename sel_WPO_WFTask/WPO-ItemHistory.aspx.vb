...
' This file implements the code-behind class for WPO_ItemHistory.aspx.
' App_Code\WPO_ItemHistory.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WPO_ItemHistory
        Inherits BaseApplicationPage
' Code-behind class for the WPO_ItemHistory page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          ' or replace the call to LoadData_Base().
            LoadData_Base()
            LoadGridControl()
            Me.ItemDesc.Text = CStr(Me.Page.Request.QueryString.Get("pItemDesc"))
      End Sub
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Protected Sub gridView_PageIndexChanging(ByVal sender As Object, ByVal e As GridViewPageEventArgs)
            ...
            ' new page
            Me.ItemGrid.PageIndex = e.NewPageIndex
            ...
            If (Not IsNothing(ds)) Then
                ...
                ' from session.
                Me.ItemGrid.DataSource = CType(ds, DataSet)
                Me.ItemGrid.DataBind()
                Me.ItemGrid.Visible = True
            Else
                Me.ItemGrid.Visible = False
            End If
        End Sub

        Protected Sub gridView_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs) Handles ItemGrid.RowDataBound
            Dim lBtn As LinkButton = New LinkButton
            Dim str As String = ""
            If e.Row.RowType = DataControlRowType.DataRow Then
                lBtn.Text = e.Row.Cells(5).Text
                lBtn.ForeColor = Drawing.Color.Blue
                lBtn.Attributes.Add("onclick", "window.open('../wf_po/WPO_VendorHistory1.aspx?pItemNo=0&pVendorID=" & e.Row.Cells(4).Text & "&pCompanyID=" & CStr(Me.Page.Request.QueryString.Get("pCompanyID")) & "&pPONUMBR=" & e.Row.Cells(4).Text & "&pVendorName=" & e.Row.Cells(5).Text & "', '', 'scrollbars=yes,menubar=no,width=700,height=500,top=(screen.height  - 240)/2,left=(screen.width  - 640)/2');return false;")
        ...
        Private Sub LoadGridControl()
            ...
            Me.ItemGrid.AllowPaging = True

            ' Get the data for GridView control from stored procedure.	
            Me.ItemGrid.DataSource = Me.GetItemVendorHistory()
            ...
            Me.Page.Session("DataSet") = Me.ItemGrid.DataSource

            ' Let the GridView control handle rendering of columns
            ' and their names.
            Me.ItemGrid.AutoGenerateColumns = True

            ' Bind the GridView control with the data from stored procedure.		
            Me.ItemGrid.DataBind()
            Me.ItemGrid.Visible = True
            'Me.ItemGrid.Columns(4).Visible = False
            'Me.ItemGrid.Columns(6).Visible = False
            'Me.ItemGrid.Columns(7).Visible = False
            'Me.ItemGrid.Columns(8).Visible = False
        End Sub


        Private Function GetItemVendorHistory() As System.Data.DataSet
            'Dim varType As Integer = 0
            'If Me.Page.Request.QueryString.Get("pItemNo") = "0" Then
            '    varType = 1
            'ElseIf Me.Page.Request.QueryString.Get("pVendorID") = "0" Then
            '    varType = 2
            'End If

            Dim firstParameter As BaseClasses.Data.StoredProcedureParameter = Nothing
            firstParameter = New BaseClasses.Data.StoredProcedureParameter("@p_Type", 1, System.Data.SqlDbType.Int, System.Data.ParameterDirection.Input)

            Dim secondParameter As BaseClasses.Data.StoredProcedureParameter = Nothing
            secondParameter = New BaseClasses.Data.StoredProcedureParameter("@p_CompanyID", CInt(CStr(Me.Page.Request.QueryString.Get("pCompanyID"))), System.Data.SqlDbType.Int, System.Data.ParameterDirection.Input)

            Dim thirdParameter As BaseClasses.Data.StoredProcedureParameter = Nothing
            thirdParameter = New BaseClasses.Data.StoredProcedureParameter("@p_ItemNo", CStr(Me.Page.Request.QueryString.Get("pItemNo")), System.Data.SqlDbType.VarChar, System.Data.ParameterDirection.Input)

            Dim fourthParameter As BaseClasses.Data.StoredProcedureParameter = Nothing
            fourthParameter = New BaseClasses.Data.StoredProcedureParameter("@p_VendorID", CStr(Me.Page.Request.QueryString.Get("pVendorID")), System.Data.SqlDbType.VarChar, System.Data.ParameterDirection.Input)

            Dim fifthParameter As BaseClasses.Data.StoredProcedureParameter = Nothing
            fifthParameter = New BaseClasses.Data.StoredProcedureParameter("@p_PONUMBR", CStr(Me.Page.Request.QueryString.Get("pPONUMBR")), System.Data.SqlDbType.VarChar, System.Data.ParameterDirection.Input)
            ...
            myStoredProcedure = New BaseClasses.Data.StoredProcedure("DatabaseANFLO-WF1", "usp_sel_WPO_ItemVendorHistory_Details", parameterList)

            'Dim TrTiID As String = ""
            ...
            Else
                Dim str As String = myStoredProcedure.ErrorMessage()
                Return Nothing
            End If
        End Function
