...
' This file implements the code-behind class for WPO_Comment1.aspx.
' App_Code\WPO_Comment1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WPO_Comment1
        Inherits BaseApplicationPage
' Code-behind class for the WPO_Comment1 page.
...
'        Public Sub SetSel_WPO_POP105501RecordControl()
'            SetSel_WPO_POP105501RecordControl_Base() 
'        End Sub
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "Sel_WPO_POP10550RecordControl"
                 SetSel_WPO_POP10550RecordControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.Sel_WPO_POP10550RecordControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetSel_WPO_POP10550RecordControl_Base()           
        
        
            If Sel_WPO_POP10550RecordControl.Visible Then
                Sel_WPO_POP10550RecordControl.LoadData()
                Sel_WPO_POP10550RecordControl.DataBind()
            End If
        End Sub        
