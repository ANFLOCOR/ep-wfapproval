...
' This file implements the code-behind class for rpt_PO_History1.aspx.
' App_Code\rpt_PO_History1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class rpt_PO_History1
        Inherits BaseApplicationPage
' Code-behind class for the rpt_PO_History1 page.
...
#Region "Section 1: Place your customizations here."
      ...
      'sParam & "&rc:Parameters=false"
            'sUrl = "http://" & sWebServer & "/reportserver?%2fWORKFLOW%2fPO+Approver+History&rs:Command=Render&UserID=" & _
            '    sParam & "&rc:Parameters=false"
            sUrl = "http://" & sWebServer & "/reportserver?%2fWORKFLOW%2fwf_po_approver_history&rs:Command=Render&UserID=" & _
                sParam & "&rc:Parameters=false"
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "ePortal Workflow Approval  - PO Approval History (North)"
