...
' This file implements the code-behind class for Show_WPO_WFTask.aspx.
' App_Code\Show_WPO_WFTask.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_WPO_WFTask
        Inherits BaseApplicationPage
' Code-behind class for the Show_WPO_WFTask page.
