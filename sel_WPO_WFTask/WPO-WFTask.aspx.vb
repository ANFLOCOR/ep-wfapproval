...
' This file implements the code-behind class for WPO_WFTask.aspx.
' App_Code\Edit_Sel_WPO_WFTask.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WPO_WFTask
        Inherits BaseApplicationPage
' Code-behind class for the WPO_WFTask page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            ...
            If Not IsNull(System.Web.HttpContext.Current.Session("UserID1").ToString()) Then
                System.Web.HttpContext.Current.Session("ActivityUserID") = System.Web.HttpContext.Current.Session("UserID1").ToString()
            End If
            ...
            If WPOP_Status.Text = "Completed" Then
        ...
        Protected Sub ddlAction_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlAction.SelectedIndexChanged
            ...
            If ddlAction.SelectedIndex = 2 Or ddlAction.SelectedIndex = 1 Then 'RETURN
                Try
                    ...
                    wc1.iAND(WPO_ActivityTable.WPO_WDT_ID, BaseFilter.ComparisonOperator.EqualsTo, Me.WPOP_DT_ID1.Text)
                    wc1.iAND(WPO_ActivityTable.WPO_W_U_ID, BaseFilter.ComparisonOperator.EqualsTo, System.Web.HttpContext.Current.Session("ActivityUserID").ToString())

                    Dim itemValue1 As WPO_ActivityRecord
                    Dim bNoParent As Boolean = False
                    Dim sStepID As String = ""
                    Dim sStepType As String = ""
                    For Each itemValue1 In WPO_ActivityTable.GetRecords(wc1, Nothing, 0, 100)
                        If (itemValue1.WPO_WS_IDSpecified) Then
                            ...
                            Do While sStepType <> "Start"
                                ...
                                Dim itemValue2 As WPO_StepRecord
                                wc2.iAND(WPO_StepTable.WPO_S_ID_Next, BaseFilter.ComparisonOperator.EqualsTo, sStepID)


                                If WPO_StepTable.GetRecords(wc2, Nothing, 0, 100).Length > 0 Then
                                    For Each itemValue2 In WPO_StepTable.GetRecords(wc2, Nothing, 0, 100)
                    ...
                    cvalue1 = "0"
                    fvalue1 = Me.WPOP_U_ID.SelectedItem.ToString 'Me.WPOP_U_ID.Text '"Creator"
