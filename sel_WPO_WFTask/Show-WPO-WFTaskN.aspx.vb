...
' This file implements the code-behind class for Show_WPO_WFTaskN.aspx.
' App_Code\Show_WPO_WFTaskN.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_WPO_WFTaskN
        Inherits BaseApplicationPage
' Code-behind class for the Show_WPO_WFTaskN page.
