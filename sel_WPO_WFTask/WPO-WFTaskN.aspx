...
<asp:Button runat="server" id="btnApprove" causesvalidation="True" commandname="Redirect" consumers="page" text="&lt;%# GetResourceValue(&quot;Approve&quot;, &quot;ePortalWFApproval&quot;) %>" tooltip="&lt;%# GetResourceValue(&quot;Approve&quot;, &quot;ePortalWFApproval&quot;) %>" width="100px">		
	</asp:Button></td><td class="dfv" style="white-space:nowrap;text-align:center;"><asp:Button runat="server" id="btnReturn" causesvalidation="False" commandname="Redirect" consumers="page" text="Return" width="100px">		
	</asp:Button></td><td class="dfv" style="white-space:nowrap;text-align:center;"><asp:Button CommandName="Redirect" runat="server" id="btnReject" causesvalidation="false" text="&lt;%# GetResourceValue(&quot;Reject&quot;, &quot;ePortalWFApproval&quot;) %>" tooltip="&lt;%# GetResourceValue(&quot;Reject&quot;, &quot;ePortalWFApproval&quot;) %>" width="100px">		
...
<%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("EditButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("CancelButton"))%>
</td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="fls" style="white-space:nowrap;text-align:left;"><asp:Literal runat="server" id="TRDISAMTLabel" Text="Trade Disc.">	</asp:Literal></td><td style="white-space:nowrap;text-align:right;"><span style="white-space:nowrap;">
<asp:Label runat="server" id="TRDISAMT"></asp:Label></span>
</td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="fls" style="white-space:nowrap;text-align:left;"><asp:Literal runat="server" id="FRTAMNTLabel" Text="Freight">	</asp:Literal></td><td style="white-space:nowrap;text-align:right;"><span style="white-space:nowrap;">
<asp:Label runat="server" id="FRTAMNT1"></asp:Label></span>
</td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="fls" style="white-space:nowrap;text-align:left;"><asp:Literal runat="server" id="TAXAMNTLabel" Text="Tax">	</asp:Literal></td><td style="white-space:nowrap;text-align:right;"><span style="white-space:nowrap;">
<asp:Label runat="server" id="TAXAMNT"></asp:Label></span>
</td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="fls" style="white-space:nowrap;text-align:left;"><asp:Literal runat="server" id="MSCCHAMTLabel" Text="Misc">	</asp:Literal></td><td style="white-space:nowrap;text-align:right;"><span style="white-space:nowrap;">
<asp:Label runat="server" id="MSCCHAMT"></asp:Label></span>
</td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="fls" style="white-space:nowrap;text-align:left;"><asp:Literal runat="server" id="TOTALLabel" Text="Total">	</asp:Literal></td><td style="white-space:nowrap;text-align:right;"><span style="white-space:nowrap;">
