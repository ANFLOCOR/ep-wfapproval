...
<ePortalWFApproval:Sel_WPO_WFTaskRecordControl runat="server" id="Sel_WPO_WFTaskRecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelHeaderL"></td><td class="dh">
                  ...
                  <asp:panel id="Sel_WPO_WFTaskRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
                    <asp:panel id="Sel_WPO_WFTaskRecordControlPanel" runat="server"><table><tr><td class="fls"></td><td class="fls" style="text-align:left;" colspan="6"><asp:literal id="Literal8" runat="server" text="&nbsp" /></td><td class="fls" style="text-align:left;"></td></tr><tr><td class="fls"></td><td class="fls" style="text-align:left;font-weight:bold;"><asp:Literal runat="server" id="CompanyIDLabel" Text="Company">	</asp:Literal></td><td style="color:Black;font-family:Tahoma;text-align:left;"><asp:literal id="litSpace" runat="server" text="&nbsp;&nbsp;&nbsp;&nbsp;" /></td><td style="width:500px;text-align:left;font-weight:bold;"><b><span style="font-family:Tahoma;font-size:10pt"><span style="white-space:nowrap;">
<asp:Label runat="server" id="CompanyID" forecolor="Black"></asp:Label></span>
...
</span></b></td><td class="dfv" style="white-space:nowrap;"><asp:literal id="Literal1" runat="server" text="&nbsp;&nbsp;" /></td><td class="dfv" style="white-space:nowrap;text-align:right;" rowspan="6" colspan="2"><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("CancelButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("EditButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("OKButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveAndNewButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="WPOP_RemarkTextBoxMaxLengthValidator" ControlToValidate="WPOP_Remark" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ePortalWFApproval&quot;).Replace(&quot;{FieldName}&quot;, &quot;WPOP Remark&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td><td class="fls"></td><td class="fls"></td><td class="fls"></td></tr><tr><td class="fls"></td><td class="fls" style="text-align:left;" colspan="6">&nbsp;</td></tr><tr><td class="fls"></td><td class="fls" style="text-align:center;" colspan="3"><span style="white-space:nowrap;">
...
<asp:Button runat="server" id="btnApprove" causesvalidation="True" commandname="Redirect" consumers="page" text="&lt;%# GetResourceValue(&quot;Approve&quot;, &quot;ePortalWFApproval&quot;) %>" tooltip="&lt;%# GetResourceValue(&quot;Approve&quot;, &quot;ePortalWFApproval&quot;) %>" width="120px">		
	</asp:Button> 
<asp:Literal runat="server" id="litSpace1" Text="&amp;nbsp;&amp;nbsp;">	</asp:Literal> 
<asp:Button runat="server" id="btnReturn" causesvalidation="False" commandname="Redirect" consumers="page" text="Return" width="120px">		
	</asp:Button> 
<asp:Literal runat="server" id="litSpace2" Text="&amp;nbsp;&amp;nbsp;">	</asp:Literal> 
<asp:Button CommandName="Redirect" runat="server" id="btnReject" causesvalidation="false" text="&lt;%# GetResourceValue(&quot;Reject&quot;, &quot;ePortalWFApproval&quot;) %>" tooltip="&lt;%# GetResourceValue(&quot;Reject&quot;, &quot;ePortalWFApproval&quot;) %>" width="120px">		
	</asp:Button> 
</td><td class="dfv" style="white-space:nowrap;text-align:left;"><asp:dropdownlist id="ddlMoveTo" runat="server" class="fls" width="238px" Name="ddlMoveTo">
...
</td><td class="dfv" style="white-space:nowrap;text-align:right;"><asp:literal id="Literal7" runat="server" text="&nbsp" /></td></tr><tr><td class="fls"></td><td class="fls" style="text-align:left;font-weight:bold;"><asp:Literal runat="server" id="DOCDATELabel" Text="Doc. Date">	</asp:Literal></td><td style="text-align:left;"></td><td style="width:500px;text-align:left;font-weight:bold;"><b><span style="font-family:Tahoma;font-size:10pt"><span style="white-space:nowrap;">
<asp:Label runat="server" id="DOCDATE" forecolor="Black"></asp:Label></span>
</span></b></td><td style="color:Black;font-family:Tahoma;text-align:left;"></td><td class="dfv" style="white-space:nowrap;text-align:right;"></td></tr><tr><td class="fls" style="text-align:left;"><asp:literal id="Literal2" runat="server" text="&nbsp;" /></td><td class="fls" style="text-align:left;font-weight:bold;"><asp:Literal runat="server" id="PONUMBERLabel" Text="PO Number">	</asp:Literal></td><td style="text-align:left;"></td><td style="width:500px;text-align:left;font-weight:bold;"><b><span style="font-family:Tahoma;font-size:10pt"><asp:Label runat="server" id="PONUMBER" forecolor="Black"></asp:Label></span></b></td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="fls" style="text-align:left;font-weight:bold;"><asp:Literal runat="server" id="VENDNAMELabel" Text="Vendor">	</asp:Literal></td><td style="text-align:left;"></td><td style="width:500px;text-align:left;font-weight:bold;"><b><span style="font-family:Tahoma;font-size:10pt"><asp:Label runat="server" id="VENDNAME" forecolor="Black"></asp:Label></span></b></td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="fls" style="text-align:left;font-weight:bold;"><asp:Literal runat="server" id="BUYERIDLabel" Text="Buyer">	</asp:Literal></td><td style="text-align:left;"></td><td style="width:500px;text-align:left;font-weight:bold;"><b><span style="font-family:Tahoma;font-size:10pt"><asp:Label runat="server" id="BUYERID" forecolor="Black"></asp:Label></span></b></td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="dfv" style="white-space:nowrap;text-align:left;"><asp:Literal runat="server" id="BUYERIDLabel1" Text="Payment Terms">	</asp:Literal></td><td style="text-align:left;"></td><td style="width:500px;text-align:left;font-weight:bold;color:Black;"><b><span style="font-family:Tahoma;font-size:10pt"><asp:Literal runat="server" id="litPaymentTerms" Text="&amp;nbsp;">	</asp:Literal></span></b></td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="fls" style="color:Black;font-family:Tahoma;text-align:left;text-decoration:underline;"></td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td><td class="fls" style="color:Black;font-family:Tahoma;text-align:left;text-decoration:underline;"></td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="fls" style="color:Black;font-family:Tahoma;text-align:left;text-decoration:underline;"><asp:Label runat="server" id="Label" Text="TOTALS" font-bold="True" font-underline="True">	</asp:Label></td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td><td class="fls" style="color:Black;font-family:Tahoma;text-align:left;text-decoration:underline;"></td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="fls" style="text-align:left;font-weight:bold;"><asp:Literal runat="server" id="SUBTOTALLabel" Text="Sub Total">	</asp:Literal></td><td style="white-space:nowrap;text-align:right;"></td><td style="text-align:right;font-weight:bold;"><span style="white-space:nowrap;">
<asp:Label runat="server" id="SUBTOTAL1" forecolor="Black"></asp:Label></span>
</td><td class="dfv" style="white-space:nowrap;"></td><td class="fls" style="text-align:left;border-width:0px 0px 0px 0px;border-style:solid;" rowspan="6" colspan="2"><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("CancelButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("EditButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("OKButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveAndNewButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
...
<%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("EditButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("CancelButton"))%>
</td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="fls" style="text-align:left;font-weight:bold;"><asp:Literal runat="server" id="TRDISAMTLabel" Text="Trade Disc.">	</asp:Literal></td><td style="white-space:nowrap;text-align:right;"></td><td style="text-align:right;font-weight:bold;"><span style="white-space:nowrap;">
<asp:Label runat="server" id="TRDISAMT" forecolor="Black"></asp:Label></span>
</td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="fls" style="text-align:left;font-weight:bold;"><asp:Literal runat="server" id="FRTAMNTLabel" Text="Freight">	</asp:Literal></td><td style="white-space:nowrap;text-align:right;"></td><td style="text-align:right;font-weight:bold;"><span style="white-space:nowrap;">
<asp:Label runat="server" id="FRTAMNT1" forecolor="Black"></asp:Label></span>
</td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="fls" style="text-align:left;font-weight:bold;"><asp:Literal runat="server" id="TAXAMNTLabel" Text="Tax">	</asp:Literal></td><td style="white-space:nowrap;text-align:right;"></td><td style="text-align:right;font-weight:bold;"><span style="white-space:nowrap;">
<asp:Label runat="server" id="TAXAMNT" forecolor="Black"></asp:Label></span>
</td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="fls" style="text-align:left;font-weight:bold;"><asp:Literal runat="server" id="MSCCHAMTLabel" Text="Misc">	</asp:Literal></td><td style="white-space:nowrap;text-align:right;"></td><td style="text-align:right;font-weight:bold;"><span style="white-space:nowrap;">
<asp:Label runat="server" id="MSCCHAMT" forecolor="Black"></asp:Label></span>
</td><td class="dfv" style="white-space:nowrap;"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="fls" style="text-align:left;font-weight:bold;"><asp:Literal runat="server" id="TOTALLabel" Text="Total">	</asp:Literal></td><td style="white-space:nowrap;text-align:right;"></td><td style="text-align:right;font-weight:bold;"><span style="white-space:nowrap;">
<asp:Label runat="server" id="TOTAL" forecolor="Black"></asp:Label></span>
...
<tr><td class="ttc"><asp:ImageButton runat="server" id="ImageButton1" causesvalidation="False" commandname="Redirect" imageurl="../Images/icon-view.png" onmouseout="this.src=&#39;../Images/icon-view.png&#39;" onmouseover="this.src=&#39;../Images/icon-view-over.png&#39;" tooltip="&lt;%# GetResourceValue(&quot;Txt:ViewRecord&quot;, &quot;ePortalWFApproval&quot;) %>">		
