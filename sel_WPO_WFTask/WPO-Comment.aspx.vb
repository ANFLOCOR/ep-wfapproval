...
' This file implements the code-behind class for WPO_Comment.aspx.
' App_Code\WPO_Comment.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WPO_Comment
        Inherits BaseApplicationPage
' Code-behind class for the WPO_Comment page.
