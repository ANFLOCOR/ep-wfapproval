<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.Show_WPO_WFTaskN" %>

<%@ Register Tagprefix="Selectors" Namespace="ePortalWFApproval" %>

<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-WPO-WFTaskN.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="ePortalWFApproval.UI.Show_WPO_WFTaskN" %>
...
<ePortalWFApproval:Sel_WPO_WFTaskRecordControl runat="server" id="Sel_WPO_WFTaskRecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelHeaderL"></td><td class="dh">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dhtr" valign="middle" style="font-weight:bold;font-size:12pt;font-family:Tahoma;color:#016106"><asp:Literal runat="server" id="Sel_WPO_WFTaskTitle" Text="PO Approval - View Page (North)">	</asp:Literal></td></tr></table>
                  ...
                  <asp:panel id="Sel_WPO_WFTaskRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
                    <asp:panel id="Sel_WPO_WFTaskRecordControlPanel" runat="server"><table><tr><td class="fls"></td><td class="fls" style="text-align:left;" colspan="5"><asp:literal id="Literal8" runat="server" text="&nbsp" /></td><td class="fls" style="text-align:left;"></td></tr><tr><td class="fls"></td><td class="fls" style="white-space:nowrap;text-align:left;"><asp:Literal runat="server" id="CompanyIDLabel" Text="Company">	</asp:Literal></td><td style="white-space:nowrap;text-align:left;"><span style="white-space:nowrap;">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="WPOP_RemarkTextBoxMaxLengthValidator" ControlToValidate="WPOP_Remark" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ePortalWFApproval&quot;).Replace(&quot;{FieldName}&quot;, &quot;WPOP Remark&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td><td class="fls"></td><td class="fls"></td><td class="fls"></td></tr><tr><td class="fls"></td><td class="fls" style="text-align:left;" colspan="6">&nbsp;</td></tr><tr><td class="fls" style="display:none"></td><td class="fls" style="display:none"><span style="white-space:nowrap;">
...
<asp:Button runat="server" id="btnApprove" causesvalidation="True" commandname="Redirect" consumers="page" text="&lt;%# GetResourceValue(&quot;Approve&quot;, &quot;ePortalWFApproval&quot;) %>" tooltip="&lt;%# GetResourceValue(&quot;Approve&quot;, &quot;ePortalWFApproval&quot;) %>">		
	</asp:Button></td><td class="dfv" style="display:none"><asp:Button runat="server" id="btnReturn" causesvalidation="False" commandname="Redirect" consumers="page" text="Return">		
	</asp:Button></td><td class="dfv" style="display:none"><asp:Button CommandName="Redirect" runat="server" id="btnReject" causesvalidation="false" text="&lt;%# GetResourceValue(&quot;Reject&quot;, &quot;ePortalWFApproval&quot;) %>" tooltip="&lt;%# GetResourceValue(&quot;Reject&quot;, &quot;ePortalWFApproval&quot;) %>">		
	</asp:Button></td><td class="dfv" style="display:none"><asp:dropdownlist id="ddlMoveTo" runat="server" class="fls" width="238px" Name="ddlMoveTo">
	
</asp:dropdownlist></td><td class="fls" style="display:none"></td><td class="fls" style="display:none"></td></tr></table></asp:panel>
...
<ePortalWFApproval:Sel_WPO_WFTaskActivity_RemarksRecordControl runat="server" id="Sel_WPO_WFTaskActivity_RemarksRecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td>
                  <asp:panel id="Sel_WPO_WFTaskActivity_RemarksRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
                    <asp:panel id="Sel_WPO_WFTaskActivity_RemarksRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="fls" style="text-align:left;"><asp:Literal runat="server" id="WPO_RemarkLabel1" Text="Comment(s)">	</asp:Literal></td></tr><tr><td class="fls" style="text-align:left;"><asp:TextBox runat="server" id="WPO_Remark1" MaxLength="1073741823" columns="60" cssclass="field_input" readonly="True" rows="6" textmode="MultiLine"></asp:TextBox>&nbsp;
...
<tr><td class="ttc" style="text-align:left;"><asp:ImageButton runat="server" id="ImageButton" causesvalidation="False" commandname="Redirect" imageurl="../Images/icon_view.gif" tooltip="&lt;%# GetResourceValue(&quot;Txt:ViewRecord&quot;, &quot;ePortalWFApproval&quot;) %>">		
...
<tr><td class="ttc"><asp:ImageButton runat="server" id="ImageButton2" causesvalidation="False" commandname="Redirect" imageurl="../Images/icon_view.gif">		
