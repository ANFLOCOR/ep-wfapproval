			...
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table><tr><td><asp:Literal runat="server" id="HFIN_C_IDLabel" Text="Company">	</asp:Literal></td><td><asp:DropDownList runat="server" id="HFIN_C_IDFromFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)" width="200px">	</asp:DropDownList> <span class="rft"></span> </td><td></td></tr><tr><td><asp:Literal runat="server" id="AFIN_StatusLabel1" Text="Status">	</asp:Literal></td><td><asp:DropDownList runat="server" id="AFIN_StatusFromFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)" width="200px">	</asp:DropDownList> <span class="rft"></span> </td><td><ePortalWFApproval:ThemeButton runat="server" id="GoButton" button-causesvalidation="false" button-commandname="Search" button-text="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;ePortalWFApproval&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;ePortalWFApproval&quot;) %>" postback="False"></ePortalWFApproval:ThemeButton></td></tr></table>
