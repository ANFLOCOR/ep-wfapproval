...
' This file implements the code-behind class for WFin_RepInquiryView.aspx.
' App_Code\WFin_RepInquiryView.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class WFin_RepInquiryView
        Inherits BaseApplicationPage
' Code-behind class for the WFin_RepInquiryView page.
...
#Region "Section 1: Place your customizations here."
      ...
      End Sub
       ...
       Public Sub LoadData()
            ...
            Dim sWebServer As String = System.Configuration.ConfigurationManager.AppSettings.Item("WebServer1")
            ...
            Select Case sParamDB
                ...
                Case Else
                    If IsNumeric(sParamDB) Then
                        ...
                        Dim compRec As Vw_ANFLO_DW_CompanyNonGPRecord = Vw_ANFLO_DW_CompanyNonGPView.GetRecord("CompanyID=" & sParamDB, obC)
