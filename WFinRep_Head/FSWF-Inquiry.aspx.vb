...
' This file implements the code-behind class for FSWF_Inquiry.aspx.
...
Partial Public Class FSWF_Inquiry
        Inherits BaseApplicationPage
' Code-behind class for the FSWF_Inquiry page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SetWFinRep_HeadTableControl()
            SetWFinRep_HeadTableControl_Base() 
        End Sub
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.WFinRep_HeadTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetWFinRep_HeadTableControl_Base()           
