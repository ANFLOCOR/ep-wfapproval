<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="WFinRep-DocType-QuickSelector1.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="ePortalWFApproval.UI.WFinRep_DocType_QuickSelector1" %>
<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.WFinRep_DocType_QuickSelector1" %>
