...
' This file implements the code-behind class for Inquiry_WCanvass_Quotation_Internal_File.aspx.
' App_Code\Inquiry_WCanvass_Quotation_Internal_File.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Inquiry_WCanvass_Quotation_Internal_File
        Inherits BaseApplicationPage
' Code-behind class for the Inquiry_WCanvass_Quotation_Internal_File page.
