...
' This file implements the code-behind class for Show_WCanvass_Internal.aspx.
' App_Code\Show_WCanvass_Internal.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_WCanvass_Internal
        Inherits BaseApplicationPage
' Code-behind class for the Show_WCanvass_Internal page.
