...
' This file implements the code-behind class for Inquiry_POP30300_POP30310_Vendor_Item1.aspx.
' App_Code\Inquiry_POP30300_POP30310_Vendor_Item1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Inquiry_POP30300_POP30310_Vendor_Item1
        Inherits BaseApplicationPage
' Code-behind class for the Inquiry_POP30300_POP30310_Vendor_Item1 page.
...
Public Sub SetSel_POP30300_POP303101TableControl()
            SetSel_POP30300_POP303101TableControl_Base() 
        End Sub
'<System.Web.Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_Sel_POP30300_POP303101SearchText(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetSel_POP30300_POP303101SearchTextCompletionList gets the list of suggestions from the database.
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "Sel_POP30300_POP303101TableControl"
                 SetSel_POP30300_POP303101TableControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.Sel_POP30300_POP303101TableControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetSel_POP30300_POP303101TableControl_Base()           
        
        
            If Sel_POP30300_POP303101TableControl.Visible Then
                Sel_POP30300_POP303101TableControl.LoadData()
                Sel_POP30300_POP303101TableControl.DataBind()
            End If
        End Sub        
