...
<table><tr><td><ePortalWFApproval:ThemeButton runat="server" id="btnBack" button-causesvalidation="False" button-commandname="Redirect" button-text="Back" button-tooltip="Back"></ePortalWFApproval:ThemeButton></td><td style="display:none;"><ePortalWFApproval:ThemeButton runat="server" id="btnPrint" button-causesvalidation="False" button-text="&lt;%# GetResourceValue(&quot;Print Canvass&quot;, &quot;ePortalWFApproval&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Print Canvass&quot;, &quot;ePortalWFApproval&quot;) %>"></ePortalWFApproval:ThemeButton></td><td style="display:none;"><ePortalWFApproval:ThemeButton runat="server" id="EditButton" button-causesvalidation="False" button-commandname="Redirect" button-text="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;ePortalWFApproval&quot;) %>" visible="False"></ePortalWFApproval:ThemeButton></td><td><ePortalWFApproval:ThemeButton runat="server" id="OKButton" button-causesvalidation="False" button-commandname="Custom" button-text="&lt;%# GetResourceValue(&quot;Back&quot;, &quot;ePortalWFApproval&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Back to Previous Page&quot;, &quot;ePortalWFApproval&quot;) %>" visible="False"></ePortalWFApproval:ThemeButton></td></tr></table>
</td></tr><tr><td>
