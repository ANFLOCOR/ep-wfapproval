...
' This file implements the code-behind class for Inquiry_POP30300_POP30310_Vendor1.aspx.
' App_Code\Inquiry_POP30300_POP30310_Vendor1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Inquiry_POP30300_POP30310_Vendor1
        Inherits BaseApplicationPage
' Code-behind class for the Inquiry_POP30300_POP30310_Vendor1 page.
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "Sel_POP30300_POP30310TableControl"
                 SetSel_POP30300_POP30310TableControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.Sel_POP30300_POP30310TableControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetSel_POP30300_POP30310TableControl_Base()           
        
        
            If Sel_POP30300_POP30310TableControl.Visible Then
                Sel_POP30300_POP30310TableControl.LoadData()
                Sel_POP30300_POP30310TableControl.DataBind()
            End If
        End Sub        
