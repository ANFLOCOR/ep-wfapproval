...
' This file implements the code-behind class for Inquiry_WCanvass_Quotation_Internal_File1.aspx.
' App_Code\Inquiry_WCanvass_Quotation_Internal_File1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Inquiry_WCanvass_Quotation_Internal_File1
        Inherits BaseApplicationPage
' Code-behind class for the Inquiry_WCanvass_Quotation_Internal_File1 page.
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "WCanvass_Quotation_InternalTableControl"
      ...
      Public Sub SaveData_Base()
        ...
        Me.WCanvass_Quotation_InternalTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetWCanvass_Quotation_InternalTableControl_Base()           
