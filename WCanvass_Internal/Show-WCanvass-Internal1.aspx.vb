...
' This file implements the code-behind class for Show_WCanvass_Internal1.aspx.
' App_Code\Show_WCanvass_Internal1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_WCanvass_Internal1
        Inherits BaseApplicationPage
' Code-behind class for the Show_WCanvass_Internal1 page.
...
'        Public Sub SetWCanvass_Internal1RecordControl()
'            SetWCanvass_Internal1RecordControl_Base() 
'        End Sub
...
Public Sub SetWCanvass_InternalRecordControl()
            SetWCanvass_InternalRecordControl_Base() 
        End Sub
<System.Web.Services.WebMethod()> _
...
#Region "Section 2: Do not modify this section."
    ...
    Public Shared Function GetRecordFieldValue_Base(ByVal tableName As String, _
        ...
        'Now format the content if there are any text formatting done on the page based on the column name.
        Select Case fieldName
        
            Case "WCDI_Aw1"
                content = String.Format("PREFERRED VENDOR: <font color=blue>{0}</font>", content)
    ...
    End Function
      ...
      Public Sub SetControl_Base(ByVal control As String)
          ...
          Select Case control
              ...
              Case "WCanvass_InternalRecordControl"
                 SetWCanvass_InternalRecordControl()
      ...
      Public Sub SaveData_Base()
        ...
        Me.WCanvass_InternalRecordControl.SaveData()
      ...
      End Sub  
        ...
        Public Sub SetWCanvass_InternalRecordControl_Base()           
        
        
            If WCanvass_InternalRecordControl.Visible Then
                WCanvass_InternalRecordControl.LoadData()
                WCanvass_InternalRecordControl.DataBind()
            End If
        End Sub        
