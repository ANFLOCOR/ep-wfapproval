<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.Inquiry_POP30300_POP30310_Vendor_Item1" %>
...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Inquiry-POP30300-POP30310-Vendor-Item1.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Blank.master" Inherits="ePortalWFApproval.UI.Inquiry_POP30300_POP30310_Vendor_Item1" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
      ...
      <asp:UpdateProgress runat="server" id="UpdatePanel1_UpdateProgress1" AssociatedUpdatePanelID="UpdatePanel1">
		...
		<asp:UpdatePanel runat="server" id="UpdatePanel1" UpdateMode="Conditional">
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td><ePortalWFApproval:Sel_POP30300_POP303101TableControl runat="server" id="Sel_POP30300_POP303101TableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td><asp:literal id="Literal" runat="server" text="&nbsp;" /></td></tr><tr><td class="dfv"><asp:Literal runat="server" id="litVendor" Text="NONE">	</asp:Literal></td></tr><tr><td><asp:literal id="Literal1" runat="server" text="&nbsp;" /></td></tr><tr><td class="panelB"><asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"> 
...
<asp:Literal runat="server" id="receiptdate"></asp:Literal></span>
</td></tr></ePortalWFApproval:Sel_POP30300_POP303101TableControlRow>
</ITEMTEMPLATE>
	...
	<asp:hiddenfield id="Sel_POP30300_POP303101TableControl_PostbackTracker" runat="server" />
</ePortalWFApproval:Sel_POP30300_POP303101TableControl>
</td></tr></table>
      </ContentTemplate>
</asp:UpdatePanel>
