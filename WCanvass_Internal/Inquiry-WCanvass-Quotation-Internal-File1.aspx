<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Inquiry-WCanvass-Quotation-Internal-File1.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Blank.master" Inherits="ePortalWFApproval.UI.Inquiry_WCanvass_Quotation_Internal_File1" %>
...
<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.Inquiry_WCanvass_Quotation_Internal_File1" %>
      ...
      <asp:UpdateProgress runat="server" id="UpdatePanel1_UpdateProgress1" AssociatedUpdatePanelID="UpdatePanel1">
		...
		<asp:UpdatePanel runat="server" id="UpdatePanel1" UpdateMode="Conditional">
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td><ePortalWFApproval:WCanvass_Quotation_InternalTableControl runat="server" id="WCanvass_Quotation_InternalTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td>
